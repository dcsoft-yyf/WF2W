...
namespace System.Windows.Forms {
    ...
    internal class DataStreamFromComStream : Stream {
        ...
        private WinFormUnsafeNativeMethods.IStream comStream;

        public DataStreamFromComStream(WinFormUnsafeNativeMethods.IStream comStream) : base() {
        ...
        */
        ...
        public unsafe override void Write(byte[] buffer, int index, int count) {
            ...
            if (bytesWritten < count) {
                throw new IOException(DCSR.GetString(DCSR.DataStreamWrite));
            }
        }
        ...
        protected override void Dispose(bool disposing) {
            try {               
                if (disposing && comStream != null) {
                    try {
                        comStream.Commit(WinFormNativeMethods.STGC_DEFAULT);
                    }
                    catch(Exception) {
                    }
                }
