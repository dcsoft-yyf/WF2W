...
namespace System.Windows.Forms {
    ...
    SRDescription(DCSR.DescriptionDomainUpDown)
    ]
[System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = false )]
    public class DomainUpDown : UpDownBase {
        ...
        SRDescription(DCSR.DomainUpDownItemsDescr),
        Localizable(true),
        ...
        SRDescription(DCSR.DomainUpDownSelectedIndexDescr)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.DomainUpDownSelectedItemDescr)
        ]
        ...
        DefaultValue(false),
        SRDescription(DCSR.DomainUpDownSortedDescr)
        ]
        public bool Sorted {
        ...
        Localizable(true),
        DefaultValue(false),
        SRDescription(DCSR.DomainUpDownWrapDescr)
        ]
        public bool Wrap {
        ...
        ///    </para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.DomainUpDownOnSelectedItemChangedDescr)]
        ...
        public class DomainUpDownItemCollection : ArrayList {
            ...
            public override void Remove(object item) {
                ...
                if (index == -1) {
                    throw new ArgumentOutOfRangeException("item", DCSR.GetString(DCSR.InvalidArgument, "item", item.ToString()));
                }
                else {
                    RemoveAt(index);    
                }
