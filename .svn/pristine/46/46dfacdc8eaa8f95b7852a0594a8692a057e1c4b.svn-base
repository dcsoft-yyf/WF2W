...
namespace System.Windows.Forms
{
    ...
    public class DataGridViewRow : DataGridViewBand
    {
        ...
        [
            ...
            SRDescription(DCSR.DataGridView_RowContextMenuStripDescr)
        ]
        ...
        [
            ...
            SRDescription(DCSR.DataGridView_RowDefaultCellStyleDescr)
        ]
        public override DataGridViewCellStyle DefaultCellStyle
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidPropertySetOnSharedRow, "DefaultCellStyle"));
                }
        ...
        public override bool Displayed
        {
            get
            {
                if (this.DataGridView != null && this.Index == -1)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidPropertyGetOnSharedRow, "Displayed"));
                }
        ...
        [
            ...
            NotifyParentProperty(true),
            SRCategory(DCSR.CatAppearance),
            SRDescription(DCSR.DataGridView_RowDividerHeightDescr)
        ]
        public int DividerHeight
        {
            ...
            set 
            {
                if (this.DataGridView != null && this.Index == -1)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidPropertySetOnSharedRow, "DividerHeight"));
                }
        ...
        [
            ...
            NotifyParentProperty(true),
            SRCategory(DCSR.CatAppearance),
            SRDescription(DCSR.DataGridView_RowErrorTextDescr)
        ]
        ...
        public override bool Frozen
        {
            get
            {
                if (this.DataGridView != null && this.Index == -1)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidPropertyGetOnSharedRow, "Frozen"));
                }
            ...
            set
            {
                if (this.DataGridView != null && this.Index == -1)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidPropertySetOnSharedRow, "Frozen"));
                }
                base.Frozen = value;
            }
        }
        ...
        [
            ...
            NotifyParentProperty(true),
            SRCategory(DCSR.CatAppearance),
            SRDescription(DCSR.DataGridView_RowHeightDescr)
        ]
        public int Height
        {
            get
            ...
            set
            {
                if (this.DataGridView != null && this.Index == -1)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidPropertySetOnSharedRow, "Height"));
                }
        ...
        public override DataGridViewCellStyle InheritedStyle
        {
            get
            {
                if (this.Index == -1)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidPropertyGetOnSharedRow, "InheritedStyle"));
                }
        ...
        public int MinimumHeight
        {
            ...
            set
            {
                if (this.DataGridView != null && this.Index == -1)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidPropertySetOnSharedRow, "MinimumHeight"));
                }
        ...
        [
            ...
            NotifyParentProperty(true),
            SRCategory(DCSR.CatBehavior),
            SRDescription(DCSR.DataGridView_RowReadOnlyDescr)
        ]
        public override bool ReadOnly
        {
            get
            {
                if (this.DataGridView != null && this.Index == -1)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidPropertyGetOnSharedRow, "ReadOnly"));
                }
        ...
        [
            NotifyParentProperty(true),
            SRCategory(DCSR.CatBehavior),
            SRDescription(DCSR.DataGridView_RowResizableDescr)
        ]
        public override DataGridViewTriState Resizable
        {
            get
            {
                if (this.DataGridView != null && this.Index == -1)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidPropertyGetOnSharedRow, "Resizable"));
                }
        ...
        public override bool Selected
        {
            get
            {
                if (this.DataGridView != null && this.Index == -1)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidPropertyGetOnSharedRow, "Selected"));
                }
        ...
        public override DataGridViewElementStates State
        {
            get
            {
                if (this.DataGridView != null && this.Index == -1)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidPropertyGetOnSharedRow, "State"));
                }
        ...
        public override bool Visible
        {
            get
            {
                if (this.DataGridView != null && this.Index == -1)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidPropertyGetOnSharedRow, "Visible"));
                }
            ...
            set
            {
                if (this.DataGridView != null && this.Index == -1)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidPropertySetOnSharedRow, "Visible"));
                }
                base.Visible = value;
            }
        }
        ...
        public void CreateCells(DataGridView dataGridView)
        {
            ...
            foreach (DataGridViewColumn dataGridViewColumn in dataGridViewColumns)
            {
                ...
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_AColumnHasNoCellTemplate));
                }
            ...
            bool cellsPaintSelectionBackground)
        {
            if (this.DataGridView == null)
            {
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_RowDoesNotYetBelongToDataGridView));
            }
            if (graphics == null)
            {
        ...
        public ContextMenuStrip GetContextMenuStrip(int rowIndex)
        {
            ...
            if (this.DataGridView != null)
            {
                if (rowIndex == -1)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidOperationOnSharedRow));
                }
        ...
        public virtual DataGridViewElementStates GetState(int rowIndex)
        {
            ...
            if (this.DataGridView == null || this.DataGridView.Rows.SharedRow(rowIndex).Index != -1)
            {
                ...
                {
                    throw new ArgumentException(DCSR.GetString(DCSR.InvalidArgument, "rowIndex", rowIndex.ToString(CultureInfo.CurrentCulture)));
                }
                return base.State;
            }
            else 
            ...
            DataGridViewPaintParts paintParts)
        {
            ...
            {
                throw new ArgumentException(DCSR.GetString(DCSR.DataGridView_InvalidDataGridViewPaintPartsCombination, "paintParts"));
            }
        ...
        public bool SetValues(params object[] values)
        {
            ...
            if (this.DataGridView != null)
            {
                ...
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidOperationInVirtualMode));
                }
                if (this.Index == -1)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidOperationOnSharedRow));
        ...
        protected class DataGridViewRowAccessibleObject : AccessibleObject
        {
            ...
            public override Rectangle Bounds
            {
                get {
                    ...
                    if (this.owner == null)
                    {
                        throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewRowAccessibleObject_OwnerNotSet));
                    }
            ...
            public override string Name
            {
                get
                {
                    ...
                    return DCSR.GetString(DCSR.DataGridView_AccRowName, this.owner.Index.ToString(CultureInfo.CurrentCulture));
                }
            }
            ...
            public DataGridViewRow Owner
            {
                ...
                set
                {
                    if (this.owner != null)
                    {
                        throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewRowAccessibleObject_OwnerAlreadySet));
                    }
                    this.owner = value;
                }
            }
            ...
            public override string Value
            {
                ...
                get
                {
                    ...
                    {
                        return DCSR.GetString(DCSR.DataGridView_AccRowCreateNew);
                    }
        ...
        private class DataGridViewSelectedRowCellsAccessibleObject : AccessibleObject
        {
            ...
            public override string Name
            {
                get
                {
                    return DCSR.GetString(DCSR.DataGridView_AccSelectedRowCellsName);
                }
            }
