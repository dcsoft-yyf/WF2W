...
namespace System.Windows.Forms {
    ...
    public class ListBox : ListControl {
        ...
        /// </devdoc>
        public const int NoMatches = WinFormNativeMethods.LB_ERR;
        ...
        SRDescription(DCSR.ListBoxBorderDescr)
        ]
        ...
        Localizable(true),
        DefaultValue(0),
        SRDescription(DCSR.ListBoxColumnWidthDescr)
        ]
        public int ColumnWidth {
            ...
            set {
                if (value < 0) {
                    throw new ArgumentException(DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "value",
                ...
                if (columnWidth != value) {
                    ...
                    if (columnWidth == 0) {
                        ...
                        SendMessage(WinFormNativeMethods.LB_SETCOLUMNWIDTH, columnWidth, 0);
                    }
                }
            }
        }
        ...
        protected override CreateParams CreateParams {
            ...
            get {
                ...
                cp.Style |= WinFormNativeMethods.WS_VSCROLL | WinFormNativeMethods.LBS_NOTIFY | WinFormNativeMethods.LBS_HASSTRINGS;
                if (scrollAlwaysVisible) cp.Style |= WinFormNativeMethods.LBS_DISABLENOSCROLL;
                if (!integralHeight) cp.Style |= WinFormNativeMethods.LBS_NOINTEGRALHEIGHT;
                if (useTabStops) cp.Style |= WinFormNativeMethods.LBS_USETABSTOPS;
                ...
                if (multiColumn) {
                    cp.Style |= WinFormNativeMethods.LBS_MULTICOLUMN | WinFormNativeMethods.WS_HSCROLL;
                }
                ...
                switch (selectionMode) {
                    case SelectionMode.None:
                        cp.Style |= WinFormNativeMethods.LBS_NOSEL;
                        break;
                    case SelectionMode.MultiSimple:
                        cp.Style |= WinFormNativeMethods.LBS_MULTIPLESEL;
                        break;
                    case SelectionMode.MultiExtended:
                        cp.Style |= WinFormNativeMethods.LBS_EXTENDEDSEL;
                        break;
                ...
                switch (drawMode) {
                    ...
                    case DrawMode.OwnerDrawFixed:
                        cp.Style |= WinFormNativeMethods.LBS_OWNERDRAWFIXED;
                        break;
                    case DrawMode.OwnerDrawVariable:
                        cp.Style |= WinFormNativeMethods.LBS_OWNERDRAWVARIABLE;
                        break;
                }
        ...
        SRDescription(DCSR.ListBoxDrawModeDescr),
            ...
            set {
                ...
                if (drawMode != value) {
                    if (MultiColumn && value == DrawMode.OwnerDrawVariable) {
                        throw new ArgumentException(DCSR.GetString(DCSR.ListBoxVarHeightMultiCol), "value");
                    }
                    drawMode = value;
                    RecreateHandle();
        ...
        internal int FocusedIndex {
            get {
                if (IsHandleCreated) {
                    return unchecked( (int) (long)SendMessage(WinFormNativeMethods.LB_GETCARETINDEX, 0, 0));
                }
        ...
        DefaultValue(0),
        Localizable(true),
        SRDescription(DCSR.ListBoxHorizontalExtentDescr)
        ]
        ...
        DefaultValue(false),
        Localizable(true),
        SRDescription(DCSR.ListBoxHorizontalScrollbarDescr)
        ]
        public bool HorizontalScrollbar {
            ...
            set {
                if (value != horizontalScrollbar) {
                    ...
                    this.LogWF2WPropertyValue("HorizontalScrollbar", value);
                }
            }
        }
        ...
        DefaultValue(true),
        Localizable(true),
        SRDescription(DCSR.ListBoxIntegralHeightDescr),
        RefreshProperties(RefreshProperties.Repaint)
        ]
        ...
        Localizable(true),
        SRDescription(DCSR.ListBoxItemHeightDescr),
        RefreshProperties(RefreshProperties.Repaint)
        ]
        public virtual int ItemHeight {
            ...
            set {
                if (value < 1 || value > 255) {
                    throw new ArgumentOutOfRangeException("ItemHeight", DCSR.GetString(DCSR.InvalidExBoundArgument, "ItemHeight", (value).ToString(CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture), "256"));
                }
                if (itemHeight != value) {
                    itemHeight = value;
                    if (drawMode == DrawMode.OwnerDrawFixed && IsHandleCreated) {
                        BeginUpdate();
                        SendMessage(WinFormNativeMethods.LB_SETITEMHEIGHT, 0, value);
        ...
        Localizable(true),
        SRDescription(DCSR.ListBoxItemsDescr),
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(false),
        SRDescription(DCSR.ListBoxMultiColumnDescr)
        ]
        public bool MultiColumn {
            ...
            set {
                if (multiColumn != value) {
                    ...
                    multiColumn = value;
                    RecreateHandle();
                    this.LogWF2WPropertyValue("MultiColumn", value);
                }
            }
        }
        ...
        SRDescription(DCSR.ListBoxPreferredHeightDescr)
        ]
        ...
        DefaultValue(false),
        Localizable(true),
        SRDescription(DCSR.ListBoxScrollIsVisibleDescr)
        ]
        ...
        Bindable(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ListBoxSelectedIndexDescr)
        ]
        public override int SelectedIndex {
            get {
                ...
                if (current == SelectionMode.One && IsHandleCreated) {
                    return unchecked( (int) (long)SendMessage(WinFormNativeMethods.LB_GETCURSEL, 0, 0));
                }
            ...
            set {
                ...
                if (selectionMode == SelectionMode.None) {
                    throw new ArgumentException(DCSR.GetString(DCSR.ListBoxInvalidSelectionMode), "SelectedIndex");
                }
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ListBoxSelectedIndicesDescr)
        ]
        ...
        Bindable(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ListBoxSelectedItemDescr)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ListBoxSelectedItemsDescr)
        ]
        ...
        SRDescription(DCSR.ListBoxSelectionModeDescr)
        ]
        public virtual SelectionMode SelectionMode {
            ...
            set {
                ...
                if (selectionMode != value) {
                    ...
                    this.LogWF2WPropertyValue("SelectionMode", value);
                }
            }
        }
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(false),
        SRDescription(DCSR.ListBoxSortedDescr)
        ]
        public bool Sorted {
            get {
                return sorted;
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ListBoxTopIndexDescr)
        ]
        public int TopIndex {
            get {
                if (IsHandleCreated) {
                    return unchecked( (int) (long)SendMessage(WinFormNativeMethods.LB_GETTOPINDEX, 0, 0));
                }
                else {
                    return topIndex;
                }
            ...
            set {
                if (IsHandleCreated) {
                    SendMessage(WinFormNativeMethods.LB_SETTOPINDEX, value, 0);
                }
                else {
                    topIndex = value;
                }
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(true),
        SRDescription(DCSR.ListBoxUseTabStopsDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.ListBoxCustomTabOffsetsDescr),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content),
        Browsable(false)
        ]
        ...
        public int GetItemHeight(int index) {
            ...
            if (IsHandleCreated) {
                int h = unchecked( (int) (long)SendMessage(WinFormNativeMethods.LB_GETITEMHEIGHT, index, 0));
                if (h == -1)
        ...
        public Rectangle GetItemRectangle(int index) {
            ...
            SendMessage(WinFormNativeMethods.LB_GETITEMRECT, index, ref rect);
        ...
        private bool GetSelectedInternal(int index) {
            if (IsHandleCreated) {
                int sel = unchecked( (int) (long)SendMessage(WinFormNativeMethods.LB_GETSEL, index, 0));
                if (sel == -1) {
                    throw new Win32Exception();
                }
                return sel > 0;
        ...
        public int IndexFromPoint(int x, int y) {
            ...
            WinFormUnsafeNativeMethods.GetClientRect(new HandleRef(this, Handle), ref r);
            if (r.left <= x && x < r.right && r.top <= y && y < r.bottom) {
                int index = unchecked( (int) (long)SendMessage(WinFormNativeMethods.LB_ITEMFROMPOINT, 0, unchecked( (int) (long)WinFormNativeMethods.Util.MAKELPARAM(x, y))));
                if (WinFormNativeMethods.Util.HIWORD(index) == 0) {
                    // Inside ListBox client area
                    return WinFormNativeMethods.Util.LOWORD(index);
                }
            }
        ...
        private int NativeAdd(object item) {
            ...
            int insertIndex = unchecked( (int) (long)SendMessage(WinFormNativeMethods.LB_ADDSTRING, 0, GetItemText(item)));

            if (insertIndex == WinFormNativeMethods.LB_ERRSPACE) {
                throw new OutOfMemoryException();
            }

            if (insertIndex == WinFormNativeMethods.LB_ERR) {
                ...
                // overflow.
                //
                throw new OutOfMemoryException(DCSR.GetString(DCSR.ListBoxItemOverflow));
            }
        ...
        private void NativeClear() {
            Debug.Assert(IsHandleCreated, "Shouldn't be calling Native methods before the handle is created.");
            SendMessage(WinFormNativeMethods.LB_RESETCONTENT, 0, 0);
        }
        ...
        internal string NativeGetItemText(int index) {
            int len = unchecked( (int) (long)SendMessage(WinFormNativeMethods.LB_GETTEXTLEN, index, 0));
            StringBuilder sb = new StringBuilder(len + 1);
            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.LB_GETTEXT, index, sb);
            return sb.ToString();
        }
        ...
        private int NativeInsert(int index, object item) {
            Debug.Assert(IsHandleCreated, "Shouldn't be calling Native methods before the handle is created.");
            int insertIndex = unchecked( (int) (long)SendMessage(WinFormNativeMethods.LB_INSERTSTRING, index, GetItemText(item)));
        ...
        private void NativeRemoveAt(int index) {
            ...
            bool selected = (unchecked( (int) (long)SendMessage(WinFormNativeMethods.LB_GETSEL, (IntPtr)index, IntPtr.Zero)) > 0);
            SendMessage(WinFormNativeMethods.LB_DELETESTRING, index, 0);
        ...
        private void NativeSetSelected(int index, bool value) {
            ...
            if (selectionMode == SelectionMode.One) {
                SendMessage(WinFormNativeMethods.LB_SETCURSEL, (value ? index : -1), 0);
            }
            else {
                SendMessage(WinFormNativeMethods.LB_SETSEL, value? -1: 0, index);
            }
        }
        ...
        private void NativeUpdateSelection() {
            ...
            switch (selectionMode) {
                ...
                case SelectionMode.One:
                    int index = unchecked( (int) (long)SendMessage(WinFormNativeMethods.LB_GETCURSEL, 0, 0));
                    if (index >= 0) result = new int[] {index};
                    break;

                case SelectionMode.MultiSimple:
                case SelectionMode.MultiExtended:
                    int count = unchecked( (int) (long)SendMessage(WinFormNativeMethods.LB_GETSELCOUNT, 0, 0));
                    if (count > 0) {
                        result = new int[count];
                        WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.LB_GETSELITEMS, count, result);
                    }
                    break;
            }
        ...
        protected override void OnHandleCreated(EventArgs e) {
            ...
            //
            SendMessage(WinFormNativeMethods.LB_SETLOCALE, CultureInfo.CurrentCulture.LCID, 0);

            if (columnWidth != 0) {
                SendMessage(WinFormNativeMethods.LB_SETCOLUMNWIDTH, columnWidth, 0);
            }
            if (drawMode == DrawMode.OwnerDrawFixed) {
                SendMessage(WinFormNativeMethods.LB_SETITEMHEIGHT, 0, ItemHeight);
            }

            if (topIndex != 0) {
                SendMessage(WinFormNativeMethods.LB_SETTOPINDEX, topIndex, 0);
            }
            ...
            if (UseCustomTabOffsets && CustomTabOffsets != null) {
                ...
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.LB_SETTABSTOPS, wpar, offsets);
            }
       ...
       protected override void ScaleControl(SizeF factor, BoundsSpecified specified) {
        ...
        protected override void SetItemsCore(IList value) {
                ...
                if (this.DataManager != null) {
                    ...
                    if (IsHandleCreated) {
                        SendMessage(WinFormNativeMethods.LB_SETCURSEL, DataManager.Position, 0);
                    }
        ...
        public void SetSelected(int index, bool value) {
            ...
            if (selectionMode == SelectionMode.None)
                throw new InvalidOperationException(DCSR.GetString(DCSR.ListBoxInvalidSelectionMode));
        ...
        private void UpdateHorizontalExtent() {
            if (!multiColumn && horizontalScrollbar && IsHandleCreated) {
                ...
                SendMessage(WinFormNativeMethods.LB_SETHORIZONTALEXTENT, width, 0);
            }
        }
       ...
       // ]
        protected virtual void WmReflectCommand(ref Message m) {
            switch (WinFormNativeMethods.Util.HIWORD(m.WParam)) {
                case WinFormNativeMethods.LBN_SELCHANGE:
                    if (selectedItems != null) {
                        selectedItems.Dirty();
                    }
                    OnSelectedIndexChanged(EventArgs.Empty);
                    break;
                case WinFormNativeMethods.LBN_DBLCLK:
        ...
        protected override async Task WndProc(Message m) {
            switch (m.Msg) {
                ...
                case WinFormNativeMethods.WM_LBUTTONUP:
                    ...
                    if (captured && WinFormUnsafeNativeMethods.WindowFromPoint(pt.X, pt.Y) == Handle) {
                        ...
                        if (!doubleClickFired && !ValidationCancelled) {
                            ...
                            if (!ValidationCancelled) {
                                OnDoubleClick(new MouseEventArgs(MouseButtons.Left, 2, WinFormNativeMethods.Util.SignedLOWORD(m.LParam), WinFormNativeMethods.Util.SignedHIWORD(m.LParam), 0));
                                OnMouseDoubleClick(new MouseEventArgs(MouseButtons.Left, 2, WinFormNativeMethods.Util.SignedLOWORD(m.LParam), WinFormNativeMethods.Util.SignedHIWORD(m.LParam), 0));
                ...
                case WinFormNativeMethods.WM_RBUTTONUP:
                    // Get the mouse location
                    //
                    int rx = WinFormNativeMethods.Util.SignedLOWORD(m.LParam);
                    int ry = WinFormNativeMethods.Util.SignedHIWORD(m.LParam);
                    Point rpt = new Point(rx,ry);
                    rpt = PointToScreen(rpt);
                    bool rCaptured = Capture;
                    if (rCaptured && WinFormUnsafeNativeMethods.WindowFromPoint(rpt.X, rpt.Y) == Handle) {
                        if (selectedItems != null) {
                            selectedItems.Dirty();
                        }
                    }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
            ...
            private class EntryEnumerator : IEnumerator {
                ...
                bool IEnumerator.MoveNext() {
                    if(version != items.version) throw new InvalidOperationException(DCSR.GetString(DCSR.ListEnumVersionMismatch));
                ...
                object IEnumerator.Current {
                    get {
                        if (current == -1 || current == items.count) {
                            throw new InvalidOperationException(DCSR.GetString(DCSR.ListEnumCurrentOutOfRange));
                        }
        ...
        public class IntegerCollection : IList {
            ...
            void IList.Insert(int index, object value) {
                throw new NotSupportedException(DCSR.GetString(DCSR.ListBoxCantInsertIntoIntegerCollection));
            }
        ...
        public class SelectedIndexCollection : IList {
            ...
            int IList.Add(object value) {
                throw new NotSupportedException(DCSR.GetString(DCSR.ListBoxSelectedIndexCollectionIsReadOnly));
            }
        ...
        public class SelectedObjectCollection : IList {
                ...
                get {
                    if (owner.IsHandleCreated) {
                        ...
                        switch (current) {
                            ...
                            case SelectionMode.MultiSimple:
                            case SelectionMode.MultiExtended:
                                return unchecked( (int) (long)owner.SendMessage(WinFormNativeMethods.LB_GETSELCOUNT, 0, 0));
                        }
            ...
            /// <internalonly/>
            int IList.Add(object value) {
                throw new NotSupportedException(DCSR.GetString(DCSR.ListBoxSelectedObjectCollectionIsReadOnly));
            }
