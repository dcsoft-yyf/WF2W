...
namespace System.Windows.Forms {
    ...
    public class TabControl : Control {
        ...
        //    try
        //    {
        //        json["Alignment"] = System.Text.Json.Nodes.JsonValue.Create(alignment.ToString());
        //        json["Appearance"] = System.Text.Json.Nodes.JsonValue.Create(appearance.ToString());
        //        json["DrawMode"] = System.Text.Json.Nodes.JsonValue.Create(drawMode.ToString());
        //        json["SizeMode"] = System.Text.Json.Nodes.JsonValue.Create(sizeMode.ToString());

        //        json["Multiline"] = System.Text.Json.Nodes.JsonValue.Create(Multiline);
        //        json["HotTrack"] = System.Text.Json.Nodes.JsonValue.Create(HotTrack);
        //        json["ShowToolTips"] = System.Text.Json.Nodes.JsonValue.Create(ShowToolTips);
        //        json["SelectedIndex"] = System.Text.Json.Nodes.JsonValue.Create(SelectedIndex);

        //        if (!itemSize.IsEmpty)
        //        {
        //            var itemSizeObj = new System.Text.Json.Nodes.JsonObject();
        //            itemSizeObj["Width"] = System.Text.Json.Nodes.JsonValue.Create(itemSize.Width);
        //            itemSizeObj["Height"] = System.Text.Json.Nodes.JsonValue.Create(itemSize.Height);
        //            json["ItemSize"] = itemSizeObj;
        //        }

        //        var padObj = new System.Text.Json.Nodes.JsonObject();
        //        padObj["X"] = System.Text.Json.Nodes.JsonValue.Create(padding.X);
        //        padObj["Y"] = System.Text.Json.Nodes.JsonValue.Create(padding.Y);
        //        json["Padding"] = padObj;
        //    }
        //    catch
        //    {
        ...
        /// </devdoc>
        /// <internalonly/>
        private readonly int tabBaseReLayoutMessage = WinFormSafeNativeMethods.RegisterWindowMessage(Application.WindowMessagesVersion + "_TabBaseReLayout");
        ...
        SRDescription(DCSR.TabBaseAlignmentDescr)
        ]
            ...
            set {
                if (this.alignment != value) {
                    ...
                    if (this.alignment == TabAlignment.Left || this.alignment == TabAlignment.Right)
                        Multiline = true;
                    RecreateHandle();
                    this.LogWF2WPropertyValue("Alignment", value);
                }
            }
        }
        ...
        SRDescription(DCSR.TabBaseAppearanceDescr)
        ]
        public TabAppearance Appearance {
            ...
            set {
                if (this.appearance != value) {
                    ...
                    this.LogWF2WPropertyValue("Appearance", value);
                }
            }
        }
        ...
        protected override CreateParams CreateParams {
            ...
            get {
                ...
                cp.ClassName = WinFormNativeMethods.WC_TABCONTROL;

                // set up window styles
                //
                if (Multiline == true) cp.Style |= WinFormNativeMethods.TCS_MULTILINE;
                if (drawMode == TabDrawMode.OwnerDrawFixed) cp.Style |= WinFormNativeMethods.TCS_OWNERDRAWFIXED;
                if (ShowToolTips && !DesignMode) {
                    cp.Style |= WinFormNativeMethods.TCS_TOOLTIPS;
                }

                if (alignment == TabAlignment.Bottom ||
                    alignment == TabAlignment.Right)
                    cp.Style |= WinFormNativeMethods.TCS_BOTTOM;

                if (alignment == TabAlignment.Left ||
                    alignment == TabAlignment.Right)
                    cp.Style |= WinFormNativeMethods.TCS_VERTICAL | WinFormNativeMethods.TCS_MULTILINE;

                if (tabControlState[TABCONTROLSTATE_hotTrack]) {
                    cp.Style |= WinFormNativeMethods.TCS_HOTTRACK;
                }

                if (appearance == TabAppearance.Normal)
                    cp.Style |= WinFormNativeMethods.TCS_TABS;
                else {
                    cp.Style |= WinFormNativeMethods.TCS_BUTTONS;
                    if (appearance == TabAppearance.FlatButtons && alignment == TabAlignment.Top)
                        cp.Style |= WinFormNativeMethods.TCS_FLATBUTTONS;
                }

                switch (sizeMode) {
                    case TabSizeMode.Normal:
                        cp.Style |= WinFormNativeMethods.TCS_RAGGEDRIGHT;
                        break;
                    case TabSizeMode.FillToRight:
                        cp.Style |= WinFormNativeMethods.TCS_RIGHTJUSTIFY;
                        break;
                    case TabSizeMode.Fixed:
                        cp.Style |= WinFormNativeMethods.TCS_FIXEDWIDTH;
                        break;
                }
        ...
        public override Rectangle DisplayRectangle {
            get {
                ...
                WinFormNativeMethods.RECT rect = WinFormNativeMethods.RECT.FromXYWH(bounds.X, bounds.Y, bounds.Width, bounds.Height);
                ...
                if (!IsDisposed)
                {
                    ...
                    if (IsHandleCreated)
                    {
                        SendMessage(WinFormNativeMethods.TCM_ADJUSTRECT, 0, ref rect);
                    }
                }
        ...
        SRDescription(DCSR.TabBaseDrawModeDescr)
        ]
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(false),
        SRDescription(DCSR.TabBaseHotTrackDescr)
        ]
        public bool HotTrack {
            ...
            set {
                if (HotTrack != value) {
                    ...
                    this.LogWF2WPropertyValue("HotTrack", value);
                }
            }
        }
        ...
        DefaultValue(null),
        SRDescription(DCSR.TabBaseImageListDescr)
        ]
        public ImageList ImageList {
            ...
            set {
                if (this.imageList != value) {
                    ...
                    if (IsHandleCreated)
                        SendMessage(WinFormNativeMethods.TCM_SETIMAGELIST, IntPtr.Zero, handle);
        ...
        SRCategory(DCSR.CatBehavior),
        Localizable(true),
        SRDescription(DCSR.TabBaseItemSizeDescr)
        ]
        public Size ItemSize {
            ...
            set {
                if (value.Width < 0 || value.Height < 0) {
                    throw new ArgumentOutOfRangeException("ItemSize", DCSR.GetString(DCSR.InvalidArgument, "ItemSize", value.ToString()));
                }
                itemSize = value;
                ApplyItemSize();
                UpdateSize();
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(false),
        SRDescription(DCSR.TabBaseMultilineDescr)
        ]
        ...
        SRCategory(DCSR.CatBehavior),
        Localizable(true),
        SRDescription(DCSR.TabBasePaddingDescr)
        ]
        public new Point Padding {
            ...
            set {
                ...
                if ( value.X < 0 || value.Y < 0 )
                    throw new ArgumentOutOfRangeException("Padding", DCSR.GetString(DCSR.InvalidArgument, "Padding", value.ToString()));
        ...
        SRDescription(DCSR.TabBaseRowCountDescr)
        ]
        public int RowCount {
            get {
                int n;
                n = unchecked( (int) (long)SendMessage(WinFormNativeMethods.TCM_GETROWCOUNT, 0, 0));
                return n;
            }
        }
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(-1),
        SRDescription(DCSR.selectedIndexDescr)
        ]
        public int SelectedIndex {
            get {
                if (IsHandleCreated) {
                    int n;
                    n = unchecked( (int) (long)SendMessage(WinFormNativeMethods.TCM_GETCURSEL, 0, 0));
                    return n;
                }
                else {
            ...
            set {
                if (value < -1) {
                    throw new ArgumentOutOfRangeException("SelectedIndex", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "SelectedIndex", value.ToString(CultureInfo.CurrentCulture), (-1).ToString(CultureInfo.CurrentCulture)));
                }
                ...
                if (SelectedIndex != value) {
                    if (IsHandleCreated) {
                        ...
                        SendMessage(WinFormNativeMethods.TCM_SETCURSEL, value, 0);
                    ...
                    this.LogWF2WPropertyValue("SelectedIndex", value);
                }
            }
        }
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.TabControlSelectedTabDescr)
        ]
        ...
        SRDescription(DCSR.TabBaseSizeModeDescr),
        RefreshProperties(RefreshProperties.Repaint)
        ]
        public TabSizeMode SizeMode {
            ...
            set {
                ...
                sizeMode = value;
                RecreateHandle();
                this.LogWF2WPropertyValue("SizeMode", value);
            }
        }
        ...
        DefaultValue(false),
        Localizable(true),
        SRDescription(DCSR.TabBaseShowToolTipsDescr)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.TabBaseTabCountDescr)
        ]
        public int TabCount {
        ...
        [
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.TabControlTabsDescr),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        ...
        ///    </para>
        /// </devdoc>
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.TabControlSelectingEventDescr)
        ]
        ...
        ///    </para>
        /// </devdoc>
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.TabControlSelectedEventDescr)
        ]
        ...
        ///    </para>
        /// </devdoc>
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.TabControlDeselectingEventDescr)
        ]
        ...
        ///    </para>
        /// </devdoc>
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.TabControlDeselectedEventDescr)
        ]
        ...
        /// </devdoc>
        /// <internalonly/>
        internal int AddTabPage(TabPage tabPage, WinFormNativeMethods.TCITEM_T tcitem) {
        ...
        internal int AddNativeTabPage(WinFormNativeMethods.TCITEM_T tcitem) {
            int index = (int)WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.TCM_INSERTITEM, tabPageCount + 1, tcitem);
            WinFormUnsafeNativeMethods.PostMessage(new HandleRef(this, Handle), tabBaseReLayoutMessage, IntPtr.Zero, IntPtr.Zero);
            return index;
        }
        ...
        internal void ApplyItemSize() {
            if (IsHandleCreated && ShouldSerializeItemSize()) {
                SendMessage(WinFormNativeMethods.TCM_SETITEMSIZE, 0, (int)WinFormNativeMethods.Util.MAKELPARAM(itemSize.Width, itemSize.Height));
            }
        ...
        public Rectangle GetTabRect(int index) {
            ...
            SendMessage(WinFormNativeMethods.TCM_GETITEMRECT, index, ref rect);
        ...
        private void ImageListRecreateHandle(object sender, EventArgs e) {
            if (IsHandleCreated)
                SendMessage(WinFormNativeMethods.TCM_SETIMAGELIST, 0, ImageList.Handle);
        }
        ...
        private void InsertItem(int index, TabPage tabPage) {
            ...
            int retIndex;
            if (IsHandleCreated) {
                WinFormNativeMethods.TCITEM_T tcitem = tabPage.GetTCITEM();
                retIndex = (int)WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.TCM_INSERTITEM, index, tcitem);
        ...
        protected override void OnHandleCreated(EventArgs e) {
            ...
            if (!padding.IsEmpty) {
                SendMessage(WinFormNativeMethods.TCM_SETPADDING, 0, WinFormNativeMethods.Util.MAKELPARAM(padding.X, padding.Y));
            }
            ...
            if (ShowToolTips) {
                IntPtr tooltipHwnd;
                tooltipHwnd = SendMessage(WinFormNativeMethods.TCM_GETTOOLTIPS, 0, 0);
                if (tooltipHwnd != IntPtr.Zero) {
                    WinFormSafeNativeMethods.SetWindowPos(new HandleRef(this, tooltipHwnd),
        ...
        internal override void RecreateHandleCore() {
            ...
            // So, no RemoveAll()
            if (IsHandleCreated) {
                SendMessage(WinFormNativeMethods.TCM_DELETEALLITEMS, 0, 0);
            }
            this.tabPages = null;
            tabPageCount = 0;
        ...
        internal void RemoveTabPage(int index) {
            ...
            if (IsHandleCreated) {
                SendMessage(WinFormNativeMethods.TCM_DELETEITEM, index, 0);
            }
            cachedDisplayRect = Rectangle.Empty;
        }
        ...
        internal void SetToolTip(ToolTip toolTip, string controlToolTipText) {
            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, this.Handle), WinFormNativeMethods.TCM_SETTOOLTIPS, new HandleRef(toolTip, toolTip.Handle), 0);
        ...
        /// </devdoc>
        /// <internalonly/>
        internal void SetTabPage(int index, TabPage tabPage, WinFormNativeMethods.TCITEM_T tcitem) {
            if (index < 0 || index >= tabPageCount)
                throw new ArgumentOutOfRangeException("index", DCSR.GetString(DCSR.InvalidArgument, "index", index.ToString(CultureInfo.CurrentCulture)));
            if (IsHandleCreated)
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.TCM_SETITEM, index, tcitem);
            // Make the Updated tab page the currently selected tab page
            if (DesignMode && IsHandleCreated) {
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.TCM_SETCURSEL, (IntPtr)index, IntPtr.Zero);
            }
            tabPages[index] = tabPage;
        }
        ...
        private bool WmSelChange() {
            ...
            if (!tcc.Cancel) {
                ...
                SendMessage(WinFormNativeMethods.TCM_SETCURSEL, lastSelection, 0);
        ...
        protected override async Task WndProc(Message m) {
            ...
            switch (m.Msg) {
                ...
                case WinFormNativeMethods.WM_REFLECT + WinFormNativeMethods.WM_NOTIFY:
                    ...
                    case WinFormNativeMethods.TCN_SELCHANGING:
                            if (WmSelChanging()) {
                                m.Result = (IntPtr)1;
                                tabControlState[TABCONTROLSTATE_UISelection] = false;
                                return;
                            ...
                            break;
                        case WinFormNativeMethods.TCN_SELCHANGE:
                            if (WmSelChange ()) {
                                m.Result = (IntPtr)1;
                                tabControlState[TABCONTROLSTATE_UISelection] = false;
                                return;
        ...
        public new class ControlCollection : Control.ControlCollection {
            ...
            public override void Add(Control value) {
                if (!(value is TabPage)) {
                    throw new ArgumentException(DCSR.GetString(DCSR.TabControlInvalidTabPageType, value.GetType().Name));
                }
