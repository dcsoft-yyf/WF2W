...
[System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = false )]
    public class ToolStripContainer : ContainerControl {
        ...
        SRDescription(DCSR.ToolStripContainerBottomToolStripPanelDescr),
        Localizable(false),
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripContainerBottomToolStripPanelVisibleDescr),
        DefaultValue(true)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripContainerContentPanelDescr),
        Localizable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripContainerLeftToolStripPanelDescr),
        Localizable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripContainerLeftToolStripPanelVisibleDescr),
        DefaultValue(true)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripContainerRightToolStripPanelDescr),
        Localizable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripContainerRightToolStripPanelVisibleDescr),
        DefaultValue(true)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripContainerTopToolStripPanelDescr),
        Localizable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripContainerTopToolStripPanelVisibleDescr),
        DefaultValue(true)
        ]
        ...
        internal class ToolStripContainerTypedControlCollection : WindowsFormsUtils.ReadOnlyControlCollection {
            ...
            public override void Add(Control value) {
                ...
                if (IsReadOnly) {
                    throw new NotSupportedException(DCSR.GetString(DCSR.ToolStripContainerUseContentPanel));
                }

                Type controlType = value.GetType();
                if (!contentPanelType.IsAssignableFrom(controlType) && !panelType.IsAssignableFrom(controlType)) {
                    throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, DCSR.GetString(DCSR.TypedControlCollectionShouldBeOfTypes, contentPanelType.Name, panelType.Name)), value.GetType().Name);
                }
                base.Add(value);
            }
