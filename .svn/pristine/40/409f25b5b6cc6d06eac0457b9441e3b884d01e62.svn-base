...
namespace System.Windows.Forms {
    ...
    public class TreeNode : MarshalByRefObject, ICloneable{
        ...
        private readonly static int insertMask = 
                               WinFormNativeMethods.TVIF_TEXT
                             | WinFormNativeMethods.TVIF_IMAGE
                             | WinFormNativeMethods.TVIF_SELECTEDIMAGE;
        ...
        SRDescription(DCSR.TreeNodeBackColorDescr)
        ]
        ...
        public Rectangle Bounds {
            get {
                ...
                if ((int)WinFormUnsafeNativeMethods.SendMessage(new HandleRef(TreeView, TreeView.Handle), WinFormNativeMethods.TVM_GETITEMRECT, 1, ref rc) == 0) {
        ...
        internal Rectangle RowBounds {
            get {
                ...
                if ((int)WinFormUnsafeNativeMethods.SendMessage(new HandleRef(TreeView, TreeView.Handle), WinFormNativeMethods.TVM_GETITEMRECT, 0, ref rc) == 0) {
                    // This means the node is not visible
                    //
                    return Rectangle.Empty;
                }
        ...
        internal bool CheckedInternal {
            ...
            set {
                ...
                WinFormNativeMethods.TV_ITEM item = new WinFormNativeMethods.TV_ITEM();
                item.mask = WinFormNativeMethods.TVIF_HANDLE | WinFormNativeMethods.TVIF_STATE;
                item.hItem = handle;
                item.stateMask = WinFormNativeMethods.TVIS_STATEIMAGEMASK;
                item.state |= value ? CHECKED : UNCHECKED;
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(tv, tv.Handle), WinFormNativeMethods.TVM_SETITEM, 0, ref item);
        ...
        SRDescription(DCSR.TreeNodeCheckedDescr),
        DefaultValue(false)
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public bool Checked {
            get {
                ...
                if(handle != IntPtr.Zero) {
                    ...
                    item.hItem = handle;                         
                    item.stateMask = WinFormNativeMethods.TVIS_STATEIMAGEMASK;
                    WinFormUnsafeNativeMethods.SendMessage(new HandleRef(null, TreeView.Handle), WinFormNativeMethods.TVM_GETITEM, 0, ref item);
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(null),
        SRDescription(DCSR.ControlContextMenuDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.TreeNodeForeColorDescr)
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        public string FullPath {
            get {
                ...
                if (tv != null) {
                    ...
                    throw new InvalidOperationException(DCSR.GetString(DCSR.TreeNodeNoParent));
            }
        }
       ...
       [Browsable(false)]
        ...
        Localizable(true),
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.TreeNodeImageIndexDescr),
        ...
        public int ImageIndex {
            ...
            set {
                ...
                UpdateNode(WinFormNativeMethods.TVIF_IMAGE);
            }
        }
        ...
        Localizable(true),
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.TreeNodeImageKeyDescr),
        ...
        [
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.TreeNodeIndexDescr),
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public int Index {
            get { return index;}
       ...
       [Browsable(false)]
        ...
        public bool IsExpanded {
            get {
                ...
                return(State & WinFormNativeMethods.TVIS_EXPANDED) != 0;
            }
        }
        ...
        public bool IsSelected {
            get {
                ...
                return(State & WinFormNativeMethods.TVIS_SELECTED) != 0;
            }
        }
        ...
        public bool IsVisible {
            get {
                ...
                bool visible = ((int)WinFormUnsafeNativeMethods.SendMessage(new HandleRef(tv, tv.Handle), WinFormNativeMethods.TVM_GETITEMRECT, 1, ref rc) != 0);
                if (visible) {
        ...
        public TreeNode NextVisibleNode {
            get {
                ...
                if (node != null) {
                    IntPtr next = WinFormUnsafeNativeMethods.SendMessage(new HandleRef(TreeView, TreeView.Handle),
                                               WinFormNativeMethods.TVM_GETNEXTITEM, WinFormNativeMethods.TVGN_NEXTVISIBLE, node.Handle);
                    if (next != IntPtr.Zero) {
        ...
        Localizable(true),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.TreeNodeNodeFontDescr),
        DefaultValue(null)
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        public TreeNode PrevVisibleNode {
            get {
                ...
                if (node != null) {
                    ...
                    IntPtr prev = WinFormUnsafeNativeMethods.SendMessage(new HandleRef(TreeView, TreeView.Handle),
                                               WinFormNativeMethods.TVM_GETNEXTITEM,
                                               WinFormNativeMethods.TVGN_PREVIOUSVISIBLE, node.Handle);
                    if (prev != IntPtr.Zero) {
        ...
        Localizable(true),
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.TreeNodeSelectedImageIndexDescr),
        TypeConverterAttribute(typeof(TreeViewImageIndexConverter)),
        DefaultValue(-1),
        RefreshProperties(RefreshProperties.Repaint),
        Editor("System.Windows.Forms.Design.ImageIndexEditor, " + AssemblyRef.SystemDesign, typeof(UITypeEditor)),
        ...
        public int SelectedImageIndex {
            ...
            set {
                ...
                UpdateNode(WinFormNativeMethods.TVIF_SELECTEDIMAGE);
            }
        }
        ...
        Localizable(true),
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.TreeNodeSelectedImageKeyDescr),
        TypeConverterAttribute(typeof(TreeViewImageKeyConverter)),
        DefaultValue(""),
        RefreshProperties(RefreshProperties.Repaint),
        Editor("System.Windows.Forms.Design.ImageIndexEditor, " + AssemblyRef.SystemDesign, typeof(UITypeEditor)),
        ...
        internal int State {
            get {
                ...
                item.hItem = Handle;
                item.mask = WinFormNativeMethods.TVIF_HANDLE | WinFormNativeMethods.TVIF_STATE;
                item.stateMask = WinFormNativeMethods.TVIS_SELECTED | WinFormNativeMethods.TVIS_EXPANDED;
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(TreeView, TreeView.Handle), WinFormNativeMethods.TVM_GETITEM, 0, ref item);
                return item.state;
            }
        }
        ...
        Localizable(true),
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.TreeNodeStateImageKeyDescr),
        ...
        public string StateImageKey {
            ...
            set {
                if (StateImageIndexer.Key != value) {
                    ...
                    {
                        UpdateNode(WinFormNativeMethods.TVIF_STATE);
                    }
                }
            }
        }
        ...
        DefaultValue(-1),
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.TreeNodeStateImageIndexDescr),
        Editor("System.Windows.Forms.Design.ImageIndexEditor, " + AssemblyRef.SystemDesign, typeof(UITypeEditor)),
        RefreshProperties(RefreshProperties.Repaint),
        RelatedImageList("TreeView.StateImageList")
        ]
        ...
        public int StateImageIndex {
            ...
            set {
                if (value < -1 || value > ALLOWEDIMAGES) {
                    throw new ArgumentOutOfRangeException("StateImageIndex", DCSR.GetString(DCSR.InvalidArgument, "StateImageIndex", (value).ToString(CultureInfo.CurrentCulture)));
                }
        ...
        Localizable(true),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.TreeNodeTextDescr)
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public string Text {
            get {
            ...
            set {
                this.text = value;
                UpdateNode(WinFormNativeMethods.TVIF_TEXT);
            }
        }
        ...
        Localizable(false),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.TreeNodeToolTipTextDescr),
        DefaultValue("")
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.TreeNodeNodeNameDescr)
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public string Name {
            get {
        ...
        public void BeginEdit() {
            if (handle != IntPtr.Zero) {
                ...
                if (tv.LabelEdit == false)
                    throw new InvalidOperationException(DCSR.GetString(DCSR.TreeNodeBeginEditFailed));
                if (!tv.Focused)
                    tv.FocusInternal();
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(tv, tv.Handle), WinFormNativeMethods.TVM_EDITLABEL, 0, handle);
            }
        }
        ...
        private void DoCollapse(TreeView tv) {
            if ((State & WinFormNativeMethods.TVIS_EXPANDED) != 0) {
                TreeViewCancelEventArgs e = new TreeViewCancelEventArgs(this, false, TreeViewAction.Collapse);
                tv.OnBeforeCollapse(e);
                if (!e.Cancel) {
                    WinFormUnsafeNativeMethods.SendMessage(new HandleRef(tv, tv.Handle), WinFormNativeMethods.TVM_EXPAND, WinFormNativeMethods.TVE_COLLAPSE, Handle);
        ...
        public void EndEdit(bool cancel) {
            ...
            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(TreeView, TreeView.Handle), WinFormNativeMethods.TVM_ENDEDITLABELNOW, cancel?1:0, 0);
        }
        ...
        public void EnsureVisible() {
            ...
            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(TreeView, TreeView.Handle), WinFormNativeMethods.TVM_ENSUREVISIBLE, 0, Handle);
        }
        ...
        public void Expand() {
            ...
            if (!IsExpanded) {
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(tv, tv.Handle), WinFormNativeMethods.TVM_EXPAND, WinFormNativeMethods.TVE_EXPAND, Handle);
            }
            expandOnRealization = false;
        }
        ...
        internal void Realize(bool insertFirst) {
            ...
            if (tv == null || !tv.IsHandleCreated)
                ...
                if (tv.InvokeRequired) {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.InvalidCrossThreadControlCall));
                }

                WinFormNativeMethods.TV_INSERTSTRUCT tvis = new WinFormNativeMethods.TV_INSERTSTRUCT();
                tvis.item_mask = insertMask;
                tvis.hParent = parent.handle;
                TreeNode prev = PrevNode;
                if (insertFirst || prev == null) {
                    tvis.hInsertAfter = (IntPtr)WinFormNativeMethods.TVI_FIRST;
                }
                else {
                ...
                tvis.item_mask = WinFormNativeMethods.TVIF_TEXT;

                tvis.item_stateMask = 0;
                tvis.item_state = 0;

                if (tv.CheckBoxes) {
                    tvis.item_mask |= WinFormNativeMethods.TVIF_STATE;
                    tvis.item_stateMask |= WinFormNativeMethods.TVIS_STATEIMAGEMASK;
                ...
                if (tvis.item_iImage >= 0) tvis.item_mask |= WinFormNativeMethods.TVIF_IMAGE;
                if (tvis.item_iSelectedImage >= 0) tvis.item_mask |= WinFormNativeMethods.TVIF_SELECTEDIMAGE;
                ...
                //
                bool editing = false;
                IntPtr editHandle = WinFormUnsafeNativeMethods.SendMessage(new HandleRef(TreeView, TreeView.Handle), WinFormNativeMethods.TVM_GETEDITCONTROL, 0, 0);
                if (editHandle != IntPtr.Zero) {
                    // currently editing...
                    //
                    editing = true;
                    WinFormUnsafeNativeMethods.SendMessage(new HandleRef(TreeView, TreeView.Handle), WinFormNativeMethods.TVM_ENDEDITLABELNOW, 0 /* fCancel==FALSE */, 0);
                }

                handle = WinFormUnsafeNativeMethods.SendMessage(new HandleRef(TreeView, TreeView.Handle), WinFormNativeMethods.TVM_INSERTITEM, 0, ref tvis);
                tv.nodeTable[handle] = this;

                // Lets update the Lparam to the Handle ....
                UpdateNode(WinFormNativeMethods.TVIF_PARAM);

                Marshal.FreeHGlobal(tvis.item_pszText);

                if (editing) {
                    WinFormUnsafeNativeMethods.PostMessage(new HandleRef(TreeView, TreeView.Handle), WinFormNativeMethods.TVM_EDITLABEL, IntPtr.Zero, handle);
                }

                WinFormSafeNativeMethods.InvalidateRect(new HandleRef(tv, tv.Handle), null, false);
                ...
                if (parent.nodesCleared && (insertFirst || prev == null) && !tv.Scrollable) {
                    ...
                    WinFormUnsafeNativeMethods.SendMessage(new HandleRef(TreeView, TreeView.Handle), WinFormNativeMethods.WM_SETREDRAW, 1, 0);
                    nodesCleared = false;
                }
        ...
        internal void Remove(bool notify) {
            ...
            if (handle != IntPtr.Zero) {
                if (notify && TreeView.IsHandleCreated)
                    WinFormUnsafeNativeMethods.SendMessage(new HandleRef(TreeView, TreeView.Handle), WinFormNativeMethods.TVM_DELETEITEM, 0, handle);
        ...
        private void ResetExpandedState(TreeView tv) {
            ...
            item.mask = WinFormNativeMethods.TVIF_HANDLE | WinFormNativeMethods.TVIF_STATE;
            item.hItem = handle;
            item.stateMask = WinFormNativeMethods.TVIS_EXPANDEDONCE;
            item.state = 0;
            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(tv, tv.Handle), WinFormNativeMethods.TVM_SETITEM, 0, ref item);
        }
      ...
      //  [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        ...
        private void UpdateNode(int mask) {
            ...
            WinFormNativeMethods.TV_ITEM item = new WinFormNativeMethods.TV_ITEM();
            item.mask = WinFormNativeMethods.TVIF_HANDLE | mask;
            item.hItem = handle;
            if ((mask & WinFormNativeMethods.TVIF_TEXT) != 0)
                item.pszText = Marshal.StringToHGlobalAuto(text);
            if ((mask & WinFormNativeMethods.TVIF_IMAGE) != 0)
                item.iImage = (ImageIndexer.ActualIndex == -1) ? tv.ImageIndexer.ActualIndex : ImageIndexer.ActualIndex;
            if ((mask & WinFormNativeMethods.TVIF_SELECTEDIMAGE) != 0)
            ...
            if ((mask & WinFormNativeMethods.TVIF_STATE) != 0) {
                item.stateMask = WinFormNativeMethods.TVIS_STATEIMAGEMASK;
            ...
            if ((mask & WinFormNativeMethods.TVIF_PARAM) != 0) {
                item.lParam = handle; 
            }
        ...
        internal void UpdateImage ()
        {
            ...
            item.mask = WinFormNativeMethods.TVIF_HANDLE | WinFormNativeMethods.TVIF_IMAGE;
            item.hItem = Handle;
            ...
            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(TreeView, TreeView.Handle), WinFormNativeMethods.TVM_SETITEM, 0, ref item);
        }
