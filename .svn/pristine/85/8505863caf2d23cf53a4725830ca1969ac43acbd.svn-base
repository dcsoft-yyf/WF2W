...
namespace System.Windows.Forms.ComponentModel.Com2Interop {
    ...
    internal class Com2IProvidePropertyBuilderHandler : Com2ExtendedBrowsingHandler {
        ...
        public override Type Interface {
            get {
                return typeof(WinFormNativeMethods.IProvidePropertyBuilder);
            }
        }

        private bool GetBuilderGuidString(WinFormNativeMethods.IProvidePropertyBuilder target, int dispid, ref string strGuidBldr, int[] bldrType) {
            bool valid = false;
            string[] pGuidBldr = new string[1];
            if (WinFormNativeMethods.Failed(target.MapPropertyToBuilder(dispid, bldrType, pGuidBldr, ref valid))) {
                valid = false;
            }
        ...
        private void OnGetBaseAttributes(Com2PropertyDescriptor sender, GetAttributesEvent attrEvent) {
            WinFormNativeMethods.IProvidePropertyBuilder target = sender.TargetObject as WinFormNativeMethods.IProvidePropertyBuilder;
        ...
        private void OnGetTypeConverterAndTypeEditor(Com2PropertyDescriptor sender, GetTypeConverterAndTypeEditorEvent gveevent) {
            ...
            if (target is WinFormNativeMethods.IProvidePropertyBuilder) {
                WinFormNativeMethods.IProvidePropertyBuilder propBuilder = (WinFormNativeMethods.IProvidePropertyBuilder)target;
