...
namespace System.Windows.Forms
{
    ...
    public class DataGridViewSelectedColumnCollection : BaseCollection, IList
    {
        ...
        {
            throw new NotSupportedException(DCSR.GetString(DCSR.DataGridView_ReadOnlyCollection));
        }
        ...
        object IList.this[int index]
        {
            ...
            set { throw new NotSupportedException(DCSR.GetString(DCSR.DataGridView_ReadOnlyCollection)); }
        }
