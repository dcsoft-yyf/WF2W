...
namespace System.Windows.Forms.ComponentModel.Com2Interop {
    ...
    internal class Com2IManagedPerPropertyBrowsingHandler : Com2ExtendedBrowsingHandler {
        ...
        public override Type Interface {
            get {
                return typeof(WinFormNativeMethods.IManagedPerPropertyBrowsing);
            }
        }
        ...
        private void OnGetAttributes(Com2PropertyDescriptor sender, GetAttributesEvent attrEvent) {
            ...
            if (target is WinFormNativeMethods.IManagedPerPropertyBrowsing) {
                Attribute[] attrs = GetComponentAttributes((WinFormNativeMethods.IManagedPerPropertyBrowsing)target,sender.DISPID);
                if (attrs != null) {
        ...
        internal static Attribute[] GetComponentAttributes(WinFormNativeMethods.IManagedPerPropertyBrowsing target, int dispid) {
            int cItems = 0;
            ...
            if (hr != WinFormNativeMethods.S_OK || cItems == 0) {
                ...
                for (int i = 0; i < cStrings; i++) {
                    try{
                        ...
                        if (bstr != IntPtr.Zero) {
                            ...
                            WinFormSafeNativeMethods.SysFreeString(new HandleRef(null, bstr));
                        }
                        else {
                            strs[i] = "";
                        }
                ...
                for (int i = 0; i < cVariants; i++) {
                    try{
                        ...
                        if (curVariant != IntPtr.Zero) {
                            ...
                            WinFormSafeNativeMethods.VariantClear(new HandleRef(null, curVariant));
                        }
                        else {
