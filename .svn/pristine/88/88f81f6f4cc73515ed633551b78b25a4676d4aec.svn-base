...
namespace System.Windows.Forms {
    ...
    public class ToolStrip : System.Windows.Forms.ScrollableControl, 
        ...
        internal override void WriteAdditionJsonForCreateControl(JsonObject json)
        {
            if (this.Items != null && this.Items.Count > 0)
            {
                ...
                foreach (ToolStripItem item in this.Items)
                {
                    ...
                    DCWinFormHelper.WritePropertyValueToJson(item, obj2 , true );
                    arr2.Add(obj2);
                }
                json["Items"] = arr2;
            }
        ...
        public override bool AutoScroll {
            ...
            set {
                throw new NotSupportedException(DCSR.GetString(DCSR.ToolStripDoesntSupportAutoScroll));
            }
        }
        ...
        public override bool AllowDrop {
            ...
            set {
                if (value && AllowItemReorder) {
                    throw new ArgumentException(DCSR.GetString(DCSR.ToolStripAllowItemReorderAndAllowDropCannotBeSetToTrue));
                }
        ...
        [
        DefaultValue(false),
        SRDescription(DCSR.ToolStripAllowItemReorderDescr),
        ...
        [
        DefaultValue(true),
        SRDescription(DCSR.ToolStripAllowMergeDescr),
        SRCategory(DCSR.CatBehavior)
        ]
        ...
        /// </devdoc>
        [
        SRDescription(DCSR.ToolStripBackColorDescr),
        ...
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.ToolStripOnBeginDrag)]
        ...
        [
        DefaultValue(true),
        SRDescription(DCSR.ToolStripCanOverflowDescr),
        ...
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.ToolStripOnEndDrag)]
        ...
        [Browsable(false)]
        [SRDescription(DCSR.ToolStripDefaultDropDownDirectionDescr)]
        [SRCategory(DCSR.CatBehavior)]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripGripStyleDescr),
        ...
        public ToolStripGripStyle GripStyle {
            ...
            set {
                ...
                if (toolStripGripStyle != value) {
                    ...
                    this.LogWF2WPropertyValue("GripStyle", value);
                }
            }
        ...
        [
        SRCategory(DCSR.CatLayout),
        SRDescription(DCSR.ToolStripGripDisplayStyleDescr)
        ]
        ...
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripImageScalingSizeDescr),
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        DefaultValue(null),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripImageListDescr),
        Browsable(false)
        ]
        ...
        SRDescription(DCSR.ToolStripItemsDescr),
        ...
        [SRCategory(DCSR.CatAppearance), SRDescription(DCSR.ToolStripItemAddedDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.ToolStripItemOnClickDescr)]
        public event ToolStripItemClickedEventHandler ItemClicked {
            add {
                this.Events.AddHandler(EventItemClicked, value);
            }
            remove {
                this.Events.RemoveHandler(EventItemClicked, value);
            }
        }

        private static readonly object EventItemClickedAsync = new object();
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.ToolStripItemOnClickDescr)]
        public event ToolStripItemClickedAsyncEventHandler ItemClickedAsync
        {
            add
            {
                this.Events.AddHandler(EventItemClickedAsync, value);
            }
            remove
            {
                this.Events.RemoveHandler(EventItemClickedAsync, value);
            }
        }
        ...
        [SRCategory(DCSR.CatAppearance), SRDescription(DCSR.ToolStripItemRemovedDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [
        SRDescription(DCSR.ToolStripLayoutStyle),
        SRCategory(DCSR.CatLayout),
           ...
           get {
            ...
            set {
                ...
                if (layoutStyle != value) {
                    ...
                    this.LogWF2WPropertyValue("LayoutStyle", value);
                }
            }
        }
        ...
        /// </devdoc>
        [SRCategory(DCSR.CatAppearance), SRDescription(DCSR.ToolStripLayoutCompleteDescr)]
        ...
        /// <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatAppearance), SRDescription(DCSR.ToolStripLayoutStyleChangedDescr)]
        ...
        /// <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatAppearance), SRDescription(DCSR.ToolStripPaintGripDescr)]
        ...
        [DefaultValue(false)]
        [SRCategory(DCSR.CatLayout)]
        [SRDescription(DCSR.ToolStripStretchDescr)]
        public bool Stretch {
            get {
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [
         SRDescription(DCSR.ToolStripRenderModeDescr),
         SRCategory(DCSR.CatAppearance),
         ]
         public ToolStripRenderMode RenderMode {
             ...
             set {
                 ...
                 if (value == ToolStripRenderMode.Custom) {
                     throw new NotSupportedException(DCSR.GetString(DCSR.ToolStripRenderModeUseRendererPropertyInstead));
                 }
                 ...
                 this.LogWF2WPropertyValue("RenderMode", value);
            }
         }
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [DefaultValue(true)]
        [SRDescription(DCSR.ToolStripShowItemToolTipsDescr)]
        [SRCategory(DCSR.CatBehavior)]
            ...
            if (nextItem != null) {
                ...
                if (controlHost != null) {
                    if (hwndThatLostFocus == IntPtr.Zero) {
                        SnapFocus(WinFormUnsafeNativeMethods.GetFocus());
                    }
...
#region MeasurementGraphics
        ...
        internal async Task HandleItemClickAsync(ToolStripItem dismissingItem)
        {
            ToolStripItemClickedEventArgs e = new ToolStripItemClickedEventArgs(dismissingItem);
            await OnItemClickedAsync(e);
            // VSWhidbey 395136 - ensure both the overflow and the main toolstrip fire ItemClick event
            // otherwise the overflow wont dismiss.
            if (!IsDropDown && dismissingItem.IsOnOverflow)
            {
                await OverflowButton.DropDown.HandleItemClickAsync(dismissingItem);
            }
        }
        ...
        internal override void PrintToMetaFileRecursive(HandleRef hDC, IntPtr lParam, Rectangle bounds) {
            ...
            using (Graphics g = Graphics.FromImage(image)) {
                ...
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, this.Handle), WinFormNativeMethods.WM_PRINT, (IntPtr)imageHdc,
                ...
                WinFormSafeNativeMethods.BitBlt(new HandleRef(this, desthDC), bounds.X, bounds.Y, bounds.Width, bounds.Height,
                                             new HandleRef(g, imageHdc), 0, 0, WinFormNativeMethods.SRCCOPY);
...
// DEBUG code which is helpful for FlickerFest debugging.
        ...
        protected virtual async ValueTask OnItemClickedAsync(ToolStripItemClickedEventArgs e)
        {
            var handler = (ToolStripItemClickedAsyncEventHandler)Events[EventItemClickedAsync];
            if (handler != null) await handler(this, e);
                          ...
                          try {
                                ...
                                for (int i = 0; i < DisplayedItems.Count; i++) {
                                   ...
                                   if (item != null)  { // CONSIDER ! item is ToolStripControlHost
                                       ...
                                       WinFormSafeNativeMethods.BitBlt(itemHDC, 0, 0, item.Size.Width, item.Size.Height, toolStripHDC, item.Bounds.X, item.Bounds.Y, WinFormNativeMethods.SRCCOPY);
                                       ...
                                       WinFormSafeNativeMethods.BitBlt(toolStripHDC, item.Bounds.X, item.Bounds.Y, item.Size.Width, item.Size.Height, itemHDC, 0, 0, WinFormNativeMethods.SRCCOPY);
        ...
        protected virtual void RestoreFocus() {
           ...
           if ((hwndThatLostFocus != IntPtr.Zero) && (hwndThatLostFocus != this.Handle)) {
            ...
            if (!focusSuccess) {
                ...
                WinFormUnsafeNativeMethods.SetFocus(WinFormNativeMethods.NullHandleRef);
            }
        }
        ...
        protected internal void SetItemLocation(ToolStripItem item, Point location) {
            ...
            if (item.Owner != this) {
                throw new NotSupportedException(DCSR.GetString(DCSR.ToolStripCanOnlyPositionItsOwnItems));
            }
               ...
               if (snapFocus) {
                  ...
                  // MenuAutoExpand = true;
                   ...
                   if ((thisHandle.Handle != otherHandle.Handle) &&
                       !WinFormUnsafeNativeMethods.IsChild(thisHandle, otherHandle)) {
        ...
        protected override async Task WndProc(Message m) {
            ...
            if (m.Msg == WinFormNativeMethods.WM_SETFOCUS) {
                SnapFocus(m.WParam);
            }
            if (m.Msg == WinFormNativeMethods.WM_MOUSEACTIVATE) {
                    ...
                    IntPtr hwndClicked = WinFormUnsafeNativeMethods.ChildWindowFromPointEx(new HandleRef(null, Handle), pt.X, pt.Y,(int)(GetChildAtPointSkip.Invisible | GetChildAtPointSkip.Disabled | GetChildAtPointSkip.Transparent));
                    ...
                    if (hwndClicked == this.Handle) {
                        lastMouseDownedItem = null;
                        m.Result = (IntPtr)WinFormNativeMethods.MA_NOACTIVATE;
                        ...
                        if (!IsDropDown && !IsInDesignMode) {
                            ...
                            if (rootHwnd.Handle != IntPtr.Zero) {
                                ...
                                if (hwndActive != rootHwnd.Handle) {
                                    ...
                                    m.Result = (IntPtr)WinFormNativeMethods.MA_ACTIVATEANDEAT;
                                }                               
                            }
                        }
                        return;
                  ...
                  switch (m.Msg) {
                       ...
                       case WinFormNativeMethods.WM_NCMBUTTONDOWN:
                            if (ownerToolStrip.ContainsFocus) {
                                ...
                                if (!WinFormUnsafeNativeMethods.IsChild(new HandleRef(this, ownerToolStrip.Handle), new HandleRef(this,m.HWnd))) {
                                    HandleRef rootHwnd =  WindowsFormsUtils.GetRootHWnd(ownerToolStrip);
                                    if (rootHwnd.Handle == m.HWnd || WinFormUnsafeNativeMethods.IsChild(rootHwnd, new HandleRef(this,m.HWnd))) {
    ...
    internal class CachedItemHdcInfo : IDisposable {
        ...
        private HandleRef cachedItemHDC = WinFormNativeMethods.NullHandleRef;
        private Size cachedHDCSize = Size.Empty;
        private HandleRef cachedItemBitmap = WinFormNativeMethods.NullHandleRef;
        ...
        public HandleRef GetCachedItemDC(HandleRef toolStripHDC, Size bitmapSize) {
               ...
               if ((cachedHDCSize.Width < bitmapSize.Width)
                    ...
                    if (cachedItemHDC.Handle == IntPtr.Zero) {
                        ...
                        IntPtr compatibleHDC = WinFormUnsafeNativeMethods.CreateCompatibleDC(toolStripHDC);
                        cachedItemHDC = new HandleRef(this, compatibleHDC);
                    }

                    // create compatible bitmap with the correct size.
                    cachedItemBitmap = new HandleRef(this, WinFormSafeNativeMethods.CreateCompatibleBitmap(toolStripHDC, bitmapSize.Width, bitmapSize.Height));
                    IntPtr oldBitmap = WinFormSafeNativeMethods.SelectObject(cachedItemHDC,cachedItemBitmap);

                    // delete the old bitmap
                    if (oldBitmap != IntPtr.Zero) {
                      // ExternalDelete to prevent Handle underflow
                      WinFormSafeNativeMethods.ExternalDeleteObject(new HandleRef(null, oldBitmap));
        ...
        private void DeleteCachedItemHDC() {
            ...
            if (cachedItemHDC.Handle != IntPtr.Zero) {
               ...
               if (cachedItemBitmap.Handle != IntPtr.Zero) {
                  WinFormSafeNativeMethods.DeleteObject(cachedItemBitmap);
                  cachedItemBitmap = WinFormNativeMethods.NullHandleRef;
               }
               // delete the DC itself.
               WinFormUnsafeNativeMethods.DeleteCompatibleDC(cachedItemHDC);
            }

            cachedItemHDC = WinFormNativeMethods.NullHandleRef;
            cachedItemBitmap = WinFormNativeMethods.NullHandleRef;
