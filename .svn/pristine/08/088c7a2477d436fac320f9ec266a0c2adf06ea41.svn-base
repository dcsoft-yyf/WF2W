...
namespace System.Windows.Forms {
    ...
    public class ToolStripPanelRow : Component, IArrangedElement {
        ...
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), SRDescription(DCSR.ControlControlsDescr), SuppressMessage("Microsoft.Performance", "CA1819:PropertiesShouldNotReturnArrays")]
        ...
        /// </devdoc>
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), SRDescription(DCSR.ControlControlsDescr)]
      ...
      internal static readonly TraceSwitch ToolStripPanelMouseDebug = new TraceSwitch("ToolStripPanelMouse", "Debug WinBar WM_MOUSEACTIVATE code");
        ...
        internal class ToolStripPanelRowControlCollection : ArrangedElementCollection, IList, IEnumerable {
            ...
            public int Add(Control value) {
                ...
                if (control == null) {
                    throw new NotSupportedException(DCSR.GetString(DCSR.TypedControlCollectionShouldBeOfType, typeof(ToolStrip).Name));                 
                }
            ...
            public void CopyTo(Control[] array, int index) {
                ...
                if (index >= array.Length || InnerList.Count > array.Length - index) {
                    throw new ArgumentException(DCSR.GetString(DCSR.ToolStripPanelRowControlCollectionIncorrectIndexLength));
                }
