...
namespace System.Windows.Forms {
    ...
    public class SelectionRangeConverter : TypeConverter {
        ...
        public override object CreateInstance(ITypeDescriptorContext context, IDictionary propertyValues) {
            ...
            {
                throw new ArgumentException(DCSR.GetString(DCSR.PropertyValueInvalidEntry), invalidCast);
            }
            catch (NullReferenceException nullRef)
            {
                throw new ArgumentException(DCSR.GetString(DCSR.PropertyValueInvalidEntry), nullRef);
            }
        }
