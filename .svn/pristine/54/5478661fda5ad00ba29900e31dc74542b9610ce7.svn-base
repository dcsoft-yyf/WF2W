...
{
    public partial class frmTestPrintPreviewDialog : Form
    {
        public frmTestPrintPreviewDialog()
        {
            InitializeComponent();
        }

        private void frmTestPrintPreviewDialog_Load(object sender, EventArgs e)
        {
