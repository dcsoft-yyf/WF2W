...
namespace System.Windows.Forms {
    ...
    public class ToolStripControlHost : ToolStripItem {
        ...
        public ToolStripControlHost(Control c) {
            if (c == null) {
                throw new ArgumentNullException("c", DCSR.ControlCannotBeNull);
            }
            control = c;
            SyncControlParent();
            c.Visible = true;
        ...
        [
        SRCategory(DCSR.CatFocus), 
        SRDescription(DCSR.ToolStripItemOnGotFocusDescr), 
        Browsable(false), 
        ...
        public new ContentAlignment ImageAlign {
         ...
         [
         SRCategory(DCSR.CatFocus), 
         SRDescription(DCSR.ToolStripItemOnLostFocusDescr), 
         Browsable(false), 
         EditorBrowsable(EditorBrowsableState.Advanced)
         ]
