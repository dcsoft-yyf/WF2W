    ...
    public sealed class BufferedGraphicsContext : IDisposable {
        ...
        public Size MaximumBuffer {
            ...
            set {
                if (value.Width <= 0 || value.Height <= 0) {
                    throw new ArgumentException(DCSR.GetString(DCSR.InvalidArgument, "MaximumBuffer", value));
                }
        ...
        private bool bFillBitmapInfo(IntPtr hdc, IntPtr hpal, ref NativeMethods.BITMAPINFO_FLAT pbmi) {
            ...
            try {
                ...
                if (hbm == IntPtr.Zero) {
                    throw new OutOfMemoryException(DCSR.GetString(DCSR.GraphicsBufferQueryFail));
                }
        ...
        private IntPtr CreateCompatibleDIB(IntPtr hdc, IntPtr hpal, int ulWidth, int ulHeight, ref IntPtr ppvBits) {
            ...
            switch(objType) {
                ...
                case NativeMethods.OBJ_ENHMETADC:
                    break;
                default:
                    throw new ArgumentException(DCSR.GetString(DCSR.DCTypeInvalid));
            }
        ...
        private void Dispose(bool disposing) {
            ...
            if(disposing){
                if (oldBusy == BUFFER_BUSY_PAINTING) {
                    ...
                    throw new InvalidOperationException(DCSR.GetString(DCSR.GraphicsBufferCurrentlyBusy));
                }
