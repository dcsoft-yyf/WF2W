...
namespace System.Windows.Forms {
    ...
    public class PictureBox : Control, ISupportInitialize {
        ...
        //    // Only serialize properties defined in PictureBox itself. Do not call base.WriteTo(json).
        //    // BorderStyle and SizeMode (enums as strings)
        //    json["BorderStyle"] = JsonValue.Create(this.borderStyle.ToString());
        //    json["SizeMode"] = JsonValue.Create(this.sizeMode.ToString());

        //    // ImageLocation and WaitOnLoad
        //    json["ImageLocation"] = this.imageLocation != null ? JsonValue.Create(this.imageLocation) : null;
        //    json["WaitOnLoad"] = JsonValue.Create(this.WaitOnLoad);

        //    //// Indicate whether InitialImage/ErrorImage are set (could be default)
        //    //json["HasInitialImage"] = JsonValue.Create(this.initialImage != null && !object.ReferenceEquals(this.initialImage, defaultInitialImage));
        //    //json["HasErrorImage"] = JsonValue.Create(this.errorImage != null && !object.ReferenceEquals(this.errorImage, defaultErrorImage));
        ...
        public Image Image {
            ...
            set {
                ...
                if(  value != null)
                {
                    this.LogWF2WPropertyValue("Image", value.CreateBlobUrl());
                }
            }
        }
        ...
        public string ImageLocation 
        {
            ...
            set 
            {
                ...
                Invalidate();
                this.LogWF2WPropertyValue("ImageLocation", value );
            }
        }
        ...
        public void Load()
        {
            ...
            {
                throw new
                    InvalidOperationException(DCSR.GetString(DCSR.PictureBoxNoImageLocation));
            }
        ...
        /// </devdoc>
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.PictureBoxOnSizeModeChangedDescr)]
