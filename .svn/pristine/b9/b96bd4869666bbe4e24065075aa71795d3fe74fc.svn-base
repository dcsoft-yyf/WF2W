...
//            this.ownHandle = true;
        ...
        {
            var f = new System.Drawing.Font(this.Name, this.Size, this.style);
            return f;
        }
        /// Constructors.
        ...
        public WindowsFont( string faceName, float size, FontStyle style, byte charSet, WindowsFontQuality fontQuality )
        {
            ...
            //
            int pixelsY = (int)Math.Ceiling(96 * size / 72);// WindowsGraphicsCacheManager.MeasurementGraphics.DeviceContext.DpiY * size / 72); // 1 point = 1/72 inch.;
            this.fontSize = size;
            //
...
//            }
        ...
        public float Size 
        {
            get
            {
                ...
                {
                    this.fontSize = this.logFont.lfHeight;
                    //WindowsGraphics wg  = WindowsGraphicsCacheManager.MeasurementGraphics;
