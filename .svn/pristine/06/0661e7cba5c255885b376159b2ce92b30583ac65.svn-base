...
namespace System.Windows.Forms {
    ...
    using Util = WinFormNativeMethods.Util;
...
[System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = false )]
    public class RichTextBox : TextBoxBase {
        ...
        DefaultValue(false),
        SRDescription(DCSR.RichTextBoxAutoWordSelection)
        ]
        ...
        DefaultValue(0),
        Localizable(true),
        SRDescription(DCSR.RichTextBoxBulletIndent)
        ]
        public int BulletIndent {
            ...
            set {
                ...
                if (value < 0) {
                    throw new ArgumentOutOfRangeException("BulletIndent", DCSR.GetString(DCSR.InvalidArgument, "BulletIndent", (value).ToString(CultureInfo.CurrentCulture)));
                }
        ...
        SRDescription(DCSR.RichTextBoxCanRedoDescr)
        ]
        public bool CanRedo {
            get {
                if (IsHandleCreated) {
        ...
        protected override CreateParams CreateParams {
            ...
            get {
                ...
                if (moduleHandle == IntPtr.Zero) {
                    moduleHandle = WinFormUnsafeNativeMethods.LoadLibrary(RichTextBoxConstants.DLL_RICHEDIT);
                    ...
                    if ((ulong)moduleHandle < (ulong)32) {
                        throw new Win32Exception(lastWin32Error, DCSR.GetString(DCSR.LoadDLLError,RichTextBoxConstants.DLL_RICHEDIT));
                    }

                    //Determine whether we're Rich Edit 2.0 or 3.0: see 
                    //http://msdn.microsoft.com/library/default.asp?url=/library/en-us/shellcc/platform/commctls/richedit/richeditcontrols/aboutricheditcontrols.asp
                    StringBuilder pathBuilder = new StringBuilder(WinFormNativeMethods.MAX_PATH);
                    WinFormUnsafeNativeMethods.GetModuleFileName(new HandleRef(null, moduleHandle), pathBuilder, pathBuilder.Capacity);
                ...
                if (BorderStyle.FixedSingle == BorderStyle && ((cp.Style & WinFormNativeMethods.WS_BORDER) != 0)) {
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(true),
        SRDescription(DCSR.RichTextBoxDetectURLs)
        ]
        public bool DetectUrls {
            ...
            set {
                if (value != DetectUrls) {
                    ...
                    this.LogWF2WPropertyValue("DetectUrls", value);
                }
            }
        }
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(false),
        SRDescription(DCSR.RichTextBoxEnableAutoDragDrop)
        ]
        ...
        public override Font Font {
            ...
            set {
                if (IsHandleCreated)
                {
                    if (WinFormSafeNativeMethods.GetWindowTextLength(new HandleRef(this, Handle)) > 0) {
                        if (value == null) {
                            base.Font = null;
        ...
        public RichTextBoxLanguageOptions LanguageOption
        {
            get
            {
                ...
                if (IsHandleCreated) {
                    opt = (RichTextBoxLanguageOptions)WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_GETLANGOPTIONS, 0, 0);
                }
                else {
                    opt = languageOption;
                }
            ...
            set
            {
                if (this.LanguageOption != value)
                {
                    ...
                    if (IsHandleCreated) {
                        WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_SETLANGOPTIONS, 0, (int) value);
                    }
                }
            }
        }
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.RichTextBoxRedoActionNameDescr)
        ]
        ...
        DefaultValue(0),
        Localizable(true),
        SRDescription(DCSR.RichTextBoxRightMargin)
        ]
        public int RightMargin {
            ...
            set {
                if (this.rightMargin != value) {
                    if (value < 0)
                        throw new ArgumentOutOfRangeException("RightMargin", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "RightMargin", value.ToString(CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture)));
                    ...
                    if (value == 0) {
                        ...
                        IntPtr hDC = WinFormUnsafeNativeMethods.CreateIC("DISPLAY", null, null, new HandleRef(null, IntPtr.Zero));
                        try {
                            SendMessage(RichTextBoxConstants.EM_SETTARGETDEVICE, hDC, (IntPtr)Pixel2Twip(hDC, value, true));
                        }
                        finally {
                            if (hDC != IntPtr.Zero) {
                                WinFormUnsafeNativeMethods.DeleteDC(new HandleRef(null, hDC));
                            }
                        }
                    }
                }
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.RichTextBoxRTF),
        ...
        Localizable(true),
        SRDescription(DCSR.RichTextBoxScrollBars)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.RichTextBoxSelAlignment)
        ]
        public HorizontalAlignment SelectionAlignment {
            get {
                ...
                ForceHandleCreate();
                WinFormNativeMethods.PARAFORMAT pf = new WinFormNativeMethods.PARAFORMAT();
                pf.rgxTabs = new int[RichTextBoxConstants.MAX_TAB_STOPS];

                // get the format for our currently selected paragraph
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_GETPARAFORMAT, 0, pf);
            ...
            set {
                ...
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_SETPARAFORMAT, 0, pf);
            }
        }
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.RichTextBoxSelBullet)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.RichTextBoxSelCharOffset)
        ]
        public int SelectionCharOffset {
            get {
                ...
                ForceHandleCreate();
                WinFormNativeMethods.CHARFORMATA cf = GetCharFormat(true);
            ...
            set {
                if (value > 2000 || value < -2000)
                    throw new ArgumentOutOfRangeException("SelectionCharOffset", DCSR.GetString(DCSR.InvalidBoundArgument, "SelectionCharOffset", value, -2000, 2000));

                ForceHandleCreate();
                WinFormNativeMethods.CHARFORMATA cf = new WinFormNativeMethods.CHARFORMATA();
                ...
                //
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_SETCHARFORMAT, RichTextBoxConstants.SCF_SELECTION, cf);
            }
        }
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.RichTextBoxSelColor)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.RichTextBoxSelBackColor)
        ]
        public Color SelectionBackColor {
            get {
                ...
                if (IsHandleCreated) {
                    WinFormNativeMethods.CHARFORMAT2A cf2 = GetCharFormat2(true);
                    // If the effects member contains valid info
            ...
            set
            {
                ...
                if (IsHandleCreated)
                {
                    WinFormNativeMethods.CHARFORMAT2A cf2 = new WinFormNativeMethods.CHARFORMAT2A();
                    ...
                    WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_SETCHARFORMAT, RichTextBoxConstants.SCF_SELECTION, cf2);
                }
            }
        }
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.RichTextBoxSelFont)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.RichTextBoxSelHangingIndent)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.RichTextBoxSelIndent)
        ]
        ...
        [
        DefaultValue(false),
        SRDescription(DCSR.RichTextBoxSelProtected),
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.RichTextBoxSelRTF)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.RichTextBoxSelRightIndent)
        ]
        public int SelectionRightIndent {
            ...
            set {
                if (value < 0)
                    throw new ArgumentOutOfRangeException("SelectionRightIndent", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "SelectionRightIndent", value, 0));
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.RichTextBoxSelTabs)
        ]
        public int[] SelectionTabs {
            ...
            set {
                ...
                if (value != null && value.Length > RichTextBoxConstants.MAX_TAB_STOPS)
                    throw new ArgumentOutOfRangeException("SelectionTabs", DCSR.GetString(DCSR.SelTabCountRange));
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.RichTextBoxSelText)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.RichTextBoxSelTypeDescr)
        ]
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(false),
        SRDescription(DCSR.RichTextBoxSelMargin)
        ]
            ...
            set {
                using(LayoutTransaction.CreateTransactionIf(AutoSize, ParentInternal, this, PropertyNames.Text)) {
                    ...
                    if (!IsHandleCreated) {
                        ...
                        // reset Modified
                        SendMessage(WinFormNativeMethods.EM_SETMODIFY, 0, 0);
                    }
                }
            }
        }
        ...
        public override int TextLength {
            get 
            {
                WinFormNativeMethods.GETTEXTLENGTHEX gtl = new WinFormNativeMethods.GETTEXTLENGTHEX();
                ...
                return unchecked( (int) (long)WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_GETTEXTLENGTHEX, gtl, 0 /*ignored*/)); 
            }
        }
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.RichTextBoxUndoActionNameDescr)
        ]
        ...
        private string GetEditorActionName(int actionID) {
            switch (actionID) {
                case 0:
                    return DCSR.GetString(DCSR.RichTextBox_IDUnknown);
                case 1:
                    return DCSR.GetString(DCSR.RichTextBox_IDTyping);
                case 2:
                    return DCSR.GetString(DCSR.RichTextBox_IDDelete);
                case 3:
                    return DCSR.GetString(DCSR.RichTextBox_IDDragDrop);
                case 4:
                    return DCSR.GetString(DCSR.RichTextBox_IDCut);
                case 5:
                    return DCSR.GetString(DCSR.RichTextBox_IDPaste);
                default:
                    goto
                case 0;
            }
        ...
        DefaultValue(1.0f),
        Localizable(true),
        SRDescription(DCSR.RichTextBoxZoomFactor)
        ]
        public float ZoomFactor {
            ...
            set {
                ...
                if (value <= 0.015625f || value >= 64.0f)
                    throw new ArgumentOutOfRangeException("ZoomFactor", DCSR.GetString(DCSR.InvalidExBoundArgument, "ZoomFactor", (value).ToString(CultureInfo.CurrentCulture), (0.015625f).ToString(CultureInfo.CurrentCulture), (64.0f).ToString(CultureInfo.CurrentCulture)));
                SendZoomFactor(value);
                this.LogWF2WPropertyValue("ZoomFactor", value);
            }
        }
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.RichTextBoxContentsResized)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.RichTextBoxHScroll)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.RichTextBoxLinkClick)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.RichTextBoxIMEChange)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.RichTextBoxProtected)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.RichTextBoxSelChange)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.RichTextBoxVScroll)]
        ...
        public int Find(string str, int start, int end, RichTextBoxFinds options) {
            ...
            if (start < 0 || start > textLen)
                throw new ArgumentOutOfRangeException("start", DCSR.GetString(DCSR.InvalidBoundArgument, "start", start, 0, textLen));
            if (end < -1)
                throw new ArgumentOutOfRangeException("end", DCSR.GetString(DCSR.RichTextFindEndInvalid, end));

            bool selectWord = true;
            WinFormNativeMethods.FINDTEXT ft = new WinFormNativeMethods.FINDTEXT();
            ft.chrg = new WinFormNativeMethods.CHARRANGE();
            ...
            if (start > end) {
                throw new ArgumentException(DCSR.GetString(DCSR.RichTextFindEndInvalid, end));
            }
            ...
            position = (int)WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_FINDTEXT, findOptions, ft);
            ...
            if (position != -1 && selectWord) {
                ...
                WinFormNativeMethods.CHARRANGE chrg = new WinFormNativeMethods.CHARRANGE();
                chrg.cpMin = position;
                ...
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_EXSETSEL, 0, chrg);
                SendMessage(WinFormNativeMethods.EM_SCROLLCARET, 0, 0);
        ...
        public int Find(char[] characterSet, int start, int end) {
            ...
            if (start < 0 || start > textLength)
                throw new ArgumentOutOfRangeException("start", DCSR.GetString(DCSR.InvalidBoundArgument, "start", start, 0, textLength));
            if (end < start && end != -1)
                throw new ArgumentOutOfRangeException("end", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "end", end, "start"));

            // Don't do anything if we get nothing to look for
            if (characterSet.Length == 0)
                return -1;

            int textLen = WinFormSafeNativeMethods.GetWindowTextLength(new HandleRef(this, Handle));
            if (start == end) {
                start = 0;
                end = textLen;
            }
            ...
            WinFormNativeMethods.CHARRANGE chrg = new WinFormNativeMethods.CHARRANGE(); // The range of characters we have searched
            chrg.cpMax = chrg.cpMin = start;

            // Use the TEXTRANGE to move our text buffer forward
            // or backwards within the main text
            WinFormNativeMethods.TEXTRANGE txrg = new WinFormNativeMethods.TEXTRANGE(); // Characters we have slurped into memory in order to search
            txrg.chrg = new WinFormNativeMethods.CHARRANGE();

            txrg.chrg.cpMin = chrg.cpMin;
            txrg.chrg.cpMax = chrg.cpMax;
            WinFormUnsafeNativeMethods.CharBuffer charBuffer;
            charBuffer = WinFormUnsafeNativeMethods.CharBuffer.CreateBuffer(CHAR_BUFFER_LEN + 1);
            ...
            try {
                ...
                while (!done) {
                    ...
                    int len;
                    len = (int)WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_GETTEXTRANGE, 0, txrg);
                    if (len == 0) {
        ...
        private bool InternalSetForeColor(Color value) {
            WinFormNativeMethods.CHARFORMATA cf = GetCharFormat(false);
            if ((cf.dwMask & RichTextBoxConstants.CFM_COLOR) != 0 
        ...
        private WinFormNativeMethods.CHARFORMATA GetCharFormat(bool fSelection) {
            WinFormNativeMethods.CHARFORMATA cf = new WinFormNativeMethods.CHARFORMATA();
            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_GETCHARFORMAT, fSelection ? RichTextBoxConstants.SCF_SELECTION : RichTextBoxConstants.SCF_DEFAULT, cf);
            return cf;
        }

        private WinFormNativeMethods.CHARFORMAT2A GetCharFormat2(bool fSelection) {
            WinFormNativeMethods.CHARFORMAT2A cf2 = new WinFormNativeMethods.CHARFORMAT2A();
            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_GETCHARFORMAT, fSelection ? RichTextBoxConstants.SCF_SELECTION : RichTextBoxConstants.SCF_DEFAULT, cf2);
            return cf2;
        }
        ...
        Font GetCharFormatFont(bool selectionOnly) {
            ...
            WinFormNativeMethods.CHARFORMATA cf = GetCharFormat(selectionOnly);
        ...
        public override int GetCharIndexFromPosition(Point pt) {
            WinFormNativeMethods.POINT wpt = new WinFormNativeMethods.POINT(pt.X, pt.Y);
            int index = (int)WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.EM_CHARFROMPOS, 0, wpt);
        ...
        public override Point GetPositionFromCharIndex(int index) {
            ...
            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.EM_POSFROMCHAR, pt, index);
        ...
        public void LoadFile(Stream data, RichTextBoxStreamType fileType) {
            ...
            switch (fileType) {
                ...
                case RichTextBoxStreamType.UnicodePlainText:
                    ...
                    break;
                default:
                    throw new ArgumentException(DCSR.GetString(DCSR.InvalidFileType));
            }
        ...
        protected override void OnHandleCreated(EventArgs e) {
            ...
            if (ShowSelectionMargin) {
                ...
                WinFormUnsafeNativeMethods.PostMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_SETOPTIONS, (IntPtr)RichTextBoxConstants.ECOOP_OR,
        ...
        private void PasteUnsafe(DataFormats.Format clipFormat, int hIcon) {
            WinFormNativeMethods.REPASTESPECIAL rps = null;

            if (hIcon != 0) {
                rps = new WinFormNativeMethods.REPASTESPECIAL();
                rps.dwAspect = DVASPECT_ICON;
                rps.dwParam = hIcon;
            }
            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_PASTESPECIAL, clipFormat.Id, rps);
        }
            ...
            if (IsHandleCreated) {
                ...
                switch (charFormat) {
                    ...
                    case RichTextBoxSelectionAttribute.None:
                        ...
                        break;
                    default:
                        throw new ArgumentException(DCSR.GetString(DCSR.UnknownAttr));
                }

                // set the format information
                return IntPtr.Zero != WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_SETCHARFORMAT, RichTextBoxConstants.SCF_SELECTION, cf);
            }
            return false;
        }

        private bool SetCharFormat(int charRange, WinFormNativeMethods.CHARFORMATA cf) {
            return IntPtr.Zero != WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_SETCHARFORMAT, charRange, cf);
        }
        ...
        private void SetCharFormatFont(bool selectionOnly, Font value) {
            ...
            if (Marshal.SystemDefaultCharSize == 1)            
            {
                ...
                WinFormNativeMethods.CHARFORMATA cfA = new WinFormNativeMethods.CHARFORMATA();
                ...
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_SETCHARFORMAT, selectionOnly ? RichTextBoxConstants.SCF_SELECTION : RichTextBoxConstants.SCF_ALL, cfA);
            }
            else
            {
                bytesFaceName = Encoding.Unicode.GetBytes(logfont.lfFaceName);

                WinFormNativeMethods.CHARFORMATW cfW = new WinFormNativeMethods.CHARFORMATW();
                ...
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_SETCHARFORMAT, selectionOnly ? RichTextBoxConstants.SCF_SELECTION : RichTextBoxConstants.SCF_ALL, cfW);
            }
        }
        ...
        static private void FontToLogFont(Font value, WinFormNativeMethods.LOGFONT logfont) {
        ...
        private static void SetupLogPixels(IntPtr hDC) {
            bool release = false;
            if (hDC == IntPtr.Zero) {
                hDC = WinFormUnsafeNativeMethods.GetDC(WinFormNativeMethods.NullHandleRef);
                release = true;
            }
            if (hDC == IntPtr.Zero) return;
            logPixelsX = WinFormUnsafeNativeMethods.GetDeviceCaps(new HandleRef(null, hDC), WinFormNativeMethods.LOGPIXELSX);
            logPixelsY = WinFormUnsafeNativeMethods.GetDeviceCaps(new HandleRef(null, hDC), WinFormNativeMethods.LOGPIXELSY);
            if (release)
                WinFormUnsafeNativeMethods.ReleaseDC(WinFormNativeMethods.NullHandleRef, new HandleRef(null, hDC));
        }
        ...
        private void StreamIn(string str, int flags) {
            if (str.Length == 0 ) {
                ...
                if ((RichTextBoxConstants.SFF_SELECTION & flags) != 0) {
                    SendMessage(WinFormNativeMethods.WM_CLEAR, 0, 0);
                    ProtectedError = false;
                    return;
                }
                // WM_SETTEXT is allowed even if we have protected text
                //
                SendMessage(WinFormNativeMethods.WM_SETTEXT, 0, "");
                return;
            }
        ...
        private void StreamIn(Stream data, int flags) {
            ...
            if ((flags & RichTextBoxConstants.SFF_SELECTION) == 0) {
                WinFormNativeMethods.CHARRANGE cr = new WinFormNativeMethods.CHARRANGE();
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_EXSETSEL, 0, cr);
            }
            ...
            try {
                ...
                if ((flags & RichTextBoxConstants.SF_RTF) != 0) {
                    ...
                    if (!SZ_RTF_TAG.Equals(str))
                        throw new ArgumentException(DCSR.GetString(DCSR.InvalidFileFormat));
                ...
                WinFormNativeMethods.EDITSTREAM es = new WinFormNativeMethods.EDITSTREAM();
                if ((flags & RichTextBoxConstants.SF_UNICODE) != 0) {
                ...
                es.pfnCallback = new WinFormNativeMethods.EditStreamCallback(this.EditStreamProc);
                ...
                if (IntPtr.Size == 8) { 
                    WinFormNativeMethods.EDITSTREAM64 es64 = ConvertToEDITSTREAM64(es);
                    WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_STREAMIN, flags, es64);

                    //Assign back dwError value
                    es.dwError = GetErrorValue64(es64);
                }
                else {
                    WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_STREAMIN, flags, es);
                }
                ...
                if (es.dwError != 0)
                    throw new InvalidOperationException(DCSR.GetString(DCSR.LoadTextError));

                // set the modify tag on the control
                SendMessage(WinFormNativeMethods.EM_SETMODIFY, -1, 0);

                // EM_GETLINECOUNT will cause the RichTextBoxConstants to recalculate its line indexes
                SendMessage(WinFormNativeMethods.EM_GETLINECOUNT, 0, 0);
        ...
        private void StreamOut(Stream data, int flags, bool includeCrLfs) {
            ...
            try {
                ...
                if (IntPtr.Size == 8) { 
                    WinFormNativeMethods.EDITSTREAM64 es64 = ConvertToEDITSTREAM64(es);
                    WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_STREAMOUT, flags, es64);

                    //Assign back dwError value
                    es.dwError = GetErrorValue64(es64);
                }
                else {
                    WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_STREAMOUT, flags, es);
                }

                // check to make sure things went well
                if (es.dwError != 0)
                    throw new InvalidOperationException(DCSR.GetString(DCSR.SaveTextError));
            }
            finally {
                // release any storage space held.
                editStream = null;
        ...
        private unsafe WinFormNativeMethods.EDITSTREAM64 ConvertToEDITSTREAM64(WinFormNativeMethods.EDITSTREAM es) {
            WinFormNativeMethods.EDITSTREAM64 es64 = new WinFormNativeMethods.EDITSTREAM64();
        ...
        private unsafe int GetErrorValue64(WinFormNativeMethods.EDITSTREAM64 es64) {
            int errorVal;
...
*/
            ...
            if (IsHandleCreated) {
                if (oleCallback == null) {
                    ...
                    try {
                        ...
                        Guid iidRichEditOleCallback = typeof(WinFormUnsafeNativeMethods.IRichEditOleCallback).GUID;
                        Marshal.QueryInterface(punk, ref iidRichEditOleCallback, out pRichEditOleCallback);
                        try {
                            WinFormUnsafeNativeMethods.SendCallbackMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_SETOLECALLBACK, IntPtr.Zero, pRichEditOleCallback);
                        }
                        finally {
                ...
                WinFormUnsafeNativeMethods.DragAcceptFiles(new HandleRef(this, Handle), false);
            }
        }
        ...
        private void EnLinkMsgHandler(ref Message m) {
            WinFormNativeMethods.ENLINK enlink;
            ...
            if (IntPtr.Size == 8) {
                enlink = ConvertFromENLINK64((WinFormNativeMethods.ENLINK64)m.GetLParam(typeof(WinFormNativeMethods.ENLINK64)));
            }
            else {
                enlink = (WinFormNativeMethods.ENLINK)m.GetLParam(typeof(WinFormNativeMethods.ENLINK));
            }
        ...
        /// </devdoc>
        /// <internalonly/>
        private string CharRangeToString(WinFormNativeMethods.CHARRANGE c) {
            WinFormNativeMethods.TEXTRANGE txrg = new WinFormNativeMethods.TEXTRANGE();
            txrg.chrg = c;
            ...
            WinFormUnsafeNativeMethods.CharBuffer charBuffer = WinFormUnsafeNativeMethods.CharBuffer.CreateBuffer(characters);
            IntPtr unmanagedBuffer = charBuffer.AllocCoTaskMem();
            if (unmanagedBuffer == IntPtr.Zero)
                throw new OutOfMemoryException(DCSR.GetString(DCSR.OutOfMemory));

            txrg.lpstrText = unmanagedBuffer;
            int len = (int)WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), RichTextBoxConstants.EM_GETTEXTRANGE, 0, txrg);
        ...
        private void WmReflectCommand(ref Message m) {
            ...
            if (m.LParam == Handle && !GetState(STATE_CREATINGHANDLE))
            {
                switch (Util.HIWORD(m.WParam)) {
                    ...
                    case WinFormNativeMethods.EN_HSCROLL:
                        OnHScroll(EventArgs.Empty);
                        break;

                    case WinFormNativeMethods.EN_VSCROLL:
            ...
            if (m.HWnd == Handle) {
                ...
                switch (nmhdr.code) {
                    ...
                    case RichTextBoxConstants.EN_DROPFILES:
                        WinFormNativeMethods.ENDROPFILES endropfiles = (WinFormNativeMethods.ENDROPFILES)m.GetLParam(typeof(WinFormNativeMethods.ENDROPFILES));

                        // Only look at the first file.
                        StringBuilder path = new StringBuilder(WinFormNativeMethods.MAX_PATH);
                        WinFormUnsafeNativeMethods.DragQueryFile(new HandleRef(endropfiles, endropfiles.hDrop), 0, path, WinFormNativeMethods.MAX_PATH);
                    ...
                    case RichTextBoxConstants.EN_REQUESTRESIZE:
                        if (!CallOnContentsResized) {
                            WinFormNativeMethods.REQRESIZE reqResize = (WinFormNativeMethods.REQRESIZE)m.GetLParam(typeof(WinFormNativeMethods.REQRESIZE));
                    ...
                    case RichTextBoxConstants.EN_SELCHANGE:
                        WinFormNativeMethods.SELCHANGE selChange = (WinFormNativeMethods.SELCHANGE)m.GetLParam(typeof(WinFormNativeMethods.SELCHANGE));
                        WmSelectionChange(selChange);
                        break;

                    case RichTextBoxConstants.EN_PROTECTED: {
                            WinFormNativeMethods.ENPROTECTED enprotected;
                             
                            //On 64-bit, we do some custom marshalling to get this to work. The richedit control
                            //unfortunately does not respect IA64 struct alignment conventions. See VSWhidbey #122276
                            if (IntPtr.Size == 8) { 
                                enprotected = ConvertFromENPROTECTED64((WinFormNativeMethods.ENPROTECTED64)m.GetLParam(typeof(WinFormNativeMethods.ENPROTECTED64)));
                            }
                            else {
                                enprotected = (WinFormNativeMethods.ENPROTECTED)m.GetLParam(typeof(WinFormNativeMethods.ENPROTECTED));
                            }
                            ...
                            switch (enprotected.msg) {
                                case RichTextBoxConstants.EM_SETCHARFORMAT:
                                    ...
                                    //
                                    WinFormNativeMethods.CHARFORMATA charFormat = (WinFormNativeMethods.CHARFORMATA)WinFormUnsafeNativeMethods.PtrToStructure(enprotected.lParam, typeof(WinFormNativeMethods.CHARFORMATA));
                                ...
                                case WinFormNativeMethods.EM_REPLACESEL:
                                    break;
                                ...
                                case RichTextBoxConstants.EM_STREAMIN:
                                    ...
                                    // Allow the following
                                    //
                                case WinFormNativeMethods.WM_COPY:
                                case WinFormNativeMethods.WM_SETTEXT:
                                case RichTextBoxConstants.EM_EXLIMITTEXT:
                                    ...
                                    //
                                default:
                                    WinFormSafeNativeMethods.MessageBeep(0);
                                    break;
                            }
        ...
        private unsafe WinFormNativeMethods.ENPROTECTED ConvertFromENPROTECTED64(WinFormNativeMethods.ENPROTECTED64 es64) {
            WinFormNativeMethods.ENPROTECTED es = new WinFormNativeMethods.ENPROTECTED();

            fixed (byte* es64p =  &es64.contents[0]) {
                es.nmhdr = new WinFormNativeMethods.NMHDR();
                es.chrg  = new WinFormNativeMethods.CHARRANGE();
        ...
        private static unsafe WinFormNativeMethods.ENLINK ConvertFromENLINK64(WinFormNativeMethods.ENLINK64 es64) {
            WinFormNativeMethods.ENLINK es = new WinFormNativeMethods.ENLINK();

            fixed (byte* es64p =  &es64.contents[0]) {
                es.nmhdr = new WinFormNativeMethods.NMHDR();
                es.charrange  = new WinFormNativeMethods.CHARRANGE();
        ...
        /// </devdoc>
        /// <internalonly/>
        private void WmSelectionChange(WinFormNativeMethods.SELCHANGE selChange) {
            ...
            if( ImeMode == ImeMode.Hangul || ImeMode == ImeMode.HangulFull ) {
                ...
                if (RichTextBoxConstants.ICM_NOTOPEN != compMode) {
                    ...
                    int textLength = WinFormSafeNativeMethods.GetWindowTextLength(new HandleRef(this, Handle));
                    if (selStart == selEnd && textLength == MaxLength) {

                        SendMessage(WinFormNativeMethods.WM_KILLFOCUS, 0, 0);
                        SendMessage(WinFormNativeMethods.WM_SETFOCUS, 0, 0);
                        WinFormUnsafeNativeMethods.PostMessage(new HandleRef(this, Handle), WinFormNativeMethods.EM_SETSEL, selEnd - 1, selEnd);
                    }
                }
            }
            ...
            switch (m.Msg) {
                ...
                case WinFormNativeMethods.WM_SETCURSOR:
                    ...
                    if (LinkCursor && !Cursor.Equals(Cursors.WaitCursor)) {
                        WinFormUnsafeNativeMethods.SetCursor(new HandleRef(Cursors.Hand, Cursors.Hand.Handle));
                        m.Result = (IntPtr)1;
                    }
                    else {
                ...
                case WinFormNativeMethods.WM_SETFONT:
                    WmSetFont(ref m);
                    break;
                ...
                case WinFormNativeMethods.WM_GETDLGCODE:
                    await base.WndProc(m);
                    m.Result = (IntPtr)((AcceptsTab) ? unchecked( (int) (long)m.Result) | WinFormNativeMethods.DLGC_WANTTAB : unchecked( (int) (long)m.Result) & ~WinFormNativeMethods.DLGC_WANTTAB);
                    break;
                ...
                case WinFormNativeMethods.WM_GETOBJECT:
                    ...
                    if (unchecked((int)(long)m.LParam) == WinFormNativeMethods.OBJID_QUERYCLASSNAMEIDX) {
                ...
                case WinFormNativeMethods.WM_VSCROLL:
                    ...
                    if (loWord == WinFormNativeMethods.SB_THUMBTRACK)
                    {
                        OnVScroll(EventArgs.Empty);
                    } else
                        if (loWord == WinFormNativeMethods.SB_THUMBPOSITION)
                        {
                            OnVScroll(EventArgs.Empty);
                        }
                    break;
        ...
        private class OleCallback : WinFormUnsafeNativeMethods.IRichEditOleCallback {
            ...
            public int GetNewStorage(out WinFormUnsafeNativeMethods.IStorage storage) {
                ...
                WinFormUnsafeNativeMethods.ILockBytes pLockBytes = WinFormUnsafeNativeMethods.CreateILockBytesOnHGlobal(WinFormNativeMethods.NullHandleRef, true);

                Debug.Assert(pLockBytes != null, "pLockBytes is NULL!");

                storage = WinFormUnsafeNativeMethods.StgCreateDocfileOnILockBytes(pLockBytes,
                                                                           WinFormNativeMethods.STGM_SHARE_EXCLUSIVE | WinFormNativeMethods.STGM_CREATE | WinFormNativeMethods.STGM_READWRITE,
                                                                           0);
            ...
            public int QueryInsertObject(ref Guid lpclsid, IntPtr lpstg, int cp)
            {
                ...
                int hr = WinFormUnsafeNativeMethods.ReadClassStg(new HandleRef(null, lpstg), ref realClsid);
            ...
            public int QueryAcceptData(IComDataObject lpdataobj,
                ...
                if (reco == WinFormNativeMethods.RECO_DROP) {
                    if (owner.AllowDrop || owner.EnableAutoDragDrop) {
                        ...
                        if ((b & MouseButtons.Left) == MouseButtons.Left) {
                            keyState |= WinFormNativeMethods.MK_LBUTTON;
                        }
                        
                        if ((b & MouseButtons.Right) == MouseButtons.Right) {
                            keyState |= WinFormNativeMethods.MK_RBUTTON;
                        }
                        
                        if ((b & MouseButtons.Middle) == MouseButtons.Middle) {
                            keyState |= WinFormNativeMethods.MK_MBUTTON;
                        }

                        if ((k & Keys.Control) == Keys.Control) {
                            keyState |= WinFormNativeMethods.MK_CONTROL;
                        }

                        if ((k & Keys.Shift) == Keys.Shift) {
                            keyState |= WinFormNativeMethods.MK_SHIFT;
                        }
                        ...
                        if (fReally == 0) {
                            ...
                            e.Effect = ((keyState & WinFormNativeMethods.MK_CONTROL) == WinFormNativeMethods.MK_CONTROL) ? DragDropEffects.Copy : DragDropEffects.Move;
                            owner.OnDragEnter(e);
                        }
                        else {
                            owner.OnDragDrop(e);
            ...
            public int GetClipboardData(WinFormNativeMethods.CHARRANGE lpchrg, int reco,
                                        IntPtr lplpdataobj) {
                    ...
                    if (fDrag && grfKeyState == 0) {
                        ...
                        if (!fDrag && lastDataObject != null && grfKeyState != 0) {
                            ...
                            if (lastEffect != DragDropEffects.None) {
                                e.Effect = ((grfKeyState & WinFormNativeMethods.MK_CONTROL) == WinFormNativeMethods.MK_CONTROL) ? DragDropEffects.Copy : DragDropEffects.Move;
                            }
            ...
            public int GetContextMenu(short seltype, IntPtr lpoleobj, WinFormNativeMethods.CHARRANGE lpchrg, out IntPtr hmenu) {
