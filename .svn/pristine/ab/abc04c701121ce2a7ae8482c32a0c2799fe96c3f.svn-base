    ...
    public class ControlBindingsCollection : BindingsCollection {
        ...
        protected override void AddCore(Binding dataBinding) {
            ...
            if (dataBinding.BindableComponent == control)
                throw new ArgumentException(DCSR.GetString(DCSR.BindingsCollectionAdd1));
            if (dataBinding.BindableComponent != null)
                throw new ArgumentException(DCSR.GetString(DCSR.BindingsCollectionAdd2));
        ...
        internal void CheckDuplicates(Binding binding) {
            ...
            for (int i = 0; i < Count; i++) {
                if (binding != this[i] && this[i].PropertyName.Length > 0 &&
                    ...
                    throw new ArgumentException(DCSR.GetString(DCSR.BindingsCollectionDup), "binding");
                }
            }
        }
        ...
        protected override void RemoveCore(Binding dataBinding) {
            if (dataBinding.BindableComponent != control)
                throw new ArgumentException(DCSR.GetString(DCSR.BindingsCollectionForeign));
            dataBinding.SetBindableComponent(null);
