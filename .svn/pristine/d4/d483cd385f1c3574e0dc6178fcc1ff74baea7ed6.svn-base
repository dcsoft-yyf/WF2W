...
namespace System.Windows.Forms.ComponentModel.Com2Interop {
    ...
    internal class Com2PropertyBuilderUITypeEditor : Com2ExtendedUITypeEditor {
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value) {
            ...
            IntPtr parentHandle = (IntPtr)WinFormUnsafeNativeMethods.GetFocus();
            ...
            try{
               ...
               if (obj is ICustomTypeDescriptor) {
                ...
                Debug.Assert(obj is WinFormNativeMethods.IProvidePropertyBuilder, "object is not IProvidePropertyBuilder");
                WinFormNativeMethods.IProvidePropertyBuilder propBuilder = (WinFormNativeMethods.IProvidePropertyBuilder)obj;

                if (WinFormNativeMethods.Failed(propBuilder.ExecuteBuilder(propDesc.DISPID,
                                                          guidString,
                                                          null,
