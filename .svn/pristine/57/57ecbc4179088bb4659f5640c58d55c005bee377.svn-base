        ...
        protected class DataGridViewTopRowAccessibleObject : AccessibleObject
        {
            ...
            public override Rectangle Bounds
            {
                get
                {
                    if (this.owner == null)
                    {
                        throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewTopRowAccessibleObject_OwnerNotSet));
                    }
            ...
            public override string Name
            {
                get
                {
                    return DCSR.GetString(DCSR.DataGridView_AccTopRow);
                }
            }
            ...
            public DataGridView Owner
            {
                ...
                set
                {
                    if (this.owner != null)
                    {
                        throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewTopRowAccessibleObject_OwnerAlreadySet));
                    }
                    this.owner = value;
                }
            }
