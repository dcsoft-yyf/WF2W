        ...
        protected class DataGridViewTopLeftHeaderCellAccessibleObject : DataGridViewColumnHeaderCellAccessibleObject
        {
            ...
            public override string DefaultAction
            {
                get
                {
                    ...
                    {
                        return DCSR.GetString(DCSR.DataGridView_AccTopLeftColumnHeaderCellDefaultAction);
                    }
                    else
                    {
                        return String.Empty;
                ...
                get
                {
                    ...
                    if (String.IsNullOrEmpty(strValue))
                    {
                        if (this.Owner.DataGridView != null)
                        {
                            ...
                            {
                                return DCSR.GetString(DCSR.DataGridView_AccTopLeftColumnHeaderCellName);
                            }
                            else
                            {
                                return DCSR.GetString(DCSR.DataGridView_AccTopLeftColumnHeaderCellNameRTL);
                            }
                        }
                        else
                        {
