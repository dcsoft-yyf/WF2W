...
namespace System.Windows.Forms {
    ...
    public class Label : Control {
        ...
        //{
        //    json["AutoSize"] = this.AutoSize;
        //    json["AutoEllipsis"] = this.AutoEllipsis;
        //    json["BorderStyle"] = this.BorderStyle.ToString();
        ...
        Localizable(true),
        SRDescription(DCSR.LabelAutoSizeDescr),
        Browsable(true),
        ...
        public override bool AutoSize {
            ...
            set {
                if (AutoSize != value) {
                    base.AutoSize = value;
                    AdjustSize();
                    this.LogWF2WPropertyValue("AutoSize", value);
                }
            }
        }
        ...
        Browsable(true),
        EditorBrowsable(EditorBrowsableState.Always),
        SRDescription(DCSR.LabelAutoEllipsisDescr)
        ]
        ...
        SRDescription(DCSR.LabelBackgroundImageDescr)
        ]
        ...
        SRDescription(DCSR.LabelBorderDescr)
        ]
        ...
        protected override CreateParams CreateParams {
            ...
            get {
                ...
                if (OwnerDraw) {
                    ...
                    cp.Style |= WinFormNativeMethods.SS_OWNERDRAW;

                    // Since we're owner draw, I don't see any point in setting the
                    // SS_CENTER/SS_RIGHT styles.
                    //
                    cp.ExStyle &= ~WinFormNativeMethods.WS_EX_RIGHT;   // WS_EX_RIGHT overrides the SS_XXXX alignment styles
                }
                ...
                if (!OwnerDraw) {
                    switch(TextAlign) {
                        ...
                        case ContentAlignment.BottomLeft:
                            cp.Style |= WinFormNativeMethods.SS_LEFT;
                            break;

                        case ContentAlignment.TopRight:
                        case ContentAlignment.MiddleRight:
                        case ContentAlignment.BottomRight:
                            cp.Style |= WinFormNativeMethods.SS_RIGHT;
                            break;

                        case ContentAlignment.TopCenter:
                        case ContentAlignment.MiddleCenter:
                        case ContentAlignment.BottomCenter:
                            cp.Style |= WinFormNativeMethods.SS_CENTER;
                            break;
                    }
                }
                else
                ...
                switch (BorderStyle) {
                    ...
                    case BorderStyle.Fixed3D:
                        cp.Style |= WinFormNativeMethods.SS_SUNKEN;
                        break;
                }

                if (!UseMnemonic)
                    cp.Style |= WinFormNativeMethods.SS_NOPREFIX;
        ...
        */
        ...
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.LabelPreferredHeightDescr)
        ]
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.LabelPreferredWidthDescr)
        ]
        ...
        /// </devdoc>
        [
        SRDescription(DCSR.LabelTextAlignDescr),
        Localizable(true),
        ...
        /// </devdoc>
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.LabelOnTextAlignChangedDescr)]
        ...
        /// </devdoc>
        [
        SRDescription(DCSR.LabelUseMnemonicDescr),
        DefaultValue(true),
        SRCategory(DCSR.CatAppearance)
        ]
                ...
                if (UseMnemonic != value) {
                   ...
                   if (IsHandleCreated) {
                      ...
                      if (!UseMnemonic) {
                         ...
                         style |= WinFormNativeMethods.SS_NOPREFIX;
                      }
                      else {
                         style &= ~WinFormNativeMethods.SS_NOPREFIX;
                      }
        ...
        */
        ...
        internal override Size GetPreferredSizeCore(Size proposedConstraints) {
            ...
            if (string.IsNullOrEmpty(Text)) {
                requiredSize.Height = (int)this.Font.GetHeight();
        ...
        internal bool IsOwnerDraw(){
            return false;// FlatStyle != FlatStyle.System;
        }
        ...
        protected override async Task WndProc(Message m) {
            switch (m.Msg) {
                case WinFormNativeMethods.WM_NCHITTEST:
                    ...
                    m.Result = (IntPtr)((rectInScreen.Contains(pt) ? WinFormNativeMethods.HTCLIENT : WinFormNativeMethods.HTNOWHERE));
                    break;
