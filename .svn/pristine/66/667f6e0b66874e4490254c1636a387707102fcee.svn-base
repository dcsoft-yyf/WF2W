    ...
    public class ContainerControl : ScrollableControl, IContainerControl {
        ...
        public SizeF AutoScaleDimensions {
            ...
            set {
                if (value.Width < 0 || value.Height < 0) {
                    throw new ArgumentOutOfRangeException(DCSR.GetString(DCSR.ContainerControlInvalidAutoScaleDimensions), "value");
                }
        ...
        public AutoScaleMode AutoScaleMode {
            ...
            set {
                ...
                this.LogWF2WPropertyValue("AutoScaleMode", value);
            }
        }
        ...
        public virtual AutoValidate AutoValidate {
            ...
            set {
                ...
                if (autoValidate != value) {
                    ...
                    this.LogWF2WPropertyValue("AutoValidate", value);
                }
            }
        }
                ...
                if (currentAutoScaleDimensions.IsEmpty) {
                    switch (AutoScaleMode) {
                        case AutoScaleMode.Font:
                            currentAutoScaleDimensions = new SizeF(8.0f, 13.0f);// GetFontAutoScaleDimensions();
                            break;

                        case AutoScaleMode.Dpi:
                            // Screen Dpi
                            currentAutoScaleDimensions = new Size(96, 96);// WindowsGraphicsCacheManager.MeasurementGraphics.DeviceContext.Dpi;
                            break;
        ...
        SRDescription(DCSR.ContainerControlParentFormDescr)
        ]
        ...
        internal void FocusActiveControlInternal() {
            ...
            if (activeControl != null && activeControl.Visible) {
                ...
                if (focusHandle == IntPtr.Zero || Control.FromChildHandleInternal(focusHandle) != activeControl) {
                    WinFormUnsafeNativeMethods.SetFocus(new HandleRef(activeControl, activeControl.Handle));
                }
            }
            else {
                ...
                {
                    WinFormUnsafeNativeMethods.SetFocus(new HandleRef(cc, cc.Handle));
                }
            }
        }
        ...
        private SizeF GetFontAutoScaleDimensions() 
        {
            ...
            // on.
            IntPtr dc = WinFormUnsafeNativeMethods.CreateCompatibleDC(WinFormNativeMethods.NullHandleRef);
            if (dc == IntPtr.Zero) {
            ...
            try {
                ...
                HandleRef hfontOld = new HandleRef(this, WinFormSafeNativeMethods.SelectObject(hdc, hfont));

                try {
                    WinFormNativeMethods.TEXTMETRIC tm = new WinFormNativeMethods.TEXTMETRIC();
                    WinFormSafeNativeMethods.GetTextMetrics(hdc, ref tm);

                    retval.Height = tm.tmHeight;

                    if ((tm.tmPitchAndFamily & WinFormNativeMethods.TMPF_FIXED_PITCH) != 0) {
                    ...
                    WinFormSafeNativeMethods.SelectObject(hdc, hfontOld);
                }
            }
            finally {
                WinFormUnsafeNativeMethods.DeleteCompatibleDC(hdc);
            }
        ...
        internal void SetActiveControlInternal(Control value) {
            ...
            if (activeControl != value || (value != null && !value.Focused)) {
                if (value != null && !Contains(value)) {
                    throw new ArgumentException(DCSR.GetString(DCSR.CannotActivateControl));
                }
        ...
        /// </devdoc>
        /// <internalonly/>
        private async Task WmSetFocus( Message m) {
