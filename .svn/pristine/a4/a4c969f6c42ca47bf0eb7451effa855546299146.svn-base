    ...
    public class DataGridViewRowHeightInfoNeededEventArgs : EventArgs
    {
        ...
        public int Height
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("Height", DCSR.GetString(DCSR.InvalidHighBoundArgumentEx, "Height", (value).ToString(CultureInfo.CurrentCulture), (DataGridViewBand.maxBandThickness).ToString(CultureInfo.CurrentCulture)));
                }
                this.height = value;
            }
        }
