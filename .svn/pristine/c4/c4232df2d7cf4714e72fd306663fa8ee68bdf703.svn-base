    ...
    internal class ListManagerBindingsCollection : BindingsCollection {
        ...
        protected override void AddCore(Binding dataBinding) {
            ...
            if (dataBinding.BindingManagerBase == bindingManagerBase)
                throw new ArgumentException(DCSR.GetString(DCSR.BindingsCollectionAdd1), "dataBinding");
            if (dataBinding.BindingManagerBase != null)
                throw new ArgumentException(DCSR.GetString(DCSR.BindingsCollectionAdd2), "dataBinding");
