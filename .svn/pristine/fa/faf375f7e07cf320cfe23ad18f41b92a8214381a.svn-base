    ...
    public class TreeView : Control {
        ...
        public override Color BackColor {
            ...
            set {
                ...
                if (IsHandleCreated) {
                    SendMessage(WinFormNativeMethods.TVM_SETBKCOLOR, 0, ColorTranslator.ToWin32(BackColor));
                    ...
                    SendMessage(WinFormNativeMethods.TVM_SETINDENT, Indent, 0);
                }
            }
        }
        ...
        SRCategory(DCSR.CatAppearance),
        DefaultValue(false),
        SRDescription(DCSR.TreeViewCheckBoxesDescr)
        ]
        ...
        protected override CreateParams CreateParams {
            ...
            get {
                ...
                cp.ClassName = WinFormNativeMethods.WC_TREEVIEW;
                ...
                if (!Scrollable)
                    cp.Style |= WinFormNativeMethods.LVS_NOSCROLL;

                if (!HideSelection)
                    cp.Style |= WinFormNativeMethods.TVS_SHOWSELALWAYS;
                if (LabelEdit)
                    cp.Style |= WinFormNativeMethods.TVS_EDITLABELS;
                if (ShowLines)
                    cp.Style |= WinFormNativeMethods.TVS_HASLINES;
                if (ShowPlusMinus)
                    cp.Style |= WinFormNativeMethods.TVS_HASBUTTONS;
                if (ShowRootLines)
                    cp.Style |= WinFormNativeMethods.TVS_LINESATROOT;
                if (HotTracking)
                    cp.Style |= WinFormNativeMethods.TVS_TRACKSELECT;
                if (FullRowSelect)
                    cp.Style |= WinFormNativeMethods.TVS_FULLROWSELECT;
                if (setOddHeight) {
                    cp.Style |= WinFormNativeMethods.TVS_NONEVENHEIGHT;
                }
                ...
                if (ShowNodeToolTips && IsHandleCreated && !DesignMode) {
                    cp.Style |= WinFormNativeMethods.TVS_INFOTIP;
                }
                ...
                if (CheckBoxes && IsHandleCreated)
                    cp.Style |= WinFormNativeMethods.TVS_CHECKBOXES;
                ...
                if (RightToLeft == RightToLeft.Yes) {
                    if (RightToLeftLayout == true) {
                        ...
                        cp.Style |= WinFormNativeMethods.TVS_RTLREADING;
                    }
                }
        ...
        public override Color ForeColor {
            ...
            set {
                ...
                if (IsHandleCreated)
                    SendMessage(WinFormNativeMethods.TVM_SETTEXTCOLOR, 0, ColorTranslator.ToWin32(ForeColor));
            }
        }
        ...
        DefaultValue(false),
        SRDescription(DCSR.TreeViewFullRowSelectDescr)
        ]
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(true),
        SRDescription(DCSR.TreeViewHideSelectionDescr)
        ]
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(false),
        SRDescription(DCSR.TreeViewHotTrackingDescr)
        ]
        ...
        SRDescription(DCSR.TreeViewImageIndexDescr),
        ...
        public int ImageIndex {
            ...
            set {
                ...
                if (value < 0) {
                    throw new ArgumentOutOfRangeException("ImageIndex", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "ImageIndex", value.ToString(CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture)));
                }
        ...
        DefaultValue(""),
        RefreshProperties(RefreshProperties.Repaint),
        SRDescription(DCSR.TreeViewImageKeyDescr),
        RelatedImageList("ImageList")
        ]
        public string ImageKey {
            ...
            set {
                if (ImageIndexer.Key != value) {
                    ...
                    if (String.IsNullOrEmpty(value) || value.Equals(DCSR.GetString(DCSR.toStringNone))) {
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(null),
        SRDescription(DCSR.TreeViewImageListDescr),
        RefreshProperties(RefreshProperties.Repaint)
        ]
        public ImageList ImageList {
            ...
            set {
                if (value != imageList) {
                    ...
                    //
                    if (IsHandleCreated) {
                        SendMessage(WinFormNativeMethods.TVM_SETIMAGELIST, 0,
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(null),
        SRDescription(DCSR.TreeViewStateImageListDescr)
        ]
        ...
        Localizable(true),
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.TreeViewIndentDescr)
        ]
        public int Indent {
            get {
                if (indent != -1) {
                    ...
                    return unchecked( (int) (long)SendMessage(WinFormNativeMethods.TVM_GETINDENT, 0, 0));
                }
            ...
            set {
                if (indent != value) {
                    if (value < 0) {
                        throw new ArgumentOutOfRangeException("Indent", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "Indent", (value).ToString(CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture)));
                    }
                    if (value > MaxIndent) {
                        throw new ArgumentOutOfRangeException("Indent", DCSR.GetString(DCSR.InvalidHighBoundArgumentEx, "Indent", (value).ToString(CultureInfo.CurrentCulture), (MaxIndent).ToString(CultureInfo.CurrentCulture)));
                    }
                    indent = value;
                    if (IsHandleCreated) {
                        SendMessage(WinFormNativeMethods.TVM_SETINDENT, value, 0);
                        indent = unchecked( (int) (long)SendMessage(WinFormNativeMethods.TVM_GETINDENT, 0, 0));
                    }
                }
            }
        }
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.TreeViewItemHeightDescr)
        ]
        public int ItemHeight {
            get {
                ...
                if (IsHandleCreated) {
                    return unchecked( (int) (long)SendMessage(WinFormNativeMethods.TVM_GETITEMHEIGHT, 0, 0));
                }
                else {
            ...
            set {
                if (itemHeight != value) {
                    if (value < 1) {
                        throw new ArgumentOutOfRangeException("ItemHeight", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "ItemHeight", (value).ToString(CultureInfo.CurrentCulture), (1).ToString(CultureInfo.CurrentCulture)));
                    }
                    if (value >= Int16.MaxValue) {
                        throw new ArgumentOutOfRangeException("ItemHeight", DCSR.GetString(DCSR.InvalidHighBoundArgument, "ItemHeight", (value).ToString(CultureInfo.CurrentCulture), Int16.MaxValue.ToString(CultureInfo.CurrentCulture)));
                    }
                    itemHeight = value;
                    if (IsHandleCreated) {
                        if (itemHeight % 2 != 0) {
                        ...
                        SendMessage(WinFormNativeMethods.TVM_SETITEMHEIGHT, value, 0);
                        itemHeight = unchecked( (int) (long)SendMessage(WinFormNativeMethods.TVM_GETITEMHEIGHT, 0, 0));
                    }
                }
            }
        }
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(false),
        SRDescription(DCSR.TreeViewLabelEditDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.TreeViewLineColorDescr),
        DefaultValue(typeof(Color), "Black")
        ]
        public Color LineColor {
            get {
                if (IsHandleCreated) {
                    int intColor = unchecked((int)(long)SendMessage(WinFormNativeMethods.TVM_GETLINECOLOR, 0, 0));
            ...
            set {
                if (lineColor != value) {
                    lineColor = value;
                    if (IsHandleCreated) {
                        SendMessage(WinFormNativeMethods.TVM_SETLINECOLOR, 0, ColorTranslator.ToWin32(lineColor));
        ...
        Localizable(true),
        SRDescription(DCSR.TreeViewNodesDescr),
        ...
        SRDescription(DCSR.TreeViewDrawModeDescr)
        ]
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue("\\"),
        SRDescription(DCSR.TreeViewPathSeparatorDescr)
        ]
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(true),
        SRDescription(DCSR.TreeViewScrollableDescr)
        ]
        ...
        Localizable(true),
        Editor("System.Windows.Forms.Design.ImageIndexEditor, " + AssemblyRef.SystemDesign, typeof(UITypeEditor)),
        SRDescription(DCSR.TreeViewSelectedImageIndexDescr),
        RelatedImageList("ImageList")
        ]
        public int SelectedImageIndex {
            ...
            set {
                ...
                if (value < 0) {
                    throw new ArgumentOutOfRangeException("SelectedImageIndex", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "SelectedImageIndex", value.ToString(CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture)));
                }
        ...
        DefaultValue(""),
        RefreshProperties(RefreshProperties.Repaint),
        SRDescription(DCSR.TreeViewSelectedImageKeyDescr),
        RelatedImageList("ImageList")
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.TreeViewSelectedNodeDescr)
        ]
        public TreeNode SelectedNode {
            get {
                if (IsHandleCreated) {
                    Debug.Assert(selectedNode == null || selectedNode.TreeView != this, "handle is created, but we're still caching selectedNode");
                    IntPtr hItem = SendMessage(WinFormNativeMethods.TVM_GETNEXTITEM, WinFormNativeMethods.TVGN_CARET, 0);
            ...
            set {
                if (IsHandleCreated && (value == null || value.TreeView == this)) {
                    ...
                    SendMessage(WinFormNativeMethods.TVM_SELECTITEM, WinFormNativeMethods.TVGN_CARET, hnode);
                    selectedNode = null;
                }
                else {
                    selectedNode = value;
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(true),
        SRDescription(DCSR.TreeViewShowLinesDescr)
        ]
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(false),
        SRDescription(DCSR.TreeViewShowShowNodeToolTipsDescr)
        ]
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(true),
        SRDescription(DCSR.TreeViewShowPlusMinusDescr)
        ]
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(true),
        SRDescription(DCSR.TreeViewShowRootLinesDescr)
        ]
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(false),
        SRDescription(DCSR.TreeViewSortedDescr),
        Browsable(false), EditorBrowsable(EditorBrowsableState.Never)
        ]
        public bool Sorted {
            get {
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.TreeViewNodeSorterDescr)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.TreeViewTopNodeDescr)
        ]
        public TreeNode TopNode {
            get {
                if (IsHandleCreated) {
                    IntPtr hitem = SendMessage(WinFormNativeMethods.TVM_GETNEXTITEM, WinFormNativeMethods.TVGN_FIRSTVISIBLE, 0);
            ...
            set {
                if (IsHandleCreated && (value == null || value.TreeView == this)) {
                    ...
                    IntPtr hnode = (value == null ? IntPtr.Zero : value.Handle);
                    SendMessage(WinFormNativeMethods.TVM_SELECTITEM, WinFormNativeMethods.TVGN_FIRSTVISIBLE, hnode);
                    topNode = null;
                }
                else {
                    topNode = value;
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.TreeViewVisibleCountDescr)
        ]
        public int VisibleCount {
            get {
                if (IsHandleCreated)
                    return unchecked( (int) (long)SendMessage(WinFormNativeMethods.TVM_GETVISIBLECOUNT, 0, 0));
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.TreeViewBeforeEditDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.TreeViewAfterEditDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.TreeViewBeforeCheckDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.TreeViewAfterCheckDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.TreeViewBeforeCollapseDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.TreeViewAfterCollapseDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.TreeViewBeforeExpandDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.TreeViewAfterExpandDescr)]
        ...
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.TreeViewDrawNodeEventDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.TreeViewNodeMouseHoverDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.TreeViewBeforeSelectDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.TreeViewAfterSelectDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.TreeViewNodeMouseClickDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.TreeViewNodeMouseDoubleClickDescr)]
        ...
        protected override void CreateHandle() {
            if (!RecreatingHandle) {
                ...
                try {
                    ...
                    icc.dwICC = WinFormNativeMethods.ICC_TREEVIEW_CLASSES;
        ...
        internal void ForceScrollbarUpdate(bool delayed) {
            ...
            {
                if (IsHandleCreated) {
                    SendMessage(WinFormNativeMethods.WM_SETREDRAW, 0, 0);
                    if (delayed)
                        WinFormUnsafeNativeMethods.PostMessage(new HandleRef(this, Handle), WinFormNativeMethods.WM_SETREDRAW, (IntPtr)1, IntPtr.Zero);
                    else
        ...
        internal void SetToolTip(ToolTip toolTip, string toolTipText) {
            if (toolTip != null) {
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(toolTip, toolTip.Handle), WinFormNativeMethods.TTM_SETMAXTIPWIDTH, 0, SystemInformation.MaxWindowTrackSize.Width);
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, this.Handle), WinFormNativeMethods.TVM_SETTOOLTIPS, new HandleRef(toolTip, toolTip.Handle), 0);
        ...
        public TreeViewHitTestInfo HitTest(int x, int y) {
            WinFormNativeMethods.TV_HITTESTINFO tvhi = new WinFormNativeMethods.TV_HITTESTINFO();
            tvhi.pt_x = x;
            tvhi.pt_y = y;
            IntPtr hnode = WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.TVM_HITTEST, 0, tvhi);
        ...
        private void ImageListRecreateHandle(object sender, EventArgs e) {
            if (IsHandleCreated) {
                ...
                SendMessage(WinFormNativeMethods.TVM_SETIMAGELIST, 0, handle);
            }
        }
        ...
        protected override void OnHandleCreated(EventArgs e) {
            ...
            if (CheckBoxes) {
                int style = unchecked((int)(WinFormUnsafeNativeMethods.GetWindowLong(new HandleRef(this, Handle), WinFormNativeMethods.GWL_STYLE)));
                style |= WinFormNativeMethods.TVS_CHECKBOXES;
            ...
            if (ShowNodeToolTips && !DesignMode) {
                int style = unchecked((int)(WinFormUnsafeNativeMethods.GetWindowLong(new HandleRef(this, Handle), WinFormNativeMethods.GWL_STYLE)));
                style |= WinFormNativeMethods.TVS_INFOTIP;
                WinFormUnsafeNativeMethods.SetWindowLong(new HandleRef(this, Handle), WinFormNativeMethods.GWL_STYLE, new HandleRef(null, (IntPtr)style));
            }
            ...
            if (c != SystemColors.Window)
                SendMessage(WinFormNativeMethods.TVM_SETBKCOLOR, 0, ColorTranslator.ToWin32(c));
            c = ForeColor;

            if (c != SystemColors.WindowText)
                SendMessage(WinFormNativeMethods.TVM_SETTEXTCOLOR, 0, ColorTranslator.ToWin32(c));
            ...
            if (imageList != null)
                SendMessage(WinFormNativeMethods.TVM_SETIMAGELIST, 0, imageList.Handle);
            ...
            if (itemHeight != -1) {
                SendMessage(WinFormNativeMethods.TVM_SETITEMHEIGHT, ItemHeight, 0);
            }
            ...
            try
            {
                ...
                oldSize = this.Width;
                int flags = WinFormNativeMethods.SWP_NOZORDER | WinFormNativeMethods.SWP_NOACTIVATE | WinFormNativeMethods.SWP_NOMOVE;
                WinFormSafeNativeMethods.SetWindowPos(new HandleRef(this, this.Handle), WinFormNativeMethods.NullHandleRef, this.Left, this.Top, Int32.MaxValue, this.Height, flags);

                root.Realize(false);

                if (oldSize != 0)
                {
                    WinFormSafeNativeMethods.SetWindowPos(new HandleRef(this, this.Handle), WinFormNativeMethods.NullHandleRef, this.Left, this.Top, oldSize, this.Height, flags);
                }
            }
            finally
            {
        ...
        private void UpdateNativeStateImageList()
        {
            if (stateImageList != null && stateImageList.Images.Count > 0)
            {
                ...
                SendMessage(WinFormNativeMethods.TVM_SETIMAGELIST, WinFormNativeMethods.TVSIL_STATE, newImageList.Handle);
        ...
        private void SetStateImageList(IntPtr handle)
        {
            ...
            IntPtr handleOld = SendMessage(WinFormNativeMethods.TVM_SETIMAGELIST, WinFormNativeMethods.TVSIL_STATE, handle);
            if ((handleOld != IntPtr.Zero) && (handleOld != handle))
            {
                WinFormSafeNativeMethods.ImageList_Destroy_Native(new HandleRef(this, handleOld));
            }
        }
        ...
        {
            IntPtr handle = SendMessage(WinFormNativeMethods.TVM_GETIMAGELIST, WinFormNativeMethods.TVSIL_STATE, IntPtr.Zero);
            if (handle != IntPtr.Zero)
            {
                WinFormSafeNativeMethods.ImageList_Destroy_Native(new HandleRef(this, handle));
                if (reset)
                {
                    SendMessage(WinFormNativeMethods.TVM_SETIMAGELIST, WinFormNativeMethods.TVSIL_STATE, IntPtr.Zero);
                }
            }
        }
        ...
        protected override void OnMouseHover(EventArgs e)  {
            ...
            WinFormNativeMethods.TV_HITTESTINFO tvhip = new WinFormNativeMethods.TV_HITTESTINFO();
            Point pos = Cursor.Position;
            pos = PointToClientInternal(pos);
            tvhip.pt_x = pos.X;
            tvhip.pt_y = pos.Y;
            IntPtr hnode = WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.TVM_HITTEST, 0, tvhip);

            if (hnode != IntPtr.Zero && ((tvhip.flags & WinFormNativeMethods.TVHT_ONITEM) != 0)) {
        ...
        private unsafe void TvnBeginDrag(MouseButtons buttons, WinFormNativeMethods.NMTREEVIEW* nmtv) {
            WinFormNativeMethods.TV_ITEM item = nmtv->itemNew;
        ...
        private unsafe IntPtr TvnExpanding(WinFormNativeMethods.NMTREEVIEW* nmtv) {
            WinFormNativeMethods.TV_ITEM item = nmtv->itemNew;
            ...
            if ((item.state & WinFormNativeMethods.TVIS_EXPANDED) == 0) {
        ...
        private unsafe void TvnExpanded(WinFormNativeMethods.NMTREEVIEW* nmtv) {
            WinFormNativeMethods.TV_ITEM item = nmtv->itemNew;
        ...
        private unsafe IntPtr TvnSelecting(WinFormNativeMethods.NMTREEVIEW* nmtv) {
            ...
            switch(nmtv->action) {
                case WinFormNativeMethods.TVC_BYKEYBOARD:
                    action = TreeViewAction.ByKeyboard;
                    break;
                case WinFormNativeMethods.TVC_BYMOUSE:
        ...
        private unsafe void TvnSelected(WinFormNativeMethods.NMTREEVIEW* nmtv) {
            ...
            *((IntPtr *) &rc.left) = nmtv->itemOld.hItem;
            if (nmtv->itemOld.hItem != IntPtr.Zero) {
                if (unchecked( (int) (long)WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.TVM_GETITEMRECT, 1, ref rc)) != 0)
                    WinFormSafeNativeMethods.InvalidateRect(new HandleRef(this, Handle), ref rc, true);
            }
        }

        private IntPtr TvnBeginLabelEdit(WinFormNativeMethods.NMTVDISPINFO nmtvdi) {
        ...
        private IntPtr TvnEndLabelEdit(WinFormNativeMethods.NMTVDISPINFO nmtvdi) {
            editNode = null;
        ...
        private void WmMouseDown(ref Message m, MouseButtons button, int clicks) {
            ...
            SendMessage(WinFormNativeMethods.TVM_SELECTITEM, WinFormNativeMethods.TVGN_DROPHILITE, null);
        ...
        private void CustomDraw(ref Message m) {
            WinFormNativeMethods.NMTVCUSTOMDRAW nmcd = (WinFormNativeMethods.NMTVCUSTOMDRAW)m.GetLParam(typeof(WinFormNativeMethods.NMTVCUSTOMDRAW));

            // Find out which stage we're drawing
            switch (nmcd.nmcd.dwDrawStage) {
                // Do we want OwnerDraw for this paint cycle?
                case WinFormNativeMethods.CDDS_PREPAINT:
                    m.Result = (IntPtr)WinFormNativeMethods.CDRF_NOTIFYITEMDRAW; // yes, we do...
                    return;
                ...
                case WinFormNativeMethods.CDDS_ITEMPREPAINT:
                    ...
                    if (drawMode == TreeViewDrawMode.OwnerDrawText)
                    {
                        ...
                        m.Result = (IntPtr) (WinFormNativeMethods.CDRF_NEWFONT | WinFormNativeMethods.CDRF_NOTIFYPOSTPAINT);
                        return;
                    }
                    else if (drawMode == TreeViewDrawMode.OwnerDrawAll)
                    {
                        ...
                        try {
                            ...
                            si.fMask = WinFormNativeMethods.SIF_POS;
                   ...
                   OwnerDrawPropertyBag renderinfo = GetItemRenderStyles(node,state);
                    ...
                    if (renderinfo != null && renderinfo.Font != null) {
                        ...
                        WinFormSafeNativeMethods.SelectObject(new HandleRef(nmcd.nmcd, nmcd.nmcd.hdc), new HandleRef(renderinfo, renderinfo.FontHandle));
                ...
                case (WinFormNativeMethods.CDDS_ITEMPOSTPAINT):
        ...
        protected OwnerDrawPropertyBag GetItemRenderStyles(TreeNode node, int state) {
            ...
            if ((state & (WinFormNativeMethods.CDIS_SELECTED | WinFormNativeMethods.CDIS_GRAYED | WinFormNativeMethods.CDIS_HOT | WinFormNativeMethods.CDIS_DISABLED))==0) {
            ...
            if (hnode != IntPtr.Zero && ((tvhip.flags & WinFormNativeMethods.TVHT_ONITEM) != 0)) {
                ...
                if (tn != null) 
                {
                    if (!ShowNodeToolTips) // default ToolTips
                    {
                        ...
                        WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, tooltipHandle), WinFormNativeMethods.TTM_ADJUSTRECT, 1, ref bounds);
                        WinFormSafeNativeMethods.SetWindowPos(new HandleRef(this, tooltipHandle),
                                WinFormNativeMethods.HWND_TOPMOST, bounds.Left, bounds.Top, 0, 0, WinFormNativeMethods.SWP_NOACTIVATE | WinFormNativeMethods.SWP_NOSIZE | WinFormNativeMethods.SWP_NOZORDER);
                        return true;
                    }
                }
            }
        ...
        private void WmNeedText(ref Message m) {
            WinFormNativeMethods.TOOLTIPTEXT ttt = (WinFormNativeMethods.TOOLTIPTEXT) m.GetLParam(typeof(WinFormNativeMethods.TOOLTIPTEXT));
            ...
            //
            if (RightToLeft == RightToLeft.Yes) {
                ttt.uFlags |= WinFormNativeMethods.TTF_RTLREADING;
            }
        ...
        private unsafe void WmNotify(ref Message m) {
            ...
            //
            if ((nmhdr->code ==  WinFormNativeMethods.NM_CUSTOMDRAW)) {
                CustomDraw(ref m);
            }
            else {
                
                WinFormNativeMethods.NMTREEVIEW* nmtv = (WinFormNativeMethods.NMTREEVIEW*)m.LParam;

                switch (nmtv->nmhdr.code) {
                    case WinFormNativeMethods.TVN_ITEMEXPANDINGA:
                    case WinFormNativeMethods.TVN_ITEMEXPANDINGW:
                        m.Result = TvnExpanding(nmtv);
                        break;
                    case WinFormNativeMethods.TVN_ITEMEXPANDEDA:
                    case WinFormNativeMethods.TVN_ITEMEXPANDEDW:
                        TvnExpanded(nmtv);
                        break;
                    case WinFormNativeMethods.TVN_SELCHANGINGA:
                    case WinFormNativeMethods.TVN_SELCHANGINGW:
                        m.Result = TvnSelecting(nmtv);
                        break;
                    case WinFormNativeMethods.TVN_SELCHANGEDA:
                    case WinFormNativeMethods.TVN_SELCHANGEDW:
                        TvnSelected(nmtv);
                        break;
                    case WinFormNativeMethods.TVN_BEGINDRAGA:
                    case WinFormNativeMethods.TVN_BEGINDRAGW:
                        TvnBeginDrag(MouseButtons.Left, nmtv);
                        break;
                    case WinFormNativeMethods.TVN_BEGINRDRAGA:
                    case WinFormNativeMethods.TVN_BEGINRDRAGW:
                        TvnBeginDrag(MouseButtons.Right, nmtv);
                        break;
                    case WinFormNativeMethods.TVN_BEGINLABELEDITA:
                    case WinFormNativeMethods.TVN_BEGINLABELEDITW:
                        m.Result = TvnBeginLabelEdit((WinFormNativeMethods.NMTVDISPINFO)m.GetLParam(typeof(WinFormNativeMethods.NMTVDISPINFO)));
                        break;
                    case WinFormNativeMethods.TVN_ENDLABELEDITA:
                    case WinFormNativeMethods.TVN_ENDLABELEDITW:
                        m.Result = TvnEndLabelEdit((WinFormNativeMethods.NMTVDISPINFO)m.GetLParam(typeof(WinFormNativeMethods.NMTVDISPINFO)));
                        break;
                    ...
                    case WinFormNativeMethods.NM_RCLICK:
                        ...
                        tvhip.pt_y = pos.Y;
                        IntPtr hnode = WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.TVM_HITTEST, 0, tvhip);
                        if (nmtv->nmhdr.code != WinFormNativeMethods.NM_CLICK
                                    || (tvhip.flags & WinFormNativeMethods.TVHT_ONITEM) != 0) {
                                button = nmtv->nmhdr.code == WinFormNativeMethods.NM_CLICK
                        ...
                        if (nmtv->nmhdr.code != WinFormNativeMethods.NM_CLICK
                            || (tvhip.flags & WinFormNativeMethods.TVHT_ONITEM) != 0 || FullRowSelect) {
                        ...
                        if (nmtv->nmhdr.code == WinFormNativeMethods.NM_RCLICK) {
                            ...
                            if (treeNode != null && (treeNode.ContextMenu != null || treeNode.ContextMenuStrip != null)) {
                                ...
                                SendMessage(WinFormNativeMethods.WM_CONTEXTMENU, Handle, WinFormSafeNativeMethods.GetMessagePos());
                            }
                            m.Result = (IntPtr)1;
        ...
        private void ShowContextMenu(TreeNode treeNode) {
            ...
            if (treeNode.ContextMenu != null || treeNode.ContextMenuStrip != null) {
                ...
                if (contextMenu != null)
                {
                    ...
                    WinFormUnsafeNativeMethods.SetForegroundWindow(new HandleRef(this, this.Handle));

                    contextMenu.OnPopup( EventArgs.Empty );

                    WinFormSafeNativeMethods.TrackPopupMenuEx(new HandleRef(contextMenu, contextMenu.Handle),
                                             WinFormNativeMethods.TPM_VERTICAL,
                                             pt.x,
                                             pt.y,
                    ...
                    WinFormUnsafeNativeMethods.PostMessage(new HandleRef(this, this.Handle), WinFormNativeMethods.WM_NULL, IntPtr.Zero, IntPtr.Zero);
                }
                // VsWhidbey : 432712.
                // Need to send TVM_SELECTITEM to highlight the node while the contextMenuStrip is being shown.
                else if (menu != null)
                {
                    WinFormUnsafeNativeMethods.PostMessage(new HandleRef(this, Handle), WinFormNativeMethods.TVM_SELECTITEM, WinFormNativeMethods.TVGN_DROPHILITE, treeNode.Handle);
        ...
        protected override async Task WndProc(Message m) {
            switch (m.Msg) {
                ...
                case WinFormNativeMethods.WM_NCCALCSIZE:
        ...
        case WinFormNativeMethods.WM_PRINT:
            WmPrint(ref m);
            break;
                case WinFormNativeMethods.TVM_SETITEMA:
                case WinFormNativeMethods.TVM_SETITEMW:
                    await base.WndProc(m);
                    if (this.CheckBoxes) {
                        WinFormNativeMethods.TV_ITEM item = (WinFormNativeMethods.TV_ITEM) m.GetLParam(typeof(WinFormNativeMethods.TV_ITEM));
                        // Check for invalid node handle
                        if (item.hItem != IntPtr.Zero) {
                            WinFormNativeMethods.TV_ITEM item1 = new WinFormNativeMethods.TV_ITEM();
                            item1.mask = WinFormNativeMethods.TVIF_HANDLE | WinFormNativeMethods.TVIF_STATE;
                            item1.hItem = item.hItem;
                            item1.stateMask = WinFormNativeMethods.TVIS_STATEIMAGEMASK;
                            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(null, this.Handle), WinFormNativeMethods.TVM_GETITEM, 0, ref item1);
                ...
                case WinFormNativeMethods.WM_NOTIFY:
                    WinFormNativeMethods.NMHDR nmhdr = (WinFormNativeMethods.NMHDR) m.GetLParam(typeof(WinFormNativeMethods.NMHDR));
                    switch (nmhdr.code) {
                        case WinFormNativeMethods.TTN_GETDISPINFOA:
                        case WinFormNativeMethods.TTN_GETDISPINFOW:
                            // MSDN:
                            // Setting the max width has the added benefit of enabling multiline
                            // tool tips!
                            //
                            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(nmhdr, nmhdr.hwndFrom), WinFormNativeMethods.TTM_SETMAXTIPWIDTH, 0, SystemInformation.MaxWindowTrackSize.Width);
                            WmNeedText(ref m);
                            m.Result = (IntPtr)1;
                            return;
						case WinFormNativeMethods.TTN_SHOW:
                ...
                case WinFormNativeMethods.WM_LBUTTONDOWN:
                    ...
                    treeViewState[TREEVIEWSTATE_mouseUpFired] = false;
                    WinFormNativeMethods.TV_HITTESTINFO tvhip = new WinFormNativeMethods.TV_HITTESTINFO();
                    tvhip.pt_x = WinFormNativeMethods.Util.SignedLOWORD(m.LParam);
                    tvhip.pt_y = WinFormNativeMethods.Util.SignedHIWORD(m.LParam);
                    hNodeMouseDown = WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.TVM_HITTEST, 0, tvhip);
                    ...
                    if ((tvhip.flags & WinFormNativeMethods.TVHT_ONITEMSTATEICON) != 0) {
                        //We donot pass the Message to the Control .. so fire MouseDowm ...
                        OnMouseDown(new MouseEventArgs(MouseButtons.Left, 1, WinFormNativeMethods.Util.SignedLOWORD(m.LParam), WinFormNativeMethods.Util.SignedHIWORD(m.LParam), 0));
                ...
                case WinFormNativeMethods.WM_RBUTTONUP:
                    WinFormNativeMethods.TV_HITTESTINFO tvhi = new WinFormNativeMethods.TV_HITTESTINFO();
                    tvhi.pt_x = WinFormNativeMethods.Util.SignedLOWORD(m.LParam);
                    tvhi.pt_y = WinFormNativeMethods.Util.SignedHIWORD(m.LParam);
                    IntPtr hnode = WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.TVM_HITTEST, 0, tvhi);
                    ...
                    if(hnode != IntPtr.Zero) {
                        if (!ValidationCancelled && !treeViewState[TREEVIEWSTATE_doubleclickFired] & !treeViewState[TREEVIEWSTATE_mouseUpFired]) {
                            ...
                            if (hnode == hNodeMouseDown) {
                                OnNodeMouseClick(new TreeNodeMouseClickEventArgs(NodeFromHandle(hnode), downButton, 1, WinFormNativeMethods.Util.SignedLOWORD(m.LParam), WinFormNativeMethods.Util.SignedHIWORD(m.LParam)));
                            }
                            
                            OnClick(new MouseEventArgs(downButton, 1, WinFormNativeMethods.Util.SignedLOWORD(m.LParam), WinFormNativeMethods.Util.SignedHIWORD(m.LParam), 0));
                            OnMouseClick(new MouseEventArgs(downButton, 1, WinFormNativeMethods.Util.SignedLOWORD(m.LParam), WinFormNativeMethods.Util.SignedHIWORD(m.LParam), 0));
                        }
                        ...
                        if (treeViewState[TREEVIEWSTATE_doubleclickFired]) {
                            ...
                            if (!ValidationCancelled) {
                                 ...
                                 OnNodeMouseDoubleClick(new TreeNodeMouseClickEventArgs(NodeFromHandle(hnode), downButton, 2, WinFormNativeMethods.Util.SignedLOWORD(m.LParam), WinFormNativeMethods.Util.SignedHIWORD(m.LParam)));
                                 OnDoubleClick(new MouseEventArgs(downButton, 2, WinFormNativeMethods.Util.SignedLOWORD(m.LParam), WinFormNativeMethods.Util.SignedHIWORD(m.LParam), 0));
                ...
                case WinFormNativeMethods.WM_RBUTTONDOWN:
                    ...
                    WinFormNativeMethods.TV_HITTESTINFO tvhit = new WinFormNativeMethods.TV_HITTESTINFO();
                    tvhit.pt_x = WinFormNativeMethods.Util.SignedLOWORD(m.LParam);
                    tvhit.pt_y = WinFormNativeMethods.Util.SignedHIWORD(m.LParam);
                    hNodeMouseDown = WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.TVM_HITTEST, 0, tvhit);
                    
                    WmMouseDown(ref m, MouseButtons.Right, 1);
                    downButton = MouseButtons.Right;
                    break;
                    //# VS7 15052
                case WinFormNativeMethods.WM_SYSCOLORCHANGE:
                    SendMessage(WinFormNativeMethods.TVM_SETINDENT, Indent, 0);
                    await base.WndProc(m);
                    break;
