...
namespace System.Windows.Forms
{
    ...
    internal class Formatter
    {
        ...
        private static string GetCantConvertMessage(object value, Type targetType) {
            string stringResId = (value == null) ? DCSR.Formatter_CantConvertNull : DCSR.Formatter_CantConvert;
            return String.Format(CultureInfo.CurrentCulture, DCSR.GetString(stringResId), value, targetType.Name);
        }
