...
{
    public partial class frmTestToolStripDropDownMenu : Form
    {
        public frmTestToolStripDropDownMenu()
        {
            InitializeComponent();
        }

        private void frmTestToolStripDropDownMenu_Load(object sender, EventArgs e)
        {
