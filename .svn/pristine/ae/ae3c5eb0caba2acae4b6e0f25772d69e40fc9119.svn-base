...
namespace System.Windows.Forms {
    ...
    public class RadioButton : ButtonBase {
        ...
        SRDescription(DCSR.RadioButtonAutoCheckDescr)
        ]
        public bool AutoCheck {
            ...
            set {
                if (autoCheck != value) {
                    ...
                    this.LogWF2WPropertyValue("AutoCheck", value);
                }
            }
        }
        ...
        Localizable(true),
        SRDescription(DCSR.RadioButtonAppearanceDescr)
        ]
        ...
        /// </devdoc>
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.RadioButtonOnAppearanceChangedDescr)]
        ...
        SRDescription(DCSR.RadioButtonCheckAlignDescr)
        ]
        public ContentAlignment CheckAlign {
            ...
            set {
                ...
                this.LogWF2WPropertyValue("CheckAlign", value);
            }
        }
        ...
        DefaultValue(false),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.RadioButtonCheckedDescr)
        ]
        public bool Checked {
            get {
                return isChecked;
            ...
            set {
                if (isChecked != value) {
                    ...
                    if (IsHandleCreated) SendMessage(WinFormNativeMethods.BM_SETCHECK, value? 1: 0, 0);
                    Invalidate();
                    Update();
                    PerformAutoUpdates(false);
                    OnCheckedChanged(EventArgs.Empty);
                    this.LogWF2WPropertyValue("Checked", value);
                }
            }
        }
        ...
        protected override CreateParams CreateParams {
            ...
            get {
                ...
                if (OwnerDraw) {
                    ...
                    cp.Style |= WinFormNativeMethods.BS_RADIOBUTTON;
                    if (Appearance == Appearance.Button) {
                        cp.Style |= WinFormNativeMethods.BS_PUSHLIKE;
                    }
                    ...
                    if ((int)(align & anyRight) != 0) {
                        cp.Style |= WinFormNativeMethods.BS_RIGHTBUTTON;
                    }
                }
                return cp;
            }
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRDescription(DCSR.RadioButtonOnCheckedChangedDescr)]
        ...
        protected override void OnHandleCreated(EventArgs e) {
            ...
            if (IsHandleCreated) {
                SendMessage(WinFormNativeMethods.BM_SETCHECK, isChecked? 1: 0, 0);
            }
        }
        ...
        protected override void OnEnter(EventArgs e) {
            ...
            if (MouseButtons == MouseButtons.None) {
                if (WinFormUnsafeNativeMethods.GetKeyState((int)Keys.Tab) >= 0) {
        ...
        protected override void OnMouseUp(MouseEventArgs mevent) {
            if (mevent.Button == MouseButtons.Left && GetStyle(ControlStyles.UserPaint)) {
                if (base.MouseIsDown) {
                    ...
                    if (WinFormUnsafeNativeMethods.WindowFromPoint(pt.X, pt.Y) == Handle) {
                        //Paint in raised state...
                        //
                        ResetFlagsandPaint();
                        if (!ValidationCancelled) {
