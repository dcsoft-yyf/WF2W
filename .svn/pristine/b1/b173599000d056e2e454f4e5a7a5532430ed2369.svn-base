    ...
    internal class ToolStripPanelCell : ArrangedElement {
        ...
        public ToolStripPanelCell(ToolStripPanelRow parent, Control control) {
            ...
            if (control == null) {
               ...
               throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, DCSR.GetString(DCSR.TypedControlCollectionShouldBeOfType, typeof(ToolStrip).Name)), control.GetType().Name);
            }
