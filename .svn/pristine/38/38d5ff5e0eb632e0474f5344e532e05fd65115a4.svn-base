...
namespace System.Windows.Forms {
    ...
    internal static class WebBrowserHelper {
        ...
        //
        // Special guids
        private static Guid ifont_Guid = typeof(WinFormUnsafeNativeMethods.IFont).GUID;
        ...
        internal static readonly int REGMSG_MSG = WinFormSafeNativeMethods.RegisterWindowMessage(Application.WindowMessagesVersion + "_subclassCheck");
        ...
        internal static WinFormNativeMethods.COMRECT GetClipRect() {
            return new WinFormNativeMethods.COMRECT(new Rectangle(0, 0, 32000, 32000));
        }
    }
}
