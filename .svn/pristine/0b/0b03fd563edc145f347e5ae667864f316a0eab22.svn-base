...
namespace System.Windows.Forms.VisualStyles {
    ...
    public enum VisualStyleState {
        ...
        ///    </para>
        /// </devdoc>
        ClientAreaEnabled = WinFormNativeMethods.STAP_ALLOW_CONTROLS,
        ...
        ///    </para>
        /// </devdoc>
        NonClientAreaEnabled = WinFormNativeMethods.STAP_ALLOW_NONCLIENT,
        ...
        ///    </para>
        /// </devdoc>
       ClientAndNonClientAreasEnabled = WinFormNativeMethods.STAP_ALLOW_NONCLIENT | WinFormNativeMethods.STAP_ALLOW_CONTROLS
    }
}
