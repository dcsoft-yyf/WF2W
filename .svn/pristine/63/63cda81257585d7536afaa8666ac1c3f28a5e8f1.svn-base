...
namespace System.Windows.Forms
{
    ...
    public class DataGridViewRowCollection : ICollection ,IList
    {
        ...
        public virtual int Add()
        {
            ...
            {
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewRowCollection_AddUnboundRow));
            }

            if (this.DataGridView.NoDimensionChangeAllowed)
            {
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_ForbiddenOperationInEventHandler));
            }
        ...
        internal int AddInternal(bool newRow, object[] values)
        {
            ...
            {
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewRowCollection_NoColumns));
            }

            if (this.DataGridView.RowTemplate.Cells.Count > this.DataGridView.Columns.Count)
            {
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewRowCollection_RowTemplateTooManyCells));
            }
        ...
        public virtual int Add(int count)
        {
            ...
            if (count <= 0)
            {
                throw new ArgumentOutOfRangeException("count", DCSR.GetString(DCSR.DataGridViewRowCollection_CountOutOfRange));
            }
        ...
        internal int AddInternal(DataGridViewRow dataGridViewRow)
        {
            ...
            {
                throw new ArgumentException(DCSR.GetString(DCSR.DataGridViewRowCollection_TooManyCells), "dataGridViewRow");
            }

            if (dataGridViewRow.Selected)
            {
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewRowCollection_CannotAddOrInsertSelectedRow));
            }
        ...
        internal int AddCopyInternal(int indexSource, DataGridViewElementStates dgvesAdd, DataGridViewElementStates dgvesRemove, bool newRow)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("indexSource", DCSR.GetString(DCSR.DataGridViewRowCollection_IndexSourceOutOfRange));
            }
        ...
        public virtual void Clear()
        {
            ...
            if (this.DataGridView.DataSource != null)
            {
                ...
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewRowCollection_CantClearRowCollectionWithWrongSource));
                }
            }
            else
            {
        ...
        public int GetFirstRow(DataGridViewElementStates includeFilter)
        {
            ...
            {
                throw new ArgumentException(DCSR.GetString(DCSR.DataGridView_InvalidDataGridViewElementStateCombination, "includeFilter"));
            }
#if DEBUG
                               ...
                               DataGridViewElementStates excludeFilter)
        {
            ...
            if ((excludeFilter & ~(DataGridViewElementStates.Displayed | DataGridViewElementStates.Frozen | DataGridViewElementStates.Resizable |
                DataGridViewElementStates.ReadOnly | DataGridViewElementStates.Selected | DataGridViewElementStates.Visible)) != 0)
            {
                throw new ArgumentException(DCSR.GetString(DCSR.DataGridView_InvalidDataGridViewElementStateCombination, "excludeFilter"));
            }
#if DEBUG
            Debug.Assert(this.cachedRowCountsAccessAllowed);
#endif
        ...
        public int GetNextRow(int indexStart, DataGridViewElementStates includeFilter)
        {
            ...
            if (indexStart < -1)
            {
                throw new ArgumentOutOfRangeException("indexStart", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "indexStart", (indexStart).ToString(CultureInfo.CurrentCulture), (-1).ToString(CultureInfo.CurrentCulture)));
            }
        ...
        public int GetPreviousRow(int indexStart, DataGridViewElementStates includeFilter)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("indexStart", DCSR.GetString(DCSR.InvalidHighBoundArgumentEx, "indexStart", (indexStart).ToString(CultureInfo.CurrentCulture), (this.items.Count).ToString(CultureInfo.CurrentCulture)));
            }
        ...
        public virtual DataGridViewElementStates GetRowState(int rowIndex)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("rowIndex", DCSR.GetString(DCSR.DataGridViewRowCollection_RowIndexOutOfRange));
            }
        ...
        public virtual void Insert(int rowIndex, int count)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("rowIndex", DCSR.GetString(DCSR.DataGridViewRowCollection_IndexDestinationOutOfRange));
            }
            ...
            if (this.DataGridView.NewRowIndex != -1 && rowIndex == this.Count)
            {
                ...
                Debug.Assert(this.DataGridView.AllowUserToAddRowsInternal);
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewRowCollection_NoInsertionAfterNewRow));
            }
        ...
        private void InsertCopiesPrivate(int indexSource, int indexDestination, int count)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("indexDestination", DCSR.GetString(DCSR.DataGridViewRowCollection_IndexDestinationOutOfRange));
            }
        ...
        public virtual void Remove(DataGridViewRow dataGridViewRow)
        {
            ...
            {
                throw new ArgumentException(DCSR.GetString(DCSR.DataGridView_RowDoesNotBelongToDataGridView), "dataGridViewRow");
            }

            if (dataGridViewRow.Index == -1)
            {
                throw new ArgumentException(DCSR.GetString(DCSR.DataGridView_RowMustBeUnshared), "dataGridViewRow");
            }
            else
            {
        ...
        public virtual void RemoveAt(int index)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("index", DCSR.GetString(DCSR.DataGridViewRowCollection_RowIndexOutOfRange));
            }

            if (this.DataGridView.NewRowIndex == index)
            {
                Debug.Assert(this.DataGridView.AllowUserToAddRowsInternal);
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewRowCollection_CannotDeleteNewRow)); 
            }
            ...
            if (this.DataGridView.DataSource != null)
            {
                ...
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewRowCollection_CantRemoveRowsWithWrongSource));
                }
            }
            else
            {
        ...
        private class UnsharingRowEnumerator : IEnumerator 
        {
            ...
            object IEnumerator.Current 
            {
                get 
                {
                    if (this.current == -1) 
                    {
                        throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewRowCollection_EnumNotStarted));
                    }
                    if (this.current == this.owner.Count)
                    {
                        throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewRowCollection_EnumFinished));
                    }
