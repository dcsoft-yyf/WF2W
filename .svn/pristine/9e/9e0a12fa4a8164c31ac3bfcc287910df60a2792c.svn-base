...
namespace System.Windows.Forms {
    ...
    public class KeysConverter : TypeConverter, IComparer {
        ...
        private void Initialize() {
            ...
            AddKey(DCSR.GetString(DCSR.toStringEnter), Keys.Return);
            AddKey("F12", Keys.F12);
            AddKey("F11", Keys.F11);
            AddKey("F10", Keys.F10);
            AddKey(DCSR.GetString(DCSR.toStringEnd), Keys.End);
            AddKey(DCSR.GetString(DCSR.toStringControl), Keys.Control);
            AddKey("F8", Keys.F8);
            AddKey("F9", Keys.F9);
            AddKey(DCSR.GetString(DCSR.toStringAlt), Keys.Alt);
            AddKey("F4", Keys.F4);
            AddKey("F5", Keys.F5);
            AddKey("F6", Keys.F6);
            AddKey("F7", Keys.F7);
            ...
            AddKey("F2", Keys.F2);
            AddKey("F3", Keys.F3);
            AddKey(DCSR.GetString(DCSR.toStringPageDown), Keys.Next);
            AddKey(DCSR.GetString(DCSR.toStringInsert), Keys.Insert);
            AddKey(DCSR.GetString(DCSR.toStringHome), Keys.Home);
            AddKey(DCSR.GetString(DCSR.toStringDelete), Keys.Delete);
            AddKey(DCSR.GetString(DCSR.toStringShift), Keys.Shift);
            AddKey(DCSR.GetString(DCSR.toStringPageUp), Keys.Prior);
            AddKey(DCSR.GetString(DCSR.toStringBack), Keys.Back);
                    ...
                    for (int i = 0; i < tokens.Length; i++) {
                        ...
                        if (obj != null) {
                            ...
                            if ((currentKey & Keys.KeyCode) != 0) {
                                ...
                                //
                                if (foundKeyCode) {
                                    throw new FormatException(DCSR.GetString(DCSR.KeysConverterInvalidKeyCombination));
                                }
                                foundKeyCode = true;
                            }
                            ...
                            //
                            throw new FormatException(DCSR.GetString(DCSR.KeysConverterInvalidKeyName, tokens[i]));
