    ...
    public class StatusBar : Control {
        ...
        protected override CreateParams CreateParams {
            ...
            get {
                ...
                cp.ClassName = WinFormNativeMethods.WC_STATUSBAR;

                if (this.sizeGrip) {
                    cp.Style |= WinFormNativeMethods.SBARS_SIZEGRIP;
                }
                else {
                    cp.Style &= (~WinFormNativeMethods.SBARS_SIZEGRIP);
                }
                cp.Style |= WinFormNativeMethods.CCS_NOPARENTALIGN | WinFormNativeMethods.CCS_NORESIZE;
        ...
        SRDescription(DCSR.StatusBarPanelsDescr),
        Localizable(true),
        ...
        */
        ...
        DefaultValue(false),
        SRDescription(DCSR.StatusBarShowPanelsDescr)
        ]
            ...
            set {
                if (showPanels != value) {
                    ...
                    if (IsHandleCreated) {
                        ...
                        SendMessage(WinFormNativeMethods.SB_SIMPLE, bShowPanels, 0);
        ...
        SRCategory(DCSR.CatAppearance),
        DefaultValue(true),
        SRDescription(DCSR.StatusBarSizingGripDescr)
        ]
        ...
        ///    </para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.StatusBarDrawItem)]
        ...
        ///    </para>
        /// </devdoc>
        [SRCategory(DCSR.CatMouse), SRDescription(DCSR.StatusBarOnPanelClickDescr)]
        ...
        private void ApplyPanelWidths() {
            ...
            if (length == 0) {
                ...
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.SB_SETPARTS, 1, offsets);
                SendMessage(WinFormNativeMethods.SB_SETICON, 0, IntPtr.Zero);
            ...
            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.SB_SETPARTS, length, offsets2);
        ...
        protected override void OnHandleCreated(EventArgs e) {
            ...
            if (!this.showPanels) {
                SendMessage(WinFormNativeMethods.SB_SIMPLE, 1, 0);
                SetSimpleText(simpleText);
            }
            else {
                ForcePanelUpdate();
        ...
        internal void RealizePanels() {
            ...
            if (length == 0) {
                SendMessage(WinFormNativeMethods.SB_SETTEXT, 0, "");
            }
            ...
            for (; i<old; i++) {
                SendMessage(WinFormNativeMethods.SB_SETTEXT, 0, null);
            }
        }
        ...
        private void SetSimpleText(string simpleText) {
            if (!showPanels && IsHandleCreated) {
                ...
                int wparam = SIMPLE_INDEX + WinFormNativeMethods.SBT_NOBORDERS;
                if (RightToLeft == RightToLeft.Yes) {
                    wparam |= WinFormNativeMethods.SBT_RTLREADING;
                }

                SendMessage(WinFormNativeMethods.SB_SETTEXT, wparam, simpleText);
            }
        }
        ...
        /// <devdoc>
        /// </devdoc>
        private void WmNotifyNMClick(WinFormNativeMethods.NMHDR note) {
        ...
        private void WmNCHitTest(ref Message m) {
            ...
            if (callSuper) {
                ...
                m.Result = (IntPtr)WinFormNativeMethods.HTCLIENT;
            }
        }
            ...
            public virtual StatusBarPanel this[int index] {
                ...
                set {
                    ...
                    if (value.Parent != null) {
                        throw new ArgumentException(DCSR.GetString(DCSR.ObjectHasParent), "value");
                    }
            ...
            object IList.this[int index] {
                ...
                set {
                    if (value is StatusBarPanel) {
                        ...
                        throw new ArgumentException(DCSR.GetString(DCSR.StatusBarBadStatusBarPanel), "value");
                    }
                }
            }
            /// <include file='doc\StatusBar.uex' path='docs/doc[@for="StatusBar.StatusBarPanelCollection.this"]/*' />
        ...
        private class ControlToolTip {
            ...
            private void AddTool(Tool tool) {
                if (tool != null && tool.text != null && tool.text.Length > 0) {
                    ...
                    if (p.ToolTipSet) {
                        ret = (int)WinFormUnsafeNativeMethods.SendMessage(new HandleRef(p.MainToolTip, p.MainToolTip.Handle), WinFormNativeMethods.TTM_ADDTOOL, 0, GetTOOLINFO(tool));
                    }
                    else {
                        ret = (int)WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.TTM_ADDTOOL, 0, GetTOOLINFO(tool));
                    }
                    if (ret == 0) {
                        throw new InvalidOperationException(DCSR.GetString(DCSR.StatusBarAddFailed));
                    }
                }
            }
            private void RemoveTool(Tool tool) {
                if (tool != null && tool.text != null && tool.text.Length > 0 && (int)tool.id >= 0) {
                    WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.TTM_DELTOOL, 0, GetMinTOOLINFO(tool));
                }
            }
            private void UpdateTool(Tool tool) {
                if (tool != null && tool.text != null && tool.text.Length > 0 && (int)tool.id >= 0) {
                    WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.TTM_SETTOOLINFO, 0, GetTOOLINFO(tool));
                }
            }
            ...
            /// </devdoc>
            private WinFormNativeMethods.TOOLINFO_T GetMinTOOLINFO(Tool tool) {
                WinFormNativeMethods.TOOLINFO_T ti = new WinFormNativeMethods.TOOLINFO_T();
                ti.cbSize = Marshal.SizeOf(typeof(WinFormNativeMethods.TOOLINFO_T));
            ...
            /// </devdoc>
            private WinFormNativeMethods.TOOLINFO_T GetTOOLINFO(Tool tool) {
                WinFormNativeMethods.TOOLINFO_T ti = GetMinTOOLINFO(tool);
                ti.cbSize = Marshal.SizeOf(typeof(WinFormNativeMethods.TOOLINFO_T));
                ...
                ti.rect = WinFormNativeMethods.RECT.FromXYWH(tool.rect.X, tool.rect.Y, tool.rect.Width, tool.rect.Height);
                return ti;
            }
