...
namespace System.Windows.Forms {
    ...
    internal class DataGridParentRows {
        ...
        internal Color BackColor {
            ...
            set {
                if (value.IsEmpty)
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridEmptyColor, "Parent Rows BackColor"));
        ...
        */
        ...
        internal Color ForeColor {
            ...
            set {
                if (value.IsEmpty)
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridEmptyColor, "Parent Rows ForeColor"));
        ...
        */
        ...
        protected internal class DataGridParentRowsAccessibleObject : AccessibleObject {
            ...
            public override string DefaultAction {
                get {
                    return DCSR.GetString(DCSR.AccDGNavigateBack);
                }
            }

            public override string Name {
                get {
                    return DCSR.GetString(DCSR.AccDGParentRows);
                }
            }
