...
#if WF2W
            this.menuItemNewGame.ClickAsync += this.menuItemNewGame_Click;
#else
...
#if WF2W
            this.menuItemDebug.ClickAsync += this.menuItemDebug_Click;
#else
...
#if WF2W
            this.menuItemExit.ClickAsync += this.menuItemExit_Click;
#else
...
#if WF2W
            this.menuItemAbout.ClickAsync += this.menuItemAbout_Click;
#else
