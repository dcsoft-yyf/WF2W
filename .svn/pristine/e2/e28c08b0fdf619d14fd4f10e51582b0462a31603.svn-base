...
namespace System.Windows.Forms {
    ...
    public abstract class CommonDialog : Component {
        ...
        private const int CDM_SETDEFAULTFOCUS = WinFormNativeMethods.WM_USER + 0x51;
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRDescription(DCSR.CommonDialogHelpRequested)]
        ...
        */
        ...
        protected virtual IntPtr HookProc(IntPtr hWnd, int msg, IntPtr wparam, IntPtr lparam) {
            if (msg == WinFormNativeMethods.WM_INITDIALOG) {
                ...
                WinFormUnsafeNativeMethods.SetFocus(new HandleRef(null, wparam));
            }
            else if (msg == WinFormNativeMethods.WM_SETFOCUS) {
                WinFormUnsafeNativeMethods.PostMessage(new HandleRef(null, hWnd), CDM_SETDEFAULTFOCUS, 0, 0);
            }
                ...
                //
                WinFormUnsafeNativeMethods.SetFocus(new HandleRef(this, defaultControlHwnd));
            }
            return IntPtr.Zero;
        }
        ...
        internal static void MoveToScreenCenter(IntPtr hWnd) {
            ...
            WinFormUnsafeNativeMethods.GetWindowRect(new HandleRef(null, hWnd), ref r);
            ...
            WinFormSafeNativeMethods.SetWindowPos(new HandleRef(null, hWnd), WinFormNativeMethods.NullHandleRef, x, y, 0, 0, WinFormNativeMethods.SWP_NOSIZE |
                                 WinFormNativeMethods.SWP_NOZORDER | WinFormNativeMethods.SWP_NOACTIVATE);
        }
        ...
        protected virtual IntPtr OwnerWndProc(IntPtr hWnd, int msg, IntPtr wparam, IntPtr lparam) {
            ...
            return WinFormUnsafeNativeMethods.CallWindowProc(defOwnerWndProc, hWnd, msg, wparam, lparam);         
        }
        ...
        //[System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        //public virtual async Task<DialogResult> ShowDialog( IWin32Window owner ) {
        ...
        //    //        hwndOwner = WinFormUnsafeNativeMethods.GetActiveWindow();
        //    //    }
        ...
        //    //    if (helpMsg == 0) {
        //    //        helpMsg = WinFormSafeNativeMethods.RegisterWindowMessage("commdlg_help");
        //    //    }
    
        //    //    WinFormNativeMethods.WndProc ownerProc = new WinFormNativeMethods.WndProc(this.OwnerWndProc);
        ...
        //    //        defOwnerWndProc = WinFormUnsafeNativeMethods.SetWindowLong(new HandleRef(this, hwndOwner), WinFormNativeMethods.GWL_WNDPROC, ownerProc);
        ...
        //    //    }
        //    //    finally {
        //    //        IntPtr currentSubClass = WinFormUnsafeNativeMethods.GetWindowLong(new HandleRef(this, hwndOwner), WinFormNativeMethods.GWL_WNDPROC);
        //    //        if ( IntPtr.Zero != defOwnerWndProc || currentSubClass != hookedWndProc) {
        //    //            WinFormUnsafeNativeMethods.SetWindowLong(new HandleRef(this, hwndOwner), WinFormNativeMethods.GWL_WNDPROC, new HandleRef(this, defOwnerWndProc));
        //    //        }
