...
namespace System.Windows.Forms {
    ...
    public abstract class TableLayoutStyle {
        ...
        internal float Size {
            ...
            set {
                if (value < 0) {
                    throw new ArgumentOutOfRangeException("Size", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "Size", value.ToString(CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture)));
                }
                if (_size != value) {
                    _size = value;
                    if(Owner != null) {
