...
[System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = false )]
    public class SplitContainer : ContainerControl, ISupportInitialize
    {
        ...
        Localizable(true),
        DefaultValue(false),
        SRDescription(DCSR.FormAutoScrollDescr),
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Never),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.FormAutoScrollPositionDescr)        
        ]
        ...
        [
        Browsable(false),
        SRDescription(DCSR.ContainerControlBindingContextDescr),
        ...
        System.Runtime.InteropServices.DispId(WinFormNativeMethods.ActiveX.DISPID_BORDERSTYLE),
        SRDescription(DCSR.SplitterBorderStyleDescr)
        ]
        ...
        SRCategory(DCSR.CatLayout),
        SRDescription(DCSR.SplitContainerFixedPanelDescr)
        ]
        ...
        DefaultValue(false),
        Localizable(true),
        SRDescription(DCSR.SplitContainerIsSplitterFixedDescr)
        ]
        ...
        Localizable(true),
        SRDescription(DCSR.SplitContainerOrientationDescr)
        ]
                ...
                if (overrideCursor != value) {
                    ...
                    if (IsHandleCreated) {
                        ...
                        if ((r.left <= p.x && p.x < r.right && r.top <= p.y && p.y < r.bottom) || WinFormUnsafeNativeMethods.GetCapture() == Handle)
                            SendMessage(WinFormNativeMethods.WM_SETCURSOR, Handle, WinFormNativeMethods.HTCLIENT);
                    }
                }
            }
        }
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.SplitContainerPanel1Descr),
        Localizable(false),
        ...
        SRCategory(DCSR.CatLayout),
        DefaultValue(false),
        SRDescription(DCSR.SplitContainerPanel1CollapsedDescr)
        ]
        ...
        SRCategory(DCSR.CatLayout),
        DefaultValue(false),
        SRDescription(DCSR.SplitContainerPanel2CollapsedDescr)
        ]
        ...
        DefaultValue(25),
        Localizable(true),
        SRDescription(DCSR.SplitContainerPanel1MinSizeDescr),
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.SplitContainerPanel2Descr),
        Localizable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)
        ]
        ...
        DefaultValue(25),
        Localizable(true),
        SRDescription(DCSR.SplitContainerPanel2MinSizeDescr),
        RefreshProperties(RefreshProperties.All)
        ]
        ...
        SRDescription(DCSR.SplitContainerSplitterDistanceDescr),
        DefaultValue(50)
        ]
        public int SplitterDistance 
        {
            ...
            set
            {
                ...
                {
                    if (value < 0) {
                        throw new ArgumentOutOfRangeException("SplitterDistance", DCSR.GetString(DCSR.InvalidLowBoundArgument, "SplitterDistance", (value).ToString(CultureInfo.CurrentCulture), "0"));
                    }
                    ...
                    try
                    {
                        ...
                        if (Orientation == Orientation.Vertical) {
                            ...
                            if (value < 0 ) {
                                throw new InvalidOperationException(DCSR.GetString(DCSR.SplitterDistanceNotAllowed));
                            }
                            splitDistance = value;
        ...
        DefaultValue(1),
        Localizable(true),
        SRDescription(DCSR.SplitContainerSplitterIncrementDescr)
        ]
        public int SplitterIncrement {
            ...
            set {
                ...
                if (value < 1 ) {
                    throw new ArgumentOutOfRangeException("SplitterIncrement", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "SplitterIncrement", (value).ToString(CultureInfo.CurrentCulture), "1"));
                }
        ...
        [
        SRCategory(DCSR.CatLayout),
        SRDescription(DCSR.SplitContainerSplitterRectangleDescr),
        Browsable(false)
        ]
        ...
        [
        SRCategory(DCSR.CatLayout),
        SRDescription(DCSR.SplitContainerSplitterWidthDescr),
        Localizable(true),
        DefaultValue(4)
        ]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.SplitterSplitterMovingDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.SplitterSplitterMovedDescr)]
	...
	protected override void OnMove(EventArgs e)
	{
        ...
        private void ApplyPanel1MinSize(int value) {
            if (value < 0) {
                throw new ArgumentOutOfRangeException("Panel1MinSize", DCSR.GetString(DCSR.InvalidLowBoundArgument, "Panel1MinSize", (value).ToString(CultureInfo.CurrentCulture), "0"));
            }

            if (Orientation== Orientation.Vertical) {
                if (DesignMode && Width != DefaultSize.Width && value + Panel2MinSize + SplitterWidth > Width) {
                    throw new ArgumentOutOfRangeException("Panel1MinSize", DCSR.GetString(DCSR.InvalidArgument, "Panel1MinSize", (value).ToString(CultureInfo.CurrentCulture)));
                }
            }
        ...
        private void ApplyPanel2MinSize(int value) {
            if (value < 0) {
                throw new ArgumentOutOfRangeException("Panel2MinSize", DCSR.GetString(DCSR.InvalidLowBoundArgument, "Panel2MinSize", (value).ToString(CultureInfo.CurrentCulture), "0"));
            }
            if (Orientation == Orientation.Vertical) {
                if (DesignMode && Width != DefaultSize.Width && value + Panel1MinSize + SplitterWidth > Width) {
                    throw new ArgumentOutOfRangeException("Panel2MinSize", DCSR.GetString(DCSR.InvalidArgument, "Panel2MinSize", (value).ToString(CultureInfo.CurrentCulture)));
                }
        ...
        private void ApplySplitterWidth(int value) {
            if (value < 1) {
                throw new ArgumentOutOfRangeException("SplitterWidth", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "SplitterWidth", (value).ToString(CultureInfo.CurrentCulture), "1"));
            }
            if (Orientation == Orientation.Vertical) {
                if (DesignMode && value + Panel1MinSize + Panel2MinSize > Width) {
                    throw new ArgumentOutOfRangeException("SplitterWidth", DCSR.GetString(DCSR.InvalidArgument, "SplitterWidth", (value).ToString(CultureInfo.CurrentCulture)));
                }
        ...
        private void DrawSplitHelper(int splitSize) {
            ...
            WinFormUnsafeNativeMethods.ReleaseDC(new HandleRef(this, parentHandle), new HandleRef(null, dc));
        }
        ...
        private void WmSetCursor(ref Message m) {
            ...
            //
            if (m.WParam == InternalHandle && ((int)m.LParam & 0x0000FFFF) == WinFormNativeMethods.HTCLIENT) {
        ...
        private class SplitContainerMessageFilter : IMessageFilter 
        {
            ...
            bool IMessageFilter.PreFilterMessage(ref Message m) {
                if (m.Msg >= WinFormNativeMethods.WM_KEYFIRST && m.Msg <= WinFormNativeMethods.WM_KEYLAST) {
                    if ((m.Msg == WinFormNativeMethods.WM_KEYDOWN && (int)m.WParam == (int)Keys.Escape)
                        || (m.Msg == WinFormNativeMethods.WM_SYSKEYDOWN)) {
         ...
         internal class SplitContainerTypedControlCollection : WindowsFormsUtils.TypedControlCollection {
            ...
            public override void Remove(Control value) {
                if (value is SplitterPanel) {
                    if (!owner.DesignMode) {
                        if (IsReadOnly) throw new NotSupportedException(DCSR.GetString(DCSR.ReadonlyControlsCollection));
                    }
                }
                base.Remove(value);
            }
            ...
            internal override void SetChildIndexInternal(Control child, int newIndex)
            {
               if (child is SplitterPanel) {
                   if (!owner.DesignMode) {
                       if (IsReadOnly) {
                           throw new NotSupportedException(DCSR.GetString(DCSR.ReadonlyControlsCollection));
                       }
                   }
                   else {
                       // just no-op it at DT.
