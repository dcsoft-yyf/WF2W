...
namespace System.Windows.Forms {
    ...
    public abstract class ListControl : Control {
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ListControlOnDataSourceChangedDescr)]
        ...
        SRDescription(DCSR.ListControlDisplayMemberDescr)
        ]
        public string DisplayMember {
            ...
            set {
                ...
                this.LogWF2WPropertyValue("DisplayMember", value);
            }
        }
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ListControlOnDisplayMemberChangedDescr)]
        ...
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ListControlFormatDescr)]
        ...
        [
            ...
            SRDescription(DCSR.ListControlFormatInfoChangedDescr)
        ]
        ...
        [
            DefaultValue(""), 
            SRDescription(DCSR.ListControlFormatStringDescr),
        ...
        [
            SRCategory(DCSR.CatPropertyChanged),
            SRDescription(DCSR.ListControlFormatStringChangedDescr)
        ]
        ...
        [
            DefaultValue(false), 
            SRDescription(DCSR.ListControlFormattingEnabledDescr)
        ]
        ...
        [
            SRCategory(DCSR.CatPropertyChanged),
            SRDescription(DCSR.ListControlFormattingEnabledChangedDescr)
        ]
        ...
        DefaultValue(""),
        Editor("System.Windows.Forms.Design.DataMemberFieldEditor, " + AssemblyRef.SystemDesign, typeof(System.Drawing.Design.UITypeEditor)),
        SRDescription(DCSR.ListControlValueMemberDescr)
        ]
                ...
                if (!newValueMember.Equals(valueMember)) {
                    ...
                    if (this.dataManager != null && value != null && value.Length != 0)
                        if (!BindingMemberInfoInDataManager(newValueMember)) {
                            throw new ArgumentException(DCSR.GetString(DCSR.ListControlWrongValueMember), "value");
                        }

                    valueMember = newValueMember;
                    OnValueMemberChanged(EventArgs.Empty);
                    OnSelectedValueChanged(EventArgs.Empty);
                    this.LogWF2WPropertyValue("ValueMember", value);
                }
            }
        }        
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ListControlOnValueMemberChangedDescr)]
        ...
        SRDescription(DCSR.ListControlSelectedValueDescr),
        Bindable(true)
        ]        
            ...
            set {
                if (dataManager != null) {
                    ...
                    if (string.IsNullOrEmpty(propertyName))
                        throw new InvalidOperationException(DCSR.GetString(DCSR.ListControlEmptyValueMemberInSettingSelectedValue));
                    PropertyDescriptorCollection props = dataManager.GetItemProperties();
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ListControlOnSelectedValueChangedDescr)]
                    ...
                    if (isDataSourceInitialized) {
                        ...
                        if (dataManager != null && (displayMemberChanged || dataSourceChanged) && displayMember.BindingMember != null && displayMember.BindingMember.Length != 0) {
                            ...
                            if (!BindingMemberInfoInDataManager(displayMember))
                                throw new ArgumentException(DCSR.GetString(DCSR.ListControlWrongDisplayMember), "newDisplayMember");
                        }
