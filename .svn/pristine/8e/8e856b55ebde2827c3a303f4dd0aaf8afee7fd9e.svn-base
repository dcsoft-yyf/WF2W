...
[System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = false )]
        public class DataGrid : Control, ISupportInitialize, IDataGridEditingService {
            ...
            private  WinFormNativeMethods.RECT[]               cachedScrollableRegion = null;
           ...
           // private bool listHasErrors = false;
            ...
            DefaultValue(true),
            SRDescription(DCSR.DataGridAllowSortingDescr)
            ]
            ...
            [
             SRCategory(DCSR.CatColors),
             SRDescription(DCSR.DataGridAlternatingBackColorDescr)
            ]
            public Color AlternatingBackColor {
                ...
                set {
                    if (value.IsEmpty) {
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridEmptyColor,
                                                                  "AlternatingBackColor"));
                    }
                    if (IsTransparentColor(value))
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridTransparentAlternatingBackColorNotAllowed));
            ...
            [
             SRCategory(DCSR.CatColors),
             SRDescription(DCSR.ControlBackColorDescr)
            ]
            public override Color BackColor {
                ...
                set {
                    if (IsTransparentColor(value))
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridTransparentBackColorNotAllowed));
            ...
            SRDescription(DCSR.DataGridBorderStyleDescr)
            ]
            ...
            ///    <para>[To be supplied.]</para>
            /// </devdoc>
            [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.DataGridOnBorderStyleChangedDescr)]
           ...
           private bool ListHasErrors {
            ...
            [
             SRCategory(DCSR.CatColors),
             SRDescription(DCSR.DataGridCaptionBackColorDescr)
            ]
            public Color CaptionBackColor {
                ...
                set {
                    if (IsTransparentColor(value))
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridTransparentCaptionBackColorNotAllowed));
            ...
            [
             SRCategory(DCSR.CatColors),
             SRDescription(DCSR.DataGridCaptionForeColorDescr)
            ]
            ...
            [
             ...
             Localizable(true),
             AmbientValue(null),
             SRDescription(DCSR.DataGridCaptionFontDescr)
            ]
            ...
            [
             ...
             DefaultValue(""),
             Localizable(true),
             SRDescription(DCSR.DataGridCaptionTextDescr)
            ]
            ...
            [
             ...
             SRDescription(DCSR.DataGridCaptionVisibleDescr)        
            ]
            ...
            ///    <para>[To be supplied.]</para>
            /// </devdoc>
            [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.DataGridOnCaptionVisibleChangedDescr)]
            ...
            [
             ...
             SRDescription(DCSR.DataGridCurrentCellDescr)
            ]
            public DataGridCell CurrentCell {
                ...
                set {
                    ...
                    if (layout.dirty)
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridSettingCurrentCellNotGood));
                    ...
                    if (errorMessage != null) {
                        DialogResult result = RTLAwareMessageBox.Show(null,
                            DCSR.GetString(DCSR.DataGridPushedIncorrectValueIntoColumn, errorMessage),
                            DCSR.GetString(DCSR.DataGridErrorMessageBoxCaption), MessageBoxButtons.YesNo,
            ...
            ///    <para>[To be supplied.]</para>
            /// </devdoc>
            [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.DataGridOnCurrentCellChangedDescr)]
            ...
            [
             SRCategory(DCSR.CatColors),
             SRDescription(DCSR.DataGridSelectionBackColorDescr)
            ]
            public Color SelectionBackColor {
                ...
                set {
                    if (value.IsEmpty)
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridEmptyColor, "SelectionBackColor"));
                    if (IsTransparentColor(value))
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridTransparentSelectionBackColorNotAllowed));
            ...
            [
             SRCategory(DCSR.CatColors),
             SRDescription(DCSR.DataGridSelectionForeColorDescr)        
            ]
            public Color SelectionForeColor {
                ...
                set {
                    if (value.IsEmpty)
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridEmptyColor, "SelectionForeColor"));
            ...
            private void ResetToolTip()
            {
                ...
                if (!this.parentRows.IsEmpty()) {
                    ...
                    ToolTipProvider.AddToolTip(DCSR.GetString(DCSR.DataGridCaptionBackButtonToolTip), new IntPtr(0), backButton);
                    ToolTipProvider.AddToolTip(DCSR.GetString(DCSR.DataGridCaptionDetailsButtonToolTip), new IntPtr(1), detailsButton);
                    ToolTipId = 2;
                } else {
                    ToolTipId = 0;
                }
            ...
            [
             ...
             SRDescription(DCSR.DataGridDataSourceDescr)
            ]
            public object DataSource {
                ...
                set {
                    if (value != null && !(value is IList || value is IListSource))
                        throw new ArgumentException(DCSR.GetString(DCSR.BadDataSourceForComplexBinding));
            ...
            ///    <para>[To be supplied.]</para>
            /// </devdoc>
            [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.DataGridOnDataSourceChangedDescr)]
            ...
            [
             ...
             SRDescription(DCSR.DataGridDataMemberDescr)
            ]
            ...
            [
             ...
             SRDescription(DCSR.DataGridListManagerDescr)
            ]
            internal protected CurrencyManager ListManager {
                ...
                set {
                    throw new NotSupportedException(DCSR.GetString(DCSR.DataGridSetListManager));
                }
            }
            ...
            [
             DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
             Browsable(false),
             SRDescription(DCSR.DataGridSelectedIndexDescr)         
            ]
            public int CurrentRowIndex {
                ...
                set {
                    if (this.listManager == null)
                        throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridSetSelectIndex));
            ...
            [
             ...
             Localizable(true),
             SRDescription(DCSR.DataGridGridTablesDescr)
            ]
            ...
            [
             SRCategory(DCSR.CatColors),
             SRDescription(DCSR.DataGridGridLineColorDescr)
            ]
            public Color GridLineColor {
                ...
                set {
                    if (gridLineBrush.Color != value) {
                        if (value.IsEmpty)
                            throw new ArgumentException(DCSR.GetString(DCSR.DataGridEmptyColor, "GridLineColor"));
            ...
            [
             ...
             SRDescription(DCSR.DataGridGridLineStyleDescr)
            ]
            ...
            [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
             ...
             SRCategory(DCSR.CatDisplay),
             SRDescription(DCSR.DataGridParentRowsLabelStyleDescr)
            ]
            ...
            ///    <para>[To be supplied.]</para>
            /// </devdoc>
            [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.DataGridOnParentRowsLabelStyleChangedDescr)]
            ...
            [
             Browsable(false),
             SRDescription(DCSR.DataGridFirstVisibleColumnDescr)
            ]
            ...
            [
             DefaultValue(false),
             SRCategory(DCSR.CatAppearance),
             SRDescription(DCSR.DataGridFlatModeDescr)
            ]
            ...
            ///    <para>[To be supplied.]</para>
            /// </devdoc>
            [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.DataGridOnFlatModeChangedDescr)]
            ...
            [
             SRCategory(DCSR.CatColors),
             SRDescription(DCSR.DataGridHeaderBackColorDescr)         
            ]
            public Color HeaderBackColor {
                ...
                set {
                    if (value.IsEmpty)
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridEmptyColor, "HeaderBackColor"));
                    if (IsTransparentColor(value))
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridTransparentHeaderBackColorNotAllowed));
	     ...
	     private void ResetBackgroundColor() {
            ...
            [
             SRCategory(DCSR.CatColors),
             SRDescription(DCSR.DataGridBackgroundColorDescr)         
            ]
            public Color BackgroundColor {
                ...
                set {
                    if (value.IsEmpty)
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridEmptyColor, "BackgroundColor"));
            ...
            ///    <para>[To be supplied.]</para>
            /// </devdoc>
            [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.DataGridOnBackgroundColorChangedDescr)]
            ...
            [
             SRCategory(DCSR.CatAppearance),
             SRDescription(DCSR.DataGridHeaderFontDescr)
            ]
            ...
            [
             SRCategory(DCSR.CatColors),
             SRDescription(DCSR.DataGridHeaderForeColorDescr)         
            ]
            public Color HeaderForeColor {
                ...
                set {
                    if (value.IsEmpty)
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridEmptyColor, "HeaderForeColor"));
            ...
            internal int HorizontalOffset {
                ...
                set {
                    ...
                    WinFormNativeMethods.RECT[] rects = CreateScrollableRegion(scroll);
                    ScrollRectangles(rects, change);
                    OnScroll(EventArgs.Empty);
                }
            }
    
            private void ScrollRectangles(WinFormNativeMethods.RECT[] rects, int change) {
                if (rects != null) {
                    WinFormNativeMethods.RECT scroll;
                    if (isRightToLeft()) change = -change;
                    for (int r = 0; r < rects.Length; r++) {
                        scroll = rects[r];
                        WinFormSafeNativeMethods.ScrollWindow(new HandleRef(this, Handle),
                                            change,
                                            0,
                                            ref scroll,
                                            ref scroll);
            ...
            /// </devdoc>
            [
             SRDescription(DCSR.DataGridHorizScrollBarDescr)        
            ]
            ...
            [
             SRCategory(DCSR.CatColors),
             SRDescription(DCSR.DataGridLinkColorDescr)
            ]
            public Color LinkColor {
                ...
                set {
                    if (value.IsEmpty)
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridEmptyColor, "LinkColor"));
            ...
            /// </devdoc>
            [
             SRDescription(DCSR.DataGridLinkHoverColorDescr),
             SRCategory(DCSR.CatColors),
             Browsable(false),
            ...
            [
             DefaultValue(true),
             SRDescription(DCSR.DataGridNavigationModeDescr),
             SRCategory(DCSR.CatBehavior)
            ]
            ...
            ///    <para>[To be supplied.]</para>
            /// </devdoc>
            [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.DataGridOnNavigationModeChangedDescr)]
            ...
            [
             SRCategory(DCSR.CatColors),
             SRDescription(DCSR.DataGridParentRowsBackColorDescr)
            ]
            public Color ParentRowsBackColor {
                ...
                set {
                    if (IsTransparentColor(value))
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridTransparentParentRowsBackColorNotAllowed));
            ...
            [
             SRCategory(DCSR.CatColors),
             SRDescription(DCSR.DataGridParentRowsForeColorDescr)         
            ]
            ...
            [
             ...
             SRDescription(DCSR.DataGridPreferredColumnWidthDescr),
            ...
            public int PreferredColumnWidth {
                ...
                set {
                    if (value < 0)
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridColumnWidth), "PreferredColumnWidth");
            ...
            [
             SRCategory(DCSR.CatLayout),
             SRDescription(DCSR.DataGridPreferredRowHeightDescr)
            ]
            public int PreferredRowHeight {
                ...
                set {
                    if (value < 0)
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridRowRowHeight));
	     ...
	     private void ResetPreferredRowHeight() {
            ...
            [
             DefaultValue(false),
             SRCategory(DCSR.CatBehavior),
             SRDescription(DCSR.DataGridReadOnlyDescr)
            ]
            ...
            ///    <para>[To be supplied.]</para>
            /// </devdoc>
            [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.DataGridOnReadOnlyChangedDescr)]
            ...
            [
             SRCategory(DCSR.CatDisplay),
             DefaultValue(true),
             SRDescription(DCSR.DataGridColumnHeadersVisibleDescr)
            ]
            ...
            [
             SRCategory(DCSR.CatDisplay),
             DefaultValue(true),
             SRDescription(DCSR.DataGridParentRowsVisibleDescr)        
            ]
            ...
            ///    <para>[To be supplied.]</para>
            /// </devdoc>
            [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.DataGridOnParentRowsVisibleChangedDescr)]
            ...
            [
             SRCategory(DCSR.CatDisplay),
             DefaultValue(true),
             SRDescription(DCSR.DataGridRowHeadersVisibleDescr)
            ]
            ...
            [
             ...
             SRDescription(DCSR.DataGridRowHeaderWidthDescr)
            ]
            ...
            [
             Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
             SRDescription(DCSR.DataGridVertScrollBarDescr)
            ]
            ...
            [
             Browsable(false),
             SRDescription(DCSR.DataGridVisibleColumnCountDescr)
            ]
            ...
            [
             Browsable(false),
             SRDescription(DCSR.DataGridVisibleRowCountDescr)
            ]
            ...
            */
            ...
            private void HandleEndCurrentEdit() {
                ...
                if (errorMessage != null) {
                    DialogResult result = RTLAwareMessageBox.Show(null, DCSR.GetString(DCSR.DataGridPushedIncorrectValueIntoColumn,
                            errorMessage), DCSR.GetString(DCSR.DataGridErrorMessageBoxCaption), MessageBoxButtons.YesNo,
                            MessageBoxIcon.Error, MessageBoxDefaultButton.Button1, 0);
            ...
            protected override void OnBindingContextChanged(EventArgs e) {
                if (this.DataSource != null && !gridState[GRIDSTATE_inSetListManager])
                    try {
                        ...
                        RTLAwareMessageBox.Show(null, DCSR.GetString(DCSR.DataGridExceptionInPaint), null,
            ...
            protected override void OnMouseWheel(MouseEventArgs e) {
                ...
                gridState[GRIDSTATE_isScrolling] = true;
                wheelDelta += e.Delta;
                float movePerc = (float)wheelDelta / (float)WinFormNativeMethods.WHEEL_DELTA;
            ...
            protected override void OnPaint(PaintEventArgs pe) {
                try {
                    ...
                    try {
                        RTLAwareMessageBox.Show(null, DCSR.GetString(DCSR.DataGridExceptionInPaint), null, MessageBoxButtons.OK,
                            MessageBoxIcon.Error, MessageBoxDefaultButton.Button1, 0);
            ...
            /// </devdoc>
            [SRCategory(DCSR.CatAction), SRDescription(DCSR.DataGridNavigateEventDescr)]
            ...
            ///    </para>
            /// </devdoc>
            [SRCategory(DCSR.CatAction), SRDescription(DCSR.DataGridNodeClickEventDescr)]
            ...
            ///    </para>
            /// </devdoc>
            [SRCategory(DCSR.CatAction), SRDescription(DCSR.DataGridScrollEventDescr)]
            ...
            public void BeginInit() {
                if (inInit)
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridBeginInit));
                inInit = true;
            }
            ...
            /// </devdoc>
            private WinFormNativeMethods.RECT[] CreateScrollableRegion(Rectangle scroll) {
                ...
                using(Region region = new Region(scroll)) {
                    ...
                    using (Graphics graphics = CreateGraphicsInternal()) {
                        ...
                        if (handle != IntPtr.Zero) {
                            cachedScrollableRegion = WinFormUnsafeNativeMethods.GetRectsFromRegion(handle);
            ...
            private void DrawSplitBar(Rectangle r)
            {
                ...
                IntPtr dc = WinFormUnsafeNativeMethods.GetDCEx(new HandleRef(this, parentHandle), WinFormNativeMethods.NullHandleRef, WinFormNativeMethods.DCX_CACHE | WinFormNativeMethods.DCX_LOCKWINDOWUPDATE);
                IntPtr halftone = ControlPaint.CreateHalftoneHBRUSH();
                IntPtr saveBrush = WinFormSafeNativeMethods.SelectObject(new HandleRef(this, dc), new HandleRef(null, halftone));
                WinFormSafeNativeMethods.PatBlt(new HandleRef(this, dc), r.X, r.Y, r.Width, r.Height, WinFormNativeMethods.PATINVERT);
                WinFormSafeNativeMethods.SelectObject(new HandleRef(this, dc), new HandleRef(null, saveBrush));
                WinFormSafeNativeMethods.DeleteObject(new HandleRef(null, halftone));
                WinFormUnsafeNativeMethods.ReleaseDC(new HandleRef(this, parentHandle), new HandleRef(this, dc));
            }
            ...
            private void EnsureBound() {
                if (!Bound) {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridUnbound));
                }
            }
            ...
            protected override bool ProcessKeyPreview(ref Message m) {
                ...
                //
                } else if (m.Msg == WinFormNativeMethods.WM_KEYUP) {
                    KeyEventArgs ke = new KeyEventArgs((Keys)(unchecked((int)(long)m.WParam)) | ModifierKeys);
            ...
            [
             ...
             SRDescription(DCSR.DataGridBackButtonClickDescr)
            ]
            ...
            [
             SRCategory(DCSR.CatAction),
             SRDescription(DCSR.DataGridDownButtonClickDescr)
            ]
            ...
            private void ScrollDown(int rows) {
                ...
                if (rows != 0) {
                    ...
                    WinFormNativeMethods.RECT scrollArea = WinFormNativeMethods.RECT.FromXYWH(rowsRect.X, rowsRect.Y, rowsRect.Width, rowsRect.Height);
                    WinFormSafeNativeMethods.ScrollWindow(new HandleRef(this, Handle), 0, deltaY, ref scrollArea, ref scrollArea);
                    OnScroll(EventArgs.Empty);
            ...
            internal void SetParentRowsVisibility(bool visible) {
                ...
                if (visible) {
                    ...
                    */
                    ...
                    WinFormNativeMethods.RECT scrollRECT = WinFormNativeMethods.RECT.FromXYWH(underParentRows.X, underParentRows.Y - layout.ParentRows.Height, underParentRows.Width, underParentRows.Height + layout.ParentRows.Height);
    
                    WinFormSafeNativeMethods.ScrollWindow(new HandleRef(this, Handle), 0, -parentRowsRect.Height, ref scrollRECT, ref scrollRECT);
