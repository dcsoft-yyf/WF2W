...
namespace System.Windows.Forms {
    ...
    public abstract class ScrollBar : Control {
        ...
        : base() {
            ...
            if ((this.CreateParams.Style & WinFormNativeMethods.SBS_VERT) != 0)
            {
        ...
        protected override void OnMouseWheel(MouseEventArgs e) {
            ...
            while (Math.Abs(wheelDelta) >= WinFormNativeMethods.WHEEL_DELTA) {
                if (wheelDelta > 0) {
                    wheelDelta -= WinFormNativeMethods.WHEEL_DELTA;
        ...
        protected void UpdateScrollInfo() {
            if (IsHandleCreated && Enabled) {
                ...
                WinFormUnsafeNativeMethods.SetScrollInfo(new HandleRef(this, Handle), WinFormNativeMethods.SB_CTL, si, true);
            }
        }
        ...
        private void DoScroll(ScrollEventType type) {
            ...
            switch (type) {
                ...
                case ScrollEventType.ThumbTrack:
                    ...
                    WinFormSafeNativeMethods.GetScrollInfo(new HandleRef(this, Handle), WinFormNativeMethods.SB_CTL, si);
        ...
        protected override async Task WndProc(Message m) {
            switch (m.Msg) {
                ...
                case WinFormNativeMethods.WM_SIZE:
                    ...
                    if (WinFormUnsafeNativeMethods.GetFocus() == this.Handle) {
                        DefWndProc(ref m);
