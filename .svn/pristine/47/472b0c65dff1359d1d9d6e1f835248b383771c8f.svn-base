...
namespace System.Windows.Forms {
    ...
    SRDescription(DCSR.DescriptionCheckedListBox)
    ]
[System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = false )]
    public class CheckedListBox : ListBox {
        ...
        static CheckedListBox() {
            LBC_GETCHECKSTATE = WinFormSafeNativeMethods.RegisterWindowMessage("LBC_GETCHECKSTATE");
            LBC_SETCHECKSTATE = WinFormSafeNativeMethods.RegisterWindowMessage("LBC_SETCHECKSTATE");
        }
        ...
        DefaultValue(false),
        SRDescription(DCSR.CheckedListBoxCheckOnClickDescr)
        ]
        ...
        protected override CreateParams CreateParams {
            ...
            get {
                ...
                cp.Style |= WinFormNativeMethods.LBS_OWNERDRAWFIXED | WinFormNativeMethods.LBS_WANTKEYBOARDINPUT;
                return cp;
            }
        }
        ...
        public override SelectionMode SelectionMode {
            ...
            set {
                ...
                if (value != SelectionMode.One
                    ...
                    throw new ArgumentException(DCSR.GetString(DCSR.CheckedListBoxInvalidSelectionMode));
                }
        ...
        DefaultValue(false),
        SRDescription(DCSR.CheckedListBoxThreeDCheckBoxesDescr)
        ]
        ...
        private void InvalidateItem(int index) {
            if (IsHandleCreated) {
                ...
                WinFormSafeNativeMethods.InvalidateRect(new HandleRef(this, Handle), ref rect, false);
            }
        }
        ...
        protected override void OnBackColorChanged(EventArgs e) {
            ...
            if (IsHandleCreated) {
                WinFormSafeNativeMethods.InvalidateRect(new HandleRef(this, Handle), null, true);
            }
        }
        ...
        private void WmReflectVKeyToItem(ref Message m) {
            int keycode = WinFormNativeMethods.Util.LOWORD(m.WParam);
            switch ((Keys)keycode) {
                case Keys.Up:
                case Keys.Down:
                case Keys.PageUp:
            ...
            m.Result = WinFormNativeMethods.InvalidIntPtr;
        }
        ...
        protected override async Task WndProc(Message m) {
            ...
            switch (m.Msg) {
                case WinFormNativeMethods.WM_REFLECT + WinFormNativeMethods.WM_CHARTOITEM:
                    m.Result = WinFormNativeMethods.InvalidIntPtr;
                    break;
                case WinFormNativeMethods.WM_REFLECT + WinFormNativeMethods.WM_VKEYTOITEM:
        ...
        public class CheckedIndexCollection : IList {
            ...
            object IList.this[int index] {
                ...
                set {
                    throw new NotSupportedException(DCSR.GetString(DCSR.CheckedListBoxCheckedIndexCollectionIsReadOnly));
                }
            }
        ...
        public class CheckedItemCollection : IList {
            ...
            public object this[int index] {
                ...
                set {
                    throw new NotSupportedException(DCSR.GetString(DCSR.CheckedListBoxCheckedItemCollectionIsReadOnly));
                }
            }
        ...
        internal class CheckedListBoxItemAccessibleObject : AccessibleObject {
            ...
            public override Rectangle Bounds {
                get {
                    ...
                    WinFormUnsafeNativeMethods.ClientToScreen(new HandleRef(ParentCheckedListBox, ParentCheckedListBox.Handle), pt);
            ...
            public override string DefaultAction {
                get {
                    if (ParentCheckedListBox.GetItemChecked(index)) {
                        return DCSR.GetString(DCSR.AccessibleActionUncheck);
                    }
                    else {
                        return DCSR.GetString(DCSR.AccessibleActionCheck);
                    }
                }
            }
