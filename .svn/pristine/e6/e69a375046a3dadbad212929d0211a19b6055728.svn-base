...
namespace System.Windows.Forms {
    ...
    public abstract class ButtonBase : Control {
        ...
        //{
        //    json["FlatStyle"] = this.FlatStyle.ToString();
        //    json["ImageAlign"] = this.ImageAlign.ToString();
        //    json["TextAlign"] = this.TextAlign.ToString();
        //    json["TextImageRelation"] = this.TextImageRelation.ToString();
        //    json["ShowToolTip"] = this.ShowToolTip;
        //    if (this.textToolTip != null)
        //    {
        //        json["TextToolTip"] = textToolTip.GetToolTip(this) ?? "";
        //    }
        //    json["UseMnemonic"] = this.UseMnemonic;
        //    if(this.Image != null )
        //    {
        //        json["Image"] = this.Image.CreateBlobUrl();
        //    }
        ...
        SRDescription(DCSR.ButtonAutoEllipsisDescr)
        ]
        ...
        protected override CreateParams CreateParams {
            ...
            get {
                ...
                if (!OwnerDraw) {
                    cp.ExStyle &= ~WinFormNativeMethods.WS_EX_RIGHT;   // WS_EX_RIGHT overrides the BS_XXXX alignment styles
                    
                    cp.Style |= WinFormNativeMethods.BS_MULTILINE;
                    ...
                    if ((int)(align & WindowsFormsUtils.AnyLeftAlign) != 0) {
                        cp.Style |= WinFormNativeMethods.BS_LEFT;
                    }
                    else if ((int)(align & WindowsFormsUtils.AnyRightAlign) != 0) {
                        cp.Style |= WinFormNativeMethods.BS_RIGHT;
                    }
                    else {
                        cp.Style |= WinFormNativeMethods.BS_CENTER;
                    
                    }
                    if ((int)(align & WindowsFormsUtils.AnyTopAlign) != 0) {
                        cp.Style |= WinFormNativeMethods.BS_TOP;
                    }
                    else if ((int)(align & WindowsFormsUtils.AnyBottomAlign) != 0) {
                        cp.Style |= WinFormNativeMethods.BS_BOTTOM;
                    }
                    else {
                        cp.Style |= WinFormNativeMethods.BS_VCENTER;
                    }
                }
                return cp;
            }
        ...
        Localizable(true),
        SRDescription(DCSR.ButtonFlatStyleDescr)
        ]
        public FlatStyle FlatStyle {
            ...
            set {
                ...
                Invalidate();
                UpdateOwnerDraw();
                this.LogWF2WPropertyValue("FlatStyle", value);
            }
        }
        ...
        Browsable(true),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ButtonFlatAppearance),
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [
        SRDescription(DCSR.ButtonImageDescr),
        Localizable(true),
        SRCategory(DCSR.CatAppearance)
        ]
        public Image Image {
            ...
            set {
                if (Image != value) {
                    ...
                    Animate();
                    Invalidate();
                    this.LogWF2WPropertyValue("Image", value);
                }
            }
        }
        ...
        Localizable(true),
        SRDescription(DCSR.ButtonImageAlignDescr),
        SRCategory(DCSR.CatAppearance)
        ]
        ...
        SRDescription(DCSR.ButtonImageIndexDescr),
        SRCategory(DCSR.CatAppearance)
        ]
        ...
        [
        DefaultValue(null),
        SRDescription(DCSR.ButtonImageListDescr),
        RefreshProperties(RefreshProperties.Repaint),        
        SRCategory(DCSR.CatAppearance)
        ]
        ...
        DefaultValue(ContentAlignment.MiddleCenter),
        Localizable(true),
        SRDescription(DCSR.ButtonTextAlignDescr),
        SRCategory(DCSR.CatAppearance)
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        Localizable(true),
        SRDescription(DCSR.ButtonTextImageRelationDescr),
        SRCategory(DCSR.CatAppearance)]
        public TextImageRelation TextImageRelation {
            ...
            set {
                ...
                if(value != TextImageRelation) {
                    ...
                    Invalidate();
                    this.LogWF2WPropertyValue("TextImageRelation", value);
                }                
            }
        }
        ...
        /// </devdoc>
        [
        SRDescription(DCSR.ButtonUseMnemonicDescr),
        DefaultValue(true),
        SRCategory(DCSR.CatAppearance)
        ]
        public bool UseMnemonic {
            ...
            set {
                ...
                Invalidate();
                this.LogWF2WPropertyValue("UseMnemonic", value);
            }
        }
        ...
        protected override void OnKeyDown(KeyEventArgs kevent) {
            ...
            if (kevent.KeyData == Keys.Space) {
                if (!GetFlag(FlagMouseDown)) {
                    ...
                    //
                    if(!OwnerDraw) {
                        SendMessage(WinFormNativeMethods.BM_SETSTATE, 1, 0);
                    }
                    Invalidate(DownChangeRectangle);
                }
                kevent.Handled = true;
        ...
        protected override void OnKeyUp(KeyEventArgs kevent) {
            if (GetFlag(FlagMouseDown) && !ValidationCancelled) {
                if (OwnerDraw) {
                    ...
                    SetFlag(FlagMousePressed, false);
                    SetFlag(FlagMouseDown, false);
                    SendMessage(WinFormNativeMethods.BM_SETSTATE, 0, 0);
                }
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ButtonUseVisualStyleBackColorDescr)
        ]
        public bool UseVisualStyleBackColor {
            ...
            set {
                ...
                this.Invalidate();
                this.LogWF2WPropertyValue("UseVisualStyleBackColor", value);
            }
        }
        ...
        protected override async Task WndProc(Message m) {
            ...
            switch (m.Msg) {
                ...
                //
                case WinFormNativeMethods.BM_CLICK:
            ...
            if (OwnerDraw) {
                switch (m.Msg) {
                    case WinFormNativeMethods.BM_SETSTATE:
                    ...
                    case WinFormNativeMethods.WM_CANCELMODE:
                ...
                switch (m.Msg) {
                    case WinFormNativeMethods.WM_REFLECT + WinFormNativeMethods.WM_COMMAND:
                        if (WinFormNativeMethods.Util.HIWORD(m.WParam) == WinFormNativeMethods.BN_CLICKED && !ValidationCancelled) {
                            OnClick(EventArgs.Empty);
                        }
                        break;
                    default:
