...
[System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = false )]
    public class MaskedTextBox : TextBoxBase
    {
        ...
        SRDescription(DCSR.MaskedTextBoxAllowPromptAsInputDescr), 
        DefaultValue(true)
        ]
        ...
        [
        SRCategory(DCSR.CatBehavior), 
        SRDescription(DCSR.MaskedTextBoxAsciiOnlyDescr), 
        ...
        [
        SRCategory(DCSR.CatBehavior), 
        SRDescription(DCSR.MaskedTextBoxBeepOnErrorDescr), 
        DefaultValue(false)
        ]
        ...
        [
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.MaskedTextBoxCultureDescr),
        RefreshProperties(RefreshProperties.Repaint),
        ]
        ...
        [
        SRCategory(DCSR.CatBehavior), 
        SRDescription(DCSR.MaskedTextBoxCutCopyMaskFormat), 
        RefreshProperties(RefreshProperties.Repaint),
        ...
        [
        SRCategory(DCSR.CatBehavior), 
        SRDescription(DCSR.MaskedTextBoxHidePromptOnLeaveDescr),
        RefreshProperties(RefreshProperties.Repaint),
        DefaultValue(false)
        ]
        ...
        [
        SRCategory(DCSR.CatBehavior), 
        SRDescription(DCSR.MaskedTextBoxInsertKeyModeDescr), 
        ...
        SRDescription(DCSR.MaskedTextBoxIsOverwriteModeChangedDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatBehavior), 
        SRDescription(DCSR.MaskedTextBoxMaskDescr), 
        RefreshProperties(RefreshProperties.Repaint),
        DefaultValue(""),
                ...
                else    // Setting control to a new value.
                {
                    foreach( char c in value )
                    {
                        if( !MaskedTextProvider.IsValidMaskChar( c ) )
                        {
                            ...
                            throw new ArgumentException( DCSR.GetString( DCSR.MaskedTextBoxMaskInvalidChar) );
                        }
                    }
        ...
        [
        SRCategory(DCSR.CatPropertyChanged),
        SRDescription(DCSR.MaskedTextBoxMaskChangedDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatBehavior), 
        SRDescription(DCSR.MaskedTextBoxMaskInputRejectedDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatBehavior), 
        SRDescription(DCSR.MaskedTextBoxPasswordCharDescr), 
        RefreshProperties(RefreshProperties.Repaint),
        ...
        public char PasswordChar
        {
            ...
            set
            {
                if( !MaskedTextProvider.IsValidPasswordChar(value) ) // null character accepted (resets value)
                {
                    ...
                    throw new ArgumentException(DCSR.GetString(DCSR.MaskedTextBoxInvalidCharError) );
                }
                ...
                if( this.passwordChar != value )
                {
                    if( value == this.maskedTextProvider.PromptChar )
                    {
                        ...
                        throw new InvalidOperationException( DCSR.GetString(DCSR.MaskedTextBoxPasswordAndPromptCharError) );
                    }
        ...
        SRDescription(DCSR.MaskedTextBoxPromptCharDescr), 
        RefreshProperties(RefreshProperties.Repaint),
        Localizable(true),
        DefaultValue('_')
        ]
        ...
        [
        SRCategory(DCSR.CatBehavior), 
        SRDescription(DCSR.MaskedTextBoxRejectInputOnFirstFailureDescr), 
        DefaultValue(false)
        ]
        ...
        [
        SRCategory(DCSR.CatBehavior), 
        SRDescription(DCSR.MaskedTextBoxResetOnPrompt), 
        DefaultValue(true)
        ]
        ...
        [
        SRCategory(DCSR.CatBehavior), 
        SRDescription(DCSR.MaskedTextBoxResetOnSpace), 
        DefaultValue(true)
        ]
        ...
        [
        SRCategory(DCSR.CatBehavior), 
        SRDescription(DCSR.MaskedTextBoxSkipLiterals), 
        DefaultValue(true)
        ]
        ...
        private void ImeComplete()
        {
            ...
            ImeNotify(WinFormNativeMethods.CPS_COMPLETE);
        }
        ...
        private void ImeNotify(int action)
        {
            ...
            IntPtr inputContext = WinFormUnsafeNativeMethods.ImmGetContext(handle);

            if (inputContext != IntPtr.Zero)
            {
                try
                {
                    WinFormUnsafeNativeMethods.ImmNotifyIME(new HandleRef(null, inputContext), WinFormNativeMethods.NI_COMPOSITIONSTR, action, 0);
                }
                finally
                {
                    WinFormUnsafeNativeMethods.ImmReleaseContext(handle, new HandleRef(null, inputContext));
                }
            }
            else
            {
        ...
        private void SetEditControlPasswordChar( char pwdChar )
        {
            if (this.IsHandleCreated) 
            {
                ...
                SendMessage(WinFormNativeMethods.EM_SETPASSWORDCHAR, pwdChar, 0);
                Invalidate();
            }
        }
        ...
        [
        SRCategory(DCSR.CatPropertyChanged), 
        SRDescription(DCSR.RadioButtonOnTextAlignChangedDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatBehavior), 
        SRDescription(DCSR.MaskedTextBoxTextMaskFormat), 
        RefreshProperties(RefreshProperties.Repaint),
        DefaultValue(MaskFormat.IncludeLiterals)
        ]
        ...
        SRDescription(DCSR.MaskedTextBoxTypeValidationCompletedDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatBehavior), 
        SRDescription(DCSR.MaskedTextBoxUseSystemPasswordCharDescr),
        RefreshProperties(RefreshProperties.Repaint),
        DefaultValue(false)
        ]
        ...
        private object PerformTypeValidation(CancelEventArgs e)
        {
            ...
            if (this.validatingType != null)
            {
                ...
                {
                    message = DCSR.GetString(DCSR.MaskedTextBoxIncompleteMsg);
                }
                else
                {
                    string textValue;
                ...
                {
                    isValidInput = true;
                    message = DCSR.GetString(DCSR.MaskedTextBoxTypeValidationSucceeded);
                }
        ...
        protected internal override bool ProcessKeyMessage(ref Message m)
        {
            ...
            if( m.Msg == WinFormNativeMethods.WM_CHAR && base.ImeWmCharsToIgnore > 0 ) {
        ...
        private bool WmImeComposition(ref Message m)
        {
            ...
            if (ImeModeConversion.InputLanguageTable == ImeModeConversion.KoreanTable)
            {
                ...
                if ((m.LParam.ToInt32() & WinFormNativeMethods.GCS_COMPSTR) != 0)
                {
                    // The character in the composition has been updated but not yet converted.
                    imeConvertionType = imeConvertionUpdate;
                }
                else if ((m.LParam.ToInt32() & WinFormNativeMethods.GCS_RESULTSTR) != 0)
                {
        ...
        private void WmPrint(ref Message m) {
            base.WndProc( m);
            if ((WinFormNativeMethods.PRF_NONCLIENT & unchecked( (int) (long)m.LParam)) != 0 && Application.RenderWithVisualStyles && this.BorderStyle == BorderStyle.Fixed3D) {
                //IntSecurity.UnmanagedCode.Assert();
                try {
        ...
        protected override async Task WndProc(Message m)
        {
            ...
            switch (m.Msg)
            {
                ...
                case WinFormNativeMethods.EM_CANUNDO:
                    base.ClearUndo(); // resets undo buffer.
                    await base.WndProc(m);
                    return;

                case WinFormNativeMethods.EM_SCROLLCARET:  // No scroll for single-line control.
                case WinFormNativeMethods.EM_LIMITTEXT:    // Max/Min text is defined by the mask.
                case WinFormNativeMethods.EM_UNDO:
            ...
            if( this.flagState[IS_NULL_MASK])
            {
                await base.WndProc(m); // Operates as a regular text box base.
                return;
            }
            ...
            switch (m.Msg)
            {
                ...
                case WinFormNativeMethods.WM_CLEAR:
                    WmClear();
                    break;
