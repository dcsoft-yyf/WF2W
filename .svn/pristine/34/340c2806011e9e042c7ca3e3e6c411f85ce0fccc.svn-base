    ...
    public class TreeViewImageIndexConverter : ImageIndexConverter {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value) {
            ...
            if (strValue != null) {
               ...
               if (String.Compare(strValue, DCSR.GetString(DCSR.toStringDefault), true, culture) == 0) {
                   return -1;
               } 
               else if (String.Compare(strValue, DCSR.GetString(DCSR.toStringNone), true, culture) == 0) {
                   return -2;
               }
            }
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType) {
            ...
            if (destinationType == typeof(string) && value is int) {
                ...
                if (intValue == -1) {
                    return DCSR.GetString(DCSR.toStringDefault);
                }
                else if (intValue == -2) {
