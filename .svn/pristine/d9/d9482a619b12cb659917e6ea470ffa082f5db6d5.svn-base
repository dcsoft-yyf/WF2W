...
namespace WinFormsControlsDemo
{
    public partial class MainForm : Form
    {
        public MainForm()
        {
            ...
            BuildControlTree();
            this.Text = ".NET Framework 4.0 WinForms 控件全集演示";
        ...
        private void BuildControlTree()
        {
            ...
            // 1. 基本控件
            TreeNode basicNode = new TreeNode("基本控件");
            basicNode.Nodes.Add("Button");
            basicNode.Nodes.Add("CheckBox");
            basicNode.Nodes.Add("RadioButton");
            basicNode.Nodes.Add("Label");
            basicNode.Nodes.Add("LinkLabel");
            basicNode.Nodes.Add("TextBox");
            basicNode.Nodes.Add("RichTextBox");
            basicNode.Nodes.Add("NumericUpDown");
            basicNode.Nodes.Add("PictureBox");
            basicNode.Nodes.Add("ProgressBar");
            basicNode.Nodes.Add("TrackBar");
            tvControls.Nodes.Add(basicNode);

            // 2. 列表与选择控件
            TreeNode listNode = new TreeNode("列表与选择");
            listNode.Nodes.Add("ComboBox");
            listNode.Nodes.Add("ListBox");
            listNode.Nodes.Add("CheckedListBox");
            listNode.Nodes.Add("ListView");
            listNode.Nodes.Add("TreeView");
            listNode.Nodes.Add("DataGridView");
            listNode.Nodes.Add("MonthCalendar");
            listNode.Nodes.Add("DateTimePicker");
            tvControls.Nodes.Add(listNode);

            // 3. 容器控件
            TreeNode containerNode = new TreeNode("容器控件");
            containerNode.Nodes.Add("GroupBox");
            containerNode.Nodes.Add("Panel");
            containerNode.Nodes.Add("TabControl");
            containerNode.Nodes.Add("SplitContainer");
            containerNode.Nodes.Add("FlowLayoutPanel");
            containerNode.Nodes.Add("TableLayoutPanel");
            tvControls.Nodes.Add(containerNode);

            // 4. 菜单、工具栏与状态
            TreeNode menuNode = new TreeNode("菜单/工具栏");
            menuNode.Nodes.Add("MenuStrip");
            menuNode.Nodes.Add("ContextMenuStrip");
            menuNode.Nodes.Add("StatusStrip");
            menuNode.Nodes.Add("ToolStrip");
            menuNode.Nodes.Add("NotifyIcon");
            tvControls.Nodes.Add(menuNode);

            // 5. 组件（不可见控件演示）
            TreeNode componentNode = new TreeNode("组件");
            componentNode.Nodes.Add("Timer");
            componentNode.Nodes.Add("ToolTip");
            tvControls.Nodes.Add(componentNode);

            // 6. 其他控件
            TreeNode otherNode = new TreeNode("其他");
            otherNode.Nodes.Add("WebBrowser");
            tvControls.Nodes.Add(otherNode);
        ...
        /// <summary>
        /// 左侧树节点点击事件：根据节点文本加载对应的演示
        /// </summary>
        private void TvControls_NodeMouseClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            if (e.Node == null || e.Node.Parent == null) return;  // 忽略分类根节点
            string controlName = e.Node.Text;
        ...
        /// <summary>
        /// 清理演示面板：移除所有控件并释放相关组件
        /// </summary>
        private void CleanupDemoPanel()
        {
            // 停止并清理可能存在的Timer（通过componentsContainer管理）
        ...
        private void ShowCheckBoxDemo()
        {
            ...
            panel.Controls.Add(lblState);  // 添加状态标签

            // 本地函数（可以放在最后，但变量已提前声明）
        ...
        private void ShowPanelDemo()
        {
            ...
            pnl.Controls.Add(new Button { Text = "按钮3", Location = new Point(10, 70) }); // 超出区域触发滚动
        ...
        private void ShowMenuStripDemo()
        {
            ...
            // MenuStrip不能直接放在FlowLayoutPanel中，需要单独放置或者调整
