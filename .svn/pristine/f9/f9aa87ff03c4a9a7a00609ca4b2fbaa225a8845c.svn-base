    ...
    public class DataGridViewColumnHeaderCell : DataGridViewHeaderCell
    {
        ...
        public SortOrder SortGlyphDirection
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_CellDoesNotYetBelongToDataGridView));
                }
                if (value != this.sortGlyphDirection)
                {
                    ...
                    {
                        throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewColumnHeaderCell_SortModeAndSortGlyphDirectionClash, (value).ToString()));
                    }
            ...
            public override string DefaultAction
            {
                get
                {
                    if (this.Owner.OwningColumn != null)
                    {
                        ...
                        {
                            return DCSR.GetString(DCSR.DataGridView_AccColumnHeaderCellDefaultAction);
                        }
                        ...
                        {
                            return DCSR.GetString(DCSR.DataGridView_AccColumnHeaderCellSelectDefaultAction);
                        }
                        else
                        {
                            return String.Empty;
