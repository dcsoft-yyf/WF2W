...
namespace System.Windows.Forms.ComponentModel.Com2Interop {
    ...
    internal class Com2Properties {
        ...
        private static Type[] extendedInterfaces = new Type[]{
                                                        typeof(WinFormNativeMethods.ICategorizeProperties),
                                                        typeof(WinFormNativeMethods.IProvidePropertyBuilder),
                                                        typeof(WinFormNativeMethods.IPerPropertyBrowsing),
                                                        typeof(WinFormNativeMethods.IVsPerPropertyBrowsing),
                                                        typeof(WinFormNativeMethods.IManagedPerPropertyBrowsing)};
            ...
            for (int i = 0; i < extendedInterfaces.Length; i++) {
                ...
                if (t.IsInstanceOfType(target)) {
                    ...
                    if (t.IsAssignableFrom(handler.Interface)) {
                        ...
                        throw new ArgumentException(DCSR.GetString(DCSR.COM2BadHandlerType, t.Name, handler.Interface.Name));
                    }
                }
            }
        }
        ...
        private long[] GetTypeInfoVersions(object comObject) {
            ...
            // get type infos
            //
            WinFormUnsafeNativeMethods.ITypeInfo[] pTypeInfos = Com2TypeInfoProcessor.FindTypeInfos(comObject, false);
        ...
        private unsafe long GetTypeInfoVersion(WinFormUnsafeNativeMethods.ITypeInfo pTypeInfo) {
