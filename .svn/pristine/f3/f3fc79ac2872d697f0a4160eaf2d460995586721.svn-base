    ...
    public class PropertyManager : BindingManagerBase {
        ...
        internal override void SetDataSource(Object dataSource) {
            ...
            if (this.dataSource != null && !String.IsNullOrEmpty(this.propName)) {
                ...
                if (propInfo == null)
                    throw new ArgumentException(DCSR.GetString(DCSR.PropertyManagerPropDoesNotExist, propName, dataSource.ToString()));
        ...
        public override void AddNew() {
            throw new NotSupportedException(DCSR.GetString(DCSR.DataBindingAddNewNotSupportedOnPropertyManager));
        }
        ...
        public override void RemoveAt(int index) {
            throw new NotSupportedException(DCSR.GetString(DCSR.DataBindingRemoveAtNotSupportedOnPropertyManager));
        }
    }
}
