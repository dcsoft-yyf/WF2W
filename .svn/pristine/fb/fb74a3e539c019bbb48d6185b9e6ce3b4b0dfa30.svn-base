...
[System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = false )]
    public class PropertyGrid : ContainerControl, IComPropertyBrowser, WinFormUnsafeNativeMethods.IPropertyNotifySink {
        ...
        public PropertyGrid()  {
            ...
            try
            {
                ...
                toolStrip.AccessibleName = DCSR.GetString(DCSR.PropertyGridToolbarAccessibleName);
        ...
        /// </devdoc>
        [Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
        SRDescription(DCSR.PropertyGridCanShowCommandsDesc)]
        ...
        SRDescription(DCSR.PropertyGridCategoryForeColorDesc),
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridCommandsBackColorDesc)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridCommandsForeColorDesc)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridCommandsLinkColorDesc)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridCommandsActiveLinkColorDesc)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridCommandsDisabledLinkColorDesc)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridCommandsBorderColorDesc),
        ...
        SRCategory(DCSR.CatAppearance),
        DefaultValue(true),
        SRDescription(DCSR.PropertyGridCommandsVisibleIfAvailable)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridHelpBackColorDesc),
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridHelpForeColorDesc),
        DefaultValue(typeof(Color), "ControlText")
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridHelpBorderColorDesc),
        DefaultValue(typeof(Color), "ControlDark")
        ]
        ...
        DefaultValue(true),
        Localizable(true),
        SRDescription(DCSR.PropertyGridHelpVisibleDesc)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridSelectedItemWithFocusBackColorDesc),
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridSelectedItemWithFocusForeColorDesc),
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridDisabledItemForeColorDesc),
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridCategorySplitterColorDesc),
        DefaultValue(typeof(Color), "Control")
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridCanShowVisualStyleGlyphsDesc),
        DefaultValue(true)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridLineColorDesc),
        ...
        SRDescription(DCSR.PropertyGridPropertySortDesc)
        ]
        ...
        [
        DefaultValue(null),
        SRDescription(DCSR.PropertyGridSelectedObjectDesc),
                ...
                try {
                    ...
                    if (value != null && value.Length > 0) {
                       for (int count = 0; count < value.Length; count++) {
                           if (value[count] == null) {
                               throw new ArgumentException(DCSR.GetString(DCSR.PropertyGridSetNull, count.ToString(CultureInfo.CurrentCulture), value.Length.ToString(CultureInfo.CurrentCulture)));
                           }
                           else if (value[count] is IUnimplemented) {
                               throw new NotSupportedException(DCSR.GetString(DCSR.PropertyGridRemotedObject, value[count].GetType().FullName));
                           }
                       }
                    }
                    else {
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridLargeButtonsDesc),
        DefaultValue(false)
        ]
        ...
        SRCategory(DCSR.CatAppearance),
        DefaultValue(true),
        SRDescription(DCSR.PropertyGridToolbarVisibleDesc)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridViewBackColorDesc),
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridViewForeColorDesc),
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.PropertyGridViewBorderColorDesc),
        DefaultValue(typeof(Color), "ControlDark")
        ]
        ...
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.PropertyGridPropertyValueChangedDescr)]
        ...
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.PropertyGridPropertyTabchangedDescr)]
        ...
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.PropertyGridPropertySortChangedDescr)]
        ...
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.PropertyGridSelectedGridItemChangedDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.PropertyGridSelectedObjectsChangedDescr)]
        ...
        internal void ClearTabs(PropertyTabScope tabScope) {
            if (tabScope < PropertyTabScope.Document) {
                throw new ArgumentException(DCSR.GetString(DCSR.PropertyGridTabScope));
            }
        ...
        private PropertyTab CreateTab(Type tabType, IDesignerHost host) {
            ...
            if (tab != null) {
                ...
                if (bitmap == null)
                    throw new ArgumentException(DCSR.GetString(DCSR.PropertyGridNoBitmap, tab.GetType().FullName));
                ...
                if (name == null || name.Length == 0)
                    throw new ArgumentException(DCSR.GetString(DCSR.PropertyGridTabName, tab.GetType().FullName));
        ...
        */
        ...
        void WinFormUnsafeNativeMethods.IPropertyNotifySink.OnChanged(int dispID) {
            ...
            if (!GetFlag(RefreshingProperties)) {
                ...
                if (ComNativeDescriptor.Instance.IsNameDispId(obj, dispID) || dispID == WinFormNativeMethods.ActiveX.DISPID_Name) {
        ...
        private void OnViewButtonClickPP(Object sender, EventArgs e) {
            ...
            if (btnViewPropertyPages.Enabled &&
                ...
                catch (Exception ex)
                {
                    ...
                    {
                        RTLAwareMessageBox.Show(null, errString, DCSR.GetString(DCSR.PropertyGridTitle), MessageBoxButtons.OK, MessageBoxIcon.Error,
        ...
        */
                ...
                case Keys.Tab:
                    ...
                    if ((keyData & Keys.Shift) != 0) {
                        ...
                        if (passToParent) {
                            ...
                            // if we're not hosted in a windows forms thing, just give the parent the focus
                            if (!result && this.Parent == null) {
                                IntPtr hWndParent = WinFormUnsafeNativeMethods.GetParent(new HandleRef(this, Handle));
                                if (hWndParent != IntPtr.Zero) {
                                    WinFormUnsafeNativeMethods.SetFocus(new HandleRef(null, hWndParent));
                                }
                            }
                            return result;
                        }
        ...
        internal void RemoveTabs(PropertyTabScope classification, bool setupToolbar) {
            if (classification == PropertyTabScope.Static) {
                throw new ArgumentException(DCSR.GetString(DCSR.PropertyGridRemoveStaticTabs));
            }
        ...
        internal void RemoveTab(int tabIndex, bool setupToolbar) {
            ...
            if (tabIndex >= viewTabs.Length || tabIndex < 0) {
                throw new ArgumentOutOfRangeException("tabIndex", DCSR.GetString(DCSR.PropertyGridBadTabIndex));
            }
        ...
        private void SetupToolbar(bool fullRebuild) {
            ...
            try {
               ...
               if (viewSortButtons == null || fullRebuild) {
                   ...
                   viewSortButtons[ALPHA] = CreatePushButton(DCSR.GetString(DCSR.PBRSToolTipAlphabetic), alphaIndex, ehViewType);
                   viewSortButtons[CATEGORIES] = CreatePushButton(DCSR.GetString(DCSR.PBRSToolTipCategorized), categoryIndex, ehViewType);
               ...
               //
               btnViewPropertyPages = CreatePushButton(DCSR.GetString(DCSR.PBRSToolTipPropertyPages), designpg, ehPP);
               btnViewPropertyPages.Enabled = false;
        ...
        private void SinkPropertyNotifyEvents() {
            ...
            //            continue;
            //        }
            //        connectionPointCookies[i] = new AxHost.ConnectionPointCookie(obj, this, typeof(WinFormUnsafeNativeMethods.IPropertyNotifySink), /*throwException*/ false);
            //    }
            //    catch {
            //        // guess we failed eh?
            //    }
        ...
        private bool ShouldForwardChildMouseMessage(Control child, MouseEventArgs me, ref Point pt) {
            ...
            if (me.Y <= 1 || (size.Height - me.Y) <= 1) {
                ...
                WinFormNativeMethods.POINT temp = new WinFormNativeMethods.POINT();
                temp.x = me.X;
                temp.y = me.Y;
                WinFormUnsafeNativeMethods.MapWindowPoints(new HandleRef(child, child.Handle), new HandleRef(this, Handle), temp, 1);
        ...
        DefaultValue(false),
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.UseCompatibleTextRenderingDescr)
        ]
        ...
        private void GetDataFromCopyData(IntPtr lparam) {
            WinFormNativeMethods.COPYDATASTRUCT cds = (WinFormNativeMethods.COPYDATASTRUCT)WinFormUnsafeNativeMethods.PtrToStructure(lparam, typeof(WinFormNativeMethods.COPYDATASTRUCT));
        ...
        protected override async Task WndProc( Message m) {
            ...
            switch (m.Msg) {
                case WinFormNativeMethods.WM_UNDO:
                    if ((long)m.LParam == 0) {
                    ...
                    return;
                case WinFormNativeMethods.WM_CUT:
                    if ((long)m.LParam == 0) {
                ...
                case WinFormNativeMethods.WM_COPYDATA:
        ...
        public class PropertyTabCollection : ICollection {
            ...
            public PropertyTab this[int index] {
                get {
                    if (owner == null) {
                        throw new InvalidOperationException(DCSR.GetString(DCSR.PropertyGridPropertyTabCollectionReadOnly));
                    }
    ...
    internal static class AutomationMessages {
        private const int WM_USER = WinFormNativeMethods.WM_USER;
