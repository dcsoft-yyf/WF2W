    ...
    public class CurrencyManager : BindingManagerBase {
        ...
        internal override void SetDataSource(Object dataSource) {
            if (this.dataSource != dataSource) {
                ...
                if (tempList is IList) {
                    ...
                    throw new ArgumentException(DCSR.GetString(DCSR.ListManagerSetDataSource, tempList.GetType().FullName), "dataSource");
                }
        ...
        internal Object this[int index] {
            get {
                if (index < 0 || index >= list.Count) {
                    throw new IndexOutOfRangeException(DCSR.GetString(DCSR.ListManagerNoValue, index.ToString(CultureInfo.CurrentCulture)));
                }
                return list[index];
            }
            set {
        ...
        public override void AddNew() {
            ...
            if (ibl != null) {
                ...
                throw new NotSupportedException(DCSR.GetString(DCSR.CurrencyManagerCantAddNew));
            }
        ...
        private void ChangeRecordState(int newPosition, bool validating, bool endCurrentEdit, bool firePositionChange, bool pullData) {
            ...
            if ((newPosition < 0 || newPosition >= Count) && this.IsBinding) {
                throw new IndexOutOfRangeException(DCSR.GetString(DCSR.ListManagerBadPosition));
            }
        ...
        protected void CheckEmpty() {
            if (dataSource == null || list == null || list.Count == 0) {
                throw new InvalidOperationException(DCSR.GetString(DCSR.ListManagerEmptyList));
            }
        }
        ...
        private void FindGoodRow() {
            ...
            SuspendBinding();
            throw new InvalidOperationException(DCSR.GetString(DCSR.DataBindingPushDataException));
        }
