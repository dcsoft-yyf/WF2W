...
namespace System.Windows.Forms {
    ...
    public class DataGridTableStyle : Component, IDataGridEditingService {
        ...
        public bool AllowSorting {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridDefaultTableSet, "AllowSorting"));
                }
        ...
        public Color AlternatingBackColor {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridDefaultTableSet, "AlternatingBackColor"));
                }

                if (System.Windows.Forms.DataGrid.IsTransparentColor(value))
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridTableStyleTransparentAlternatingBackColorNotAllowed));
                if (value.IsEmpty) {
        ...
        public Color BackColor {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridDefaultTableSet, "BackColor"));
                }

                if (System.Windows.Forms.DataGrid.IsTransparentColor(value))
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridTableStyleTransparentBackColorNotAllowed));
                if (value.IsEmpty) {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridEmptyColor,
                                                              "BackColor"));
                }
        ...
        public Color ForeColor {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridDefaultTableSet, "ForeColor"));
                }
        ...
        public Color GridLineColor {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridDefaultTableSet, "GridLineColor"));
                }
        ...
        public DataGridLineStyle GridLineStyle {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridDefaultTableSet, "GridLineStyle"));
                }
        ...
        public Color HeaderBackColor {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridDefaultTableSet, "HeaderBackColor"));
                }

                if (System.Windows.Forms.DataGrid.IsTransparentColor(value))
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridTableStyleTransparentHeaderBackColorNotAllowed));
                if (value.IsEmpty)
        ...
        public Font HeaderFont {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridDefaultTableSet, "HeaderFont"));
                }
        ...
        public Color HeaderForeColor {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridDefaultTableSet, "HeaderForeColor"));
                }
        ...
        public Color LinkColor {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridDefaultTableSet, "LinkColor"));
                }
...
;
        ...
        public int PreferredColumnWidth {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridDefaultTableSet, "PreferredColumnWidth"));
                }
        ...
        public int PreferredRowHeight {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridDefaultTableSet, "PrefferedRowHeight"));
                }
	...
	private void ResetPreferredRowHeight() {
        ...
        public Color SelectionBackColor {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridDefaultTableSet, "SelectionBackColor"));
                }

                if (System.Windows.Forms.DataGrid.IsTransparentColor(value))
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridTableStyleTransparentSelectionBackColorNotAllowed));
                if (value.IsEmpty)
        ...
        public Color SelectionForeColor {
            ...
            set {
                if (this.isDefaultTableStyle) {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridDefaultTableSet, "SelectionForeColor"));
                }
