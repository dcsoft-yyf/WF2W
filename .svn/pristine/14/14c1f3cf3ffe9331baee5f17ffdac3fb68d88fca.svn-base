...
namespace System.Windows.Forms {
    ...
    internal class DataGridCaption {
        ...
        internal Color BackColor {
            ...
            set {
                if (!backBrush.Color.Equals(value)) {
                    if (value.IsEmpty)
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridEmptyColor, "Caption BackColor"));
        ...
        internal Color ForeColor {
            ...
            set {
                if (value.IsEmpty)
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridEmptyColor, "Caption ForeColor"));
