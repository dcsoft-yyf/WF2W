...
namespace System.Windows.Forms.PropertyGridInternal {
    ...
    internal class GridErrorDlg : Form {
        ...
        public GridErrorDlg(PropertyGrid owner) {
            ...
            detailsBtn.Text = " " + DCSR.GetString(DCSR.ExDlgShowDetails);

            details.AccessibleName = DCSR.GetString(DCSR.ExDlgDetailsText);
            
            okBtn.Text = DCSR.GetString(DCSR.ExDlgOk);
            cancelBtn.Text = DCSR.GetString(DCSR.ExDlgCancel);
