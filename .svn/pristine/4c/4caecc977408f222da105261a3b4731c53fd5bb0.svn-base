    ...
    public class Binding {
        ...
        private void CheckBinding() {
            ...
            if (control != null && propertyName.Length > 0) {
                ...
                if (tempPropInfo == null) {
                    throw new ArgumentException(DCSR.GetString(DCSR.ListBindingBindProperty, propertyName), "PropertyName");
                }
                if (tempPropInfo.IsReadOnly && this.controlUpdateMode != ControlUpdateMode.Never) {
                    throw new ArgumentException(DCSR.GetString(DCSR.ListBindingBindPropertyReadOnly, propertyName), "PropertyName");
                }
        ...
        private object FormatObject(object value) {
            ...
            if (formattingEnabled) {
                ...
                // time to fail:
                throw new FormatException(DCSR.GetString(DCSR.ListBindingFormatFailed));
            }
        }
