...
namespace System.Windows.Forms {
    ...
    public class AccessibleObject : StandardOleMarshalObject,
                                    IReflect,
                                    IAccessible,
                                    WinFormUnsafeNativeMethods.IEnumVariant,
        ...
        /// </devdoc>
        private WinFormUnsafeNativeMethods.IEnumVariant systemIEnumVariant = null;
        private WinFormUnsafeNativeMethods.IEnumVariant enumVariant = null;

        // IOleWindow interface of the 'inner' system IAccessible object that we are wrapping
        private WinFormUnsafeNativeMethods.IOleWindow systemIOleWindow = null;

        private bool systemWrapper = false;     // Indicates this object is being used ONLY to wrap a system IAccessible

        private int accObjId = WinFormNativeMethods.OBJID_CLIENT;    // Indicates what kind of 'inner' system accessible object we are using
        ...
        public virtual Rectangle Bounds {
            get {
                ...
                if (systemIAccessible != null) {
                    ...
                    int height = 0;
                    try {
                        systemIAccessible.accLocation(out left, out top, out width, out height, WinFormNativeMethods.CHILDID_SELF);
                        return new Rectangle(left, top, width, height);
                    }
                    catch (COMException e) {
                        if (e.ErrorCode != WinFormNativeMethods.DISP_E_MEMBERNOTFOUND) {
                            throw e;
                        }                        
                    }                    
                }
        ...
        public virtual string DefaultAction {
            get {
                if (systemIAccessible != null) {
                    try {
                        return systemIAccessible.get_accDefaultAction(WinFormNativeMethods.CHILDID_SELF);
                    }
                    catch (COMException e) {
        ...
        public virtual string Description {
            get {
                if (systemIAccessible != null) {
                    try {
                        return systemIAccessible.get_accDescription(WinFormNativeMethods.CHILDID_SELF);
                    }
                    catch (COMException e) {
                        if (e.ErrorCode != WinFormNativeMethods.DISP_E_MEMBERNOTFOUND) {
                            throw e;
        ...
        private WinFormUnsafeNativeMethods.IEnumVariant EnumVariant {
            get {
                if (enumVariant == null) {
        ...
        public virtual string Help {
            get {
                if (systemIAccessible != null) {
                    try {
                        return systemIAccessible.get_accHelp(WinFormNativeMethods.CHILDID_SELF);
                    }
                    catch (COMException e) {
                        if (e.ErrorCode != WinFormNativeMethods.DISP_E_MEMBERNOTFOUND) {
                            throw e;
        ...
        public virtual string KeyboardShortcut {
            get {
                if (systemIAccessible != null) {
                    try {
                        return systemIAccessible.get_accKeyboardShortcut(WinFormNativeMethods.CHILDID_SELF);
                    }
                    catch (COMException e) {
                        if (e.ErrorCode != WinFormNativeMethods.DISP_E_MEMBERNOTFOUND) {
                            throw e;
        ...
        public virtual string Name {
            ...
            get {
                if (systemIAccessible != null) {
                    try {
                        return systemIAccessible.get_accName(WinFormNativeMethods.CHILDID_SELF);
                    }
                    catch (COMException e) {
                        if (e.ErrorCode != WinFormNativeMethods.DISP_E_MEMBERNOTFOUND) {
                            throw e;
            ...
            set {
                if (systemIAccessible != null) {
                    try {
                        systemIAccessible.set_accName(WinFormNativeMethods.CHILDID_SELF, value);
                    }
                    catch (COMException e) {
                        if (e.ErrorCode != WinFormNativeMethods.DISP_E_MEMBERNOTFOUND) {
                            throw e;
        ...
        public virtual AccessibleRole Role {
            get {
                if (systemIAccessible != null) {
                    return (AccessibleRole) systemIAccessible.get_accRole(WinFormNativeMethods.CHILDID_SELF);
                }
                else {
        ...
        public virtual AccessibleStates State {
            get {
                ...
                //if (systemIAccessible != null) {
                //    return (AccessibleStates) systemIAccessible.get_accState(WinFormNativeMethods.CHILDID_SELF);
                //}
                //else {
                //    return AccessibleStates.None;
                //}
        ...
        public virtual string Value {
            ...
            get {
                //if (systemIAccessible != null) {
                //    try {
                //        return systemIAccessible.get_accValue(WinFormNativeMethods.CHILDID_SELF);
                //    }
                //    catch (COMException e) {
                //        if (e.ErrorCode != WinFormNativeMethods.DISP_E_MEMBERNOTFOUND) {
                //            throw e;
            ...
            set {
                if (systemIAccessible != null) {
                    try {
                        systemIAccessible.set_accValue(WinFormNativeMethods.CHILDID_SELF, value);
                    }
                    catch (COMException e) {
                        if (e.ErrorCode != WinFormNativeMethods.DISP_E_MEMBERNOTFOUND) {
                            throw e;
        ...
        public virtual int GetHelpTopic(out string fileName) {
            //if (systemIAccessible != null) {
            //    try {
            //        int retVal = systemIAccessible.get_accHelpTopic(out fileName, WinFormNativeMethods.CHILDID_SELF);
        ...
        void IAccessible.accDoDefaultAction(Object childID) {
            ...
            if (IsClientObject) {
                ...
                if (childID.Equals(WinFormNativeMethods.CHILDID_SELF)) {
                    DoDefaultAction();
                    return;
                }
        ...
        int WinFormUnsafeNativeMethods.IOleWindow.GetWindow(out IntPtr hwnd) {
            ...
            if (parent is WinFormUnsafeNativeMethods.IOleWindow) {
                return (parent as WinFormUnsafeNativeMethods.IOleWindow).GetWindow(out hwnd);
            }
        ...
        void WinFormUnsafeNativeMethods.IOleWindow.ContextSensitiveHelp(int fEnterMode) {
            ...
            AccessibleObject parent = this.Parent;
            if (parent is WinFormUnsafeNativeMethods.IOleWindow) {
                (parent as WinFormUnsafeNativeMethods.IOleWindow).ContextSensitiveHelp(fEnterMode);
                return;
            }
        ...
        ///    </para>
        /// </devdoc>
        void WinFormUnsafeNativeMethods.IEnumVariant.Clone(WinFormUnsafeNativeMethods.IEnumVariant[] v) {
            EnumVariant.Clone(v);
        }
        ...
        ///    </para>
        /// </devdoc>
        int WinFormUnsafeNativeMethods.IEnumVariant.Next(int n, IntPtr rgvar, int[] ns) {
        ...
        /// </devdoc>
        void WinFormUnsafeNativeMethods.IEnumVariant.Reset() {
            EnumVariant.Reset();
        }
        ...
        ///    </para>
        /// </devdoc>
        void WinFormUnsafeNativeMethods.IEnumVariant.Skip(int n) {
            EnumVariant.Skip(n);
        }
        ...
        public virtual AccessibleObject Navigate(AccessibleNavigation navdir) {
            ...
            if (systemIAccessible != null) {
                try {
                    ...
                    if (!SysNavigate((int)navdir, WinFormNativeMethods.CHILDID_SELF, out retObject))
                        retObject = systemIAccessible.accNavigate((int)navdir, WinFormNativeMethods.CHILDID_SELF);
        ...
        private object AsVariant(AccessibleObject obj) {
            if (obj == this) {
                return WinFormNativeMethods.CHILDID_SELF;
            }
        ...
        internal bool IsClientObject {
            get {
                return AccessibleObjectId == WinFormNativeMethods.OBJID_CLIENT;
            }
        }
        ...
        internal bool IsNonClientObject {
            get {
                return AccessibleObjectId == WinFormNativeMethods.OBJID_WINDOW;
            }
        }
        ...
        protected void UseStdAccessibleObjects(IntPtr handle, int objid) {
            ...
            object acc = null;
            int result = WinFormUnsafeNativeMethods.CreateStdAccessibleObject(
            ...
            Guid IID_IEnumVariant = new Guid(WinFormNativeMethods.uuid_IEnumVariant);
            object en = null;
            result = WinFormUnsafeNativeMethods.CreateStdAccessibleObject(
                                                      new HandleRef(this, handle),
                                                      objid,
            ...
            if (acc != null || en != null) {
                ...
                systemIEnumVariant = (WinFormUnsafeNativeMethods.IEnumVariant)en;
                systemIOleWindow = acc as WinFormUnsafeNativeMethods.IOleWindow;
            }
        }
        ...
        internal void ValidateChildID(ref object childID) {
            ...
            if (childID == null) {
                childID = WinFormNativeMethods.CHILDID_SELF;
            }
            else if (childID.Equals(WinFormNativeMethods.DISP_E_PARAMNOTFOUND)) {
                childID = 0;
            }
                ...
                if (member != null && member.Length > 0 && member[0] is PropertyInfo) {
                    ...
                    if (getMethod != null && getMethod.GetParameters().Length > 0) {
                        ...
                        for (int i = 0; i < args.Length; i++) {
                            args[i] = WinFormNativeMethods.CHILDID_SELF;    
                        }
                    }
                }
            }
        ...
        private class EnumVariantObject : WinFormUnsafeNativeMethods.IEnumVariant {
            ...
            int WinFormUnsafeNativeMethods.IEnumVariant.Next(int n, IntPtr rgvar, int[] ns) {
                ...
                return (ns[0] == n) ? WinFormNativeMethods.S_OK : WinFormNativeMethods.S_FALSE;
            }
            ...
            /// </devdoc>
            private static bool GotoItem(WinFormUnsafeNativeMethods.IEnumVariant iev, int index, IntPtr variantPtr) {
                int[] ns = new int[1];
    ...
    internal sealed class InternalAccessibleObject : StandardOleMarshalObject, 
                                    WinFormUnsafeNativeMethods.IAccessibleInternal,
                                    System.Reflection.IReflect,
                                    WinFormUnsafeNativeMethods.IEnumVariant,
                                    WinFormUnsafeNativeMethods.IOleWindow {

        private IAccessible publicIAccessible;                       // AccessibleObject as IAccessible
        private WinFormUnsafeNativeMethods.IEnumVariant publicIEnumVariant; // AccessibleObject as IEnumVariant
        private WinFormUnsafeNativeMethods.IOleWindow publicIOleWindow;     // AccessibleObject as IOleWindow
        ...
        internal InternalAccessibleObject(AccessibleObject accessibleImplemention) {
            ...
            publicIEnumVariant = (WinFormUnsafeNativeMethods.IEnumVariant) accessibleImplemention;
            publicIOleWindow = (WinFormUnsafeNativeMethods.IOleWindow) accessibleImplemention;
        ...
        void WinFormUnsafeNativeMethods.IAccessibleInternal.accDoDefaultAction(object childID) {
            //IntSecurity.UnmanagedCode.Assert();
            publicIAccessible.accDoDefaultAction(childID);
        }
        
        object WinFormUnsafeNativeMethods.IAccessibleInternal.accHitTest(int xLeft, int yTop) {
            //IntSecurity.UnmanagedCode.Assert();
            return AsNativeAccessible(publicIAccessible.accHitTest(xLeft, yTop));
        }

        void WinFormUnsafeNativeMethods.IAccessibleInternal.accLocation(out int l, out int t, out int w, out int h, Object childID) {
            //IntSecurity.UnmanagedCode.Assert();
            publicIAccessible.accLocation(out l, out t, out w, out h, childID);
        }

        object WinFormUnsafeNativeMethods.IAccessibleInternal.accNavigate(int navDir, object childID) {
            //IntSecurity.UnmanagedCode.Assert();
            return AsNativeAccessible(publicIAccessible.accNavigate(navDir, childID));
        }

        void WinFormUnsafeNativeMethods.IAccessibleInternal.accSelect(int flagsSelect, Object childID) {
            //IntSecurity.UnmanagedCode.Assert();
            publicIAccessible.accSelect(flagsSelect, childID);
        }

        object WinFormUnsafeNativeMethods.IAccessibleInternal.get_accChild(object childID) {
            // IntSecurity.UnmanagedCode.Assert();
            return null;// AsNativeAccessible(publicIAccessible.get_accChild(childID));
        }

        int WinFormUnsafeNativeMethods.IAccessibleInternal.get_accChildCount() {
            //IntSecurity.UnmanagedCode.Assert();
            return publicIAccessible.accChildCount;
        }

        string WinFormUnsafeNativeMethods.IAccessibleInternal.get_accDefaultAction(Object childID) {
            // IntSecurity.UnmanagedCode.Assert();
            return null;// publicIAccessible.get_accDefaultAction(childID);
        }

        string WinFormUnsafeNativeMethods.IAccessibleInternal.get_accDescription(Object childID) {
            //IntSecurity.UnmanagedCode.Assert();
            return null;// publicIAccessible.get_accDescription(childID);
        }

        object WinFormUnsafeNativeMethods.IAccessibleInternal.get_accFocus() {
            //IntSecurity.UnmanagedCode.Assert();
            return AsNativeAccessible(publicIAccessible.accFocus);
        }

        string WinFormUnsafeNativeMethods.IAccessibleInternal.get_accHelp(Object childID) {
            //IntSecurity.UnmanagedCode.Assert();
            return null;// publicIAccessible.get_accHelp(childID);
        }

        int WinFormUnsafeNativeMethods.IAccessibleInternal.get_accHelpTopic(out string pszHelpFile, Object childID) {
            //IntSecurity.UnmanagedCode.Assert();
            pszHelpFile = null;
            return 0;// publicIAccessible.get_accHelpTopic(out pszHelpFile, childID);
        }

        string WinFormUnsafeNativeMethods.IAccessibleInternal.get_accKeyboardShortcut(Object childID) {
            //IntSecurity.UnmanagedCode.Assert();
            return null;// publicIAccessible.get_accKeyboardShortcut(childID);
        }

        string WinFormUnsafeNativeMethods.IAccessibleInternal.get_accName(Object childID) {
            //IntSecurity.UnmanagedCode.Assert();
            return null;// publicIAccessible.get_accName(childID);
        }

        object WinFormUnsafeNativeMethods.IAccessibleInternal.get_accParent() {
            //IntSecurity.UnmanagedCode.Assert();
            return null;// AsNativeAccessible(publicIAccessible.accParent);
        }

        object WinFormUnsafeNativeMethods.IAccessibleInternal.get_accRole(object childID) {
            //IntSecurity.UnmanagedCode.Assert();
            return null;// publicIAccessible.get_accRole(childID);
	    }

        object WinFormUnsafeNativeMethods.IAccessibleInternal.get_accSelection() {
            //IntSecurity.UnmanagedCode.Assert();
            return AsNativeAccessible(publicIAccessible.accSelection);
        }

        object WinFormUnsafeNativeMethods.IAccessibleInternal.get_accState(object childID) {
            //IntSecurity.UnmanagedCode.Assert();
            return  null;// publicIAccessible.get_accState(childID);
        }

        string WinFormUnsafeNativeMethods.IAccessibleInternal.get_accValue(object childID) {
            //IntSecurity.UnmanagedCode.Assert();
            return  null;//  publicIAccessible.get_accValue(childID);
        }

        void WinFormUnsafeNativeMethods.IAccessibleInternal.set_accName(Object childID, string newName) {
            //IntSecurity.UnmanagedCode.Assert();
            //publicIAccessible.set_accName(childID, newName);
        }

        void WinFormUnsafeNativeMethods.IAccessibleInternal.set_accValue(Object childID, string newValue) {
           // IntSecurity.UnmanagedCode.Assert();
