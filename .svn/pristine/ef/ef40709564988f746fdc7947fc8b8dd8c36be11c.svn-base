...
namespace System.Windows.Forms {
    ...
    [ComVisible(true),
     ...
     SRDescription(DCSR.DescriptionMenuStrip)
    ]
    ...
    public class MenuStrip : ToolStrip {
        ...
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.MenuStripMenuActivateDescr)]
        ...
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.MenuStripMenuDeactivateDescr)]
        ...
        [SRDescription(DCSR.MenuStripMdiWindowListItem)]
        [SRCategory(DCSR.CatBehavior)]
       ...
       // [SecurityPermission(SecurityAction.LinkDemand, Flags = SecurityPermissionFlag.UnmanagedCode)]
            ...
            if (ToolStripManager.ModalMenuFilter.InMenuMode) {
                ...
                if (keyData == Keys.Space) {
                    ...
                    if (Focused || !ContainsFocus) {
                        ...
                        WinFormUnsafeNativeMethods.PostMessage(WindowsFormsUtils.GetRootHWnd(this), WinFormNativeMethods.WM_SYSCOMMAND, WinFormNativeMethods.SC_KEYMENU, (int)Keys.Space);
                        return true;
                    }
                }
            }
        ...
        protected override async Task WndProc(Message m) {
            ...
            if (m.Msg == WinFormNativeMethods.WM_MOUSEACTIVATE && (ActiveDropDowns.Count == 0)) {
