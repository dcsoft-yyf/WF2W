...
namespace System.Drawing {
    ...
    public static class Brushes {
        public static readonly Brush Transparent = new SolidBrush(Color.FromArgb(16777215),true);
        public static readonly Brush AliceBlue = new SolidBrush(Color.FromArgb(-984833),true);
        public static readonly Brush AntiqueWhite = new SolidBrush(Color.FromArgb(-332841),true);
        public static readonly Brush Aqua = new SolidBrush(Color.FromArgb(-16711681),true);
        public static readonly Brush Aquamarine = new SolidBrush(Color.FromArgb(-8388652),true);
        public static readonly Brush Azure = new SolidBrush(Color.FromArgb(-983041),true);
        public static readonly Brush Beige = new SolidBrush(Color.FromArgb(-657956),true);
        public static readonly Brush Bisque = new SolidBrush(Color.FromArgb(-6972),true);
        public static readonly Brush Black = new SolidBrush(Color.FromArgb(-16777216),true);
        public static readonly Brush BlanchedAlmond = new SolidBrush(Color.FromArgb(-5171),true);
        public static readonly Brush Blue = new SolidBrush(Color.FromArgb(-16776961),true);
        public static readonly Brush BlueViolet = new SolidBrush(Color.FromArgb(-7722014),true);
        public static readonly Brush Brown = new SolidBrush(Color.FromArgb(-5952982),true);
        public static readonly Brush BurlyWood = new SolidBrush(Color.FromArgb(-2180985),true);
        public static readonly Brush CadetBlue = new SolidBrush(Color.FromArgb(-10510688),true);
        public static readonly Brush Chartreuse = new SolidBrush(Color.FromArgb(-8388864),true);
        public static readonly Brush Chocolate = new SolidBrush(Color.FromArgb(-2987746),true);
        public static readonly Brush Coral = new SolidBrush(Color.FromArgb(-32944),true);
        public static readonly Brush CornflowerBlue = new SolidBrush(Color.FromArgb(-10185235),true);
        public static readonly Brush Cornsilk = new SolidBrush(Color.FromArgb(-1828),true);
        public static readonly Brush Crimson = new SolidBrush(Color.FromArgb(-2354116),true);
        public static readonly Brush Cyan = new SolidBrush(Color.FromArgb(-16711681),true);
        public static readonly Brush DarkBlue = new SolidBrush(Color.FromArgb(-16777077),true);
        public static readonly Brush DarkCyan = new SolidBrush(Color.FromArgb(-16741493),true);
        public static readonly Brush DarkGoldenrod = new SolidBrush(Color.FromArgb(-4684277),true);
        public static readonly Brush DarkGray = new SolidBrush(Color.FromArgb(-5658199),true);
        public static readonly Brush DarkGreen = new SolidBrush(Color.FromArgb(-16751616),true);
        public static readonly Brush DarkKhaki = new SolidBrush(Color.FromArgb(-4343957),true);
        public static readonly Brush DarkMagenta = new SolidBrush(Color.FromArgb(-7667573),true);
        public static readonly Brush DarkOliveGreen = new SolidBrush(Color.FromArgb(-11179217),true);
        public static readonly Brush DarkOrange = new SolidBrush(Color.FromArgb(-29696),true);
        public static readonly Brush DarkOrchid = new SolidBrush(Color.FromArgb(-6737204),true);
        public static readonly Brush DarkRed = new SolidBrush(Color.FromArgb(-7667712),true);
        public static readonly Brush DarkSalmon = new SolidBrush(Color.FromArgb(-1468806),true);
        public static readonly Brush DarkSeaGreen = new SolidBrush(Color.FromArgb(-7357301),true);
        public static readonly Brush DarkSlateBlue = new SolidBrush(Color.FromArgb(-12042869),true);
        public static readonly Brush DarkSlateGray = new SolidBrush(Color.FromArgb(-13676721),true);
        public static readonly Brush DarkTurquoise = new SolidBrush(Color.FromArgb(-16724271),true);
        public static readonly Brush DarkViolet = new SolidBrush(Color.FromArgb(-7077677),true);
        public static readonly Brush DeepPink = new SolidBrush(Color.FromArgb(-60269),true);
        public static readonly Brush DeepSkyBlue = new SolidBrush(Color.FromArgb(-16728065),true);
        public static readonly Brush DimGray = new SolidBrush(Color.FromArgb(-9868951),true);
        public static readonly Brush DodgerBlue = new SolidBrush(Color.FromArgb(-14774017),true);
        public static readonly Brush Firebrick = new SolidBrush(Color.FromArgb(-5103070),true);
        public static readonly Brush FloralWhite = new SolidBrush(Color.FromArgb(-1296),true);
        public static readonly Brush ForestGreen = new SolidBrush(Color.FromArgb(-14513374),true);
        public static readonly Brush Fuchsia = new SolidBrush(Color.FromArgb(-65281),true);
        public static readonly Brush Gainsboro = new SolidBrush(Color.FromArgb(-2302756),true);
        public static readonly Brush GhostWhite = new SolidBrush(Color.FromArgb(-460545),true);
        public static readonly Brush Gold = new SolidBrush(Color.FromArgb(-10496),true);
        public static readonly Brush Goldenrod = new SolidBrush(Color.FromArgb(-2448096),true);
        public static readonly Brush Gray = new SolidBrush(Color.FromArgb(-8355712),true);
        public static readonly Brush Green = new SolidBrush(Color.FromArgb(-16744448),true);
        public static readonly Brush GreenYellow = new SolidBrush(Color.FromArgb(-5374161),true);
        public static readonly Brush Honeydew = new SolidBrush(Color.FromArgb(-983056),true);
        public static readonly Brush HotPink = new SolidBrush(Color.FromArgb(-38476),true);
        public static readonly Brush IndianRed = new SolidBrush(Color.FromArgb(-3318692),true);
        public static readonly Brush Indigo = new SolidBrush(Color.FromArgb(-11861886),true);
        public static readonly Brush Ivory = new SolidBrush(Color.FromArgb(-16),true);
        public static readonly Brush Khaki = new SolidBrush(Color.FromArgb(-989556),true);
        public static readonly Brush Lavender = new SolidBrush(Color.FromArgb(-1644806),true);
        public static readonly Brush LavenderBlush = new SolidBrush(Color.FromArgb(-3851),true);
        public static readonly Brush LawnGreen = new SolidBrush(Color.FromArgb(-8586240),true);
        public static readonly Brush LemonChiffon = new SolidBrush(Color.FromArgb(-1331),true);
        public static readonly Brush LightBlue = new SolidBrush(Color.FromArgb(-5383962),true);
        public static readonly Brush LightCoral = new SolidBrush(Color.FromArgb(-1015680),true);
        public static readonly Brush LightCyan = new SolidBrush(Color.FromArgb(-2031617),true);
        public static readonly Brush LightGoldenrodYellow = new SolidBrush(Color.FromArgb(-329006),true);
        public static readonly Brush LightGreen = new SolidBrush(Color.FromArgb(-7278960),true);
        public static readonly Brush LightGray = new SolidBrush(Color.FromArgb(-2894893),true);
        public static readonly Brush LightPink = new SolidBrush(Color.FromArgb(-18751),true);
        public static readonly Brush LightSalmon = new SolidBrush(Color.FromArgb(-24454),true);
        public static readonly Brush LightSeaGreen = new SolidBrush(Color.FromArgb(-14634326),true);
        public static readonly Brush LightSkyBlue = new SolidBrush(Color.FromArgb(-7876870),true);
        public static readonly Brush LightSlateGray = new SolidBrush(Color.FromArgb(-8943463),true);
        public static readonly Brush LightSteelBlue = new SolidBrush(Color.FromArgb(-5192482),true);
        public static readonly Brush LightYellow = new SolidBrush(Color.FromArgb(-32),true);
        public static readonly Brush Lime = new SolidBrush(Color.FromArgb(-16711936),true);
        public static readonly Brush LimeGreen = new SolidBrush(Color.FromArgb(-13447886),true);
        public static readonly Brush Linen = new SolidBrush(Color.FromArgb(-331546),true);
        public static readonly Brush Magenta = new SolidBrush(Color.FromArgb(-65281),true);
        public static readonly Brush Maroon = new SolidBrush(Color.FromArgb(-8388608),true);
        public static readonly Brush MediumAquamarine = new SolidBrush(Color.FromArgb(-10039894),true);
        public static readonly Brush MediumBlue = new SolidBrush(Color.FromArgb(-16777011),true);
        public static readonly Brush MediumOrchid = new SolidBrush(Color.FromArgb(-4565549),true);
        public static readonly Brush MediumPurple = new SolidBrush(Color.FromArgb(-7114533),true);
        public static readonly Brush MediumSeaGreen = new SolidBrush(Color.FromArgb(-12799119),true);
        public static readonly Brush MediumSlateBlue = new SolidBrush(Color.FromArgb(-8689426),true);
        public static readonly Brush MediumSpringGreen = new SolidBrush(Color.FromArgb(-16713062),true);
        public static readonly Brush MediumTurquoise = new SolidBrush(Color.FromArgb(-12004916),true);
        public static readonly Brush MediumVioletRed = new SolidBrush(Color.FromArgb(-3730043),true);
        public static readonly Brush MidnightBlue = new SolidBrush(Color.FromArgb(-15132304),true);
        public static readonly Brush MintCream = new SolidBrush(Color.FromArgb(-655366),true);
        public static readonly Brush MistyRose = new SolidBrush(Color.FromArgb(-6943),true);
        public static readonly Brush Moccasin = new SolidBrush(Color.FromArgb(-6987),true);
        public static readonly Brush NavajoWhite = new SolidBrush(Color.FromArgb(-8531),true);
        public static readonly Brush Navy = new SolidBrush(Color.FromArgb(-16777088),true);
        public static readonly Brush OldLace = new SolidBrush(Color.FromArgb(-133658),true);
        public static readonly Brush Olive = new SolidBrush(Color.FromArgb(-8355840),true);
        public static readonly Brush OliveDrab = new SolidBrush(Color.FromArgb(-9728477),true);
        public static readonly Brush Orange = new SolidBrush(Color.FromArgb(-23296),true);
        public static readonly Brush OrangeRed = new SolidBrush(Color.FromArgb(-47872),true);
        public static readonly Brush Orchid = new SolidBrush(Color.FromArgb(-2461482),true);
        public static readonly Brush PaleGoldenrod = new SolidBrush(Color.FromArgb(-1120086),true);
        public static readonly Brush PaleGreen = new SolidBrush(Color.FromArgb(-6751336),true);
        public static readonly Brush PaleTurquoise = new SolidBrush(Color.FromArgb(-5247250),true);
        public static readonly Brush PaleVioletRed = new SolidBrush(Color.FromArgb(-2396013),true);
        public static readonly Brush PapayaWhip = new SolidBrush(Color.FromArgb(-4139),true);
        public static readonly Brush PeachPuff = new SolidBrush(Color.FromArgb(-9543),true);
        public static readonly Brush Peru = new SolidBrush(Color.FromArgb(-3308225),true);
        public static readonly Brush Pink = new SolidBrush(Color.FromArgb(-16181),true);
        public static readonly Brush Plum = new SolidBrush(Color.FromArgb(-2252579),true);
        public static readonly Brush PowderBlue = new SolidBrush(Color.FromArgb(-5185306),true);
        public static readonly Brush Purple = new SolidBrush(Color.FromArgb(-8388480),true);
        public static readonly Brush Red = new SolidBrush(Color.FromArgb(-65536),true);
        public static readonly Brush RosyBrown = new SolidBrush(Color.FromArgb(-4419697),true);
        public static readonly Brush RoyalBlue = new SolidBrush(Color.FromArgb(-12490271),true);
        public static readonly Brush SaddleBrown = new SolidBrush(Color.FromArgb(-7650029),true);
        public static readonly Brush Salmon = new SolidBrush(Color.FromArgb(-360334),true);
        public static readonly Brush SandyBrown = new SolidBrush(Color.FromArgb(-744352),true);
        public static readonly Brush SeaGreen = new SolidBrush(Color.FromArgb(-13726889),true);
        public static readonly Brush SeaShell = new SolidBrush(Color.FromArgb(-2578),true);
        public static readonly Brush Sienna = new SolidBrush(Color.FromArgb(-6270419),true);
        public static readonly Brush Silver = new SolidBrush(Color.FromArgb(-4144960),true);
        public static readonly Brush SkyBlue = new SolidBrush(Color.FromArgb(-7876885),true);
        public static readonly Brush SlateBlue = new SolidBrush(Color.FromArgb(-9807155),true);
        public static readonly Brush SlateGray = new SolidBrush(Color.FromArgb(-9404272),true);
        public static readonly Brush Snow = new SolidBrush(Color.FromArgb(-1286),true);
        public static readonly Brush SpringGreen = new SolidBrush(Color.FromArgb(-16711809),true);
        public static readonly Brush SteelBlue = new SolidBrush(Color.FromArgb(-12156236),true);
        public static readonly Brush Tan = new SolidBrush(Color.FromArgb(-2968436),true);
        public static readonly Brush Teal = new SolidBrush(Color.FromArgb(-16744320),true);
        public static readonly Brush Thistle = new SolidBrush(Color.FromArgb(-2572328),true);
        public static readonly Brush Tomato = new SolidBrush(Color.FromArgb(-40121),true);
        public static readonly Brush Turquoise = new SolidBrush(Color.FromArgb(-12525360),true);
        public static readonly Brush Violet = new SolidBrush(Color.FromArgb(-1146130),true);
        public static readonly Brush Wheat = new SolidBrush(Color.FromArgb(-663885),true);
        public static readonly Brush White = new SolidBrush(Color.FromArgb(-1),true);
        public static readonly Brush WhiteSmoke = new SolidBrush(Color.FromArgb(-657931),true);
        public static readonly Brush Yellow = new SolidBrush(Color.FromArgb(-256),true);
        public static readonly Brush YellowGreen = new SolidBrush(Color.FromArgb(-6632142),true);
