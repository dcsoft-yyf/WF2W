...
namespace System.Windows.Forms {
    ...
    SRDescription(DCSR.DescriptionErrorProvider)
    ]
    public class ErrorProvider : Component, IExtenderProvider, ISupportInitialize {
        ...
        SRDescription(DCSR.ErrorProviderBlinkStyleDescr)
        ]
        ...
        SRDescription(DCSR.ErrorProviderContainerControlDescr)
        ]
        ...
        SRDescription(DCSR.ErrorProviderDataSourceDescr)
        ]
        ...
        SRDescription(DCSR.ErrorProviderDataMemberDescr)
        ]
        ...
        SRDescription(DCSR.ErrorProviderBlinkRateDescr),
        ...
        public int BlinkRate {
            ...
            set {
                if (value < 0) {
                    throw new ArgumentOutOfRangeException("BlinkRate", value, DCSR.GetString(DCSR.BlinkRateMustBeZeroOrMore));
                }
                blinkRate = value;
        ...
        Localizable(true),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ErrorProviderIconDescr)
        ]
        public Icon Icon {
            get {
                return icon;
        ...
        Localizable(true),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ErrorProviderErrorDescr)
        ]
        ...
        Localizable(true),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ErrorProviderIconAlignmentDescr)
        ]
        ...
        Localizable(true),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ErrorProviderIconPaddingDescr)
        ]
        ...
        internal class ErrorWindow : NativeWindow {
            ...
            bool EnsureCreated() {
                if (Handle == IntPtr.Zero) {
                    ...
                    cparams.Style = WinFormNativeMethods.WS_VISIBLE | WinFormNativeMethods.WS_CHILD;
                    cparams.ClassStyle = WinFormNativeMethods.CS_DBLCLKS;
                    cparams.X = 0;
                    cparams.Y = 0;
                    cparams.Width = 0;
                    cparams.Height = 0;
                    ...
                    WinFormSafeNativeMethods.SetWindowPos(new HandleRef(tipWindow, tipWindow.Handle), WinFormNativeMethods.HWND_TOP, 0, 0, 0, 0, WinFormNativeMethods.SWP_NOSIZE | WinFormNativeMethods.SWP_NOMOVE | WinFormNativeMethods.SWP_NOACTIVATE);
            ...
            void EnsureDestroyed() {
                ...
                //
                WinFormSafeNativeMethods.SetWindowPos(new HandleRef(this, Handle),
                                               WinFormNativeMethods.HWND_TOP,
                                               windowBounds.X,
                                               windowBounds.Y,
                                               windowBounds.Width,
                                               windowBounds.Height,
                                               WinFormNativeMethods.SWP_HIDEWINDOW
            ...
            void OnPaint(ref Message m) {
                ...
                IntPtr hdc = WinFormUnsafeNativeMethods.BeginPaint(new HandleRef(this, Handle), ref ps);
                try {
                    ...
                    try {
                        for (int i = 0; i < items.Count; i++) {
                            ...
                            WinFormSafeNativeMethods.DrawIconEx(new HandleRef(this, mirrordc.Hdc), bounds.X - windowBounds.X, bounds.Y - windowBounds.Y, new HandleRef(provider.Region, provider.Region.IconHandle), bounds.Width, bounds.Height, 0, WinFormNativeMethods.NullHandleRef, WinFormNativeMethods.DI_NORMAL);
                        }
                    }
                    finally {
                        RestoreMirrorDC();
                ...
                try {
                    for (int i = 0; i < items.Count; i++) {
                        ...
                        if (tipWindow != null) {
                            ...
                            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(tipWindow, tipWindow.Handle), WinFormNativeMethods.TTM_SETTOOLINFO, 0, toolInfo);
                        }
                    ...
                    try {
                        ...
                        try {
                            ...
                            System.Internal.HandleCollector.Add(windowRegionHandle, WinFormNativeMethods.CommonHandles.GDI);
                        }
                        finally {
                            graphics.Dispose();
                            RestoreMirrorDC();
                        ...
                        if (WinFormUnsafeNativeMethods.SetWindowRgn(new HandleRef(this, Handle), new HandleRef(windowRegion, windowRegionHandle), true) != 0) {
                    ...
                    if (windowRegionHandle != IntPtr.Zero) {
                        WinFormSafeNativeMethods.DeleteObject(new HandleRef(null, windowRegionHandle));
                    }
                }

                WinFormSafeNativeMethods.SetWindowPos(new HandleRef(this, Handle), WinFormNativeMethods.HWND_TOP, windowBounds.X, windowBounds.Y,
                                     windowBounds.Width, windowBounds.Height, WinFormNativeMethods.SWP_NOACTIVATE);
                WinFormSafeNativeMethods.InvalidateRect(new HandleRef(this, Handle), null, false);
            }
            ...
            protected override void WndProc(ref Message m) {
                switch (m.Msg) {
                    case WinFormNativeMethods.WM_NOTIFY:
                        ...
                        if (nmhdr.code == WinFormNativeMethods.TTN_SHOW || nmhdr.code == WinFormNativeMethods.TTN_POP)
                        {
                            OnToolTipVisibilityChanging(nmhdr.idFrom, nmhdr.code == WinFormNativeMethods.TTN_SHOW);
                        }
                        break;
                ...
                get {
                    if (region == null) {
                        ...
                        try {
                            ...
                            WinFormSafeNativeMethods.GetBitmapBits(new HandleRef(null, mask), bits.Length, bits);
                            ...
                            if (mask != IntPtr.Zero)
                                WinFormSafeNativeMethods.DeleteObject(new HandleRef(null, mask));
                        }
                    }
