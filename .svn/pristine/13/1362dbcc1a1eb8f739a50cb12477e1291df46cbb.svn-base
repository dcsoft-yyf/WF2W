...
namespace System.Windows.Forms {
    ...
    public class ToolStripComboBox : ToolStripControlHost {
        ...
        public ToolStripComboBox(Control c) : base(c) {
            throw new NotSupportedException(DCSR.GetString(DCSR.ToolStripMustSupplyItsOwnComboBox));
        }
        ...
        private static readonly object EventDropDownAsync = new object();
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = false)]
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.ComboBoxOnDropDownDescr)]
        public event EventHandlerAsync DropDownAsync
        {
            add
            {
                Events.AddHandler(EventDropDownAsync, value);
            }
            remove
            {
                Events.RemoveHandler(EventDropDownAsync, value);
            }
        }
        ...
        public ComboBoxStyle DropDownStyle {
            ...
            set { ComboBox.DropDownStyle = value; this.LogWF2WPropertyValue("DropDownStyle", value); }
        }
...
#region WrappedMethods        
        ...
        internal virtual async ValueTask OnDropDownAsync(EventArgs e)
        {
            if (ParentInternal != null)
            {
                // PERF, SECREVIEW: dont call Application.RemoveMessageFilter as this could
            ...
            RaiseEvent(EventDropDown, e);
            var handler = (EventHandlerAsync)Events[EventDropDownAsync];
