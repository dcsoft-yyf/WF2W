    ...
    public sealed class InputLanguage {
        ...
        public static InputLanguage CurrentInputLanguage {
            get {
                ...
                return new InputLanguage(WinFormSafeNativeMethods.GetKeyboardLayout(0));
            }
            set {
                ...
                IntPtr handleOld = WinFormSafeNativeMethods.ActivateKeyboardLayout(new HandleRef(value, value.handle), 0);
                if (handleOld == IntPtr.Zero) {
                    throw new ArgumentException(DCSR.GetString(DCSR.ErrorBadInputLanguage), "value");
                }
            }
        }
        ...
        public static InputLanguage DefaultInputLanguage {
            get {
                ...
                WinFormUnsafeNativeMethods.SystemParametersInfo(WinFormNativeMethods.SPI_GETDEFAULTINPUTLANG, 0, data, 0);
        ...
        public static InputLanguageCollection InstalledInputLanguages {
            get {
                int size = WinFormSafeNativeMethods.GetKeyboardLayoutList(0, null);
                
                IntPtr[] handles = new IntPtr[size];
                WinFormSafeNativeMethods.GetKeyboardLayoutList(size, handles);
        ...
        public string LayoutName {
            get {
                ...
                */
                ...
                if (layoutName == null) {
                    layoutName = DCSR.GetString(DCSR.UnknownInputLanguageLayout);
                }
                return layoutName;
            }
        }
        ...
        private static string GetLocalizedKeyboardLayoutName(string layoutDisplayName) {
            ...
            if (layoutDisplayName != null && Environment.OSVersion.Version.Major >= 5) {
                ...
                uint res = WinFormUnsafeNativeMethods.SHLoadIndirectString(layoutDisplayName, sb, (uint)sb.Capacity, IntPtr.Zero);

                if (res == WinFormNativeMethods.S_OK) {
                    return sb.ToString();
                }
            }
