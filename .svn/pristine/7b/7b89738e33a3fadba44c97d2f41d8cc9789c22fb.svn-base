    ...
    public class DataGridViewTextBoxColumn : DataGridViewColumn
    {
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidCastException(DCSR.GetString(DCSR.DataGridViewTypeColumn_WrongCellTemplateType, "System.Windows.Forms.DataGridViewTextBoxCell"));
                }
        ...
        [
            ...
            SRDescription(DCSR.DataGridView_TextBoxColumnMaxInputLengthDescr)
        ]
