...
namespace System.Windows.Forms {
    ...
    public class BindingSource : Component,
        ...
        SRDescription(DCSR.BindingSourceDataMemberDescr)
        ]
        ...
        SRDescription(DCSR.BindingSourceDataSourceDescr)
        ]
        ...
        SRCategory(DCSR.CatData),
        DefaultValue(null),
        SRDescription(DCSR.BindingSourceSortDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatData),
        SRDescription(DCSR.BindingSourceAddingNewEventHandlerDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatData),
        SRDescription(DCSR.BindingSourceBindingCompleteEventHandlerDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatData),
        SRDescription(DCSR.BindingSourceDataErrorEventHandlerDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatData),
        SRDescription(DCSR.BindingSourceDataSourceChangedEventHandlerDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatData),
        SRDescription(DCSR.BindingSourceDataMemberChangedEventHandlerDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatData),
        SRDescription(DCSR.BindingSourceCurrentChangedEventHandlerDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatData),
        SRDescription(DCSR.BindingSourceCurrentItemChangedEventHandlerDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatData),
        SRDescription(DCSR.BindingSourceListChangedEventHandlerDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatData),
        SRDescription(DCSR.BindingSourcePositionChangedEventHandlerDescr)
        ]
        ...
        */
        ...
        private void ThrowIfBindingSourceRecursionDetected(object newDataSource) {
            ...
            while (bindingSource != null) {
                if (bindingSource == this) {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.BindingSourceRecursionDetected));
                }
        ...
        private static object CreateInstanceOfType(Type type) {
            ...
            if (instanceException != null) {
                throw new NotSupportedException(DCSR.GetString(DCSR.BindingSourceInstanceError), instanceException);
            }
        ...
        public int Find(String propertyName, object key) {
            ...
            if (pd == null) {
                throw new System.ArgumentException(DCSR.GetString(DCSR.DataSourceDataMemberPropNotFound, propertyName));
            }
            ...
            for (int i = 0; i < split.Length; i++) {
                ...
                if (current.StartsWith("[")) {
                    if (current.EndsWith("]")) {
                        ...
                        throw new ArgumentException(DCSR.GetString(DCSR.BindingSourceBadSortString));
                    }
                }
                ...
                if (prop == null) {
                    throw new ArgumentException(DCSR.GetString(DCSR.BindingSourceSortStringPropertyNotInIBindingList));
                }
        ...
        public void RemoveCurrent() {
            if (!(this as IBindingList).AllowRemove) {
                throw new InvalidOperationException(DCSR.GetString(DCSR.BindingSourceRemoveCurrentNotAllowed));
            }

            if (Position < 0 || Position >= Count) {
                throw new InvalidOperationException(DCSR.GetString(DCSR.BindingSourceRemoveCurrentNoCurrentItem));
            }
        ...
        public virtual int Add(object value) {
            ...
            if (value != null && !itemType.IsAssignableFrom(value.GetType())) {
                throw new InvalidOperationException(DCSR.GetString(DCSR.BindingSourceItemTypeMismatchOnAdd));
            }

            if (value == null && itemType.IsValueType) {
                throw new InvalidOperationException(DCSR.GetString(DCSR.BindingSourceItemTypeIsValueType));
            }
        ...
        public virtual object AddNew() {
            ...
            if (!AllowNewInternal(false)) {
                throw new InvalidOperationException(DCSR.GetString(DCSR.BindingSourceBindingListWrapperAddToReadOnlyList));
            }

            if (!AllowNewInternal(true)) {
                throw new InvalidOperationException(DCSR.GetString(
                    DCSR.BindingSourceBindingListWrapperNeedToSetAllowNew,
            ...
            if (addNewItem == null) {
                ...
                if (this.itemConstructor == null) {
                    throw new InvalidOperationException(DCSR.GetString(
                        DCSR.BindingSourceBindingListWrapperNeedAParameterlessConstructor,
                        itemType == null ? "(null)" : itemType.FullName
                        ));
                }
        ...
        SRDescription(DCSR.BindingSourceAllowNewDescr),
        ]
        ...
        public virtual bool AllowNew {
            ...
            set {
                ...
                if (value == true && !isBindingList && !IsListWriteable(false)) {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.NoAllowNewOnReadOnlyList));
                }
        ...
        void IBindingList.AddIndex(PropertyDescriptor property) {
            if (isBindingList) {
                ...
                throw new NotSupportedException(DCSR.GetString(DCSR.OperationRequiresIBindingList));
            }
        }
        ...
        public virtual void ApplySort(ListSortDescriptionCollection sorts) {
            ...
            if (iblw != null) {
                ...
                throw new NotSupportedException(DCSR.GetString(DCSR.OperationRequiresIBindingListView));
            }
        }
        ...
        SRCategory(DCSR.CatData),
        DefaultValue(null),
        SRDescription(DCSR.BindingSourceFilterDescr)
        ]
