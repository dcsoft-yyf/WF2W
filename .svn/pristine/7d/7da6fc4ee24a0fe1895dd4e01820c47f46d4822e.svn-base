    ...
    public abstract class DataGridViewCell : DataGridViewElement, ICloneable, IDisposable
    {
        ...
        public bool IsInEditMode 
        {
            get
            {
                ...
                if (this.RowIndex == -1)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidOperationOnSharedCell));
                }
                ...
                else
                {
                    if (this.owningRow == null)
                    {
                        if (value != this.ReadOnly)
                        {
                            ...
                            throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewCell_CannotSetReadOnlyState));
                        }
                    }
                    else
                    {
        ...
        public virtual bool Selected
        {
            ...
            set
            {
                ...
                else if (value)
                {
                    ...
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewCell_CannotSetSelectedState));
                }
            }
        }
            ...
            if (dgv.EditingControl.ParentInternal != null)
            {
                if (dgv.EditingControl.ContainsFocus)
                {
                    ...
                    else
                    {
                        ...
                        WinFormUnsafeNativeMethods.SetFocus(new HandleRef(null, IntPtr.Zero));
                    }
                }
                                                   ...
                                                   DataGridViewDataErrorContexts context)
        {
                ...
                (formattedValue == null || this.FormattedValueType == null || !this.FormattedValueType.IsAssignableFrom(formattedValue.GetType())))
            {
                ...
                if (this.FormattedValueType == null)
                {
                    exception = new FormatException(DCSR.GetString(DCSR.DataGridViewCell_FormattedValueTypeNull));
                }
                else
                {
                    exception = new FormatException(DCSR.GetString(DCSR.DataGridViewCell_FormattedValueHasWrongType));
                }
                DataGridViewDataErrorEventArgs dgvdee = new DataGridViewDataErrorEventArgs(exception,
                    this.ColumnIndex,
                    rowIndex,
        ...
        static internal DataGridViewFreeDimension GetFreeDimensionFromConstraint(Size constraintSize)
        {
            ...
            {
                throw new ArgumentException(DCSR.GetString(DCSR.InvalidArgument, "constraintSize", constraintSize.ToString()));
            }
        ...
        public virtual DataGridViewCellStyle GetInheritedStyle(DataGridViewCellStyle inheritedCellStyle, int rowIndex, bool includeColors)
        {
            if (this.DataGridView == null)
            {
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_CellNeedsDataGridViewForInheritedStyle));
            }
            if (rowIndex < 0 || rowIndex >= this.DataGridView.Rows.Count)
            {
                throw new ArgumentOutOfRangeException("rowIndex");
        ...
        protected virtual Size GetSize(int rowIndex)
        {
            ...
            if (rowIndex == -1)
            {
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidPropertyGetOnSharedCell, "Size"));
            }
            Debug.Assert(this.owningColumn != null);
            Debug.Assert(this.owningRow != null);
        ...
        public static int MeasureTextHeight(Graphics graphics, string text, Font font, int maxWidth, TextFormatFlags flags, out bool widthTruncated)
        {
            ...
            if (maxWidth <= 0)
            {
                throw new ArgumentOutOfRangeException("maxWidth", DCSR.GetString(DCSR.InvalidLowBoundArgument, "maxWidth", (maxWidth).ToString(CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture)));
            }
        ...
        public static Size MeasureTextPreferredSize(Graphics graphics, string text, Font font, float maxRatio, TextFormatFlags flags)
        {
            ...
            if (maxRatio <= 0.0F)
            {
                throw new ArgumentOutOfRangeException("maxRatio", DCSR.GetString(DCSR.InvalidLowBoundArgument, "maxRatio", (maxRatio).ToString(CultureInfo.CurrentCulture), "0.0"));
            }
        ...
        public static int MeasureTextWidth(Graphics graphics, string text, Font font, int maxHeight, TextFormatFlags flags)
        {
            if (maxHeight <= 0)
            {
                throw new ArgumentOutOfRangeException("maxHeight", DCSR.GetString(DCSR.InvalidLowBoundArgument, "maxHeight", (maxHeight).ToString(CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture)));
            }
                                                    ...
                                                    TypeConverter valueTypeConverter)
        {
            ...
            if (this.FormattedValueType == null)
            {
                throw new FormatException(DCSR.GetString(DCSR.DataGridViewCell_FormattedValueTypeNull));
            }
            if (valueType == null)
            {
                throw new FormatException(DCSR.GetString(DCSR.DataGridViewCell_ValueTypeNull));
            }
            if (formattedValue == null ||
                !this.FormattedValueType.IsAssignableFrom(formattedValue.GetType()))
            {
                throw new ArgumentException(DCSR.GetString(DCSR.DataGridViewCell_FormattedValueHasWrongType), "formattedValue");
            }
        ...
        protected class DataGridViewCellAccessibleObject : AccessibleObject
        {
            ...
            public override string DefaultAction
            {
                get
                {
                    if (this.Owner == null)
                    {
                        throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewCellAccessibleObject_OwnerNotSet));
                    }
                    if (!this.Owner.ReadOnly)
                    {
                        return DCSR.GetString(DCSR.DataGridView_AccCellDefaultAction);
                    }
                    else
                    {
                        return String.Empty;
            ...
            public override string Name
            {
                get
                {
                    ...
                    {
                        return DCSR.GetString(DCSR.DataGridView_AccDataGridViewCellName, this.owner.OwningColumn.HeaderText, this.owner.OwningRow.Index);
                    }
                    else
                    {
                        return String.Empty;
            ...
            public DataGridViewCell Owner
            {
                ...
                set
                {
                    if (this.owner != null)
                    {
                        throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewCellAccessibleObject_OwnerAlreadySet));
                    }
                    this.owner = value;
                }
            }
            ...
            public override string Value
            {
               // [SecurityPermission(SecurityAction.Demand, Flags = SecurityPermissionFlag.UnmanagedCode)]
                get
                {
                    ...
                    {
                        return DCSR.GetString(DCSR.DataGridView_AccNullValue);
                    }
