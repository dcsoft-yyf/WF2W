...
namespace WF2WWinFormDemo
{
    public static class WasmProgram
    {
        ...
        [JSInvokable]
        public static void RunMenuForm()
        {
            try
            {
                var frm = new WinFormsControlsDemo.MenuForm();
                Application.Run(frm);
            }
            catch (Exception ext)
            {
        ...
        [JSInvokable]
        public static void RunWinFormsControlsDemo()
        {
            try
            {
                var frm = new ControlsDemo.frmMain();
                Application.Run(frm);
            }
            catch (Exception ext)
            {
        ...
        [JSInvokable]
        public static void RunHuarongdao()
        {
            try
            {
                var frm = new Huarongdao.Form1();
                Application.Run(frm);
            }
            catch (Exception ext)
            {
        ...
        [JSInvokable]
        public static void RunWinClock()
        {
            try
            {
                var frm = new WinClock.Form10();
                Application.Run(frm);
            }
            catch (Exception ext)
            {
        ...
        [JSInvokable]
        public static void RunWinRollCall()
        {
            try
            {
                var frm = new 点名系统.Form1();
                Application.Run(frm);
            }
            catch (Exception ext)
            {
