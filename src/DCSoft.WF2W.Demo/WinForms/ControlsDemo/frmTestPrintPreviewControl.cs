...
{
    public partial class frmTestPrintPreviewControl : Form
    {
        public frmTestPrintPreviewControl()
        {
            InitializeComponent();
        }

        private void frmTestPrintPreviewControl_Load(object sender, EventArgs e)
        {
