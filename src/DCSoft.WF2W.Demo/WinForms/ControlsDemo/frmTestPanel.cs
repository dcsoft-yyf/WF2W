...
namespace WF2WWinFormDemo.ControlsDemo
{
    public partial class frmTestPanel : Form
    {
        ...
        private void frmTestPanel_Load(object sender, EventArgs e)
        {
        ...
        private async Task btnForeColor_Click(object sender, EventArgs e)
        {
            using (var dlg = new ColorDialog())
            {
                dlg.Color = this.ctlDemo.ForeColor;
#if WF2W
                if (await dlg.ShowDialog(this) == DialogResult.OK)
                {
        ...
        private async Task btnBackColor_Click(object sender, EventArgs e)
        {
            using (var dlg = new ColorDialog())
            {
        ...
        private async Task btnBackgroundImage_Click(object sender, EventArgs e)
        {
