...
{
    public partial class frmTestToolStripContainer : Form
    {
        public frmTestToolStripContainer()
        {
            InitializeComponent();
        }

        private void frmTestToolStripContainer_Load(object sender, EventArgs e)
        {
