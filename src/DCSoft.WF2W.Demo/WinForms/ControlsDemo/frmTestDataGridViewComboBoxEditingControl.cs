...
{
    public partial class frmTestDataGridViewComboBoxEditingControl : Form
    {
        public frmTestDataGridViewComboBoxEditingControl()
        {
            InitializeComponent();
        }

        private void frmTestDataGridViewComboBoxEditingControl_Load(object sender, EventArgs e)
        {
