...
{
    public partial class frmTestDataGridViewTextBoxEditingControl : Form
    {
        public frmTestDataGridViewTextBoxEditingControl()
        {
            InitializeComponent();
        }

        private void frmTestDataGridViewTextBoxEditingControl_Load(object sender, EventArgs e)
        {
