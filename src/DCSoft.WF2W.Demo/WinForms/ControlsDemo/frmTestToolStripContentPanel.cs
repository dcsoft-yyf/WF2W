...
{
    public partial class frmTestToolStripContentPanel : Form
    {
        public frmTestToolStripContentPanel()
        {
            InitializeComponent();
        }

        private void frmTestToolStripContentPanel_Load(object sender, EventArgs e)
        {
