...
namespace System.Windows.Forms
{
    ...
    public class DataGridViewHeaderCell : DataGridViewCell
    {
        ...
        public override bool ReadOnly
        {
            ...
            set
            {
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_HeaderCellReadOnlyProperty, "ReadOnly"));
            }
        }
        ...
        public override bool Selected
        {
            ...
            set
            {
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_HeaderCellReadOnlyProperty, "Selected"));
            }
        }
