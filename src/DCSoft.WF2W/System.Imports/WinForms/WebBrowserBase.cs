...
namespace System.Windows.Forms {
    ...
    public class WebBrowserBase : Control {
        ...
        private WinFormUnsafeNativeMethods.IOleObject axOleObject;
        private WinFormUnsafeNativeMethods.IOleInPlaceObject axOleInPlaceObject;
        private WinFormUnsafeNativeMethods.IOleInPlaceActiveObject axOleInPlaceActiveObject;
        private WinFormUnsafeNativeMethods.IOleControl axOleControl;
        ...
        internal WebBrowserBase(string clsidString) : base() {
            if (Application.OleRequired() != ApartmentState.STA) {
                throw new ThreadStateException(DCSR.GetString(DCSR.AXMTAThread, clsidString));
            }
        ...
        internal override void OnBoundsUpdate(int x, int y, int width, int height)
        {
            ...
            if (this.ActiveXState >= WebBrowserHelper.AXState.InPlaceActive) {
                try {
                    ...
                    this.AXInPlaceObject.SetObjectRects(new WinFormNativeMethods.COMRECT(new Rectangle(0, 0, width, height)), WebBrowserHelper.GetClipRect());
                }
                finally {
                    this.webBrowserBaseChangingSize.Width = -1;  // Invalid value. Use WebBrowserBase.Bounds instead, when this is the case.
                }
                ...
                try 
                {
                    if (axOleInPlaceObject != null)
                    {
                        ...
                        else
                        {
                            ...
                            if (hr == WinFormNativeMethods.S_FALSE)
                            {
        ...
        protected internal override bool ProcessMnemonic(char charCode) {
            ...
            if (CanSelect) {
                try {
                    WinFormNativeMethods.tagCONTROLINFO ctlInfo = new WinFormNativeMethods.tagCONTROLINFO();
                    ...
                    if (WinFormNativeMethods.Succeeded(hr)) {
                        ...
                        msg.message = WinFormNativeMethods.WM_SYSKEYDOWN;
                        msg.wParam = (IntPtr) Char.ToUpper(charCode, CultureInfo.CurrentCulture);
                        msg.lParam = (IntPtr) 0x20180001;
                        msg.time = WinFormSafeNativeMethods.GetTickCount();
                        WinFormNativeMethods.POINT p = new WinFormNativeMethods.POINT();
                        WinFormUnsafeNativeMethods.GetCursorPos(p);
                        msg.pt_x = p.x;
                        msg.pt_y = p.y;
                        if (WinFormSafeNativeMethods.IsAccelerator(new HandleRef(ctlInfo, ctlInfo.hAccel), ctlInfo.cAccel, ref msg, null)) {
            ...
            switch (m.Msg) {
                ...
                case WinFormNativeMethods.WM_DESTROY:
                    ...
                    if (this.ActiveXState >= WebBrowserHelper.AXState.InPlaceActive) {
                        ...
                        if (WinFormNativeMethods.Succeeded(this.AXInPlaceObject.GetWindow(out hwndInPlaceObject))) {
        ...
        protected override void OnFontChanged(EventArgs e) {
            ...
            AmbientChanged(WinFormNativeMethods.ActiveX.DISPID_AMBIENT_FONT);
        }
        ...
        protected override void OnForeColorChanged(EventArgs e) {
            ...
            AmbientChanged(WinFormNativeMethods.ActiveX.DISPID_AMBIENT_FORECOLOR);
        }
        ...
        protected override void OnBackColorChanged(EventArgs e) {
            ...
            AmbientChanged(WinFormNativeMethods.ActiveX.DISPID_AMBIENT_BACKCOLOR);
        }
        ...
        internal bool DoVerb(int verb) {
            int hr = this.axOleObject.DoVerb(verb, IntPtr.Zero, this.ActiveXSite, 0, this.Handle,
                    new WinFormNativeMethods.COMRECT(this.Bounds));

            Debug.Assert(hr == WinFormNativeMethods.S_OK, String.Format(CultureInfo.CurrentCulture, "DoVerb call failed for verb 0x{0:X}", verb));
            return hr == WinFormNativeMethods.S_OK;
        }
        ...
        internal void AttachWindow(IntPtr hwnd) {
            WinFormUnsafeNativeMethods.SetParent(new HandleRef(null, hwnd), new HandleRef(this, this.Handle));
        ...
        private void TransitionFromPassiveToLoaded() {
            ...
            if (this.ActiveXState == WebBrowserHelper.AXState.Passive) {
                ...
                this.activeXInstance = WinFormUnsafeNativeMethods.CoCreateInstance(ref clsid, null, WinFormNativeMethods.CLSCTX_INPROC_SERVER, ref WinFormNativeMethods.ActiveX.IID_IUnknown);
        ...
        private void TransitionFromLoadedToRunning() {
            ...
            if (this.ActiveXState == WebBrowserHelper.AXState.Loaded) {
                ...
                int bits = 0;
                int hr = this.axOleObject.GetMiscStatus(WinFormNativeMethods.ActiveX.DVASPECT_CONTENT, out bits);
                if (WinFormNativeMethods.Succeeded(hr) && ((bits & WinFormNativeMethods.ActiveX.OLEMISC_SETCLIENTSITEFIRST) != 0)) {
                    //
        ...
        private void TransitionFromRunningToInPlaceActive() {
            ...
            if (this.ActiveXState == WebBrowserHelper.AXState.Running) {
                try
                {
                    DoVerb(WinFormNativeMethods.OLEIVERB_INPLACEACTIVATE);
                }
                catch (Exception t)
                {
                    throw new TargetInvocationException(DCSR.GetString(DCSR.AXNohWnd, GetType().Name), t);
                }
        ...
        private void TransitionFromInPlaceActiveToUIActive() {
            ...
            if (this.ActiveXState == WebBrowserHelper.AXState.InPlaceActive) {
                try {
                    DoVerb(WinFormNativeMethods.OLEIVERB_UIACTIVATE);
                }
                catch (Exception t) {
                    throw new TargetInvocationException(DCSR.GetString(DCSR.AXNohWnd, GetType().Name), t);
                }
        ...
        private void TransitionFromUIActiveToInPlaceActive() {
            ...
            if (this.ActiveXState == WebBrowserHelper.AXState.UIActive) {
                ...
                Debug.Assert(WinFormNativeMethods.Succeeded(hr), "Failed to UIDeactivate");
        ...
        private void AttachInterfacesInternal() {
            ...
            this.axOleObject = (WinFormUnsafeNativeMethods.IOleObject)activeXInstance;
            this.axOleInPlaceObject = (WinFormUnsafeNativeMethods.IOleInPlaceObject)activeXInstance;
            this.axOleInPlaceActiveObject = (WinFormUnsafeNativeMethods.IOleInPlaceActiveObject)activeXInstance;
            this.axOleControl = (WinFormUnsafeNativeMethods.IOleControl)activeXInstance;
            //
        ...
        private Size SetExtent(int width, int height) {
            WinFormNativeMethods.tagSIZEL sz = new WinFormNativeMethods.tagSIZEL();
            sz.cx = width;
            sz.cy = height;
            bool resetExtents = DesignMode;
            try {
                Pixel2hiMetric(sz, sz);
                this.axOleObject.SetExtent(WinFormNativeMethods.ActiveX.DVASPECT_CONTENT, sz);
            }
            catch (COMException) {
                resetExtents = true;
            }
            if (resetExtents) {
                this.axOleObject.GetExtent(WinFormNativeMethods.ActiveX.DVASPECT_CONTENT, sz);
                try {
                    this.axOleObject.SetExtent(WinFormNativeMethods.ActiveX.DVASPECT_CONTENT, sz);
                }
        ...
        private void HiMetric2Pixel(WinFormNativeMethods.tagSIZEL sz, WinFormNativeMethods.tagSIZEL szout) {
            WinFormNativeMethods._POINTL phm = new WinFormNativeMethods._POINTL();
            phm.x = sz.cx;
            phm.y = sz.cy;
            WinFormNativeMethods.tagPOINTF pcont = new WinFormNativeMethods.tagPOINTF();
            ((WinFormUnsafeNativeMethods.IOleControlSite)this.ActiveXSite).TransformCoords(phm, pcont, WinFormNativeMethods.ActiveX.XFORMCOORDS_SIZE | WinFormNativeMethods.ActiveX.XFORMCOORDS_HIMETRICTOCONTAINER);
            szout.cx = (int)pcont.x;
            szout.cy = (int)pcont.y;
        }

        private void Pixel2hiMetric(WinFormNativeMethods.tagSIZEL sz, WinFormNativeMethods.tagSIZEL szout) {
            WinFormNativeMethods.tagPOINTF pcont = new WinFormNativeMethods.tagPOINTF();
            pcont.x = (float) sz.cx;
            pcont.y = (float) sz.cy;
            WinFormNativeMethods._POINTL phm = new WinFormNativeMethods._POINTL();
            ((WinFormUnsafeNativeMethods.IOleControlSite)this.ActiveXSite).TransformCoords(phm, pcont, WinFormNativeMethods.ActiveX.XFORMCOORDS_SIZE | WinFormNativeMethods.ActiveX.XFORMCOORDS_CONTAINERTOHIMETRIC);
            szout.cx = phm.x;
            szout.cy = phm.y;
        }
        ...
        internal ContainerControl FindContainerControlInternal() {
            ...
            if (cc == null) {
                cc = Control.FromHandle(WinFormUnsafeNativeMethods.GetParent(new HandleRef(this, Handle))) as ContainerControl;
            }
        ...
        internal WinFormUnsafeNativeMethods.IOleInPlaceObject AXInPlaceObject {
            get {
        ...
        public override bool AllowDrop {
            ...
            set {
                throw new NotSupportedException(DCSR.GetString(DCSR.WebBrowserAllowDropNotSupported));
            }
        }
       ...
       /// <include file='doc\WebBrowserBase.uex' path='docs/doc[@for="WebBrowserBase.BackgroundImage"]/*' />
        ...
        public override Image BackgroundImage {
            ...
            set {
                throw new NotSupportedException(DCSR.GetString(DCSR.WebBrowserBackgroundImageNotSupported));
            }
        }
        ...
        public override ImageLayout BackgroundImageLayout {
            ...
            set {
                throw new NotSupportedException(DCSR.GetString(DCSR.WebBrowserBackgroundImageLayoutNotSupported));
            }
        }
        ...
        public override Cursor Cursor {
            ...
            set {
                throw new NotSupportedException(DCSR.GetString(DCSR.WebBrowserCursorNotSupported));
            }
        }
        ...
        new public bool Enabled
        {
            ...
            set
            {
                throw new NotSupportedException(DCSR.GetString(DCSR.WebBrowserEnabledNotSupported));
            }
        }
        ...
        public override RightToLeft RightToLeft
        {
            ...
            set
            {
                throw new NotSupportedException(DCSR.GetString(DCSR.WebBrowserRightToLeftNotSupported));
            }
        }
        ...
        public override string Text {
            ...
            set {
                throw new NotSupportedException(DCSR.GetString(DCSR.WebBrowserTextNotSupported));
            }
        }
        ...
        public new bool UseWaitCursor {
            ...
            set {
                throw new NotSupportedException(DCSR.GetString(DCSR.WebBrowserUseWaitCursorNotSupported));
            }
        }
        ...
        new public event EventHandler BackgroundImageLayoutChanged {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "BackgroundImageLayoutChanged"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler Enter {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "Enter"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler Leave {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "Leave"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler MouseCaptureChanged {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "MouseCaptureChanged"));
            }
            remove {
            }
        }
        ...
        new public event MouseEventHandler MouseClick {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "MouseClick"));
            }
            remove {
            }
        }
        ...
        new public event MouseEventHandler MouseDoubleClick {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "MouseDoubleClick"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler BackColorChanged {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "BackColorChanged"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler BackgroundImageChanged {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "BackgroundImageChanged"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler BindingContextChanged {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "BindingContextChanged"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler CursorChanged {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "CursorChanged"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler EnabledChanged {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "EnabledChanged"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler FontChanged {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "FontChanged"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler ForeColorChanged {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "ForeColorChanged"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler RightToLeftChanged {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "RightToLeftChanged"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler TextChanged {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "TextChanged"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler Click {
            add { 
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "Click"));
            }
            remove {
            }
        }
        ...
        new public event DragEventHandler DragDrop {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "DragDrop"));
            }
            remove {
            }
        }
        ...
        new public event DragEventHandler DragEnter {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "DragEnter"));
            }
            remove {
            }
        }
        ...
        new public event DragEventHandler DragOver {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "DragOver"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler DragLeave {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "DragLeave"));
            }
            remove {
            }
        }
        ...
        new public event GiveFeedbackEventHandler GiveFeedback {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "GiveFeedback"));
            }
            remove {
            }
        }
        ...
        {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "HelpRequested"));
            }
            remove {
            }
        }
        ...
        new public event PaintEventHandler Paint {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "Paint"));
            }
            remove {
            }
        }
        ...
        new public event QueryContinueDragEventHandler QueryContinueDrag {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "QueryContinueDrag"));
            }
            remove {
            }
        }
        ...
        new public event QueryAccessibilityHelpEventHandler QueryAccessibilityHelp {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "QueryAccessibilityHelp"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler DoubleClick {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "DoubleClick"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler ImeModeChanged {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "ImeModeChanged"));
            }
            remove {
            }
        }
        ...
        new public event KeyEventHandler KeyDown {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "KeyDown"));
            }
            remove {
            }
        }
        ...
        new public event KeyPressEventHandler KeyPress {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "KeyPress"));
            }
            remove {
            }
        }
        ...
        new public event KeyEventHandler KeyUp {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "KeyUp"));
            }
            remove {
            }
        }
        ...
        new public event LayoutEventHandler Layout {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "Layout"));
            }
            remove {
            }
        }
        ...
        new public event MouseEventHandler MouseDown {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "MouseDown"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler MouseEnter {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "MouseEnter"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler MouseLeave {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "MouseLeave"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler MouseHover {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "MouseHover"));
            }
            remove {
            }
        }
        ...
        new public event MouseEventHandler MouseMove {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "MouseMove"));
            }
            remove {
            }
        }
        ...
        new public event MouseEventHandler MouseUp {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "MouseUp"));
            }
            remove {
            }
        }
        ...
        new public event MouseEventHandler MouseWheel {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "MouseWheel"));
            }
            remove {
            }
        }
        ...
        new public event UICuesEventHandler ChangeUICues {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "ChangeUICues"));
            }
            remove {
            }
        }
        ...
        new public event EventHandler StyleChanged {
            add {
                throw new NotSupportedException(DCSR.GetString(DCSR.AXAddInvalidEvent, "StyleChanged"));
            }
            remove {
            }
        }
