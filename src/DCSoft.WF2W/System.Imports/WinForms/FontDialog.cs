...
namespace System.Windows.Forms {
    ...
    SRDescription(DCSR.DescriptionFontDialog)
    ]
    public class FontDialog : CommonDialog {
        ...
        DefaultValue(true),
        SRDescription(DCSR.FnDallowSimulationsDescr)
        ]
        public bool AllowSimulations {
            get {
                return !GetOption(WinFormNativeMethods.CF_NOSIMULATIONS);
            }

            set {
                SetOption(WinFormNativeMethods.CF_NOSIMULATIONS, !value);
            }
        }
        ...
        SRCategory(DCSR.CatBehavior), 
        DefaultValue(true),
        SRDescription(DCSR.FnDallowVectorFontsDescr)
        ]
        public bool AllowVectorFonts {
            get {
                return !GetOption(WinFormNativeMethods.CF_NOVECTORFONTS);
            }

            set {
                SetOption(WinFormNativeMethods.CF_NOVECTORFONTS, !value);
            }
        }
        ...
        SRCategory(DCSR.CatBehavior), 
        DefaultValue(true),
        SRDescription(DCSR.FnDallowVerticalFontsDescr)
        ]
        public bool AllowVerticalFonts {
            get {
                return !GetOption(WinFormNativeMethods.CF_NOVERTFONTS);
            }

            set {
                SetOption(WinFormNativeMethods.CF_NOVERTFONTS, !value);
            }
        }
        ...
        SRCategory(DCSR.CatBehavior), 
        DefaultValue(true),
        SRDescription(DCSR.FnDallowScriptChangeDescr)
        ]
        public bool AllowScriptChange {
            get {
                return !GetOption(WinFormNativeMethods.CF_SELECTSCRIPT);
            }

            set {
                SetOption(WinFormNativeMethods.CF_SELECTSCRIPT, !value);
            }
        }
        ...
        SRDescription(DCSR.FnDcolorDescr),
        ...
        SRCategory(DCSR.CatBehavior), 
        DefaultValue(false),
        SRDescription(DCSR.FnDfixedPitchOnlyDescr)
        ]
        public bool FixedPitchOnly {
            get {
                return GetOption(WinFormNativeMethods.CF_FIXEDPITCHONLY);
            }

            set {
                SetOption(WinFormNativeMethods.CF_FIXEDPITCHONLY, value);
            }
        }
        ...
        System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true),
        SRCategory(DCSR.CatData), 
        SRDescription(DCSR.FnDfontDescr)
        ]
        public Font Font {
        ...
        SRCategory(DCSR.CatBehavior), 
        DefaultValue(false),
        SRDescription(DCSR.FnDfontMustExistDescr)
        ]
        public bool FontMustExist {
            get {
                return GetOption(WinFormNativeMethods.CF_FORCEFONTEXIST);
            }

            set {
                SetOption(WinFormNativeMethods.CF_FORCEFONTEXIST, value);
            }
        }
        ...
        SRDescription(DCSR.FnDmaxSizeDescr)
        ]
        public int MaxSize {
            get {
                return maxSize;
        ...
        SRDescription(DCSR.FnDminSizeDescr)
        ]
        public int MinSize {
            get {
                return minSize;
        ...
        SRCategory(DCSR.CatBehavior), 
        DefaultValue(false),
        SRDescription(DCSR.FnDscriptsOnlyDescr)
        ]
        public bool ScriptsOnly {
            get {
                return GetOption(WinFormNativeMethods.CF_SCRIPTSONLY);
            }
            set {
                SetOption(WinFormNativeMethods.CF_SCRIPTSONLY, value);
            }
        }
        ...
        SRCategory(DCSR.CatBehavior), 
        DefaultValue(false),
        SRDescription(DCSR.FnDshowApplyDescr)
        ]
        public bool ShowApply {
            get {
                return GetOption(WinFormNativeMethods.CF_APPLY);
            }
            set {
                SetOption(WinFormNativeMethods.CF_APPLY, value);
            }
        }
        ...
        SRCategory(DCSR.CatBehavior), 
        DefaultValue(false),
        SRDescription(DCSR.FnDshowColorDescr)
        ]
        ...
        SRCategory(DCSR.CatBehavior), 
        DefaultValue(true),
        SRDescription(DCSR.FnDshowEffectsDescr)
        ]
        public bool ShowEffects {
            get {
                return GetOption(WinFormNativeMethods.CF_EFFECTS);
            }
            set {
                SetOption(WinFormNativeMethods.CF_EFFECTS, value);
            }
        }
        ...
        SRCategory(DCSR.CatBehavior), 
        DefaultValue(false),
        SRDescription(DCSR.FnDshowHelpDescr)
        ]
        public bool ShowHelp {
            get {
                return GetOption(WinFormNativeMethods.CF_SHOWHELP);
            }
            set {
                SetOption(WinFormNativeMethods.CF_SHOWHELP, value);
            }
        }
        ...
        ///    </para>
        /// </devdoc>
        [SRDescription(DCSR.FnDapplyDescr)]
        ...
        protected override IntPtr HookProc(IntPtr hWnd, int msg, IntPtr wparam, IntPtr lparam) {
            ...
            switch (msg) {
                case WinFormNativeMethods.WM_COMMAND:
                    if ((int)wparam == 0x402) {
                        WinFormNativeMethods.LOGFONT lf = new WinFormNativeMethods.LOGFONT();
                        WinFormUnsafeNativeMethods.SendMessage(new HandleRef(null, hWnd), WinFormNativeMethods.WM_CHOOSEFONT_GETLOGFONT, 0, lf);
                        UpdateFont(lf);
                        int index = (int)WinFormUnsafeNativeMethods.SendDlgItemMessage(new HandleRef(null, hWnd), 0x473, WinFormNativeMethods.CB_GETCURSEL, IntPtr.Zero, IntPtr.Zero);
                        if (index != WinFormNativeMethods.CB_ERR) {
                            UpdateColor((int)WinFormUnsafeNativeMethods.SendDlgItemMessage(new HandleRef(null, hWnd), 0x473,
                                                                         WinFormNativeMethods.CB_GETITEMDATA, (IntPtr) index, IntPtr.Zero));
                        }
                    ...
                    break;
                case WinFormNativeMethods.WM_INITDIALOG:
                    if (!showColor) {
                        IntPtr hWndCtl = WinFormUnsafeNativeMethods.GetDlgItem(new HandleRef(null, hWnd), WinFormNativeMethods.cmb4);
                        WinFormSafeNativeMethods.ShowWindow(new HandleRef(null, hWndCtl), WinFormNativeMethods.SW_HIDE);
                        hWndCtl = WinFormUnsafeNativeMethods.GetDlgItem(new HandleRef(null, hWnd), WinFormNativeMethods.stc4);
                        WinFormSafeNativeMethods.ShowWindow(new HandleRef(null, hWndCtl), WinFormNativeMethods.SW_HIDE);
                    }
                    break;
            }
        ...
        public override void Reset() {
            options = WinFormNativeMethods.CF_SCREENFONTS | WinFormNativeMethods.CF_EFFECTS;
            font = null;
            color = SystemColors.ControlText;
            usingDefaultIndirectColor = true; 
            showColor = false;
            ...
            SetOption(WinFormNativeMethods.CF_TTONLY, true);
        }
        ...
        public JsonObject ToJsonObject()
        {
            ...
            json.Add("FontFamily", f.Name);
            json.Add("Name", f.Name);
            json.Add("Size", f.SizeInPoints);
            json.Add("SizeInPoints", f.SizeInPoints);
            json.Add("Style", f.Style.ToString());
            json.Add("Bold", f.Bold);
            json.Add("Italic", f.Italic);
            json.Add("Underline", f.Underline);
            json.Add("Strikeout", f.Strikeout);
            json.Add("Color", ColorTranslator.ToHtml(this.Color));
            json.Add("ShowColor", this.ShowColor);
            json.Add("ShowEffects", this.ShowEffects);
            json.Add("MinSize", this.MinSize);
            json.Add("MaxSize", this.MaxSize);
            return json;
        }
        ...
        {
            await DCWin32API.EnsureLoadJSModule(typeof(System.Windows.Forms.FontDialog));
            var json = this.ToJsonObject();
            var strResult = await DCWin32API.JSRuntime.InvokeAsync<string>("__DCWin32API.ShowFontDialog", json);
            ...
            if (strResult != null && strResult.Length > 0)
            {
                ...
                if (result != null)
                {
                    ...
                    string family = result["FontFamily"]?.GetValue<string>() ?? result["Name"]?.GetValue<string>() ?? oldFont.Name;
                    float size = result["SizeInPoints"]?.GetValue<float>() ?? result["Size"]?.GetValue<float>() ?? oldFont.SizeInPoints;
                    FontStyle style = FontStyle.Regular;
                    if (result["Bold"]?.GetValue<bool>() == true) style |= FontStyle.Bold;
                    if (result["Italic"]?.GetValue<bool>() == true) style |= FontStyle.Italic;
                    if (result["Underline"]?.GetValue<bool>() == true) style |= FontStyle.Underline;
                    if (result["Strikeout"]?.GetValue<bool>() == true) style |= FontStyle.Strikeout;
                    this.font = new Font(family, size, style, GraphicsUnit.Point);
        ...
        protected override bool RunDialog(IntPtr hWndOwner) {
            ...
            WinFormNativeMethods.CHOOSEFONT cf = new WinFormNativeMethods.CHOOSEFONT();
            ...
            try {
                logFontPtr = Marshal.AllocCoTaskMem(Marshal.SizeOf(typeof(WinFormNativeMethods.LOGFONT)));
                Marshal.StructureToPtr(lf, logFontPtr, false);

                cf.lStructSize = Marshal.SizeOf(typeof(WinFormNativeMethods.CHOOSEFONT));
                cf.hwndOwner = hWndOwner;
                cf.hDC = IntPtr.Zero;
                cf.lpLogFont = logFontPtr;
                cf.Flags = Options | WinFormNativeMethods.CF_INITTOLOGFONTSTRUCT | WinFormNativeMethods.CF_ENABLEHOOK;
                if (minSize > 0 || maxSize > 0) {
                    cf.Flags |= WinFormNativeMethods.CF_LIMITSIZE;
                }
                ...
                cf.hInstance = WinFormUnsafeNativeMethods.GetModuleHandle(null);
                cf.nSizeMin = minSize;
                if (maxSize == 0) {
                ...
                if (!WinFormSafeNativeMethods.ChooseFont(cf)) return false;


                WinFormNativeMethods.LOGFONT lfReturned = null;
                lfReturned = (WinFormNativeMethods.LOGFONT)WinFormUnsafeNativeMethods.PtrToStructure(logFontPtr, typeof(WinFormNativeMethods.LOGFONT));
        ...
        /// </devdoc>
        /// <internalonly/>
        private void UpdateFont(WinFormNativeMethods.LOGFONT lf) {
            IntPtr screenDC = WinFormUnsafeNativeMethods.GetDC(WinFormNativeMethods.NullHandleRef);
            try {
