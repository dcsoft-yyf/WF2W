...
namespace System.Windows.Forms {
    ...
    internal static class WinFormNativeMethods {
    ...
    public const int RPC_E_CHANGED_MODE = unchecked((int)0x80010106),
        ...
        WM_USER = 0x0400,
        WM_REFLECT = WinFormNativeMethods.WM_USER + 0x1C00,
        ...
        public static int WM_MOUSEENTER {
           ...
           get {
              if (wmMouseEnterMessage == -1) {
                  wmMouseEnterMessage = WinFormSafeNativeMethods.RegisterWindowMessage("WinFormsMouseEnter");
              }
        ...
        public static int WM_UIUNSUBCLASS {
            ...
            get {
                if (wmUnSubclass == -1) {
                    wmUnSubclass = WinFormSafeNativeMethods.RegisterWindowMessage("WinFormsUnSubclass");
                }
                return wmUnSubclass;
            }
        }
        ...
        static WinFormNativeMethods()
        {
            if (Marshal.SystemDefaultCharSize == 1) {
                BFFM_SETSELECTION = WinFormNativeMethods.BFFM_SETSELECTIONA;
                CBEM_GETITEM = WinFormNativeMethods.CBEM_GETITEMA;
                CBEM_SETITEM = WinFormNativeMethods.CBEM_SETITEMA;
                CBEN_ENDEDIT = WinFormNativeMethods.CBEN_ENDEDITA;
                CBEM_INSERTITEM = WinFormNativeMethods.CBEM_INSERTITEMA;
                LVM_GETITEMTEXT = WinFormNativeMethods.LVM_GETITEMTEXTA;
                LVM_SETITEMTEXT = WinFormNativeMethods.LVM_SETITEMTEXTA;
                ACM_OPEN = WinFormNativeMethods.ACM_OPENA;
                DTM_SETFORMAT = WinFormNativeMethods.DTM_SETFORMATA;
                DTN_USERSTRING = WinFormNativeMethods.DTN_USERSTRINGA;
                DTN_WMKEYDOWN = WinFormNativeMethods.DTN_WMKEYDOWNA;
                DTN_FORMAT = WinFormNativeMethods.DTN_FORMATA;
                DTN_FORMATQUERY = WinFormNativeMethods.DTN_FORMATQUERYA;
                EMR_POLYTEXTOUT = WinFormNativeMethods.EMR_POLYTEXTOUTA;
                HDM_INSERTITEM = WinFormNativeMethods.HDM_INSERTITEMA;
                HDM_GETITEM = WinFormNativeMethods.HDM_GETITEMA;
                HDM_SETITEM = WinFormNativeMethods.HDM_SETITEMA;
                HDN_ITEMCHANGING = WinFormNativeMethods.HDN_ITEMCHANGINGA;
                HDN_ITEMCHANGED = WinFormNativeMethods.HDN_ITEMCHANGEDA;
                HDN_ITEMCLICK = WinFormNativeMethods.HDN_ITEMCLICKA;
                HDN_ITEMDBLCLICK = WinFormNativeMethods.HDN_ITEMDBLCLICKA;
                HDN_DIVIDERDBLCLICK = WinFormNativeMethods.HDN_DIVIDERDBLCLICKA;
                HDN_BEGINTRACK = WinFormNativeMethods.HDN_BEGINTRACKA;
                HDN_ENDTRACK = WinFormNativeMethods.HDN_ENDTRACKA;
                HDN_TRACK = WinFormNativeMethods.HDN_TRACKA;
                HDN_GETDISPINFO = WinFormNativeMethods.HDN_GETDISPINFOA;
                LVM_SETBKIMAGE = WinFormNativeMethods.LVM_SETBKIMAGEA;
                LVM_GETITEM = WinFormNativeMethods.LVM_GETITEMA;
                LVM_SETITEM = WinFormNativeMethods.LVM_SETITEMA;
                LVM_INSERTITEM = WinFormNativeMethods.LVM_INSERTITEMA;
                LVM_FINDITEM = WinFormNativeMethods.LVM_FINDITEMA;
                LVM_GETSTRINGWIDTH = WinFormNativeMethods.LVM_GETSTRINGWIDTHA;
                LVM_EDITLABEL = WinFormNativeMethods.LVM_EDITLABELA;
                LVM_GETCOLUMN = WinFormNativeMethods.LVM_GETCOLUMNA;
                LVM_SETCOLUMN = WinFormNativeMethods.LVM_SETCOLUMNA;
                LVM_GETISEARCHSTRING = WinFormNativeMethods.LVM_GETISEARCHSTRINGA;
                LVM_INSERTCOLUMN = WinFormNativeMethods.LVM_INSERTCOLUMNA;
                LVN_BEGINLABELEDIT = WinFormNativeMethods.LVN_BEGINLABELEDITA;
                LVN_ENDLABELEDIT = WinFormNativeMethods.LVN_ENDLABELEDITA;
                LVN_ODFINDITEM = WinFormNativeMethods.LVN_ODFINDITEMA;
                LVN_GETDISPINFO = WinFormNativeMethods.LVN_GETDISPINFOA;
                LVN_GETINFOTIP = WinFormNativeMethods.LVN_GETINFOTIPA;
                LVN_SETDISPINFO = WinFormNativeMethods.LVN_SETDISPINFOA;
                PSM_SETTITLE = WinFormNativeMethods.PSM_SETTITLEA;
                PSM_SETFINISHTEXT = WinFormNativeMethods.PSM_SETFINISHTEXTA;
                RB_INSERTBAND = WinFormNativeMethods.RB_INSERTBANDA;
                SB_SETTEXT = WinFormNativeMethods.SB_SETTEXTA;
                SB_GETTEXT = WinFormNativeMethods.SB_GETTEXTA;
                SB_GETTEXTLENGTH = WinFormNativeMethods.SB_GETTEXTLENGTHA;
                SB_SETTIPTEXT = WinFormNativeMethods.SB_SETTIPTEXTA;
                SB_GETTIPTEXT = WinFormNativeMethods.SB_GETTIPTEXTA;
                TB_SAVERESTORE = WinFormNativeMethods.TB_SAVERESTOREA;
                TB_ADDSTRING = WinFormNativeMethods.TB_ADDSTRINGA;
                TB_GETBUTTONTEXT = WinFormNativeMethods.TB_GETBUTTONTEXTA;
                TB_MAPACCELERATOR = WinFormNativeMethods.TB_MAPACCELERATORA;
                TB_GETBUTTONINFO = WinFormNativeMethods.TB_GETBUTTONINFOA;
                TB_SETBUTTONINFO = WinFormNativeMethods.TB_SETBUTTONINFOA;
                TB_INSERTBUTTON = WinFormNativeMethods.TB_INSERTBUTTONA;
                TB_ADDBUTTONS = WinFormNativeMethods.TB_ADDBUTTONSA;
                TBN_GETBUTTONINFO = WinFormNativeMethods.TBN_GETBUTTONINFOA;
                TBN_GETINFOTIP = WinFormNativeMethods.TBN_GETINFOTIPA;
                TBN_GETDISPINFO = WinFormNativeMethods.TBN_GETDISPINFOA;
                TTM_ADDTOOL = WinFormNativeMethods.TTM_ADDTOOLA;
                TTM_SETTITLE = WinFormNativeMethods.TTM_SETTITLEA;
                TTM_DELTOOL = WinFormNativeMethods.TTM_DELTOOLA;
                TTM_NEWTOOLRECT = WinFormNativeMethods.TTM_NEWTOOLRECTA;
                TTM_GETTOOLINFO = WinFormNativeMethods.TTM_GETTOOLINFOA;
                TTM_SETTOOLINFO = WinFormNativeMethods.TTM_SETTOOLINFOA;
                TTM_HITTEST = WinFormNativeMethods.TTM_HITTESTA;
                TTM_GETTEXT = WinFormNativeMethods.TTM_GETTEXTA;
                TTM_UPDATETIPTEXT = WinFormNativeMethods.TTM_UPDATETIPTEXTA;
                TTM_ENUMTOOLS = WinFormNativeMethods.TTM_ENUMTOOLSA;
                TTM_GETCURRENTTOOL = WinFormNativeMethods.TTM_GETCURRENTTOOLA;
                TTN_GETDISPINFO = WinFormNativeMethods.TTN_GETDISPINFOA;
                TTN_NEEDTEXT = WinFormNativeMethods.TTN_NEEDTEXTA;
                TVM_INSERTITEM = WinFormNativeMethods.TVM_INSERTITEMA;
                TVM_GETITEM = WinFormNativeMethods.TVM_GETITEMA;
                TVM_SETITEM = WinFormNativeMethods.TVM_SETITEMA;
                TVM_EDITLABEL = WinFormNativeMethods.TVM_EDITLABELA;
                TVM_GETISEARCHSTRING = WinFormNativeMethods.TVM_GETISEARCHSTRINGA;
                TVN_SELCHANGING = WinFormNativeMethods.TVN_SELCHANGINGA;
                TVN_SELCHANGED = WinFormNativeMethods.TVN_SELCHANGEDA;
                TVN_GETDISPINFO = WinFormNativeMethods.TVN_GETDISPINFOA;
                TVN_SETDISPINFO = WinFormNativeMethods.TVN_SETDISPINFOA;
                TVN_ITEMEXPANDING = WinFormNativeMethods.TVN_ITEMEXPANDINGA;
                TVN_ITEMEXPANDED = WinFormNativeMethods.TVN_ITEMEXPANDEDA;
                TVN_BEGINDRAG = WinFormNativeMethods.TVN_BEGINDRAGA;
                TVN_BEGINRDRAG = WinFormNativeMethods.TVN_BEGINRDRAGA;
                TVN_BEGINLABELEDIT = WinFormNativeMethods.TVN_BEGINLABELEDITA;
                TVN_ENDLABELEDIT = WinFormNativeMethods.TVN_ENDLABELEDITA;
                TCM_GETITEM = WinFormNativeMethods.TCM_GETITEMA;
                TCM_SETITEM = WinFormNativeMethods.TCM_SETITEMA;
                TCM_INSERTITEM = WinFormNativeMethods.TCM_INSERTITEMA;
            }
            else {
                BFFM_SETSELECTION = WinFormNativeMethods.BFFM_SETSELECTIONW;
                CBEM_GETITEM = WinFormNativeMethods.CBEM_GETITEMW;
                CBEM_SETITEM = WinFormNativeMethods.CBEM_SETITEMW;
                CBEN_ENDEDIT = WinFormNativeMethods.CBEN_ENDEDITW;
                CBEM_INSERTITEM = WinFormNativeMethods.CBEM_INSERTITEMW;
                LVM_GETITEMTEXT = WinFormNativeMethods.LVM_GETITEMTEXTW;
                LVM_SETITEMTEXT = WinFormNativeMethods.LVM_SETITEMTEXTW;
                ACM_OPEN = WinFormNativeMethods.ACM_OPENW;
                DTM_SETFORMAT = WinFormNativeMethods.DTM_SETFORMATW;
                DTN_USERSTRING = WinFormNativeMethods.DTN_USERSTRINGW;
                DTN_WMKEYDOWN = WinFormNativeMethods.DTN_WMKEYDOWNW;
                DTN_FORMAT = WinFormNativeMethods.DTN_FORMATW;
                DTN_FORMATQUERY = WinFormNativeMethods.DTN_FORMATQUERYW;
                EMR_POLYTEXTOUT = WinFormNativeMethods.EMR_POLYTEXTOUTW;
                HDM_INSERTITEM = WinFormNativeMethods.HDM_INSERTITEMW;
                HDM_GETITEM = WinFormNativeMethods.HDM_GETITEMW;
                HDM_SETITEM = WinFormNativeMethods.HDM_SETITEMW;
                HDN_ITEMCHANGING = WinFormNativeMethods.HDN_ITEMCHANGINGW;
                HDN_ITEMCHANGED = WinFormNativeMethods.HDN_ITEMCHANGEDW;
                HDN_ITEMCLICK = WinFormNativeMethods.HDN_ITEMCLICKW;
                HDN_ITEMDBLCLICK = WinFormNativeMethods.HDN_ITEMDBLCLICKW;
                HDN_DIVIDERDBLCLICK = WinFormNativeMethods.HDN_DIVIDERDBLCLICKW;
                HDN_BEGINTRACK = WinFormNativeMethods.HDN_BEGINTRACKW;
                HDN_ENDTRACK = WinFormNativeMethods.HDN_ENDTRACKW;
                HDN_TRACK = WinFormNativeMethods.HDN_TRACKW;
                HDN_GETDISPINFO = WinFormNativeMethods.HDN_GETDISPINFOW;
                LVM_SETBKIMAGE = WinFormNativeMethods.LVM_SETBKIMAGEW;
                LVM_GETITEM = WinFormNativeMethods.LVM_GETITEMW;
                LVM_SETITEM = WinFormNativeMethods.LVM_SETITEMW;
                LVM_INSERTITEM = WinFormNativeMethods.LVM_INSERTITEMW;
                LVM_FINDITEM = WinFormNativeMethods.LVM_FINDITEMW;
                LVM_GETSTRINGWIDTH = WinFormNativeMethods.LVM_GETSTRINGWIDTHW;
                LVM_EDITLABEL = WinFormNativeMethods.LVM_EDITLABELW;
                LVM_GETCOLUMN = WinFormNativeMethods.LVM_GETCOLUMNW;
                LVM_SETCOLUMN = WinFormNativeMethods.LVM_SETCOLUMNW;
                LVM_GETISEARCHSTRING = WinFormNativeMethods.LVM_GETISEARCHSTRINGW;
                LVM_INSERTCOLUMN = WinFormNativeMethods.LVM_INSERTCOLUMNW;
                LVN_BEGINLABELEDIT = WinFormNativeMethods.LVN_BEGINLABELEDITW;
                LVN_ENDLABELEDIT = WinFormNativeMethods.LVN_ENDLABELEDITW;
                LVN_ODFINDITEM = WinFormNativeMethods.LVN_ODFINDITEMW;
                LVN_GETDISPINFO = WinFormNativeMethods.LVN_GETDISPINFOW;
                LVN_GETINFOTIP = WinFormNativeMethods.LVN_GETINFOTIPW;
                LVN_SETDISPINFO = WinFormNativeMethods.LVN_SETDISPINFOW;
                PSM_SETTITLE = WinFormNativeMethods.PSM_SETTITLEW;
                PSM_SETFINISHTEXT = WinFormNativeMethods.PSM_SETFINISHTEXTW;
                RB_INSERTBAND = WinFormNativeMethods.RB_INSERTBANDW;
                SB_SETTEXT = WinFormNativeMethods.SB_SETTEXTW;
                SB_GETTEXT = WinFormNativeMethods.SB_GETTEXTW;
                SB_GETTEXTLENGTH = WinFormNativeMethods.SB_GETTEXTLENGTHW;
                SB_SETTIPTEXT = WinFormNativeMethods.SB_SETTIPTEXTW;
                SB_GETTIPTEXT = WinFormNativeMethods.SB_GETTIPTEXTW;
                TB_SAVERESTORE = WinFormNativeMethods.TB_SAVERESTOREW;
                TB_ADDSTRING = WinFormNativeMethods.TB_ADDSTRINGW;
                TB_GETBUTTONTEXT = WinFormNativeMethods.TB_GETBUTTONTEXTW;
                TB_MAPACCELERATOR = WinFormNativeMethods.TB_MAPACCELERATORW;
                TB_GETBUTTONINFO = WinFormNativeMethods.TB_GETBUTTONINFOW;
                TB_SETBUTTONINFO = WinFormNativeMethods.TB_SETBUTTONINFOW;
                TB_INSERTBUTTON = WinFormNativeMethods.TB_INSERTBUTTONW;
                TB_ADDBUTTONS = WinFormNativeMethods.TB_ADDBUTTONSW;
                TBN_GETBUTTONINFO = WinFormNativeMethods.TBN_GETBUTTONINFOW;
                TBN_GETINFOTIP = WinFormNativeMethods.TBN_GETINFOTIPW;
                TBN_GETDISPINFO = WinFormNativeMethods.TBN_GETDISPINFOW;
                TTM_ADDTOOL = WinFormNativeMethods.TTM_ADDTOOLW;
                TTM_SETTITLE = WinFormNativeMethods.TTM_SETTITLEW;
                TTM_DELTOOL = WinFormNativeMethods.TTM_DELTOOLW;
                TTM_NEWTOOLRECT = WinFormNativeMethods.TTM_NEWTOOLRECTW;
                TTM_GETTOOLINFO = WinFormNativeMethods.TTM_GETTOOLINFOW;
                TTM_SETTOOLINFO = WinFormNativeMethods.TTM_SETTOOLINFOW;
                TTM_HITTEST = WinFormNativeMethods.TTM_HITTESTW;
                TTM_GETTEXT = WinFormNativeMethods.TTM_GETTEXTW;
                TTM_UPDATETIPTEXT = WinFormNativeMethods.TTM_UPDATETIPTEXTW;
                TTM_ENUMTOOLS = WinFormNativeMethods.TTM_ENUMTOOLSW;
                TTM_GETCURRENTTOOL = WinFormNativeMethods.TTM_GETCURRENTTOOLW;
                TTN_GETDISPINFO = WinFormNativeMethods.TTN_GETDISPINFOW;
                TTN_NEEDTEXT = WinFormNativeMethods.TTN_NEEDTEXTW;
                TVM_INSERTITEM = WinFormNativeMethods.TVM_INSERTITEMW;
                TVM_GETITEM = WinFormNativeMethods.TVM_GETITEMW;
                TVM_SETITEM = WinFormNativeMethods.TVM_SETITEMW;
                TVM_EDITLABEL = WinFormNativeMethods.TVM_EDITLABELW;
                TVM_GETISEARCHSTRING = WinFormNativeMethods.TVM_GETISEARCHSTRINGW;
                TVN_SELCHANGING = WinFormNativeMethods.TVN_SELCHANGINGW;
                TVN_SELCHANGED = WinFormNativeMethods.TVN_SELCHANGEDW;
                TVN_GETDISPINFO = WinFormNativeMethods.TVN_GETDISPINFOW;
                TVN_SETDISPINFO = WinFormNativeMethods.TVN_SETDISPINFOW;
                TVN_ITEMEXPANDING = WinFormNativeMethods.TVN_ITEMEXPANDINGW;
                TVN_ITEMEXPANDED = WinFormNativeMethods.TVN_ITEMEXPANDEDW;
                TVN_BEGINDRAG = WinFormNativeMethods.TVN_BEGINDRAGW;
                TVN_BEGINRDRAG = WinFormNativeMethods.TVN_BEGINRDRAGW;
                TVN_BEGINLABELEDIT = WinFormNativeMethods.TVN_BEGINLABELEDITW;
                TVN_ENDLABELEDIT = WinFormNativeMethods.TVN_ENDLABELEDITW;
                TCM_GETITEM = WinFormNativeMethods.TCM_GETITEMW;
                TCM_SETITEM = WinFormNativeMethods.TCM_SETITEMW;
                TCM_INSERTITEM = WinFormNativeMethods.TCM_INSERTITEMW;
            }
        }
        ...
        */
        ...
        public class PICTDESCicon {
            ...
            public PICTDESCicon(System.Drawing.Icon icon) {
                hicon = WinFormSafeNativeMethods.CopyImage(new HandleRef(icon, icon.Handle), WinFormNativeMethods.IMAGE_ICON, icon.Size.Width, icon.Size.Height, 0);
            }
        }
        ...
        public class HH_FTS_QUERY {
            ...
            internal int        iProximity = WinFormNativeMethods.HH_FTS_DEFAULT_PROXIMITY;
...
*/
        ...
        public class OPENFILENAME_I
        {
            ...
            public int      nMaxFile = WinFormNativeMethods.MAX_PATH;
            public IntPtr   lpstrFileTitle = IntPtr.Zero;
            public int      nMaxFileTitle = WinFormNativeMethods.MAX_PATH;
        ...
        public sealed class VARIANT {
            ...
            public static VARIANT FromObject(Object var) {
                ...
                if (var == null) {
                    ...
                    else if (t == typeof(object) || t == typeof(WinFormUnsafeNativeMethods.IDispatch) || t.IsCOMObject) {
                        v.vt = (t == typeof(WinFormUnsafeNativeMethods.IDispatch) ? (short)tagVT.VT_DISPATCH : (short)tagVT.VT_UNKNOWN);
                        v.data1 = Marshal.GetIUnknownForObject(var);
                    }
                    else {
                        throw new ArgumentException(DCSR.GetString(DCSR.ConnPointUnhandledType, t.Name));
                    }
                }
                return v;
            }
            ...
            public object ToObject() {
                ...
                case (int)tagVT.VT_R8:
                    ...
                    throw new FormatException(DCSR.GetString(DCSR.CannotConvertIntToFloat));
                ...
                case (int)tagVT.VT_DATE:
                    throw new FormatException(DCSR.GetString(DCSR.CannotConvertDoubleToDate));
                ...
                case (int)tagVT.VT_VARIANT:
                    VARIANT varStruct = (VARIANT)WinFormUnsafeNativeMethods.PtrToStructure(val, typeof(VARIANT));
                    return varStruct.ToObject();
                case (int)tagVT.VT_CLSID:
                    //Debug.Fail("PtrToStructure will not work with System.Guid...");
                    Guid guid =(Guid)WinFormUnsafeNativeMethods.PtrToStructure(val, typeof(Guid));
                    return guid;
                ...
                default:
                    int iVt = this.vt;
                    throw new ArgumentException(DCSR.GetString(DCSR.COM2UnhandledVT, iVt.ToString(CultureInfo.InvariantCulture)));
                }
            }
        ...
        public struct TVSORTCB {
            ...
            public WinFormNativeMethods.TreeViewCompareCallback          lpfnCompare;
            public IntPtr                                         lParam;
        }
        ...
        public sealed class tagFUNCDESC {
            ...
            public   WinFormNativeMethods.value_tagELEMDESC elemdescFunc;
            [MarshalAs(UnmanagedType.U2)]
        ...
        public sealed class tagVARDESC {
            ...
            public   WinFormNativeMethods.value_tagELEMDESC elemdescVar;
            [MarshalAs(UnmanagedType.U2)]
        ...
        public struct  value_tagELEMDESC {
            public    WinFormNativeMethods.tagTYPEDESC tdesc;
            public    WinFormNativeMethods.tagPARAMDESC paramdesc;
        }
        ...
        public interface ISpecifyPropertyPages {
             void GetPages(
                [Out] 
                WinFormNativeMethods.tagCAUUID pPages);
    ...
    */
    ...
    public struct TBBUTTONINFO    
    {
        ...
        public interface IProvideMultipleClassInfo {
             ...
             [PreserveSig]
             WinFormUnsafeNativeMethods.ITypeInfo GetClassInfo();
             ...
             int GetInfoOfIndex(int iti, int dwFlags, 
                                [In, Out]
                                ref WinFormUnsafeNativeMethods.ITypeInfo pTypeInfo, 
                                int       pTIFlags,
        ...
        public sealed class tagELEMDESC {
            public    WinFormNativeMethods.tagTYPEDESC tdesc = null;
            public    WinFormNativeMethods.tagPARAMDESC paramdesc;
        }
