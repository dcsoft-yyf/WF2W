...
namespace System.Windows.Forms {
    ...
    public class ToolStripSplitButton : ToolStripDropDownItem {
        ...
        SRDescription(DCSR.ToolStripSplitButtonOnButtonClickDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatAction),
        SRDescription(DCSR.ToolStripSplitButtonOnButtonDoubleClickDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatAction),
        SRDescription(DCSR.ToolStripSplitButtonOnDefaultItemChangedDescr)
        ]
        ...
        SRDescription(DCSR.ToolStripSplitButtonDropDownButtonWidthDescr)
        ]
        public int DropDownButtonWidth {
            ...
            set {
                if (value < 0) {
                    ...
                    throw new ArgumentOutOfRangeException("DropDownButtonWidth", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "DropDownButtonWidth", value.ToString(CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture)));                
                }
        ...
        /// </devdoc>
        [
        SRDescription(DCSR.ToolStripSplitButtonSplitterWidthDescr),
        SRCategory(DCSR.CatLayout),
        Browsable(false),
