...
namespace System.Windows.Forms {
    ...
    public class TabPage : Panel {
        ...
        //    try
        //    {
        //        json["ToolTipText"] = System.Text.Json.Nodes.JsonValue.Create(toolTipText ?? "");
        //        json["UseVisualStyleBackColor"] = System.Text.Json.Nodes.JsonValue.Create(useVisualStyleBackColor);

        //        if (imageIndexer != null)
        //        {
        //            if (imageIndexer.Index >= 0)
        //            {
        //                json["ImageIndex"] = System.Text.Json.Nodes.JsonValue.Create(imageIndexer.Index);
        //            }
        //            if (!string.IsNullOrEmpty(imageIndexer.Key))
        //            {
        //                json["ImageKey"] = System.Text.Json.Nodes.JsonValue.Create(imageIndexer.Key);
        //            }
        //        }
        //    }
        //    catch
        ...
        DefaultValue (-1),
        SRDescription (DCSR.TabItemImageIndexDescr)
        ]
        ...
        DefaultValue (false),
        SRCategory(DCSR.CatAppearance),
        SRDescription (DCSR.TabItemUseVisualStyleBackColorDescr)
        ]
        ...
        DefaultValue (""),
        Localizable (true),
        SRDescription (DCSR.TabItemToolTipTextDescr)
        ]
        ...
        internal override void AssignParent (Control value) {
            if (value != null && !(value is TabControl)) {
                throw new ArgumentException (DCSR.GetString (DCSR.TABCONTROLTabPageNotOnTabControl, value.GetType ().FullName));
            }
        ...
        /// </devdoc>
        /// <internalonly/>
        internal WinFormNativeMethods.TCITEM_T GetTCITEM () {
            WinFormNativeMethods.TCITEM_T tcitem = new WinFormNativeMethods.TCITEM_T ();
            ...
            if (text != null) {
                tcitem.mask |= WinFormNativeMethods.TCIF_TEXT;
                tcitem.pszText = text;
            ...
            tcitem.mask |= WinFormNativeMethods.TCIF_IMAGE;
        ...
        public class TabPageControlCollection : Control.ControlCollection {
            ...
            public override void Add (Control value) {
                if (value is TabPage) {
                    throw new ArgumentException (DCSR.GetString (DCSR.TABCONTROLTabPageOnTabPage));
                }
