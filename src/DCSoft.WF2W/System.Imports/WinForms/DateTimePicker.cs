...
namespace System.Windows.Forms {
    ...
    public class DateTimePicker : Control {
        ...
        private const int TIMEFORMAT_NOUPDOWN = WinFormNativeMethods.DTS_TIMEFORMAT & (~WinFormNativeMethods.DTS_UPDOWN);
        ...
        SRDescription(DCSR.DateTimePickerCalendarForeColorDescr)
        ]
        public Color CalendarForeColor {
            ...
            set {
                ...
                if (!value.Equals(calendarForeColor)) {
                    ...
                    SetControlColor(WinFormNativeMethods.MCSC_TEXT, value);
                }
            }
        }
        ...
        Localizable(true),
        AmbientValue(null),
        SRDescription(DCSR.DateTimePickerCalendarFontDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.DateTimePickerCalendarTitleBackColorDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.DateTimePickerCalendarTitleForeColorDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.DateTimePickerCalendarTrailingForeColorDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.DateTimePickerCalendarMonthBackgroundDescr)
        ]
        public Color CalendarMonthBackground {
            ...
            set {
                ...
                if (!value.Equals(calendarMonthBackground)) {
                    ...
                    SetControlColor(WinFormNativeMethods.MCSC_MONTHBK, value);
                }
            }
        }
        ...
        DefaultValue(true),
        Bindable(true),
        SRDescription(DCSR.DateTimePickerCheckedDescr)
        ]
        public bool Checked {
            get {
                ...
                if (this.ShowCheckBox && IsHandleCreated) {
                    ...
                    int gdt = (int)WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.DTM_GETSYSTEMTIME, 0, sys);
                    return gdt == WinFormNativeMethods.GDT_VALID;
                } else {
                    return validTime;
                }
            }
            set {
                if (this.Checked != value) {
                    ...
                    if (this.ShowCheckBox && IsHandleCreated) {
                        if (value) {
                            int gdt = WinFormNativeMethods.GDT_VALID;
                            WinFormNativeMethods.SYSTEMTIME sys = DateTimePicker.DateTimeToSysTime(Value);
                            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.DTM_SETSYSTEMTIME, gdt, sys);
                        }
                        else {
                            int gdt = WinFormNativeMethods.GDT_NONE;
                            WinFormNativeMethods.SYSTEMTIME sys = null;
                            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.DTM_SETSYSTEMTIME, gdt, sys);
                        }
                    }
        ...
        protected override CreateParams CreateParams {
            ...
            get {
                ...
                cp.ClassName = WinFormNativeMethods.WC_DATETIMEPICK;

                cp.Style |= style;

                switch (format) {
                    case DateTimePickerFormat.Long:
                        cp.Style |= WinFormNativeMethods.DTS_LONGDATEFORMAT;
                        break;
        ...
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.DateTimePickerCustomFormatDescr)
        ]
                ...
                if ((value != null && !value.Equals(customFormat)) ||
                    ...
                    if (IsHandleCreated) {
                        if (format == DateTimePickerFormat.Custom)
                            SendMessage(WinFormNativeMethods.DTM_SETFORMAT, 0, customFormat);
                    }
                }
            }
        }
        ...
        SRCategory(DCSR.CatAppearance),
        Localizable(true),
        SRDescription(DCSR.DateTimePickerDropDownAlignDescr)
        ]
        public LeftRightAlignment DropDownAlign {
            get {
                return((style & WinFormNativeMethods.DTS_RIGHTALIGN) != 0)
            ...
            set {
                ...
                SetStyleBit((value == LeftRightAlignment.Right), WinFormNativeMethods.DTS_RIGHTALIGN);
            }
        }
        ...
        SRCategory(DCSR.CatAppearance),
        RefreshProperties(RefreshProperties.Repaint),
        SRDescription(DCSR.DateTimePickerFormatDescr)
        ]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.DateTimePickerOnFormatChangedDescr)]
        ...
        [
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.DateTimePickerMaxDateDescr)
        ]
        public DateTime MaxDate {
            ...
            set {
                if (value != max) {
                    ...
                    {
                        throw new ArgumentOutOfRangeException("MaxDate", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "MaxDate", FormatDateTime(value), "MinDate"));
                    }

                    // If trying to set the maximum greater than MaxDateTime, throw.
                    if (value > MaximumDateTime) {
                        throw new ArgumentOutOfRangeException("MaxDate", DCSR.GetString(DCSR.DateTimePickerMaxDate, FormatDateTime(DateTimePicker.MaxDateTime)));
                    }
        ...
        [
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.DateTimePickerMinDateDescr)
        ]
        public DateTime MinDate {
            ...
            set
            {
                if (value != min)
                {
                    ...
                    {
                        throw new ArgumentOutOfRangeException("MinDate", DCSR.GetString(DCSR.InvalidHighBoundArgument, "MinDate", FormatDateTime(value), "MaxDate"));
                    }

                    // If trying to set the minimum less than MinimumDateTime, throw.
                    if (value < MinimumDateTime)
                    {
                        throw new ArgumentOutOfRangeException("MinDate", DCSR.GetString(DCSR.DateTimePickerMinDate, FormatDateTime(DateTimePicker.MinimumDateTime)));
                    }
        ...
        DefaultValue(false),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.DateTimePickerShowNoneDescr)
        ]
        public bool ShowCheckBox {
            get {
                return(style & WinFormNativeMethods.DTS_SHOWNONE) != 0;
            }
            set {
                SetStyleBit(value, WinFormNativeMethods.DTS_SHOWNONE);
            }
        }
        ...
        DefaultValue(false),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.DateTimePickerShowUpDownDescr)
        ]
        public bool ShowUpDown {
            get {
                return(style & WinFormNativeMethods.DTS_UPDOWN) != 0;
            }
            set {
                if (ShowUpDown != value) {
                    SetStyleBit(value, WinFormNativeMethods.DTS_UPDOWN);
                }
            }
        }
        ...
        SRDescription(DCSR.DateTimePickerValueDescr)
        ]
            ...
            set {
                ...
                if (!userHasSetValue || valueChanged) {
                    if ((value < MinDate) || (value > MaxDate)) {
                        throw new ArgumentOutOfRangeException("Value", DCSR.GetString(DCSR.InvalidBoundArgument, "Value", FormatDateTime(value), "'MinDate'", "'MaxDate'"));
                    }
        ...
        /// </devdoc>
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.DateTimePickerOnCloseUpDescr)]
        ...
        /// </devdoc>
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.valueChangedEventDescr)]
        ...
        /// </devdoc>
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.DateTimePickerOnDropDownDescr)]
        ...
        private void SetControlColor(int colorIndex, Color value) {
            if (IsHandleCreated) {
                SendMessage(WinFormNativeMethods.DTM_SETMCCOLOR, colorIndex, ColorTranslator.ToWin32(value));
            }
        }
        ...
        private void SetControlCalendarFont() {
            if (IsHandleCreated) {
                SendMessage(WinFormNativeMethods.DTM_SETMCFONT, CalendarFontHandle, WinFormNativeMethods.InvalidIntPtr);
            }
        }
        ...
        private void SetAllControlColors() {
            SetControlColor(WinFormNativeMethods.MCSC_MONTHBK, calendarMonthBackground);
            SetControlColor(WinFormNativeMethods.MCSC_TEXT, calendarForeColor);
            SetControlColor(WinFormNativeMethods.MCSC_TITLEBK, calendarTitleBackColor);
            SetControlColor(WinFormNativeMethods.MCSC_TITLETEXT, calendarTitleForeColor);
            SetControlColor(WinFormNativeMethods.MCSC_TRAILINGTEXT, calendarTrailingText);
        }
        ...
        private void SetRange(DateTime min, DateTime max) {
            if (IsHandleCreated) {
                ...
                flags |= WinFormNativeMethods.GDTR_MIN | WinFormNativeMethods.GDTR_MAX;
                WinFormNativeMethods.SYSTEMTIME sys = DateTimePicker.DateTimeToSysTime(min);
                sa.wYear1 = sys.wYear;
                ...
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.DTM_SETRANGE, flags, sa);
            }
        }
        ...
        private void UpdateUpDown() {
            ...
            if (ShowUpDown) {
                ...
                WinFormNativeMethods.EnumChildrenCallback cb = new WinFormNativeMethods.EnumChildrenCallback(c.enumChildren);
                WinFormUnsafeNativeMethods.EnumChildWindows(new HandleRef(this, Handle), cb, WinFormNativeMethods.NullHandleRef);
                if (c.hwndFound != IntPtr.Zero) {
                    WinFormSafeNativeMethods.InvalidateRect(new HandleRef(c, c.hwndFound), null, true);
                    WinFormSafeNativeMethods.UpdateWindow(new HandleRef(c, c.hwndFound));
                }
            }
        }
        ...
        private void WmDateTimeChange(ref Message m) {
            WinFormNativeMethods.NMDATETIMECHANGE nmdtc = (WinFormNativeMethods.NMDATETIMECHANGE)m.GetLParam(typeof(WinFormNativeMethods.NMDATETIMECHANGE));
            DateTime temp = value;
            bool oldvalid = validTime;
            if (nmdtc.dwFlags != WinFormNativeMethods.GDT_NONE) {
                validTime = true;
        ...
        private void WmDropDown(ref Message m) {
            ...
            if (this.RightToLeftLayout == true && this.RightToLeft == RightToLeft.Yes) {
                IntPtr handle = SendMessage(WinFormNativeMethods.DTM_GETMONTHCAL, 0,0);
                if (handle != IntPtr.Zero) {
                    int style = unchecked((int)((long)WinFormUnsafeNativeMethods.GetWindowLong(new HandleRef(this, handle), WinFormNativeMethods.GWL_EXSTYLE)));
                    style |= WinFormNativeMethods.WS_EX_LAYOUTRTL | WinFormNativeMethods.WS_EX_NOINHERITLAYOUT;
                    style &= ~(WinFormNativeMethods.WS_EX_RIGHT | WinFormNativeMethods.WS_EX_RTLREADING);
                    WinFormUnsafeNativeMethods.SetWindowLong(new HandleRef(this, handle), WinFormNativeMethods.GWL_EXSTYLE, new HandleRef(this, (IntPtr)style));
                }
            }
        ...
        private void WmReflectCommand(ref Message m) {
            if (m.HWnd == Handle) {
                ...
                switch (nmhdr.code) {
                    case WinFormNativeMethods.DTN_CLOSEUP:
                        WmCloseUp(ref m);
                        break;
                    case WinFormNativeMethods.DTN_DATETIMECHANGE:
                        WmDateTimeChange(ref m);
                        break;
                    case WinFormNativeMethods.DTN_DROPDOWN:
                        WmDropDown(ref m);
                        break;
                }
            }
        ...
        /// </devdoc>
        internal static WinFormNativeMethods.SYSTEMTIME DateTimeToSysTime(DateTime time) {
            WinFormNativeMethods.SYSTEMTIME sys = new WinFormNativeMethods.SYSTEMTIME();
        ...
        ///     Note: 1 second granularity.
        /// </devdoc>
        internal static DateTime SysTimeToDateTime(WinFormNativeMethods.SYSTEMTIME s) {
