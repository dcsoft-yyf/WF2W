    ...
    public class DataGridViewImageColumn : DataGridViewColumn
    {
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidCastException(DCSR.GetString(DCSR.DataGridViewTypeColumn_WrongCellTemplateType, "System.Windows.Forms.DataGridViewImageCell"));
                }
        ...
        [
            ...
            DefaultValue(""),
            SRCategory(DCSR.CatAppearance), 
            SRDescription(DCSR.DataGridViewImageColumn_DescriptionDescr)
        ]
        ...
        [
            DefaultValue(null),
            SRCategory(DCSR.CatAppearance),
            SRDescription(DCSR.DataGridViewImageColumn_ImageDescr)
        ]
        public Image Image
        {
            get
        ...
        [
            ...
            SRCategory(DCSR.CatAppearance),
            SRDescription(DCSR.DataGridViewImageColumn_ImageLayoutDescr)
        ]
