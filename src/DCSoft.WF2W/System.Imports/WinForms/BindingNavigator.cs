...
[System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = false )]
    public class BindingNavigator : ToolStrip, ISupportInitialize {
        ...
        private String countItemFormat = DCSR.GetString(DCSR.BindingNavigatorCountItemFormat);
        ...
        public virtual void AddStandardItems() {
            ...
            MoveFirstItem.Text    = DCSR.GetString(DCSR.BindingNavigatorMoveFirstItemText);
            MovePreviousItem.Text = DCSR.GetString(DCSR.BindingNavigatorMovePreviousItemText);
            MoveNextItem.Text     = DCSR.GetString(DCSR.BindingNavigatorMoveNextItemText);
            MoveLastItem.Text     = DCSR.GetString(DCSR.BindingNavigatorMoveLastItemText);
            AddNewItem.Text       = DCSR.GetString(DCSR.BindingNavigatorAddNewItemText);
            DeleteItem.Text       = DCSR.GetString(DCSR.BindingNavigatorDeleteItemText);

            CountItem.ToolTipText    = DCSR.GetString(DCSR.BindingNavigatorCountItemTip);
            PositionItem.ToolTipText = DCSR.GetString(DCSR.BindingNavigatorPositionItemTip);
            CountItem.AutoToolTip    = false;
            PositionItem.AutoToolTip = false;

            PositionItem.AccessibleName = DCSR.GetString(DCSR.BindingNavigatorPositionAccessibleName);
            //
            // Set up images
            //
        ...
        SRDescription(DCSR.BindingNavigatorBindingSourcePropDescr),
        ...
        [
        TypeConverter(typeof(ReferenceConverter)),
        SRCategory(DCSR.CatItems),
        SRDescription(DCSR.BindingNavigatorMoveFirstItemPropDescr)
        ]
        ...
        TypeConverter(typeof(ReferenceConverter)),
        SRCategory(DCSR.CatItems),
        SRDescription(DCSR.BindingNavigatorMovePreviousItemPropDescr)
        ]
        ...
        TypeConverter(typeof(ReferenceConverter)),
        SRCategory(DCSR.CatItems),
        SRDescription(DCSR.BindingNavigatorMoveNextItemPropDescr)
        ]
        ...
        TypeConverter(typeof(ReferenceConverter)),
        SRCategory(DCSR.CatItems),
        SRDescription(DCSR.BindingNavigatorMoveLastItemPropDescr)
        ]
        ...
        TypeConverter(typeof(ReferenceConverter)),
        SRCategory(DCSR.CatItems),
        SRDescription(DCSR.BindingNavigatorAddNewItemPropDescr)
        ]
        ...
        TypeConverter(typeof(ReferenceConverter)),
        SRCategory(DCSR.CatItems),
        SRDescription(DCSR.BindingNavigatorDeleteItemPropDescr)
        ]
        ...
        TypeConverter(typeof(ReferenceConverter)),
        SRCategory(DCSR.CatItems),
        SRDescription(DCSR.BindingNavigatorPositionItemPropDescr)
        ]
        ...
        TypeConverter(typeof(ReferenceConverter)),
        SRCategory(DCSR.CatItems),
        SRDescription(DCSR.BindingNavigatorCountItemPropDescr)
        ]
        ...
        SRDescription(DCSR.BindingNavigatorCountItemFormatPropDescr)
        ]
        ...
        SRDescription(DCSR.BindingNavigatorRefreshItemsEventDescr)
        ]
        ...
        private void ResetCountItemFormat() {
            countItemFormat = DCSR.GetString(DCSR.BindingNavigatorCountItemFormat);
        }

        private bool ShouldSerializeCountItemFormat() {
            return countItemFormat != DCSR.GetString(DCSR.BindingNavigatorCountItemFormat);
        }
