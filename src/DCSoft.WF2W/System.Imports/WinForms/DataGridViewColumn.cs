...
namespace System.Windows.Forms
{
    ...
    public class DataGridViewColumn : DataGridViewBand, IComponent
    {
        ...
        [
            ...
            SRDescription(DCSR.DataGridViewColumn_AutoSizeModeDescr),
               ...
               { 
                ...
                if (this.autoSizeMode != value)
                {
                    if (this.Visible && this.DataGridView != null)
                    {
                        ...
                        {
                            throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewColumn_AutoSizeCriteriaCannotUseInvisibleHeaders));
                        }
                        if (this.Frozen &&
                             ...
                             (value == DataGridViewAutoSizeColumnMode.NotSet && this.DataGridView.AutoSizeColumnsMode == DataGridViewAutoSizeColumnsMode.Fill)))
                        {
                            ...
                            throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewColumn_FrozenColumnCannotAutoFill));
                        }
                    }
        ...
        [
            ...
            SRDescription(DCSR.DataGridView_ColumnContextMenuStripDescr)
        ]
        ...
        [
            ...
            SRDescription(DCSR.DataGridView_ColumnDataPropertyNameDescr),
        ...
        [
            ...
            SRDescription(DCSR.DataGridView_ColumnDefaultCellStyleDescr)
        ]
        ...
        public int DisplayIndex
        {
            ...
            set 
            {
                if (this.displayIndex != value)
                {
                    ...
                    {
                        throw new ArgumentOutOfRangeException("DisplayIndex", value, DCSR.GetString(DCSR.DataGridViewColumn_DisplayIndexTooLarge, Int32.MaxValue.ToString(CultureInfo.CurrentCulture)));
                    }
                    if (this.DataGridView != null)
                    {
                        if (value < 0)
                        {
                            throw new ArgumentOutOfRangeException("DisplayIndex", value, DCSR.GetString(DCSR.DataGridViewColumn_DisplayIndexNegative));
                        }
                        if (value >= this.DataGridView.Columns.Count)
                        {
                            throw new ArgumentOutOfRangeException("DisplayIndex", value, DCSR.GetString(DCSR.DataGridViewColumn_DisplayIndexExceedsColumnCount));
                        }
                    ...
                    else
                    {
                        if (value < -1)
                        {
                            throw new ArgumentOutOfRangeException("DisplayIndex", value, DCSR.GetString(DCSR.DataGridViewColumn_DisplayIndexTooNegative));
                        }
                        this.displayIndex = value;
                    }
                }
        ...
        [
            DefaultValue(0),
            SRCategory(DCSR.CatLayout),
            SRDescription(DCSR.DataGridView_ColumnDividerWidthDescr)
        ]
        ...
        [
            ...
            SRDescription(DCSR.DataGridViewColumn_FillWeightDescr),
        ]
        public float FillWeight
        {
            ...
            set
            {
                if (value <= 0)
                {
                    throw new ArgumentOutOfRangeException("FillWeight", DCSR.GetString(DCSR.InvalidLowBoundArgument, "FillWeight", (value).ToString(CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture)));
                }
                if (value > (float)ushort.MaxValue)
                {
                    throw new ArgumentOutOfRangeException("FillWeight", DCSR.GetString(DCSR.InvalidHighBoundArgumentEx, "FillWeight", (value).ToString(CultureInfo.CurrentCulture), (ushort.MaxValue).ToString(CultureInfo.CurrentCulture)));
                }
                if (this.DataGridView != null)
                {
        ...
        [
            ...
            SRCategory(DCSR.CatLayout),
            SRDescription(DCSR.DataGridView_ColumnFrozenDescr)
        ]
        ...
        [
            SRCategory(DCSR.CatAppearance),
            SRDescription(DCSR.DataGridView_ColumnHeaderTextDescr),
            Localizable(true)
        ]
        ...
        [
            ...
            Localizable(true), 
            SRCategory(DCSR.CatLayout),
            SRDescription(DCSR.DataGridView_ColumnMinimumWidthDescr),
            RefreshProperties(RefreshProperties.Repaint)
        ]
        ...
        [
            SRCategory(DCSR.CatBehavior),
            SRDescription(DCSR.DataGridView_ColumnReadOnlyDescr)
        ]
        public override bool ReadOnly
        {
            ...
            set
            {
                if (this.IsDataBound &&
                    ...
                    !value)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_ColumnBoundToAReadOnlyFieldMustRemainReadOnly));
                }
                base.ReadOnly = value;
            }
        }
        ...
        [
            SRCategory(DCSR.CatBehavior),
            SRDescription(DCSR.DataGridView_ColumnResizableDescr)
        ]
        ...
        [
            ...
            SRCategory(DCSR.CatBehavior),
            SRDescription(DCSR.DataGridView_ColumnSortModeDescr)
        ]
            ...
            set
            {
                if (value != this.SortMode)
                {
                    if (value != DataGridViewColumnSortMode.NotSortable)
                    {
                        ...
                        {
                            throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewColumn_SortModeAndSelectionModeClash, (value).ToString(), this.DataGridView.SelectionMode.ToString()));
                        }
        ...
        [
            ...
            Localizable(true), 
            SRCategory(DCSR.CatAppearance),
            SRDescription(DCSR.DataGridView_ColumnToolTipTextDescr)
        ]
        ...
        [
            ...
            Localizable(true), 
            SRCategory(DCSR.CatAppearance),
            SRDescription(DCSR.DataGridView_ColumnVisibleDescr)
        ]
        ...
        [
            SRCategory(DCSR.CatLayout),
            Localizable(true), 
            SRDescription(DCSR.DataGridView_ColumnWidthDescr),
            RefreshProperties(RefreshProperties.Repaint)
        ]
        public int Width
        {
        ...
        public virtual int GetPreferredWidth(DataGridViewAutoSizeColumnMode autoSizeColumnMode, bool fixedHeight)
        {
            ...
            {
                throw new ArgumentException(DCSR.GetString(DCSR.DataGridView_NeedColumnAutoSizingCriteria, "autoSizeColumnMode"));
            }
