...
[System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = false )]
    public class WebBrowser : WebBrowserBase {
        ...
        // property instead.
        private WinFormUnsafeNativeMethods.IWebBrowser2 axIWebBrowser2;  
        ...
        ///     </para>
        /// </devdoc>
        [SRDescription(DCSR.WebBrowserAllowNavigationDescr),
        SRCategory(DCSR.CatBehavior), DefaultValue(true)]
        public bool AllowNavigation
        {
            get
            {
                return true;// webBrowserState[WEBBROWSERSTATE_allowNavigation];
            }
            set
            {
        ...
        ///     </para>
        /// </devdoc>
        [SRDescription(DCSR.WebBrowserAllowWebBrowserDropDescr),
        SRCategory(DCSR.CatBehavior), DefaultValue(true)]
        public bool AllowWebBrowserDrop {
            get {
                return true;// this.AxIWebBrowser2.RegisterAsDropTarget;
            }
            set {
        ...
        ///     </para>
        /// </devdoc>
        [SRDescription(DCSR.WebBrowserScriptErrorsSuppressedDescr),
        SRCategory(DCSR.CatBehavior), DefaultValue(false)]
        public bool ScriptErrorsSuppressed {
            get {
                return false;// this.AxIWebBrowser2.Silent;
            }
            set {
        ...
        ///     </para>
        /// </devdoc>
        [SRDescription(DCSR.WebBrowserWebBrowserShortcutsEnabledDescr),
        SRCategory(DCSR.CatBehavior), DefaultValue(true)]
        ...
        //            WinFormUnsafeNativeMethods.IHTMLDocument2 iHTMLDocument2 = null;
        //            try {
        //                iHTMLDocument2 = objDoc as WinFormUnsafeNativeMethods.IHTMLDocument2;
        //            } 
        //            catch (InvalidCastException) { 
        //            }
        //            if (iHTMLDocument2 != null) {
        //                WinFormUnsafeNativeMethods.IHTMLLocation iHTMLLocation = iHTMLDocument2.GetLocation();
        ...
        //                        return new HtmlDocument (ShimManager, iHTMLDocument2 as WinFormUnsafeNativeMethods.IHTMLDocument);
        //                    }
        //                }
        //            }
        //        }
        ...
        //        }
        //        else {
        //            WinFormUnsafeNativeMethods.IPersistStreamInit psi = htmlDocument.DomDocument as WinFormUnsafeNativeMethods.IPersistStreamInit;
        ...
        //                WinFormUnsafeNativeMethods.IStream iStream = (WinFormUnsafeNativeMethods.IStream)new WinFormUnsafeNativeMethods.ComStreamFromDataStream(memoryStream);
        ...
        public WebBrowserEncryptionLevel EncryptionLevel {
            get {
                return WebBrowserEncryptionLevel.Unknown;
            }
        }
        ...
        ///     </para>
        /// </devdoc>
        [SRDescription(DCSR.WebBrowserIsOfflineDescr), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsOffline {
            get {
                return false;// this.AxIWebBrowser2.Offline;
            }
        }
        ...
        ///     </para>
        /// </devdoc>
        [SRDescription(DCSR.WebBrowserIsWebBrowserContextMenuEnabledDescr),
        SRCategory(DCSR.CatBehavior), DefaultValue(true)]
        ...
        public object ObjectForScripting 
        {
            ...
            set 
            {
                if (value != null)
                {
                    ...
                    {
                        throw new ArgumentException(DCSR.GetString(DCSR.WebBrowserObjectForScriptingComVisibleOnly));
                    }
                }
        ...
        public WebBrowserReadyState ReadyState {
            get {
                return WebBrowserReadyState.Loaded;
        ...
        [
            SRDescription(DCSR.WebBrowserUrlDescr),
            Bindable(true),
        ...
        public void Print() {
            ...
            //try
            //{
            //    this.AxIWebBrowser2.ExecWB(WinFormNativeMethods.OLECMDID.OLECMDID_PRINT, WinFormNativeMethods.OLECMDEXECOPT.OLECMDEXECOPT_DONTPROMPTUSER, ref nullObjectArray, IntPtr.Zero);
            //}
            //catch (Exception ex)
            //{
            //    if (ClientUtils.IsSecurityOrCriticalException(ex))
        ...
        ///     </para>
        /// </devdoc>
        [SRDescription(DCSR.WebBrowserScrollBarsEnabledDescr),
        SRCategory(DCSR.CatBehavior), DefaultValue(true)]
        ...
        public void ShowPageSetupDialog() {
            ...
            //object nullObjectArray = null;
            //try {
            //    this.AxIWebBrowser2.ExecWB(WinFormNativeMethods.OLECMDID.OLECMDID_PAGESETUP, WinFormNativeMethods.OLECMDEXECOPT.OLECMDEXECOPT_PROMPTUSER, ref nullObjectArray, IntPtr.Zero);
            //}
            //catch (Exception ex) {
            //    if (ClientUtils.IsSecurityOrCriticalException(ex)) {
            //        throw;
        ...
        public void ShowPrintDialog() {
            ...
            //try {
            //    this.AxIWebBrowser2.ExecWB(WinFormNativeMethods.OLECMDID.OLECMDID_PRINT, WinFormNativeMethods.OLECMDEXECOPT.OLECMDEXECOPT_PROMPTUSER, ref nullObjectArray, IntPtr.Zero);
            //}
            //catch (Exception ex) {
            //    if (ClientUtils.IsSecurityOrCriticalException(ex)) {
            //        throw;
        ...
        public void ShowPrintPreviewDialog() {
            ...
            //try {
            //    this.AxIWebBrowser2.ExecWB(WinFormNativeMethods.OLECMDID.OLECMDID_PRINTPREVIEW, WinFormNativeMethods.OLECMDEXECOPT.OLECMDEXECOPT_PROMPTUSER, ref nullObjectArray, IntPtr.Zero);
            //}
            //catch (Exception ex) {
            //    if (ClientUtils.IsSecurityOrCriticalException(ex)) {
            //        throw;
        ...
        public void ShowPropertiesDialog() {
            ...
            //try {
            //    this.AxIWebBrowser2.ExecWB(WinFormNativeMethods.OLECMDID.OLECMDID_PROPERTIES, WinFormNativeMethods.OLECMDEXECOPT.OLECMDEXECOPT_PROMPTUSER, ref nullObjectArray, IntPtr.Zero);
            //}
            //catch (Exception ex) {
            //    if (ClientUtils.IsSecurityOrCriticalException(ex)) {
            //        throw;
        ...
        public void ShowSaveAsDialog() {
            ...
            //try {
            //    this.AxIWebBrowser2.ExecWB(WinFormNativeMethods.OLECMDID.OLECMDID_SAVEAS, WinFormNativeMethods.OLECMDEXECOPT.OLECMDEXECOPT_DODEFAULT, ref nullObjectArray, IntPtr.Zero);
            //}
            //catch (Exception ex) {
            //    if (ClientUtils.IsSecurityOrCriticalException(ex)) {
            //        throw;
        ...
        ///     </para>
        /// </devdoc>
        [Browsable(false), SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.WebBrowserCanGoBackChangedDescr)]
        ...
        ///     </para>
        /// </devdoc>
        [Browsable(false), SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.WebBrowserCanGoForwardChangedDescr)]
        ...
        ///     </para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.WebBrowserDocumentCompletedDescr)]
        ...
        ///     </para>
        /// </devdoc>
        [Browsable(false), SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.WebBrowserDocumentTitleChangedDescr)]
        ...
        ///     </para>
        /// </devdoc>
        [Browsable(false), SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.WebBrowserEncryptionLevelChangedDescr)]
        ...
        ///     </para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.WebBrowserFileDownloadDescr)]
        ...
        ///     </para>
        /// </devdoc>
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.WebBrowserNavigatedDescr)]
        ...
        ///     </para>
        /// </devdoc>
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.WebBrowserNavigatingDescr)]
        ...
        ///     </para>
        /// </devdoc>
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.WebBrowserNewWindowDescr)]
        ...
        ///     </para>
        /// </devdoc>
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.WebBrowserProgressChangedDescr)]
        ...
        ///     </para>
        /// </devdoc>
        [Browsable(false), SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.WebBrowserStatusTextChangedDescr)]
        ...
        public override bool Focused {
            get {
                ...
                return hwndFocus != IntPtr.Zero
                    && WinFormSafeNativeMethods.IsChild(new HandleRef(this, this.Handle), new HandleRef(null, hwndFocus));
            }
        }
        ...
        protected override void AttachInterfaces(object nativeActiveXObject) {
            this.axIWebBrowser2 = (WinFormUnsafeNativeMethods.IWebBrowser2)nativeActiveXObject;
        }
        ...
        protected override void CreateSink() {
            ...
            //            typeof(WinFormUnsafeNativeMethods.DWebBrowserEvents2));
            //}
        }
...
//#endregion
        ...
        private void CheckIfCreatedInIE() {
            if (WebBrowser.createdInIE) {
                if (this.ParentInternal != null) {
                    ...
                    this.Dispose();
                    throw new NotSupportedException(DCSR.GetString(DCSR.WebBrowserInIENotSupported));
                }
            }
        }
        ...
        //// ComVisible(false)]
        //protected class WebBrowserSite : WebBrowserSiteBase, WinFormUnsafeNativeMethods.IDocHostUIHandler
        //{
        ...
        //    /// <internalonly/>
        //    int WinFormUnsafeNativeMethods.IDocHostUIHandler.ShowContextMenu(int dwID, WinFormNativeMethods.POINT pt, object pcmdtReserved, object pdispReserved) {
        ...
        //    /// <internalonly/>
        //    int WinFormUnsafeNativeMethods.IDocHostUIHandler.GetHostInfo(WinFormNativeMethods.DOCHOSTUIINFO info) {
        //        WebBrowser wb = (WebBrowser)this.Host;

        //        info.dwDoubleClick = (int)WinFormNativeMethods.DOCHOSTUIDBLCLICK.DEFAULT;
        //        info.dwFlags = (int)WinFormNativeMethods.DOCHOSTUIFLAG.NO3DOUTERBORDER |
        //                        (int)WinFormNativeMethods.DOCHOSTUIFLAG.DISABLE_SCRIPT_INACTIVE;

        //        if (wb.ScrollBarsEnabled) {
        //            info.dwFlags |= (int)WinFormNativeMethods.DOCHOSTUIFLAG.FLAT_SCROLLBAR;
        //        }
        //        else {
        //            info.dwFlags |= (int)WinFormNativeMethods.DOCHOSTUIFLAG.SCROLL_NO;
        //        }

        //        if (Application.RenderWithVisualStyles) {
        //            info.dwFlags |= (int)WinFormNativeMethods.DOCHOSTUIFLAG.THEME;
        //        }
        //        else {
        //            info.dwFlags |= (int)WinFormNativeMethods.DOCHOSTUIFLAG.NOTHEME;
        //        }
        ...
        //    /// <internalonly/>
        //    int WinFormUnsafeNativeMethods.IDocHostUIHandler.EnableModeless(bool fEnable) {
        ...
        //    /// <internalonly/>
        //    int WinFormUnsafeNativeMethods.IDocHostUIHandler.ShowUI(int dwID, WinFormUnsafeNativeMethods.IOleInPlaceActiveObject activeObject, 
        //            WinFormNativeMethods.IOleCommandTarget commandTarget, WinFormUnsafeNativeMethods.IOleInPlaceFrame frame, 
        ...
        //    /// <internalonly/>
        //    int WinFormUnsafeNativeMethods.IDocHostUIHandler.HideUI() {
        //        return WinFormNativeMethods.E_NOTIMPL;
        //    }
        ...
        //    /// <internalonly/>
        //    int WinFormUnsafeNativeMethods.IDocHostUIHandler.UpdateUI() {
        //        return WinFormNativeMethods.E_NOTIMPL;
        //    }
        ...
        //    /// <internalonly/>
        //    int WinFormUnsafeNativeMethods.IDocHostUIHandler.OnDocWindowActivate(bool fActivate) {
        //        return WinFormNativeMethods.E_NOTIMPL;
        //    }
        ...
        //    /// <internalonly/>
        //    int WinFormUnsafeNativeMethods.IDocHostUIHandler.OnFrameWindowActivate(bool fActivate) {
        //        return WinFormNativeMethods.E_NOTIMPL;
        //    }
        ...
        //    /// <internalonly/>
        //    int WinFormUnsafeNativeMethods.IDocHostUIHandler.ResizeBorder(WinFormNativeMethods.COMRECT rect, WinFormUnsafeNativeMethods.IOleInPlaceUIWindow doc, bool fFrameWindow) {
        //        return WinFormNativeMethods.E_NOTIMPL;
        //    }
        ...
        //    /// <internalonly/>
        //    int WinFormUnsafeNativeMethods.IDocHostUIHandler.GetOptionKeyPath(string[] pbstrKey, int dw) {
        //        return WinFormNativeMethods.E_NOTIMPL;
        //    }
        ...
        //    /// <internalonly/>
        //    int WinFormUnsafeNativeMethods.IDocHostUIHandler.GetDropTarget(WinFormUnsafeNativeMethods.IOleDropTarget pDropTarget, out WinFormUnsafeNativeMethods.IOleDropTarget ppDropTarget) {
        //        //
        ...
        //    /// <internalonly/>
        //    int WinFormUnsafeNativeMethods.IDocHostUIHandler.GetExternal(out object ppDispatch) {
        //        WebBrowser wb = (WebBrowser)this.Host;
        ...
        //    int WinFormUnsafeNativeMethods.IDocHostUIHandler.TranslateAccelerator(ref WinFormNativeMethods.MSG msg, ref Guid group, int nCmdID) {
        //        //
        ...
        //    /// <internalonly/>
        //    int WinFormUnsafeNativeMethods.IDocHostUIHandler.TranslateUrl(int dwTranslate, string strUrlIn, out string pstrUrlOut) {
        //        //
        //        // Set to null no matter what we return, to prevent the marshaller
        //        // from going crazy if the pointer points to random stuff.
        //        pstrUrlOut = null;
        ...
        //    /// <internalonly/>
        //    int WinFormUnsafeNativeMethods.IDocHostUIHandler.FilterDataObject(IComDataObject pDO, out IComDataObject ppDORet) 
        //    {
        //        //
        //        // Set to null no matter what we return, to prevent the marshaller
        //        // from going crazy if the pointer points to random stuff.
        ...
        //        if (dispid != WinFormNativeMethods.ActiveX.DISPID_READYSTATE) {
        ...
        //private class WebBrowserEvent : StandardOleMarshalObject, WinFormUnsafeNativeMethods.DWebBrowserEvents2{
        ...
        //        //if (command == WinFormNativeMethods.CSC_NAVIGATEBACK) {
        //        //    this.parent.CanGoBackInternal = enable;
        //        //}
        //        //else if (command == WinFormNativeMethods.CSC_NAVIGATEFORWARD) {
        ...
        //        //        WinFormUnsafeNativeMethods.IStream iStream = (WinFormUnsafeNativeMethods.IStream)new WinFormUnsafeNativeMethods.ComStreamFromDataStream(
