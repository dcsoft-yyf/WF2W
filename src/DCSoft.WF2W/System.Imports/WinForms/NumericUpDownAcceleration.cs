...
namespace System.Windows.Forms {
    ...
    public class NumericUpDownAcceleration
    {
        ...
        public NumericUpDownAcceleration(Int32 seconds, Decimal increment)
        {
            if (seconds < 0)
            {
                throw new ArgumentOutOfRangeException("seconds", seconds, DCSR.GetString(DCSR.NumericUpDownLessThanZeroError));
            }

            if (increment < Decimal.Zero)
            {
                throw new ArgumentOutOfRangeException("increment", increment, DCSR.GetString(DCSR.NumericUpDownLessThanZeroError));
            }
        ...
        public Int32 Seconds
        {
            ...
            set
            {
                if (value < 0)
                {
                    throw new ArgumentOutOfRangeException("seconds", value, DCSR.GetString(DCSR.NumericUpDownLessThanZeroError));
                }
                this.seconds = value;
            }
        }
        ...
        public Decimal Increment {
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("increment", value, DCSR.GetString(DCSR.NumericUpDownLessThanZeroError));
                }
