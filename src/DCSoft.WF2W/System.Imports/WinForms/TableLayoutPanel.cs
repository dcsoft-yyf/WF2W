...
[System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = false )]
    public class TableLayoutPanel : Panel, IExtenderProvider {
        ...
        public TableLayoutSettings LayoutSettings {
            ...
            set {
                if (value != null && value.IsStub) {
                    ...
                    throw new NotSupportedException(DCSR.GetString(DCSR.TableLayoutSettingSettingsIsNotSupported));
                }
        ...
        SRDescription(DCSR.TableLayoutPanelCellBorderStyleDescr),
        Localizable(true)
        ]
        ...
        [SRDescription(DCSR.ControlControlsDescr)]
        ...
        [SRDescription(DCSR.GridPanelGetColumnSpanDescr)]
        [DefaultValue(1)]
        [SRCategory(DCSR.CatLayout)]
        ...
        [SRDescription(DCSR.GridPanelGetRowSpanDescr)]
        [DefaultValue(1)]
        [SRCategory(DCSR.CatLayout)]
        [DisplayName("RowSpan")]
        ...
        [SRDescription(DCSR.GridPanelCellPositionDescr)]
        [SRCategory(DCSR.CatLayout)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [DisplayName("Cell")]
        ...
        [SRCategory(DCSR.CatAppearance), SRDescription(DCSR.TableLayoutPanelOnPaintCellDescr)]
