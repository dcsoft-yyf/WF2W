...
namespace System.Windows.Forms {
    ...
    public class CheckBox : ButtonBase {
        ...
        SRDescription(DCSR.CheckBoxAppearanceDescr)
        ]
        ...
        /// </devdoc>
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.CheckBoxOnAppearanceChangedDescr)]
        ...
        SRDescription(DCSR.CheckBoxAutoCheckDescr)
        ]
        ...
        SRDescription(DCSR.CheckBoxCheckAlignDescr)
        ]
        ...
        public CheckState CheckState {
            ...
            set {
                ...
                if (checkState != value) {
                    ...
                    if (IsHandleCreated) {
                        SendMessage(WinFormNativeMethods.BM_SETCHECK, (int)checkState, 0);
                    }
                    ...
                    this.LogWF2WPropertyValue("CheckState", value);
                }
            }
        }
        ...
        protected override CreateParams CreateParams {
            ...
            get {
                ...
                if (OwnerDraw) {
                    ...
                    cp.Style |= WinFormNativeMethods.BS_3STATE;
        ...
        DefaultValue(false),
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.CheckBoxThreeStateDescr)
        ]
        public bool ThreeState {
            ...
            set {
                threeState = value;
                this.LogWF2WPropertyValue("ThreeState", value);
            }
        }
