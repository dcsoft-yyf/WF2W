...
namespace System.Windows.Forms {
    ...
    public class PrintControllerWithStatusDialog : PrintController {
        ...
        : this(underlyingController, DCSR.GetString(DCSR.PrintControllerWithStatusDialog_DialogTitlePrint)) {
        }
        ...
        private class BackgroundThread {
            ...
            private void ThreadUnsafeUpdateLabel() {
                // "page {0} of {1}"
                dialog.label1.Text = DCSR.GetString(DCSR.PrintControllerWithStatusDialog_NowPrinting, 
        ...
        private class StatusDialog : Form {
            ...
            private static bool IsRTLResources {
                get {
                    return DCSR.GetString(DCSR.RTL) != "RTL_False";
                }
            }
            ...
            private void InitializeComponent() {
                ...
                button1.TabIndex = 0;
                button1.Text = DCSR.GetString(DCSR.PrintControllerWithStatusDialog_Cancel);
            ...
            private void button1_Click(object sender, System.EventArgs e) {
                ...
                label1.Text = DCSR.GetString(DCSR.PrintControllerWithStatusDialog_Canceling);
