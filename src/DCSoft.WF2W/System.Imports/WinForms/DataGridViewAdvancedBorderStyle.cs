    ...
    public sealed class DataGridViewAdvancedBorderStyle : ICloneable
    {
        ...
        public DataGridViewAdvancedCellBorderStyle All
        {
            ...
            set 
            {
                ...
                if (value == DataGridViewAdvancedCellBorderStyle.NotSet ||
                    ...
                    value == this.banned3)
                {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridView_AdvancedCellBorderStyleInvalid, "All"));
                }
        ...
        public DataGridViewAdvancedCellBorderStyle Bottom
        {
            ...
            set 
            {
                ...
                if (value == DataGridViewAdvancedCellBorderStyle.NotSet)
                {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridView_AdvancedCellBorderStyleInvalid, "Bottom"));
                }
        ...
        public DataGridViewAdvancedCellBorderStyle Left
        {
            ...
            set 
            {
                ...
                if (value == DataGridViewAdvancedCellBorderStyle.NotSet)
                {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridView_AdvancedCellBorderStyleInvalid, "Left"));
                }
        ...
        public DataGridViewAdvancedCellBorderStyle Right
        {
            ...
            set 
            {
                ...
                if (value == DataGridViewAdvancedCellBorderStyle.NotSet)
                {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridView_AdvancedCellBorderStyleInvalid, "Right"));
                }
        ...
        public DataGridViewAdvancedCellBorderStyle Top
        {
            ...
            set 
            {
                ...
                if (value == DataGridViewAdvancedCellBorderStyle.NotSet)
                {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridView_AdvancedCellBorderStyleInvalid, "Top"));
                }
