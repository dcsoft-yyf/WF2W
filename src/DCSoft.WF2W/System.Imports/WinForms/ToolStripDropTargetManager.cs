             ...
             if (accept && owner.IsHandleCreated) {
                 try
                 {
                     ...
                     if (accept)
                     {
                         ...
                         // Register
                         int n = WinFormUnsafeNativeMethods.RegisterDragDrop(new HandleRef(owner, owner.Handle), (WinFormUnsafeNativeMethods.IOleDropTarget)(new DropTarget(this)));
                     ...
                     else
                     {
                         ...
                         try
                         {
                             ...
                             // Revoke
                             int n = WinFormUnsafeNativeMethods.RevokeDragDrop(new HandleRef(owner, owner.Handle));
                             Debug.WriteLineIf(CompModSwitches.DragDrop.TraceInfo, "   ret:" + n.ToString(CultureInfo.InvariantCulture));
