...
namespace System.Windows.Forms {
    ...
    public class FlatButtonAppearance {
        ...
        SRDescription(DCSR.ButtonBorderSizeDescr),
        ...
        public int BorderSize {
            ...
            set {
                if (value < 0)
                    throw new ArgumentOutOfRangeException("BorderSize", value, DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "BorderSize", value.ToString(CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture)));
        ...
        NotifyParentProperty(true),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ButtonBorderColorDescr),
        EditorBrowsable(EditorBrowsableState.Always),
        ...
        public Color BorderColor {
            ...
            set {
                if (value.Equals(Color.Transparent)) {
                    throw new NotSupportedException(DCSR.GetString(DCSR.ButtonFlatAppearanceInvalidBorderColor));
                }
        ...
        NotifyParentProperty(true),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ButtonCheckedBackColorDescr),
        EditorBrowsable(EditorBrowsableState.Always),
        DefaultValue(typeof(Color), ""),
        ]
        ...
        NotifyParentProperty(true),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ButtonMouseDownBackColorDescr),
        EditorBrowsable(EditorBrowsableState.Always),
        DefaultValue(typeof(Color), ""),
        ]
        ...
        NotifyParentProperty(true),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ButtonMouseOverBackColorDescr),
        EditorBrowsable(EditorBrowsableState.Always),
        DefaultValue(typeof(Color), ""),
        ]
