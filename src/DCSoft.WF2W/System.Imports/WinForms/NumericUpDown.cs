...
namespace System.Windows.Forms {
    ...
    public class NumericUpDown : UpDownBase, ISupportInitialize {
        ...
        SRDescription(DCSR.NumericUpDownDecimalPlacesDescr)
        ]
        public int DecimalPlaces {
            ...
            set {
                if (value < 0 || value > 99) {
                    throw new ArgumentOutOfRangeException("DecimalPlaces", DCSR.GetString(DCSR.InvalidBoundArgument, "DecimalPlaces", value.ToString(CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture), "99"));
                }
                decimalPlaces = value;
                UpdateEditText();
            }
        ...
        SRDescription(DCSR.NumericUpDownHexadecimalDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatData),
        SRDescription(DCSR.NumericUpDownIncrementDescr)
        ]
        public Decimal Increment {
            ...
            set {
                if (value < (Decimal)0.0) {
                    throw new ArgumentOutOfRangeException("Increment", DCSR.GetString(DCSR.InvalidArgument, "Increment", value.ToString(CultureInfo.CurrentCulture)));
                }
                else {
        ...
        SRDescription(DCSR.NumericUpDownMaximumDescr)
        ]
        ...
        SRCategory(DCSR.CatData),
        RefreshProperties(RefreshProperties.All),
        SRDescription(DCSR.NumericUpDownMinimumDescr)
        ]
        ...
        Localizable(true),
        SRDescription(DCSR.NumericUpDownThousandsSeparatorDescr)
        ]
        ...
        SRCategory(DCSR.CatAppearance),
        Bindable(true),
        SRDescription(DCSR.NumericUpDownValueDescr)
        ]
        ...
        ///    </para>
        /// </devdoc>
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.NumericUpDownOnValueChangedDescr)]
