    ...
    public class DataGridTextBox : TextBox {
       ...
       // [SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.UnmanagedCode)]
        protected override async Task WndProc(Message m) {
            ...
            if (m.Msg == WinFormNativeMethods.WM_PASTE || m.Msg == WinFormNativeMethods.WM_CUT || m.Msg == WinFormNativeMethods.WM_CLEAR) {
        ...
        protected internal override bool ProcessKeyMessage(ref Message m)
        {
            ...
            )
            {
                ...
                //
                if (m.Msg == WinFormNativeMethods.WM_CHAR)
                    return true;
            ...
            // the keys )
            if (m.Msg == WinFormNativeMethods.WM_KEYUP)
                return true;
            ...
            switch (keyData)
            {
                ...
                case Keys.Space:
                    if (IsInEditOrNavigateMode && (Control.ModifierKeys & Keys.Shift) == Keys.Shift)
                    {
                            ...
                            if (m.Msg == WinFormNativeMethods.WM_CHAR) return true;
