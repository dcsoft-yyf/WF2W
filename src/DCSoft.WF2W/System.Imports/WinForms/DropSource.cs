...
namespace System.Windows.Forms
{
	...
	/// </devdoc>
        internal class DropSource : WinFormUnsafeNativeMethods.IOleDropSource {
            ...
            public int OleQueryContinueDrag(int fEscapePressed, int grfKeyState) {
                ...
                else if ((grfKeyState & WinFormNativeMethods.MK_LBUTTON) == 0
                         && (grfKeyState & WinFormNativeMethods.MK_RBUTTON) == 0
                         && (grfKeyState & WinFormNativeMethods.MK_MBUTTON) == 0) {
