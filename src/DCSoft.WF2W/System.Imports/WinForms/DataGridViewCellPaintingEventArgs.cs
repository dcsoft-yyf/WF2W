...
namespace System.Windows.Forms
{
    ...
    public class DataGridViewCellPaintingEventArgs : HandledEventArgs
    {
        ...
        public void Paint(Rectangle clipBounds, DataGridViewPaintParts paintParts)
        {
            ...
            {
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewElementPaintingEventArgs_RowIndexOutOfRange));
            }
            if (this.columnIndex < -1 || this.columnIndex >= this.dataGridView.Columns.Count)
            {
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewElementPaintingEventArgs_ColumnIndexOutOfRange));
            }
