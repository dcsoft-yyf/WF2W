...
[System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = false )]
    public class MonthCalendar : Control {
        ...
        [
        Localizable(true),
        SRDescription(DCSR.MonthCalendarAnnuallyBoldedDatesDescr)
        ]
        ...
        /// </devdoc>
        [SRDescription(DCSR.MonthCalendarMonthBackColorDescr)]
        ...
        Localizable(true),
        SRDescription(DCSR.MonthCalendarDimensionsDescr)
        ]
        ...
        protected override CreateParams CreateParams {
            ...
            get {
                ...
                cp.ClassName = WinFormNativeMethods.WC_MONTHCAL;
                cp.Style |= WinFormNativeMethods.MCS_MULTISELECT | WinFormNativeMethods.MCS_DAYSTATE;
                if (!showToday) cp.Style |= WinFormNativeMethods.MCS_NOTODAY;
                if (!showTodayCircle) cp.Style |= WinFormNativeMethods.MCS_NOTODAYCIRCLE;
                if (showWeekNumbers) cp.Style |= WinFormNativeMethods.MCS_WEEKNUMBERS;
        ...
        SRDescription(DCSR.MonthCalendarFirstDayOfWeekDescr)
        ]
                ...
                if (value != firstDayOfWeek) {
                    ...
                    if (IsHandleCreated) {
                        if (value == Day.Default) {
                            ...
                            SendMessage(WinFormNativeMethods.MCM_SETFIRSTDAYOFWEEK, 0, (int) value);
                        }
                    }
                }
            }
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRDescription(DCSR.MonthCalendarForeColorDescr)]
        ...
        [
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.MonthCalendarMaxDateDescr)
        ]
            ...
            set {
                if (value != maxDate) {
                    if (value < DateTimePicker.EffectiveMinDate(minDate)) {
                        throw new ArgumentOutOfRangeException("MaxDate", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "MaxDate", FormatDate(value), "MinDate"));
                    }
                    maxDate = value;
                    SetRange();
                }
        ...
        SRDescription(DCSR.MonthCalendarMaxSelectionCountDescr)
        ]
        public int MaxSelectionCount {
            ...
            set {
                if (value < 1) {
                    throw new ArgumentOutOfRangeException("MaxSelectionCount", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "MaxSelectionCount", (value).ToString("D", CultureInfo.CurrentCulture), (1).ToString(CultureInfo.CurrentCulture)));
                }

                if (value != maxSelectionCount) {
                    if (IsHandleCreated) {
                        if (unchecked( (int) (long)SendMessage(WinFormNativeMethods.MCM_SETMAXSELCOUNT, value, 0)) == 0)
                            throw new ArgumentException(DCSR.GetString(DCSR.MonthCalendarMaxSelCount, (value).ToString("D", CultureInfo.CurrentCulture)), "MaxSelectionCount");
                    }
        ...
        [
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.MonthCalendarMinDateDescr)
        ]
            ...
            set {
                if (value != minDate) {
                    if (value > DateTimePicker.EffectiveMaxDate(maxDate)) {
                        throw new ArgumentOutOfRangeException("MinDate", DCSR.GetString(DCSR.InvalidHighBoundArgument, "MinDate", FormatDate(value), "MaxDate"));
                    }

                    // If trying to set the minimum less than DateTimePicker.MinimumDateTime, throw
                    // an exception.
                    if (value < DateTimePicker.MinimumDateTime) {
                        throw new ArgumentOutOfRangeException("MinDate", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "MinDate", FormatDate(value), FormatDate(DateTimePicker.MinimumDateTime)));
                    }
        ...
        [
        Localizable(true),
        SRDescription(DCSR.MonthCalendarMonthlyBoldedDatesDescr)
        ]
        ...
        SRDescription(DCSR.MonthCalendarScrollChangeDescr)
        ]
        public int ScrollChange {
            ...
            set {
                if (scrollChange != value) {
                    ...
                    if (value < 0) {
                        throw new ArgumentOutOfRangeException("ScrollChange", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "ScrollChange", (value).ToString("D", CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture)));
                    }
                    if (value > MaxScrollChange) {
                        throw new ArgumentOutOfRangeException("ScrollChange", DCSR.GetString(DCSR.InvalidHighBoundArgumentEx, "ScrollChange", (value).ToString("D", CultureInfo.CurrentCulture), (MaxScrollChange).ToString("D", CultureInfo.CurrentCulture)));
                    }

                    if (IsHandleCreated) {
                        SendMessage(WinFormNativeMethods.MCM_SETMONTHDELTA, value, 0);
                    }
                    scrollChange = value;
                }
            }
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.MonthCalendarSelectionEndDescr)
        ]
        public DateTime SelectionEnd {
            ...
            set {
                if (selectionEnd != value) {
                    ...
                    if (value < MinDate) {
                        throw new ArgumentOutOfRangeException("SelectionEnd", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "SelectionEnd", FormatDate(value), "MinDate"));
                    }
                    if (value > MaxDate) {
                        throw new ArgumentOutOfRangeException("SelectionEnd", DCSR.GetString(DCSR.InvalidHighBoundArgumentEx, "SelectionEnd", FormatDate(value), "MaxDate"));
                    }
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.MonthCalendarSelectionStartDescr)
        ]
        public DateTime SelectionStart {
            ...
            set {
                if (selectionStart != value) {
                    ...
                    //
                    if (value < minDate) {
                        throw new ArgumentOutOfRangeException("SelectionStart", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "SelectionStart", FormatDate(value), "MinDate"));
                    }
                    if (value > maxDate) {
                        throw new ArgumentOutOfRangeException("SelectionStart", DCSR.GetString(DCSR.InvalidHighBoundArgumentEx, "SelectionStart", FormatDate(value), "MaxDate"));
                    }
        ...
        [
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.MonthCalendarSelectionRangeDescr),
        Bindable(true)
        ]
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(true),
        SRDescription(DCSR.MonthCalendarShowTodayDescr)
        ]
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(true),
        SRDescription(DCSR.MonthCalendarShowTodayCircleDescr)
        ]
        ...
        Localizable(true),
        DefaultValue(false),
        SRDescription(DCSR.MonthCalendarShowWeekNumbersDescr)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.MonthCalendarSingleMonthSizeDescr)
        ]
        public Size SingleMonthSize {
            get {
                ...
                if (IsHandleCreated) {
                    ...
                    if (unchecked( (int) (long)SendMessage(WinFormNativeMethods.MCM_GETMINREQRECT, 0, ref rect)) == 0)
                        throw new InvalidOperationException(DCSR.GetString(DCSR.InvalidSingleMonthSize));
        ...
        [
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.MonthCalendarTodayDateDescr)
        ]
        public DateTime TodayDate {
            get {
                if (todayDateSet) return todayDate;
                if (IsHandleCreated) {
                    WinFormNativeMethods.SYSTEMTIME st = new WinFormNativeMethods.SYSTEMTIME();
                    int res = (int)WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.MCM_GETTODAY, 0, st);
            ...
            set {
                if (!(todayDateSet) || (DateTime.Compare(value, todayDate) != 0)) {
                    ...
                    if (DateTime.Compare(value, maxDate) > 0) {
                        throw new ArgumentOutOfRangeException("TodayDate", DCSR.GetString(DCSR.InvalidHighBoundArgumentEx, "TodayDate", FormatDate(value), FormatDate(maxDate)));
                    }

                    // throw if trying to set the TodayDate to a value less than MinDate
                    if (DateTime.Compare(value, minDate) < 0) {
                        throw new ArgumentOutOfRangeException("TodayDate", DCSR.GetString(DCSR.InvalidLowBoundArgument, "TodayDate", FormatDate(value), FormatDate(minDate)));
                    }
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.MonthCalendarTodayDateSetDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.MonthCalendarTitleBackColorDescr)
        ]
        public Color TitleBackColor {
            ...
            set {
                if (value.IsEmpty) {
                    throw new ArgumentException(DCSR.GetString(DCSR.InvalidNullArgument,
                                                              "value"));
                }
                titleBackColor = value;
                SetControlColor(WinFormNativeMethods.MCSC_TITLEBK, value);
            }
        }
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.MonthCalendarTitleForeColorDescr)
        ]
        public Color TitleForeColor {
            ...
            set {
                ...
                SetControlColor(WinFormNativeMethods.MCSC_TITLETEXT, value);
            }
        }
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.MonthCalendarTrailingForeColorDescr)
        ]
        public Color TrailingForeColor {
            ...
            set {
                ...
                SetControlColor(WinFormNativeMethods.MCSC_TRAILINGTEXT, value);
            }
        }
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.MonthCalendarOnDateChangedDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.MonthCalendarOnDateSelectedDescr)]
        ...
        protected override void CreateHandle() {
            if (!RecreatingHandle) {
                ...
                try {
                    ...
                    icc.dwICC = WinFormNativeMethods.ICC_DATE_CLASSES;
        ...
        public SelectionRange GetDisplayRange(bool visible) {
            if (visible)
                return GetMonthRange(WinFormNativeMethods.GMR_VISIBLE);
            else
                return GetMonthRange(WinFormNativeMethods.GMR_DAYSTATE);
        }
        ...
        private HitArea GetHitArea(int hit) {
            switch (hit) {
                case WinFormNativeMethods.MCHT_TITLEBK:
                    return HitArea.TitleBackground;
                case WinFormNativeMethods.MCHT_TITLEMONTH:
                    return HitArea.TitleMonth;
                case WinFormNativeMethods.MCHT_TITLEYEAR:
                    return HitArea.TitleYear;
                case WinFormNativeMethods.MCHT_TITLEBTNNEXT:
                    return HitArea.NextMonthButton;
                case WinFormNativeMethods.MCHT_TITLEBTNPREV:
                    return HitArea.PrevMonthButton;
                case WinFormNativeMethods.MCHT_CALENDARBK:
                    return HitArea.CalendarBackground;
                case WinFormNativeMethods.MCHT_CALENDARDATE:
                    return HitArea.Date;
                case WinFormNativeMethods.MCHT_CALENDARDATENEXT:
                    return HitArea.NextMonthDate;
                case WinFormNativeMethods.MCHT_CALENDARDATEPREV:
                    return HitArea.PrevMonthDate;
                case WinFormNativeMethods.MCHT_CALENDARDAY:
                    return HitArea.DayOfWeek;
                case WinFormNativeMethods.MCHT_CALENDARWEEKNUM:
                    return HitArea.WeekNumbers;
                case WinFormNativeMethods.MCHT_TODAYLINK:
        ...
        private Size GetMinReqRect(int newDimensionLength, bool updateRows, bool updateCols) {
            ...
            //
            if (IsHandleCreated) {
                int maxTodayWidth = unchecked( (int) (long)SendMessage(WinFormNativeMethods.MCM_GETMAXTODAYWIDTH, 0, 0));
        ...
        private SelectionRange GetMonthRange(int flag) {
            WinFormNativeMethods.SYSTEMTIMEARRAY sa = new WinFormNativeMethods.SYSTEMTIMEARRAY();
            SelectionRange range = new SelectionRange();
            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.MCM_GETMONTHRANGE, flag, sa);
        ...
        public HitTestInfo HitTest(int x, int y) {
            WinFormNativeMethods.MCHITTESTINFO mchi = new WinFormNativeMethods.MCHITTESTINFO();
            mchi.pt_x = x;
            mchi.pt_y = y;
            mchi.cbSize = Marshal.SizeOf(typeof(WinFormNativeMethods.MCHITTESTINFO));
            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.MCM_HITTEST, 0, mchi);
            ...
            if (HitTestInfo.HitAreaHasValidDateTime(hitArea)) {
                WinFormNativeMethods.SYSTEMTIME sys = new WinFormNativeMethods.SYSTEMTIME();
        ...
        protected override void OnHandleCreated(EventArgs e) {
            ...
            if (maxSelectionCount != DEFAULT_MAX_SELECTION_COUNT) {
                SendMessage(WinFormNativeMethods.MCM_SETMAXSELCOUNT, maxSelectionCount, 0);
            }
            AdjustSize();

            if (todayDateSet) {
                WinFormNativeMethods.SYSTEMTIME st = DateTimePicker.DateTimeToSysTime(todayDate);
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.MCM_SETTODAY, 0, st);
            }

            SetControlColor(WinFormNativeMethods.MCSC_TEXT, ForeColor);
            SetControlColor(WinFormNativeMethods.MCSC_MONTHBK, BackColor);
            SetControlColor(WinFormNativeMethods.MCSC_TITLEBK, titleBackColor);
            SetControlColor(WinFormNativeMethods.MCSC_TITLETEXT, titleForeColor);
            SetControlColor(WinFormNativeMethods.MCSC_TRAILINGTEXT, trailingForeColor);

            int firstDay;
            if (firstDayOfWeek == Day.Default) {
                firstDay = WinFormNativeMethods.LOCALE_IFIRSTDAYOFWEEK;
            }
            else {
                firstDay = (int)firstDayOfWeek;
            }
            SendMessage(WinFormNativeMethods.MCM_SETFIRSTDAYOFWEEK, 0, firstDay);

            SetRange();
            if (scrollChange != DEFAULT_SCROLL_CHANGE) {
                SendMessage(WinFormNativeMethods.MCM_SETMONTHDELTA, scrollChange, 0);
            }
        ...
        private void SetControlColor(int colorIndex, Color value) {
            if (IsHandleCreated) {
                SendMessage(WinFormNativeMethods.MCM_SETCOLOR, colorIndex, ColorTranslator.ToWin32(value));
            }
        }
        ...
        private void SetRange(DateTime minDate, DateTime maxDate) {
            ...
            if (IsHandleCreated) {
                ...
                WinFormNativeMethods.SYSTEMTIMEARRAY sa = new WinFormNativeMethods.SYSTEMTIMEARRAY();
                flag |= WinFormNativeMethods.GDTR_MIN | WinFormNativeMethods.GDTR_MAX;
                WinFormNativeMethods.SYSTEMTIME sys = DateTimePicker.DateTimeToSysTime(minDate);
                sa.wYear1 = sys.wYear;
                ...
                if ((int)WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.MCM_SETRANGE, flag, sa) == 0)
                    throw new InvalidOperationException(DCSR.GetString(DCSR.MonthCalendarRange, minDate.ToShortDateString(), maxDate.ToShortDateString()));
            }
        }
        ...
        public void SetCalendarDimensions(int x, int y) {
            if (x < 1) {
                throw new ArgumentOutOfRangeException("x", DCSR.GetString(DCSR.MonthCalendarInvalidDimensions, (x).ToString("D", CultureInfo.CurrentCulture), (y).ToString("D", CultureInfo.CurrentCulture)));
            }
            if (y < 1) {
                throw new ArgumentOutOfRangeException("y", DCSR.GetString(DCSR.MonthCalendarInvalidDimensions, (x).ToString("D", CultureInfo.CurrentCulture), (y).ToString("D", CultureInfo.CurrentCulture)));
            }
        ...
        public void SetDate(DateTime date) {
            ...
            if (date.Ticks < minDate.Ticks) {
                throw new ArgumentOutOfRangeException("date", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "date", FormatDate(date), "MinDate"));
            }
            if (date.Ticks > maxDate.Ticks) {
                throw new ArgumentOutOfRangeException("date", DCSR.GetString(DCSR.InvalidHighBoundArgumentEx, "date", FormatDate(date), "MaxDate"));
            }
        ...
        public void SetSelectionRange(DateTime date1, DateTime date2) {
            ...
            if (date1.Ticks < minDate.Ticks) {
                throw new ArgumentOutOfRangeException("date1", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "SelectionStart", FormatDate(date1), "MinDate"));
            }
            if (date1.Ticks > maxDate.Ticks) {
                throw new ArgumentOutOfRangeException("date1", DCSR.GetString(DCSR.InvalidHighBoundArgumentEx, "SelectionEnd", FormatDate(date1), "MaxDate"));
            }
            if (date2.Ticks < minDate.Ticks) {
                throw new ArgumentOutOfRangeException("date2", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "SelectionStart", FormatDate(date2), "MinDate"));
            }
            if (date2.Ticks > maxDate.Ticks) {
                throw new ArgumentOutOfRangeException("date2", DCSR.GetString(DCSR.InvalidHighBoundArgumentEx, "SelectionEnd", FormatDate(date2), "MaxDate"));
            }
        ...
        private void SetSelRange(DateTime lower, DateTime upper) {
            ...
            if (IsHandleCreated) {
                ...
                WinFormNativeMethods.SYSTEMTIME sys = DateTimePicker.DateTimeToSysTime(lower);
                sa.wYear1 = sys.wYear;
                sa.wMonth1 = sys.wMonth;
                sa.wDayOfWeek1 = sys.wDayOfWeek;
                sa.wDay1 = sys.wDay;
                ...
                sa.wDayOfWeek2 = sys.wDayOfWeek;
                sa.wDay2 = sys.wDay;
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.MCM_SETSELRANGE , 0, sa);
            }
        ...
        private void UpdateTodayDate() {
            if (IsHandleCreated) {
                WinFormNativeMethods.SYSTEMTIME st = null;
                if (todayDateSet) {
        ...
        private void WmDateChanged(ref Message m) {
            WinFormNativeMethods.NMSELCHANGE nmmcsc = (WinFormNativeMethods.NMSELCHANGE)m.GetLParam(typeof(WinFormNativeMethods.NMSELCHANGE));
        ...
        private void WmDateBold(ref Message m) {
            WinFormNativeMethods.NMDAYSTATE nmmcds = (WinFormNativeMethods.NMDAYSTATE)m.GetLParam(typeof(WinFormNativeMethods.NMDAYSTATE));
        ...
        private void WmGetDlgCode(ref Message m) {
            ...
            m.Result = (IntPtr)WinFormNativeMethods.DLGC_WANTARROWS;
        }
        ...
        private void WmReflectCommand(ref Message m) {
            if (m.HWnd == Handle) {
                ...
                switch (nmhdr.code) {
                    case WinFormNativeMethods.MCN_SELECT:
                        WmDateSelected(ref m);
                        break;
                    case WinFormNativeMethods.MCN_SELCHANGE:
                        WmDateChanged(ref m);
                        break;
                    case WinFormNativeMethods.MCN_GETDAYSTATE:
                        WmDateBold(ref m);
                        break;
                }
            }
