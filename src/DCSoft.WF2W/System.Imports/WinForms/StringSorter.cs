...
namespace System.Windows.Forms {
    ...
    internal sealed class StringSorter
    {
        ...
        private StringSorter(CultureInfo culture, string[] keys, object[] items, int options) {
            ...
            this.keys = keys;
            this.items = items;
            this.lcid = culture == null? WinFormSafeNativeMethods.GetThreadLocale(): culture.LCID;
        ...
        public static int Compare(string s1, string s2) {
            return Compare(WinFormSafeNativeMethods.GetThreadLocale(), s1, s2, 0);
        }
        ...
        public static int Compare(string s1, string s2, int options) {
            return Compare(WinFormSafeNativeMethods.GetThreadLocale(), s1, s2, options);
        }
        ...
        public static void Sort(CultureInfo culture, string[] keys, object[] items, int index, int count, int options) {
            ...
            if ((items == null)
                ...
                throw new ArgumentException(DCSR.GetString(DCSR.ArraysNotSameSize,
                                                                   "keys",
                                                                   "items"));
            if (count > 1) {
