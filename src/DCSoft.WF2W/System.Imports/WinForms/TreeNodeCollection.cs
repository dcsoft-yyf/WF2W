    ...
    public class TreeNodeCollection : IList {
        ...
        object IList.this[int index] {
            ...
            set {
                if (value is TreeNode) {
                    ...
                    throw new ArgumentException(DCSR.GetString(DCSR.TreeNodeCollectionBadTreeNode), "value");
                }
            }
        }
        ...
        private int AddInternal(TreeNode node, int delta) {
            ...
            if (node.handle != IntPtr.Zero)
                throw new ArgumentException(DCSR.GetString(DCSR.OnlyOneControl, node.Text), "node");
        ...
        void IList.Insert(int index, object node) {
            if (node is TreeNode) {
                ...
                throw new ArgumentException(DCSR.GetString(DCSR.TreeNodeCollectionBadTreeNode), "node");
            }
        }
