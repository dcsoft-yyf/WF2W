...
namespace System.Windows.Forms{
    ...
    public abstract class DataGridColumnStyle : Component, IDataGridColumnStyleEditingNotificationService {
        ...
        private string       nullText            = DCSR.GetString(DCSR.DataGridNullText);
...
*/
	...
	private void ResetNullText() {
		NullText = DCSR.GetString(DCSR.DataGridNullText);
	}
		

        private bool ShouldSerializeNullText() {
            return (!DCSR.GetString(DCSR.DataGridNullText).Equals(nullText));
        }
        ...
        protected internal virtual object GetColumnValueAtRow(CurrencyManager source, int rowNum) {
            ...
            if (PropertyDescriptor == null) {
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridColumnNoPropertyDescriptor));
            }
        ...
        protected void CheckValidDataSource(CurrencyManager value) {
            ...
            if (myPropDesc == null) {
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridColumnUnbound, HeaderText));
            }
        ...
        protected internal virtual void SetColumnValueAtRow(CurrencyManager source, int rowNum, object value) {
            ...
            if (source.Position != rowNum)
                throw new ArgumentException(DCSR.GetString(DCSR.DataGridColumnListManagerPosition), "rowNum");
