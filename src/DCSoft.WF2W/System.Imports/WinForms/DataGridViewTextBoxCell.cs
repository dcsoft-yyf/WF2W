    ...
    public class DataGridViewTextBoxCell : DataGridViewCell
    {
        ...
        public virtual int MaxInputLength
        {
            ...
            set
            {
                ...
                if (value < 0)
                {
                    throw new ArgumentOutOfRangeException("MaxInputLength", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "MaxInputLength", value.ToString(CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture)));
                }
