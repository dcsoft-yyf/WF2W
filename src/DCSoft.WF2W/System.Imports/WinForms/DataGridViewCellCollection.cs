    ...
    public class DataGridViewCellCollection : BaseCollection, IList
    {
        ...
        public DataGridViewCell this[int index]
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewCellCollection_CellAlreadyBelongsToDataGridView));
                }
                if (dataGridViewCell.OwningRow != null)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewCellCollection_CellAlreadyBelongsToDataGridViewRow));
                }
        ...
        public DataGridViewCell this[string columnName]
        {
            get
            {
                ...
                {
                    throw new ArgumentException(DCSR.GetString(DCSR.DataGridViewColumnCollection_ColumnNotFound, columnName), "columnName");
                }
        ...
        public virtual int Add(DataGridViewCell dataGridViewCell)
        {
            if (this.owner.DataGridView != null)
            {
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewCellCollection_OwningRowAlreadyBelongsToDataGridView));
            }
            if (dataGridViewCell.OwningRow != null)
            {
                throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewCellCollection_CellAlreadyBelongsToDataGridViewRow));
        ...
        public virtual void AddRange(params DataGridViewCell[] dataGridViewCells)
        {
            ...
            foreach (DataGridViewCell dataGridViewCell in dataGridViewCells)
            {
                if (dataGridViewCell == null)
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewCellCollection_AtLeastOneCellIsNull));
                }
            ...
            for (int cell1 = 0; cell1 < cellCount - 1; cell1++)
            {
                for (int cell2 = cell1 + 1; cell2 < cellCount; cell2++)
                {
                    ...
                    {
                        throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewCellCollection_CannotAddIdenticalCells));
                    }
                }
            }
        ...
        public virtual void Remove(DataGridViewCell cell)
        {
            ...
            if (cellIndex == -1)
            {
                throw new ArgumentException(DCSR.GetString(DCSR.DataGridViewCellCollection_CellNotFound));
            }
            else
            {
                RemoveAt(cellIndex);
