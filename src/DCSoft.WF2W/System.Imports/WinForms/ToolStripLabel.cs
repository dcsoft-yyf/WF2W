...
namespace System.Windows.Forms {
    ...
    public class ToolStripLabel : ToolStripItem {
        ...
        SRDescription(DCSR.ToolStripLabelIsLinkDescr)
        ]
        public bool IsLink {
          get {
              return isLink;
        ...
        SRDescription(DCSR.ToolStripLabelActiveLinkColorDescr)
        ]
        ...
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.ToolStripLabelLinkBehaviorDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripLabelLinkColorDescr)
        ]
        ...
        DefaultValue(false),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripLabelLinkVisitedDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripLabelVisitedLinkColorDescr)
        ]
       ...
       private bool ShouldSerializeVisitedLinkColor() {
        ...
        internal class ToolStripLabelAccessibleObject : ToolStripItemAccessibleObject {
            ...
            public override string DefaultAction {
                get {
                    if (ownerItem.IsLink) {
                        return DCSR.GetString(DCSR.AccessibleActionClick);
                    }
                    else {
                        return string.Empty;
                    }
