...
namespace System.Windows.Forms {
    ...
    public class ToolStripStatusLabel : ToolStripLabel {
        ...
        SRDescription(DCSR.ToolStripStatusLabelBorderStyleDescr),
        ...
        SRDescription(DCSR.ToolStripStatusLabelBorderSidesDescr),
        SRCategory(DCSR.CatAppearance)
        ]
        ...
        [
        DefaultValue(false),
        SRDescription(DCSR.ToolStripStatusLabelSpringDescr),
        SRCategory(DCSR.CatAppearance)
        ]
        ...
        public bool Spring {
            ...
            set {
                if (spring != value) {
                   ...
                   this.LogWF2WPropertyValue("Spring", value);
                }
            }
        }
