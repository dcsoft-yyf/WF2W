...
namespace System.Windows.Forms {
    ...
    internal class StringSource : IEnumString {
        ...
        private int current;
        private int size;
        private WinFormUnsafeNativeMethods.IAutoComplete2 autoCompleteObject2;
        ...
        public StringSource(string[] strings) {
            ...
            Guid iid_iunknown = typeof(WinFormUnsafeNativeMethods.IAutoComplete2).GUID;
            object obj = WinFormUnsafeNativeMethods.CoCreateInstance(ref autoCompleteClsid, null, WinFormNativeMethods.CLSCTX_INPROC_SERVER, ref iid_iunknown);

            autoCompleteObject2 = (WinFormUnsafeNativeMethods.IAutoComplete2)obj;
        }
