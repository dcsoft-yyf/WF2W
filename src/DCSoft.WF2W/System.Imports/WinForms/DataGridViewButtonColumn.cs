    ...
    public class DataGridViewButtonColumn : DataGridViewColumn
    {
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidCastException(DCSR.GetString(DCSR.DataGridViewTypeColumn_WrongCellTemplateType, "System.Windows.Forms.DataGridViewButtonCell"));
                }
        ...
        [
            ...
            SRCategory(DCSR.CatAppearance),
            SRDescription(DCSR.DataGridView_ButtonColumnFlatStyleDescr)
        ]
        ...
        [
            DefaultValue(null),
            SRCategory(DCSR.CatAppearance),
            SRDescription(DCSR.DataGridView_ButtonColumnTextDescr)
        ]
        public string Text
        {
            get
        ...
        [
            DefaultValue(false),
            SRCategory(DCSR.CatAppearance),
            SRDescription(DCSR.DataGridView_ButtonColumnUseColumnTextForButtonValueDescr)
        ]
