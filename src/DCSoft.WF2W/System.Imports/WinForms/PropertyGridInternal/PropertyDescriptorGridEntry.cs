    ...
    internal class PropertyDescriptorGridEntry : GridEntry {
        ...
        internal override bool NotifyValueGivenParent(object obj, int type) {
            ...
            switch (type) {
                case NOTIFY_RESET:
                    ...
                    SetPropertyValue(obj, null, true, DCSR.GetString(DCSR.PropertyGridResetValue, this.PropertyName));
                    if (pvUIItems != null) {
                        for (int i = 0; i < pvUIItems.Length; i++) {
                            pvUIItems[i].Reset();
                        }
        ...
        private object SetPropertyValue(object obj,object objVal, bool reset, string undoText) {
            ...
            try
            {
                ...
                if (host != null)
                {
                    string text = (undoText == null ? DCSR.GetString(DCSR.PropertyGridSetValue, propertyInfo.Name) : undoText);
        ...
        protected bool ViewEvent(object obj, string newHandler, EventDescriptor eventdesc, bool alwaysNavigate) {
            ...
            try {
                ...
                if (host != null) {
                    ...
                    trans = DesignerHost.CreateTransaction(DCSR.GetString(DCSR.WindowsFormsSetEvent, compName + "." + this.PropertyName));
                }
            ...
            public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value) {
                ...
                if (except != null) {
                    ...
                    if (uis != null) {
                        ...
                        RTLAwareMessageBox.Show(null, message, DCSR.GetString(DCSR.PropertyGridExceptionInfo),
