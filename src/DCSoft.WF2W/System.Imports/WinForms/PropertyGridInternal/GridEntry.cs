...
namespace System.Windows.Forms.PropertyGridInternal {
    ...
    internal abstract class GridEntry : GridItem, ITypeDescriptorContext {
        ...
        public override GridItemCollection GridItems {
            get {
                if (Disposed) {
                    throw new ObjectDisposedException(DCSR.GetString(DCSR.GridItemDisposed));
                }
        ...
        internal virtual void EditPropertyValue(PropertyGridView iva) {
            if (UITypeEditor != null) {
                ...
                catch (Exception e)
                {
                    ...
                    {
                        RTLAwareMessageBox.Show(GridEntryHost, e.Message, DCSR.GetString(DCSR.PBRSErrorTitle), MessageBoxButtons.OK,
        ...
        protected virtual GridEntry[] GetPropEntries(GridEntry peParent, object obj, Type objType) {
            ...
            catch (Exception e)
            {
                ...
                if (PbrsAssertPropsSwitch.Enabled) {
                    ...
                    w.Close();
                    s.Close();
                    RTLAwareMessageBox.Show(null, b.ToString(), DCSR.GetString(DCSR.PropertyGridInternalNoProp, path),
        ...
        */
        ...
        public virtual void PaintValue(object val, System.Drawing.Graphics g, Rectangle rect, Rectangle clipRect, PaintValueFlags paintFlags) { 
            ...
            if (strValue != null && strValue.Length > 0) {
                ...
                try {
                    oldTextColor = WinFormSafeNativeMethods.SetTextColor(new HandleRef(g, hdc), WinFormSafeNativeMethods.RGBToCOLORREF(textColor.ToArgb()));
                    oldBkColor = WinFormSafeNativeMethods.SetBkColor(new HandleRef(g, hdc), WinFormSafeNativeMethods.RGBToCOLORREF(bkColor.ToArgb()));
                    hfont = WinFormSafeNativeMethods.SelectObject(new HandleRef(g, hdc), new HandleRef(null, hfont));
                    ...
                    WinFormSafeNativeMethods.SetTextColor(new HandleRef(g, hdc), oldTextColor);
                    WinFormSafeNativeMethods.SetBkColor(new HandleRef(g, hdc), oldBkColor);
                    hfont = WinFormSafeNativeMethods.SelectObject(new HandleRef(g, hdc), new HandleRef(null, hfont));
            ...
            public override string DefaultAction {
                get {
                    if (!owner.Expandable) {
                        ...
                        return DCSR.GetString(DCSR.AccessibleActionCollapse);
                    }
                    else {
                        return DCSR.GetString(DCSR.AccessibleActionExpand);
                    }
                }
            }
