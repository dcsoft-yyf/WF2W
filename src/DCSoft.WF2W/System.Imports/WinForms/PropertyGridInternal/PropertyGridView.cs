    ...
    IServiceProvider {
        ...
        public bool CanUndo {
            get {
                ...
                return (0 != (int)Edit.SendMessage(WinFormNativeMethods.EM_CANUNDO, 0, 0));
            }
        }
        ...
        internal bool DrawValuesRightToLeft {
            get {
                if (edit != null && edit.IsHandleCreated) {
                    int exStyle = unchecked((int)((long)WinFormUnsafeNativeMethods.GetWindowLong(new HandleRef(edit, edit.Handle), WinFormNativeMethods.GWL_EXSTYLE)));
                    return ((exStyle & WinFormNativeMethods.WS_EX_RTLREADING) != 0);
                }
                else {
                    return false;
                }
        ...
        internal GridEntry SelectedGridEntry {
            ...
            set {
                ...
                throw new ArgumentException(DCSR.GetString(DCSR.PropertyGridInvalidGridEntry));
            }
        }
        ...
        */
        ...
        internal Rectangle AccessibilityGetGridEntryBounds(GridEntry gridEntry) {
            ...
            //
            WinFormNativeMethods.POINT pt = new WinFormNativeMethods.POINT(rect.X, rect.Y);
            WinFormUnsafeNativeMethods.ClientToScreen(new HandleRef(this, Handle), pt);
        ...
        private void CommonEditorHide(bool always) {
            ...
            if (Edit.Focused || DialogButton.Focused || DropDownButton.Focused) {
                ...
                if (IsHandleCreated && Visible && Enabled) {
                    ...
                    gotfocus = IntPtr.Zero != WinFormUnsafeNativeMethods.SetFocus(new HandleRef(this, Handle));
                }
            }
        ...
        public void DoUndoCommand() {
            if (this.CanUndo && Edit.Visible) {
               Edit.SendMessage(WinFormNativeMethods.WM_UNDO, 0, 0);
            }
        }
        ...
        internal bool IsExplorerTreeSupported {
            get {
                if (ownerGrid.CanShowVisualStyleGlyphs && WinFormUnsafeNativeMethods.IsVista && VisualStyleRenderer.IsSupported) {
                    return true;
                }
        ...
        public void /* cpr IWindowsFormsEditorService. */ DropDownControl(Control ctl) {
            ...
            WinFormUnsafeNativeMethods.SetWindowLong(new HandleRef(dropDownHolder, dropDownHolder.Handle), WinFormNativeMethods.GWL_HWNDPARENT, new HandleRef(this, Handle));
            dropDownHolder.SetBounds(loc.X,loc.Y,size.Width,size.Height);
            WinFormSafeNativeMethods.ShowWindow(new HandleRef(dropDownHolder, dropDownHolder.Handle), WinFormNativeMethods.SW_SHOWNA);
            Edit.Filter = true;
        ...
        private bool FilterEditWndProc(ref Message m) {
            ...
            if (dropDownHolder != null && dropDownHolder.Visible && m.Msg == WinFormNativeMethods.WM_KEYDOWN && (int)m.WParam != (int)Keys.Tab) {
...
*/
        ...
        private void OnEditLostFocus(object sender, EventArgs e) {
            ...
            if (dropDownHolder != null && dropDownHolder.Visible) {
                bool found = false;
                for (IntPtr hwnd = WinFormUnsafeNativeMethods.GetForegroundWindow();
                    hwnd != IntPtr.Zero; hwnd = WinFormUnsafeNativeMethods.GetParent(new HandleRef(null, hwnd))) {
        ...
        private void OnEditMouseDown(object sender, MouseEventArgs me) {
            ...
            if (delta < SystemInformation.DoubleClickTime) {
                ...
                if (Math.Abs(screenPoint.X - rowSelectPos.X) < SystemInformation.DoubleClickSize.Width &&
                    ...
                    DoubleClickRow(selectedRow,false, ROWVALUE);
                    Edit.SendMessage(WinFormNativeMethods.WM_LBUTTONUP, 0, (int)(me.Y << 16 | (me.X & 0xFFFF)));
                    Edit.SelectAll();                
                }
        ...
        protected override void OnMouseMove(MouseEventArgs me) {
            ...
            if ((rowMoveCur != this.TipRow || pt.X != this.TipColumn)  && !GetFlag(FlagIsSplitterMove)) {
                ...
                IntPtr  foregroundWindow = WinFormUnsafeNativeMethods.GetForegroundWindow();
                if (WinFormUnsafeNativeMethods.IsChild(new HandleRef(null, foregroundWindow), new HandleRef(null, this.Handle))) {
        ...
        protected override void OnMouseWheel(MouseEventArgs me) {
            ...
            Debug.Assert(this.cumulativeVerticalWheelDelta > -WinFormNativeMethods.WHEEL_DELTA, "cumulativeVerticalWheelDelta is too small");
            Debug.Assert(this.cumulativeVerticalWheelDelta < WinFormNativeMethods.WHEEL_DELTA, "cumulativeVerticalWheelDelta is too big");
            ...
            float partialNotches = (float)cumulativeVerticalWheelDelta / (float)WinFormNativeMethods.WHEEL_DELTA;
            ...
            int large = fullNotches * this.scrollBar.LargeChange;
                    ...
                    if (Math.Abs(initialOffset - originalOffset) >= Math.Abs(fullNotches * this.scrollBar.LargeChange)) {
                        this.cumulativeVerticalWheelDelta -= fullNotches * WinFormNativeMethods.WHEEL_DELTA;
                    }
                    else {
                 ...
                 if (scrollBands != 0) {
                    ...
                    if (scrollBands > 0) {
                        ...
                        if (this.scrollBar.Value <= this.scrollBar.Minimum) {
                            ...
                            this.cumulativeVerticalWheelDelta -= (int)((float)scrollBands  * ((float)WinFormNativeMethods.WHEEL_DELTA / (float)wheelScrollLines));
                        }
                    }
                    else {
        ...
        private void OnGridEntryValueClick(object s, EventArgs e) {
            ...
            if (lastMouseDown != InvalidPosition) {
               ...
               Edit.SendMessage(WinFormNativeMethods.WM_LBUTTONDOWN, 0, (int)(editPoint.Y << 16 | (editPoint.X & 0xFFFF))); 
               Edit.SendMessage(WinFormNativeMethods.WM_LBUTTONUP, 0, (int)(editPoint.Y << 16 | (editPoint.X & 0xFFFF))); 
            }
        ...
        private void ClearCachedFontInfo() {
            if (baseHfont != IntPtr.Zero) {
                WinFormSafeNativeMethods.ExternalDeleteObject(new HandleRef(this, baseHfont));
                baseHfont = IntPtr.Zero;
            }
            if (boldHfont != IntPtr.Zero) {
                WinFormSafeNativeMethods.ExternalDeleteObject(new HandleRef(this, boldHfont));
        ...
        public virtual void PopupDialog(int row) {
            ...
            if (gridEntry != null) {
                ...
                if (fEnum && !fBtnDropDown) {
                    ...
                    //
                    IntPtr hdc = WinFormUnsafeNativeMethods.GetDC(new HandleRef(DropDownListBox, DropDownListBox.Handle));
                    IntPtr hFont = Font.ToHfont();
                    System.Internal.HandleCollector.Add(hFont, WinFormNativeMethods.CommonHandles.GDI);
                    WinFormNativeMethods.TEXTMETRIC tm = new WinFormNativeMethods.TEXTMETRIC();
                    int iSel = -1;
                    try {
                        hFont = WinFormSafeNativeMethods.SelectObject(new HandleRef(DropDownListBox, hdc), new HandleRef(Font, hFont));
                        ...
                        WinFormSafeNativeMethods.GetTextMetrics(new HandleRef(DropDownListBox, hdc), ref tm);
                        ...
                        WinFormSafeNativeMethods.DeleteObject(new HandleRef(Font, hFont));
                        WinFormUnsafeNativeMethods.ReleaseDC(new HandleRef(DropDownListBox, DropDownListBox.Handle), new HandleRef(DropDownListBox, hdc));
                    }
        ...
        internal static void PositionTooltip(Control parent, GridToolTip ToolTip, Rectangle itemRect) {
            ...
            WinFormNativeMethods.RECT rect = WinFormNativeMethods.RECT.FromXYWH(itemRect.X, itemRect.Y, itemRect.Width, itemRect.Height);

            ToolTip.SendMessage(WinFormNativeMethods.TTM_ADJUSTRECT, 1, ref rect);
            ...
            if (HasEntries) {
                ...
                switch (keyCode) {
                    ...
                    case Keys.Tab:
                        ...
                        Control focusedControl = Control.FromHandleInternal(WinFormUnsafeNativeMethods.GetFocus());

                        if (focusedControl == null || !IsMyChild(focusedControl)) {
                            if (forward) {
                                TabSelection();
                                focusedControl = Control.FromHandleInternal(WinFormUnsafeNativeMethods.GetFocus());
        ...
        public DialogResult /* IWindowsFormsEditorService. */ ShowDialog(Form dialog) {
            ...
            //IntPtr priorFocus = WinFormUnsafeNativeMethods.GetFocus();
            ...
            //    WinFormUnsafeNativeMethods.SetFocus(new HandleRef(null, priorFocus));
            //}
        ...
        private void ShowFormatExceptionMessage(string propName, object value, Exception ex)
        {
            ...
            WinFormNativeMethods.MSG mouseMsg = new WinFormNativeMethods.MSG();
            while (WinFormUnsafeNativeMethods.PeekMessage(ref mouseMsg,
                                                   WinFormNativeMethods.NullHandleRef,
                                                   WinFormNativeMethods.WM_MOUSEFIRST,
                                                   WinFormNativeMethods.WM_MOUSELAST,
            ...
            ErrorDialog.Message = DCSR.GetString(DCSR.PBRSFormatExceptionMessage);
            ErrorDialog.Text = DCSR.GetString(DCSR.PBRSErrorTitle);
        ...
        private void ShowInvalidMessage(string propName, object value, Exception ex) {
            ...
            ErrorDialog.Message = DCSR.GetString(DCSR.PBRSErrorInvalidPropertyValue);
            ErrorDialog.Text = DCSR.GetString(DCSR.PBRSErrorTitle);
            ErrorDialog.Details = exMessage;
        ...
        private unsafe bool WmNotify(ref Message m) {
            if (m.LParam != IntPtr.Zero) {
                ...
                if (nmhdr->hwndFrom == ToolTip.Handle) {
                    switch (nmhdr->code) {
                        case WinFormNativeMethods.TTN_POP:
                            break;
        ...
        protected override async Task WndProc(Message m) {
            switch (m.Msg) {
                ...
                case WinFormNativeMethods.WM_IME_STARTCOMPOSITION:
                    Edit.FocusInternal();
                    Edit.Clear();
                    WinFormUnsafeNativeMethods.PostMessage(new HandleRef(Edit, Edit.Handle), WinFormNativeMethods.WM_IME_STARTCOMPOSITION, 0, 0); 
                    return;
                    
                case WinFormNativeMethods.WM_IME_COMPOSITION:
                    Edit.FocusInternal();
                    WinFormUnsafeNativeMethods.PostMessage(new HandleRef(Edit, Edit.Handle), WinFormNativeMethods.WM_IME_COMPOSITION, m.WParam, m.LParam);
                    return;
                    
            case WinFormNativeMethods.WM_GETDLGCODE:

                    int flags = WinFormNativeMethods.DLGC_WANTCHARS |  WinFormNativeMethods.DLGC_WANTARROWS;
                    ...
                    if (selectedGridEntry != null) {
                        if ((ModifierKeys & Keys.Shift) == 0) {
                            ...
                            //
                            if (edit.Visible) {
                                flags |= WinFormNativeMethods.DLGC_WANTTAB;
                            }
                        }
                    }
        ...
        private class DropDownHolder : Form, IMouseHookClient {
            ...
            protected override CreateParams CreateParams {
                get {
                    ...
                    cp.Style |= WinFormNativeMethods.WS_POPUP | WinFormNativeMethods.WS_BORDER;
                    if (OSFeature.IsPresent(SystemParameter.DropShadow)) {
                        cp.ClassStyle |= WinFormNativeMethods.CS_DROPSHADOW;
                    }
                    if (gridView != null) {
            ...
            public void DoModalLoop() {
                ...
                while (this.Visible) {
                    ...
                    WinFormUnsafeNativeMethods.MsgWaitForMultipleObjectsEx(0, IntPtr.Zero, 250, WinFormNativeMethods.QS_ALLINPUT, WinFormNativeMethods.MWMO_INPUTAVAILABLE);
                }
            }
            ...
            private bool OwnsWindow(IntPtr hWnd) {
                while (hWnd != IntPtr.Zero) {
                    hWnd = WinFormUnsafeNativeMethods.GetWindowLong(new HandleRef(null, hWnd), WinFormNativeMethods.GWL_HWNDPARENT);
                    if (hWnd == IntPtr.Zero) {
                        return false;
                    }
                    if (hWnd == this.Handle) {
                    ...
                    if (createType != null) {
                        ...
                        if (newValue != null) {
                            ...
                            if (!createType.IsInstanceOfType(newValue)) {
                                throw new InvalidCastException(DCSR.GetString(DCSR.PropertyGridViewEditorCreatedInvalidObject, createType));
                            }
           ...
           protected override bool ProcessDialogKey(Keys keyData) {
            ...
            protected override async Task WndProc( Message m) {
                ...
                if (m.Msg == WinFormNativeMethods.WM_ACTIVATE) {
                    ...
                    if (Visible && WinFormNativeMethods.Util.LOWORD(m.WParam) == WinFormNativeMethods.WA_INACTIVE && !this.OwnsWindow(activatedWindow)) {
                        gridView.CloseDropDownInternal(false);
                        return;
                    }
        ...
        private class GridViewEdit : TextBox , IMouseHookClient {
            ...
            public void FilterKeyPress(char keyChar) {
                ...
                if (IsInputChar(keyChar)) {
                    this.FocusInternal();
                    this.SelectAll();
                    WinFormUnsafeNativeMethods.PostMessage(new HandleRef(this, Handle), WinFormNativeMethods.WM_CHAR, (IntPtr)keyChar, IntPtr.Zero);
                }
            }
            ...
            protected override async Task WndProc(Message m) {
                ...
                switch (m.Msg) {
                    case WinFormNativeMethods.WM_STYLECHANGED:
                        if ((unchecked( (int) (long)m.WParam) & WinFormNativeMethods.GWL_EXSTYLE) != 0) {
                            psheet.Invalidate();
                        }
                        break;
                    case WinFormNativeMethods.WM_MOUSEMOVE:
                    ...
                    case WinFormNativeMethods.WM_SHOWWINDOW:
                        ...
                        break;
                    case WinFormNativeMethods.WM_PASTE:
                        /*if (!this.ReadOnly) {
                    ...
                    case WinFormNativeMethods.WM_GETDLGCODE:
                        ...
                        m.Result = (IntPtr)((long)m.Result | WinFormNativeMethods.DLGC_WANTARROWS | WinFormNativeMethods.DLGC_WANTCHARS);
                        if (psheet.NeedsCommit || this.WantsTab((ModifierKeys & Keys.Shift) == 0)) {
                            m.Result = (IntPtr)((long)m.Result | WinFormNativeMethods.DLGC_WANTALLKEYS | WinFormNativeMethods.DLGC_WANTTAB);
                        }
                        return;
        ...
        internal class MouseHook {
            ...
            private void HookMouse() {
                ...
                lock(this) {
                    ...
                    if (thisProcessID == 0) {
                        WinFormSafeNativeMethods.GetWindowThreadProcessId(new HandleRef(control, control.Handle), out thisProcessID);
                    }
                  
                    
                    WinFormNativeMethods.HookProc hook = new WinFormNativeMethods.HookProc(new MouseHookObject(this).Callback);
                    mouseHookRoot = GCHandle.Alloc(hook);

                    mouseHookHandle = WinFormUnsafeNativeMethods.SetWindowsHookEx(WinFormNativeMethods.WH_MOUSE,
                                                               hook,
                                                               WinFormNativeMethods.NullHandleRef,
                                                               WinFormSafeNativeMethods.GetCurrentThreadId());
            ...
            private IntPtr MouseHookProc(int nCode, IntPtr wparam, IntPtr lparam) {
                GC.KeepAlive(this);
                if (nCode == WinFormNativeMethods.HC_ACTION) {
                    WinFormNativeMethods.MOUSEHOOKSTRUCT mhs = (WinFormNativeMethods.MOUSEHOOKSTRUCT)WinFormUnsafeNativeMethods.PtrToStructure(lparam, typeof(WinFormNativeMethods.MOUSEHOOKSTRUCT));
                    if (mhs != null) {
                ...
                return WinFormUnsafeNativeMethods.CallNextHookEx(new HandleRef(this, mouseHookHandle), nCode, wparam, lparam);
            }
            ...
            private void UnhookMouse() {
                ...
                lock(this) {
                    if (mouseHookHandle != IntPtr.Zero) {
                        WinFormUnsafeNativeMethods.UnhookWindowsHookEx(new HandleRef(this, mouseHookHandle));
                        mouseHookRoot.Free();
            ...
            private bool ProcessMouseDown(IntPtr hWnd, int x, int y) {
               ...
               if (processing) {
                ...
                if (hWndAtPoint != handle && !control.Contains(ctrlAtPoint)) {
                    ...
                    int pid;
                    WinFormSafeNativeMethods.GetWindowThreadProcessId(new HandleRef(null, hWndAtPoint), out pid);
        ...
        internal class PropertyGridViewAccessibleObject : ControlAccessibleObject {
            ...
            public override string Name {
                get {
                    ...
                    if (name != null) {
                        ...
                        return DCSR.GetString(DCSR.PropertyGridDefaultAccessibleName);
                    }
                }
            }
            ...
            public override AccessibleObject HitTest(int x, int y) {
                ...
                WinFormUnsafeNativeMethods.ScreenToClient(new HandleRef(Owner, Owner.Handle), pt);
