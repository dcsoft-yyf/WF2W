...
namespace System.Windows.Forms {
    ...
    SRDescription(DCSR.DescriptionHelpProvider)
    ]
    public class HelpProvider : Component, IExtenderProvider {
        ...
        SRDescription(DCSR.HelpProviderHelpNamespaceDescr)
        ]
        ...
        DefaultValue(null),
        Localizable(true),
        SRDescription(DCSR.HelpProviderHelpKeywordDescr)
        ]
        ...
        Localizable(true),
        SRDescription(DCSR.HelpProviderNavigatorDescr)
        ]
        ...
        DefaultValue(null),
        Localizable(true),
        SRDescription(DCSR.HelpProviderHelpStringDescr)
        ]
        ...
        [
        Localizable(true),
        SRDescription(DCSR.HelpProviderShowHelpDescr)
        ]
