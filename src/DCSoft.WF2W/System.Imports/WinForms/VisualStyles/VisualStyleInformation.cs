    ...
    public static class VisualStyleInformation {
        ...
        public static bool IsEnabledByUser {
            get {
                ...
                return (WinFormSafeNativeMethods.IsAppThemed());
            }
        }
        ...
        internal static string ThemeFilename {
            get {
                if (IsEnabledByUser) {
                    ...
                    WinFormSafeNativeMethods.GetCurrentThemeName(filename, filename.Capacity, null, 0, null, 0); 
        ...
        public static string ColorScheme {
            get {
                if (IsEnabledByUser) {
                    ...
                    WinFormSafeNativeMethods.GetCurrentThemeName(null, 0, colorScheme, colorScheme.Capacity, null, 0); 
        ...
        public static string Size {
            get {
                if (IsEnabledByUser) {
                    ...
                    WinFormSafeNativeMethods.GetCurrentThemeName(null, 0, null, 0, size, size.Capacity); 
        ...
        public static string DisplayName {
            get {
                if (IsEnabledByUser) {
                    ...
                    WinFormSafeNativeMethods.GetThemeDocumentationProperty(ThemeFilename, VisualStyleDocProperty.DisplayName, name, name.Capacity);
        ...
        public static string Company {
            get {
                if (IsEnabledByUser) {
                    ...
                    WinFormSafeNativeMethods.GetThemeDocumentationProperty(ThemeFilename, VisualStyleDocProperty.Company, company, company.Capacity);
        ...
        public static string Author {
            get {
                if (IsEnabledByUser) {
                    ...
                    WinFormSafeNativeMethods.GetThemeDocumentationProperty(ThemeFilename, VisualStyleDocProperty.Author, author, author.Capacity);
        ...
        public static string Copyright {
            get {
                if (IsEnabledByUser) {
                    ...
                    WinFormSafeNativeMethods.GetThemeDocumentationProperty(ThemeFilename, VisualStyleDocProperty.Copyright, copyright, copyright.Capacity);
        ...
        public static string Url {
            ...
            get {
                if (IsEnabledByUser) {
                    ...
                    WinFormSafeNativeMethods.GetThemeDocumentationProperty(ThemeFilename, VisualStyleDocProperty.Url, url, url.Capacity);
                    return url.ToString();
                }
        ...
        public static string Version {
            get {
                if (IsEnabledByUser) {
                    ...
                    WinFormSafeNativeMethods.GetThemeDocumentationProperty(ThemeFilename, VisualStyleDocProperty.Version, version, version.Capacity);
        ...
        public static string Description {
            get {
                if (IsEnabledByUser) {
                    ...
                    WinFormSafeNativeMethods.GetThemeDocumentationProperty(ThemeFilename, VisualStyleDocProperty.Description, description, description.Capacity);
        ...
        public static bool SupportsFlatMenus {
            get {
                if (Application.RenderWithVisualStyles) {
                    ...
                    return (WinFormSafeNativeMethods.GetThemeSysBool(new HandleRef(null, visualStyleRenderer.Handle), VisualStyleSystemProperty.SupportsFlatMenus));
                }
        ...
        public static int MinimumColorDepth {
            get {
                if (Application.RenderWithVisualStyles) {
                    ...
                    WinFormSafeNativeMethods.GetThemeSysInt(new HandleRef(null, visualStyleRenderer.Handle), VisualStyleSystemProperty.MinimumColorDepth, ref mcDepth);
                    return mcDepth;
                }
