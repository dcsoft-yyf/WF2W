...
namespace System.Windows.Forms.ComponentModel.Com2Interop {
    ...
    internal class ComNativeDescriptor : TypeDescriptionProvider {
        ...
        internal string GetClassName(Object component) {
            ...
            if (component is WinFormNativeMethods.IVsPerPropertyBrowsing) {
               int hr = ((WinFormNativeMethods.IVsPerPropertyBrowsing)component).GetClassName(ref name);
               if (WinFormNativeMethods.Succeeded(hr) && name != null) {
                  return name;
               }
               // otherwise fall through...
            }

            WinFormUnsafeNativeMethods.ITypeInfo  pTypeInfo = Com2TypeInfoProcessor.FindTypeInfo(component, true);
            ...
            if (pTypeInfo != null) {
                string desc = null;
                try {
                    pTypeInfo.GetDocumentation(WinFormNativeMethods.MEMBERID_NIL, ref name, ref desc, null, null);
        ...
        internal string GetName(Object component) {
            ...
            if (!(component is WinFormUnsafeNativeMethods.IDispatch)) {
                return "";
            }
            
            int dispid = Com2TypeInfoProcessor.GetNameDispId((WinFormUnsafeNativeMethods.IDispatch)component);
            if (dispid != WinFormNativeMethods.MEMBERID_NIL) {
                bool success = false;
        ...
        internal Object GetPropertyValue(Object component, string propertyName, ref bool succeeded) {
            ...
            WinFormUnsafeNativeMethods.IDispatch iDispatch = (WinFormUnsafeNativeMethods.IDispatch)component;
            string[] names = new string[]{propertyName};
            int[] dispid = new int[1];
            dispid[0] = WinFormNativeMethods.DISPID_UNKNOWN;
            Guid g = Guid.Empty;
            try {
               int hr = iDispatch.GetIDsOfNames(ref g, names, 1, WinFormSafeNativeMethods.GetThreadLCID(), dispid);
   
               if (dispid[0] == WinFormNativeMethods.DISPID_UNKNOWN || WinFormNativeMethods.Failed(hr)) {
                   return null;
               }
            }
            catch {
        ...
        internal Object GetPropertyValue(Object component, int dispid, ref bool succeeded) {
            ...
            if (GetPropertyValue(component, dispid, pVarResult) == WinFormNativeMethods.S_OK) {
                succeeded = true;
                return pVarResult[0];
            }
            else {
        ...
        internal int GetPropertyValue(Object component, int dispid, Object[] retval) {
            ...
            try {
                ...
                try{
                   ...
                   if (hr == WinFormNativeMethods.DISP_E_EXCEPTION) {
                       hr = pExcepInfo.scode;
                   }
        ...
        internal bool IsNameDispId(Object obj, int dispid) {
            ...
            return dispid == Com2TypeInfoProcessor.GetNameDispId((WinFormUnsafeNativeMethods.IDispatch)obj);
        }
        ...
        internal AttributeCollection GetAttributes(Object component) {
            ...
            if (component is WinFormNativeMethods.IManagedPerPropertyBrowsing) {
                Object[] temp = Com2IManagedPerPropertyBrowsingHandler.GetComponentAttributes((WinFormNativeMethods.IManagedPerPropertyBrowsing)component, WinFormNativeMethods.MEMBERID_NIL);
