...
namespace System.Windows.Forms.ComponentModel.Com2Interop {
    ...
    internal class Com2AboutBoxPropertyDescriptor : Com2PropertyDescriptor {
        ...
        public Com2AboutBoxPropertyDescriptor() : base(WinFormNativeMethods.ActiveX.DISPID_ABOUTBOX, "About", new Attribute[]{new DispIdAttribute(WinFormNativeMethods.ActiveX.DISPID_ABOUTBOX), 
                                                                                      DesignerSerializationVisibilityAttribute.Hidden, 
                                                                                      new DescriptionAttribute(DCSR.GetString(DCSR.AboutBoxDesc)), 
        ...
        public class AboutBoxUITypeEditor : UITypeEditor {
            ...
            public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value) {
                     ...
                     if (Marshal.IsComObject(component) && component is WinFormUnsafeNativeMethods.IDispatch) {
                        ...
                        int hr = pDisp.Invoke(WinFormNativeMethods.ActiveX.DISPID_ABOUTBOX,
                                              ref g,
                                              WinFormSafeNativeMethods.GetThreadLCID(),
                                              WinFormNativeMethods.DISPATCH_METHOD,
                                              new WinFormNativeMethods.tagDISPPARAMS(),
                                              null,
                                              pExcepInfo, null);
                                              
                        Debug.Assert(WinFormNativeMethods.Succeeded(hr), "Failed to launch about box.");
                     }
                     return value;
            }
