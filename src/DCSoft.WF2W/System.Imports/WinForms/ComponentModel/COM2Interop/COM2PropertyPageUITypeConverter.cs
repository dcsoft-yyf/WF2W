...
namespace System.Windows.Forms.ComponentModel.Com2Interop {
    ...
    internal class Com2PropertyPageUITypeEditor : Com2ExtendedUITypeEditor, ICom2PropertyPageDisplayService {
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value) {
            ...
            IntPtr hWndParent = WinFormUnsafeNativeMethods.GetFocus(); // Windows.GetForegroundWindow
            ...
            try {
                ...
                if (provider != null) {
                      ...
                      if (uiSvc != null){
                        uiSvc.ShowError(ex1, DCSR.GetString(DCSR.ErrorTypeConverterFailed));
                      }
                }
            }
            return value;
        ...
        public unsafe void ShowPropertyPage(string title, object component, int dispid, Guid pageGuid, IntPtr parentHandle){
            ...
            try {
                ...
                fixed (IntPtr* pAddrs = objAddrs) {
                    WinFormSafeNativeMethods.OleCreatePropertyFrame(new HandleRef(null, parentHandle),
                                                             0, 0,
                                                             title,
                                                             nObjs,
