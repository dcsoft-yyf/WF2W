...
namespace System.Windows.Forms {
    ...
    public partial class Control :
        Component,
        //WinFormUnsafeNativeMethods.IOleControl,
        //WinFormUnsafeNativeMethods.IOleObject,
        //WinFormUnsafeNativeMethods.IOleInPlaceObject,
        //WinFormUnsafeNativeMethods.IOleInPlaceActiveObject,
        //WinFormUnsafeNativeMethods.IOleWindow,
        //WinFormUnsafeNativeMethods.IViewObject,
        //WinFormUnsafeNativeMethods.IViewObject2,
        //WinFormUnsafeNativeMethods.IPersist,
        //WinFormUnsafeNativeMethods.IPersistStreamInit,
        //WinFormUnsafeNativeMethods.IPersistPropertyBag,
        //WinFormUnsafeNativeMethods.IPersistStorage,
        //WinFormUnsafeNativeMethods.IQuickActivate,
        ...
        //public int InnerGetWindowLong( int nIndex)
        //{
        //    //return WinFormSafeNativeMethods.GetWindowLong(new HandleRef(this, this.Handle), nIndex);
        //}
        ...
        static Control() {
            ...
            WM_GETCONTROLNAME = WinFormSafeNativeMethods.RegisterWindowMessage("WM_GETCONTROLNAME");
            WM_GETCONTROLTYPE = WinFormSafeNativeMethods.RegisterWindowMessage("WM_GETCONTROLTYPE");
        ...
        private static int _threadCallbackMessage;

        // Initially check for illegal multithreading based on whether the
        // debugger is attached.
        [ResourceExposure(ResourceScope.Process)]
        private static bool _checkForIllegalCrossThreadCalls = true;// Debugger.IsAttached;
        private static ContextCallback _invokeMarshaledCallbackHelperDelegate;

        [ ThreadStatic ]
        private static bool _inCrossThreadSafeCall = false;

// disable csharp compiler warning #0414: field assigned unused value
#pragma warning disable 0414
        [ ThreadStatic ]
        internal static HelpInfo _currentHelpInfo = null;
#pragma warning restore 0414

        private static FontHandleWrapper _defaultFontHandleWrapper;
        ...
        private PropertyStore                 _propertyStore;          // Contains all properties that are not always set.
        private WinFormNativeMethods.TRACKMOUSEEVENT _trackMouseEvent;
...
*/
        ...
        internal Control(bool autoInstallSyncContext) : base() {
            ...
            this._Window = new ControlNativeWindow(this);
            ...
            if (_Width != 0 && _Height != 0) {
                ...
                WinFormSafeNativeMethods.AdjustWindowRectEx(ref rect, cp.Style, false, cp.ExStyle);
        ...
        SRDescription(DCSR.ControlAccessibilityObjectDescr)
        ]
        ...
        private AccessibleObject NcAccessibilityObject {
            get {
                ...
                if (ncAccessibleObject == null) {
                    ncAccessibleObject = new ControlAccessibleObject(this, WinFormNativeMethods.OBJID_WINDOW);
        ...
        private AccessibleObject GetAccessibilityObject(int accObjId) {
            ...
            switch (accObjId) {
                case WinFormNativeMethods.OBJID_CLIENT:
                    accessibleObject = this.AccessibilityObject;
                    break;
                case WinFormNativeMethods.OBJID_WINDOW:
        ...
        /// </devdoc>
        [
        SRCategory(DCSR.CatAccessibility),
        Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ControlAccessibleDefaultActionDescr)
        ]
        ...
        DefaultValue(null),
        Localizable(true),
        SRDescription(DCSR.ControlAccessibleDescriptionDescr)
        ]
        ...
        DefaultValue(null),
        Localizable(true),
        SRDescription(DCSR.ControlAccessibleNameDescr)
        ]
        ...
        SRDescription(DCSR.ControlAccessibleRoleDescr)
        ]
        ...
        DefaultValue(false),
        SRDescription(DCSR.ControlAllowDropDescr)
        ]
        public virtual bool AllowDrop {
            ...
            set {
                if (GetState(STATE_ALLOWDROP) != value) {
                    ...
                    this.LogWF2WPropertyValue( "AllowDrop" , value );
                    //if (IsHandleCreated) {
                    //    try {
        ...
        SRDescription(DCSR.ControlAnchorDescr),
        ...
        [SRDescription(DCSR.ControlAutoSizeDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnAutoSizeChangedDescr)]
        [Browsable(false), EditorBrowsable(EditorBrowsableState.Never)]
        ...
        internal IntPtr BackColorBrush {
            ...
            get {
                ...
                if (ColorTranslator.ToOle(color) < 0) {
                    backBrush = WinFormSafeNativeMethods.GetSysColorBrush(ColorTranslator.ToOle(color) & 0xFF);
                    SetState(STATE_OWNCTLBRUSH, false);
                }
                else {
                    backBrush = WinFormSafeNativeMethods.CreateSolidBrush(ColorTranslator.ToWin32(color));
        ...
        public virtual Color BackColor {
            ...
            set {
                if (!value.Equals(Color.Empty) && !GetStyle(ControlStyles.SupportsTransparentBackColor) && value.A < 255)
                    throw new ArgumentException(DCSR.GetString(DCSR.TransparentBackColorNotAllowed));
                ...
                if (!c.Equals(BackColor)) {
                    ...
                    this.LogWF2WPropertyValue("BackColor",value );
                }
            }
        }
        ...
        /// </devdoc>
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnBackColorChangedDescr)]
        ...
        DefaultValue(null),
        Localizable(true),
        SRDescription(DCSR.ControlBackgroundImageDescr)
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true )]
        public virtual Image BackgroundImage {
            ...
            set {
                if (BackgroundImage != value) {
                    ...
                    this.LogWF2WPropertyValue("BackgroundImage", value);
                }
            }
        }
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnBackgroundImageChangedDescr)]
        ...
        Localizable(true),
        SRDescription(DCSR.ControlBackgroundImageLayoutDescr)
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public virtual ImageLayout BackgroundImageLayout {
            ...
            set {
                if (BackgroundImageLayout != value) {
                    ...
                    this.LogWF2WPropertyValue("BackgroundImageLayout", value);
                }
            }
        }
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnBackgroundImageLayoutChangedDescr)]
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ControlBindingContextDescr)
        ]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnBindingContextChangedDescr)]
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ControlBottomDescr),
        SRCategory(DCSR.CatLayout)
        ]
        public int Bottom {
            get {
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ControlBoundsDescr),
        SRCategory(DCSR.CatLayout)
        ]
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRCategory(DCSR.CatFocus),
        SRDescription(DCSR.ControlCanFocusDescr)
        ]
        public bool CanFocus {
            get {
                ...
                bool visible = WinFormSafeNativeMethods.IsWindowVisible(new HandleRef(_Window, Handle));
                bool enabled = WinFormSafeNativeMethods.IsWindowEnabled(new HandleRef(_Window, Handle));
        ...
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRCategory(DCSR.CatFocus),
        SRDescription(DCSR.ControlCanSelectDescr)
        ]
        ...
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRCategory(DCSR.CatFocus),
        SRDescription(DCSR.ControlCaptureDescr)
        ]
        public bool Capture {
            [System.Runtime.TargetedPatchingOptOutAttribute("Performance critical to inline across NGen image boundaries")]
            get {
        ...
        internal bool CaptureInternal {
            [System.Runtime.TargetedPatchingOptOutAttribute("Performance critical to inline across NGen image boundaries")]
            get {
                return IsHandleCreated && WinFormUnsafeNativeMethods.GetCapture() == Handle;
            }
            set {
                if (CaptureInternal != value) {
                    if (value) {
                        WinFormUnsafeNativeMethods.SetCapture(new HandleRef(this, Handle));
                    }
                    else {
                        WinFormSafeNativeMethods.ReleaseCapture();
                    }
                }
            }
        }
        ...
        SRCategory(DCSR.CatFocus),
        DefaultValue(true),
        SRDescription(DCSR.ControlCausesValidationDescr)
        ]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnCausesValidationChangedDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [ Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
          SRDescription(DCSR.ControlCheckForIllegalCrossThreadCalls),
          DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        ]
        public static bool CheckForIllegalCrossThreadCalls {
            get { return _checkForIllegalCrossThreadCalls; }
            set { _checkForIllegalCrossThreadCalls = value; }
        }
        internal bool UpdateClientRectangleDirect()
        {
            if(this.IsHandleCreated )
            {
                var strText = DCWin32API.JSRuntime.Invoke<string>("__DCWin32API.GetClientSize", this.Handle.ToInt32());
                if(strText != null && strText.Length > 0 )
                {
                    var index = strText.IndexOf('|');
                    if(index > 0 
                        && int.TryParse( strText.Substring(0,index) , out var v1 )
                        && int.TryParse(strText.Substring(index +1) , out var v2 ))
                    {
                        this._ClientWidth = v1;
                        this._ClientHeight = v2;
                        return true;
                    }
                }
            }
        ...
        public Rectangle ClientRectangle {
            get {
                return new Rectangle(0, 0, this._ClientWidth, this._ClientHeight);
            }
        }
        ...
        public Size ClientSize {
            get {
                return new Size(this._ClientWidth, this._ClientHeight);
            }
        ...
        internal virtual Size InnerGetClientSize()
        {
        ...
        /// </devdoc>
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnClientSizeChangedDescr)]
        ...
        public bool ContainsFocus {
            get {
                ...
                IntPtr focusHwnd = WinFormUnsafeNativeMethods.GetFocus();
                ...
                if (WinFormUnsafeNativeMethods.IsChild(new HandleRef(this, this.Handle), new HandleRef(this, focusHwnd))) {
                    return true;
                }
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlContextMenuStripChangedDescr)]
        ...
        protected virtual CreateParams CreateParams {
            ...
            get {
                ...
                //if (WinFormUnsafeNativeMethods.GetModuleHandle(ExternDll.Comctl32) == IntPtr.Zero) {
                //    if (WinFormUnsafeNativeMethods.LoadLibrary(ExternDll.Comctl32) == IntPtr.Zero) {
                ...
                if ((_State & STATE_TOPLEVEL) == 0) {
                    ...
                    cp.Style |= WinFormNativeMethods.WS_CHILD | WinFormNativeMethods.WS_CLIPSIBLINGS;
                }
                else {
                    cp.Parent = IntPtr.Zero;
                }

                if ((_State & STATE_TABSTOP) != 0) cp.Style |= WinFormNativeMethods.WS_TABSTOP;
                if ((_State & STATE_VISIBLE) != 0) cp.Style |= WinFormNativeMethods.WS_VISIBLE;
                ...
                if (!Enabled) cp.Style |= WinFormNativeMethods.WS_DISABLED;
                ...
                if (RightToLeft == RightToLeft.Yes) {
                    cp.ExStyle |= WinFormNativeMethods.WS_EX_RTLREADING;
                    cp.ExStyle |= WinFormNativeMethods.WS_EX_RIGHT;
                    cp.ExStyle |= WinFormNativeMethods.WS_EX_LEFTSCROLLBAR;
                }
        ...
        internal int CreateThreadId {
            ...
            get {
                ...
                //if (IsHandleCreated) {
                //    int pid;
                //    return WinFormSafeNativeMethods.GetWindowThreadProcessId(new HandleRef(this, Handle), out pid);
                //}
                //else {
                //    return WinFormSafeNativeMethods.GetCurrentThreadId();
                //}
            }
        }
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ControlCursorDescr),
        AmbientValue(null)
        ]
        public virtual Cursor Cursor {
            ...
            set {
                ...
                //
                if (IsHandleCreated) {
                    DCWin32API.SetControlCursor(this.Handle.ToInt32(), value);
                    ...
                    //WinFormNativeMethods.POINT p = new WinFormNativeMethods.POINT();
                    //WinFormNativeMethods.RECT r = new WinFormNativeMethods.RECT();
                    //WinFormUnsafeNativeMethods.GetCursorPos(p);
                    //WinFormUnsafeNativeMethods.GetWindowRect(new HandleRef(this, Handle), ref r);

                    //if ((r.left <= p.x && p.x < r.right && r.top <= p.y && p.y < r.bottom) || WinFormUnsafeNativeMethods.GetCapture() == Handle)
                    //    SendMessage(WinFormNativeMethods.WM_SETCURSOR, Handle, (IntPtr)WinFormNativeMethods.HTCLIENT);
                }
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnCursorChangedDescr)]
        ...
        SRDescription(DCSR.ControlBindingsDescr),
        RefreshProperties(RefreshProperties.All),
        ...
        public static Font DefaultFont {
            ...
            get {
                if (_defaultFont == null) {
                    ...
                    Debug.Assert(_defaultFont != null, "defaultFont wasn't set!");
                }
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ControlDisplayRectangleDescr)
        ]
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ControlDisposedDescr)
        ]
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ControlDisposingDescr)
        ]
        ...
        SRDescription(DCSR.ControlDockDescr)
        ]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnDockChangedDescr)]
        ...
        [
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.ControlDoubleBufferedDescr)
        ]
...
#pragma warning restore 618
        ...
        SRCategory(DCSR.CatBehavior),
        Localizable(true),
        DispId(WinFormNativeMethods.ActiveX.DISPID_ENABLED),
        SRDescription(DCSR.ControlEnabledDescr)
        ]
        public bool Enabled {
            get {
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnEnabledChangedDescr)]
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ControlFocusedDescr)
        ]
        public virtual bool Focused {
            get {
                if(this.IsHandleCreated )
                {
                    var h = WinFormUnsafeNativeMethods.GetFocus();
                    var h2 = h.ToInt32();
                    var h3 = this.Handle.ToInt32();
                    return h == this.Handle;
                }
                return false;
                //return IsHandleCreated && WinFormUnsafeNativeMethods.GetFocus() == Handle;
            }
        }
        ...
        public virtual Font Font {
            ...
            set {
                ...
                if (localChanged) {
                    ...
                    if (value != null)
                    {
                        this.LogWF2WPropertyValue("Font", value.ToJsonObject());
                    }
                }
            }
        }
        ...
        [
        SRCategory(DCSR.CatAppearance),
        DispId(WinFormNativeMethods.ActiveX.DISPID_FORECOLOR),
        SRDescription(DCSR.ControlForeColorDescr)
        ]
        public virtual Color ForeColor {
            ...
            set {
                ...
                if (!c.Equals(ForeColor)) {
                    ...
                    this.LogWF2WPropertyValue("ForeColor", value);
                }
            }
        }

        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnForeColorChangedDescr)]
        ...
        public IntPtr Handle {
            get {
                if (_checkForIllegalCrossThreadCalls &&
                    !_inCrossThreadSafeCall &&
                    InvokeRequired) {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.IllegalCrossThreadCall,
                                                                     Name));
                }
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ControlHasChildrenDescr)
        ]
        ...
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ControlHeightDescr)
        ]
        public int Height {
            get {
                return _Height;
            ...
            set{
                SetBounds(_Left, _Top, _Width, value, BoundsSpecified.Height);
            }
        }
            ...
            get {
                if (!GetState(STATE_CHECKEDHOST)) {
                    ...
                    if (this != topMost) {
                        ...
                        IntPtr parentHandle = WinFormUnsafeNativeMethods.GetParent(new HandleRef(this, Handle));
                        ...
                        while (parentHandle != IntPtr.Zero) {
                            int len = WinFormUnsafeNativeMethods.GetClassName(new HandleRef(null, lastParentHandle), null, 0);
                            if (len > sb.Capacity) {
                                sb.Capacity = len + 5;
                            }
                            WinFormUnsafeNativeMethods.GetClassName(new HandleRef(null, lastParentHandle), sb, sb.Capacity);
                            ...
                            parentHandle = WinFormUnsafeNativeMethods.GetParent(new HandleRef(null, parentHandle));
                        }
                    }
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ControlHandleCreatedDescr)
        ]
        public bool IsHandleCreated {
            get { return _Window.Handle != IntPtr.Zero; }
        }
        ...
        internal bool IsWindowObscured {
            get {
                ...
                WinFormNativeMethods.RECT temp = new WinFormNativeMethods.RECT();
                Region working;
                ...
                WinFormUnsafeNativeMethods.GetWindowRect(new HandleRef(this, Handle), ref temp);
                ...
                try {
                    ...
                    for (prev = start;
                         (next = WinFormUnsafeNativeMethods.GetWindow(new HandleRef(null, prev), WinFormNativeMethods.GW_HWNDPREV)) != IntPtr.Zero;
                         prev = next) {

                        WinFormUnsafeNativeMethods.GetWindowRect(new HandleRef(null, next), ref temp);
                        Rectangle current = Rectangle.FromLTRB(temp.left, temp.top, temp.right, temp.bottom);

                        if (WinFormSafeNativeMethods.IsWindowVisible(new HandleRef(null, next))) {
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ControlInvokeRequiredDescr)
        ]
        public bool InvokeRequired {
            get {
                ...
                //    int pid;
                //    int hwndThread = WinFormSafeNativeMethods.GetWindowThreadProcessId(hwnd, out pid);
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ControlIsAccessibleDescr)
        ]
        ...
        internal bool IsActiveX {
            get {
                return false;// GetState2(STATE2_ISACTIVEX);
            }
        }
        ...
        internal bool IsIEParent {
            get {
                return false;// IsActiveX ? ActiveXInstance.IsIE : false;
            }
        }
        ...
        EditorBrowsable(EditorBrowsableState.Advanced),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.IsMirroredDescr)        
        ]
        public bool IsMirrored {
            get {
                if (!IsHandleCreated) {
                    CreateParams cp = CreateParams;
                    SetState(STATE_MIRRORED, (cp.ExStyle & WinFormNativeMethods.WS_EX_LAYOUTRTL) != 0);
                }
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Always),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ControlLeftDescr)
        ]
        public int Left {
            get {
                return _Left;
            ...
            set {
                SetBounds(value, _Top, _Width, _Height, BoundsSpecified.X);
            }
        }
        ...
        public Point Location {
            ...
            set {
                SetBounds(value.X, value.Y, _Width, _Height, BoundsSpecified.Location);
            }
        }
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [
        SRDescription(DCSR.ControlMarginDescr),
        SRCategory(DCSR.CatLayout),
        Localizable(true)
        ]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatLayout), SRDescription(DCSR.ControlOnMarginChangedDescr)]
        ...
        [SRCategory(DCSR.CatLayout)]
        [Localizable(true)]
        [SRDescription(DCSR.ControlMaximumSizeDescr)]
        ...
        [SRCategory(DCSR.CatLayout)]
        [Localizable(true)]
        [SRDescription(DCSR.ControlMinimumSizeDescr)]
        ...
        public static Keys ModifierKeys {
            get {
                ...
                //
                if (WinFormUnsafeNativeMethods.GetKeyState((int)Keys.ShiftKey) < 0) modifiers |= Keys.Shift;
                if (WinFormUnsafeNativeMethods.GetKeyState((int)Keys.ControlKey) < 0) modifiers |= Keys.Control;
                if (WinFormUnsafeNativeMethods.GetKeyState((int)Keys.Menu) < 0) modifiers |= Keys.Alt;
                return modifiers;
            }
        }
        ...
        public static MouseButtons MouseButtons {
            get {
                ...
                //
                if (WinFormUnsafeNativeMethods.GetKeyState((int)Keys.LButton) < 0) buttons |= MouseButtons.Left;
                if (WinFormUnsafeNativeMethods.GetKeyState((int)Keys.RButton) < 0) buttons |= MouseButtons.Right;
                if (WinFormUnsafeNativeMethods.GetKeyState((int)Keys.MButton) < 0) buttons |= MouseButtons.Middle;
                if (WinFormUnsafeNativeMethods.GetKeyState((int)Keys.XButton1) < 0) buttons |= MouseButtons.XButton1;
                if (WinFormUnsafeNativeMethods.GetKeyState((int)Keys.XButton2) < 0) buttons |= MouseButtons.XButton2;
                return buttons;
            }
        }

        internal static Point _MousePosition = Point.Empty;
        ...
        public static Point MousePosition {
            get {
                ...
                //WinFormNativeMethods.POINT pt = new WinFormNativeMethods.POINT();
                //WinFormUnsafeNativeMethods.GetCursorPos(pt);
        ...
        public string Name {
            ...
            set {
                ...
                this.LogWF2WPropertyValue("Name", (string)value);
            }
        }
        ...
        public bool RecreatingHandle {
            get {
                return(_State & STATE_RECREATE) != 0;
            }
        }
                ...
                if (oldRegion != value) {
                    ...
                    if (IsHandleCreated) {
                        ...
                        try {
                            ...
                            if (WinFormUnsafeNativeMethods.SetWindowRgn(new HandleRef(this, Handle), new HandleRef(this, regionHandle), WinFormSafeNativeMethods.IsWindowVisible(new HandleRef(this, Handle))) != 0) {
                            ...
                            if (regionHandle != IntPtr.Zero) {
                                WinFormSafeNativeMethods.DeleteObject(new HandleRef(null, regionHandle));
                            }
                        }
                    }
        ...
        /// </devdoc>
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlRegionChangedDescr)]
        ...
        internal bool RequiredScalingEnabled {
            get {
                return (_requiredScaling & RequiredScalingEnabledMask) != 0;
            }
            set {
                byte scaling = (byte)(_requiredScaling & RequiredScalingMask);
                _requiredScaling = scaling;
                if (value) _requiredScaling |= RequiredScalingEnabledMask;
            }
        }
        ...
        /// </devdoc>
        [
        SRDescription(DCSR.ControlResizeRedrawDescr)
        ]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnRightToLeftChangedDescr)]
        ...
        public Size Size {
            ...
            set {
                SetBounds(_Left, _Top, value.Width, value.Height, BoundsSpecified.Size);
            }
        }

        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnSizeChangedDescr)]
        ...
        public int TabIndex {
            get {
                return _tabIndex == -1 ? 0 : _tabIndex;
            }
            set {
                if (value < 0) {
                    throw new ArgumentOutOfRangeException("TabIndex", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "TabIndex", value.ToString(CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture)));
                }

                if (_tabIndex != value) {
                    _tabIndex = value;
                    OnTabIndexChanged(EventArgs.Empty);
                    this.LogWF2WPropertyValue("TabIndex", value);
                }
            }
        }
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnTabIndexChangedDescr)]
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(true),
        DispId(WinFormNativeMethods.ActiveX.DISPID_TABSTOP),
        SRDescription(DCSR.ControlTabStopDescr)
        ]
        public bool TabStop {
            get {
            ...
            set {
                if (TabStop != value) {
                    ...
                    if (IsHandleCreated) SetWindowStyle(WinFormNativeMethods.WS_TABSTOP, value);
                    OnTabStopChanged(EventArgs.Empty);
                    this.LogWF2WPropertyValue("TabStop", value);
                }
            }
        }
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnTabStopChangedDescr)]
        ...
        Localizable(true),
        Bindable(true),
        DispId(WinFormNativeMethods.ActiveX.DISPID_TEXT),
        SRDescription(DCSR.ControlTextDescr)
        ]
        public virtual string Text {
            ...
            set {
                ...
                this.LogWF2WPropertyValue("Text", value);
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnTextChangedDescr)]
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Always),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ControlTopDescr)
        ]
        public int Top {
            get {
                return _Top;
            ...
            set {
                SetBounds(this._Left, value, this._Width, this._Height, BoundsSpecified.Y);
            }
        }
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ControlTopLevelControlDescr)
        ]
            ...
            get {
                ...
                if ((_uiCuesState & UISTATE_KEYBOARD_CUES_MASK) == 0) {
                        ...
                        if (SystemInformation.MenuAccessKeysUnderlined) {
                            ...
                            //
                            int actionMask = (WinFormNativeMethods.UISF_HIDEACCEL | WinFormNativeMethods.UISF_HIDEFOCUS) << 16;
                            ...
                            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(TopMostParent, TopMostParent.Handle),
                                    WinFormNativeMethods.WM_CHANGEUISTATE,
                                    (IntPtr)(actionMask | WinFormNativeMethods.UIS_SET),
                                    IntPtr.Zero);
                        }
                 }
        ...
        internal virtual int ShowParams {
            get {
                return WinFormNativeMethods.SW_SHOW;
            }
        }
        ...
        Browsable(true),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ControlUseWaitCursorDescr),
        ]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnVisibleChangedDescr)]
        ...
        private void WaitForWaitHandle(WaitHandle waitHandle) {
            ...
            while (!processed) {
                ...
                if (threadHandle != null) {
                    returnValue = WinFormUnsafeNativeMethods.GetExitCodeThread(threadHandle, out exitCode);
                }
                ...
                if ((returnValue && exitCode != WinFormNativeMethods.STILL_ACTIVE) || AppDomain.CurrentDomain.IsFinalizingForUnload()) {
                    if (waitHandle.WaitOne(1, false)) {
                        break;
                    }
                    throw new InvalidAsynchronousStateException(DCSR.GetString(DCSR.ThreadNoLongerValid));
                }
        ...
        public int Width {
            ...
            set {
                SetBounds(_Left, _Top, value, _Height, BoundsSpecified.Width);
            }
        }
        ...
        private int WindowExStyle {
            get {
                return unchecked((int)(long)WinFormUnsafeNativeMethods.GetWindowLong(new HandleRef(this, Handle), WinFormNativeMethods.GWL_EXSTYLE));
            }
            set {
                WinFormUnsafeNativeMethods.SetWindowLong(new HandleRef(this, Handle), WinFormNativeMethods.GWL_EXSTYLE, new HandleRef(null, (IntPtr)value));
            }
        }
        ...
        internal int WindowStyle {
            get {
                return unchecked((int)(long)WinFormUnsafeNativeMethods.GetWindowLong(new HandleRef(this, Handle), WinFormNativeMethods.GWL_STYLE));
            }
            set {
                WinFormUnsafeNativeMethods.SetWindowLong(new HandleRef(this, Handle), WinFormNativeMethods.GWL_STYLE, new HandleRef(null, (IntPtr)value));
            }
        }
        ...
        public IWindowTarget WindowTarget {
            //[SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.UnmanagedCode)]
            get {
                return _Window.WindowTarget;
            }
            //[SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.UnmanagedCode)]
            set {
                _Window.WindowTarget = value;
            }
        }
        ...
        internal virtual string WindowText {
            get {
                ...
                return DCWin32API.GetWindowText(this.Handle.ToInt32());
                //using (new MultithreadSafeCallScope()) {

                //    // it's okay to call GetWindowText cross-thread.
                //    //

                //    int textLen = WinFormSafeNativeMethods.GetWindowTextLength(new HandleRef(window, Handle));
                ...
                //    WinFormUnsafeNativeMethods.GetWindowText(new HandleRef(window, Handle), sb, sb.Capacity);
                //    return sb.ToString();
                //}
            }
            set {
                ...
                if (!WindowText.Equals(value)) {
                    if (IsHandleCreated) {
                        DCWin32API.SetWindowText(this.Handle.ToInt32(), value);
                        //WinFormUnsafeNativeMethods.SetWindowText(new HandleRef(window, Handle), value);
                    }
                    else {
                        if (value.Length == 0) {
                            _text = null;
        ...
        private static readonly object EventClickAsync = new object();
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public event EventHandlerAsync ClickAsync
        {
            add
            {
                this.Events.AddHandler(EventClickAsync, value);
            }
            remove
            {
                this.Events.RemoveHandler(EventClickAsync, value);
            }
        }
        ...
        Browsable(true),
        EditorBrowsable(EditorBrowsableState.Advanced),
        SRDescription(DCSR.ControlOnControlAddedDescr)
        ]
        ...
        Browsable(true),
        EditorBrowsable(EditorBrowsableState.Advanced),
        SRDescription(DCSR.ControlOnControlRemovedDescr)
        ]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatDragDrop), SRDescription(DCSR.ControlOnDragDropDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatDragDrop), SRDescription(DCSR.ControlOnDragEnterDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatDragDrop), SRDescription(DCSR.ControlOnDragOverDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatDragDrop), SRDescription(DCSR.ControlOnDragLeaveDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatDragDrop), SRDescription(DCSR.ControlOnGiveFeedbackDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPrivate), Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced), SRDescription(DCSR.ControlOnCreateHandleDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPrivate), Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced), SRDescription(DCSR.ControlOnDestroyHandleDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.ControlOnHelpDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatAppearance), Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced), SRDescription(DCSR.ControlOnInvalidateDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [
        SRDescription(DCSR.ControlPaddingDescr),
        SRCategory(DCSR.CatLayout),
        Localizable(true)
        ]
        public Padding Padding {
            ...
            set {
                if (value != Padding) {
                    ...
                    PropertyValueLogger.Log(this, "Padding", value);
                }
            }
        }

        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatLayout), SRDescription(DCSR.ControlOnPaddingChangedDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatAppearance), SRDescription(DCSR.ControlOnPaintDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatDragDrop), SRDescription(DCSR.ControlOnQueryContinueDragDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.ControlOnQueryAccessibilityHelpDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.ControlOnDoubleClickDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatFocus), SRDescription(DCSR.ControlOnEnterDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatFocus), SRDescription(DCSR.ControlOnGotFocusDescr), Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatKey), SRDescription(DCSR.ControlOnKeyDownDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatKey), SRDescription(DCSR.ControlOnKeyPressDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatKey), SRDescription(DCSR.ControlOnKeyUpDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatLayout), SRDescription(DCSR.ControlOnLayoutDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatFocus), SRDescription(DCSR.ControlOnLeaveDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatFocus), SRDescription(DCSR.ControlOnLostFocusDescr), Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.ControlOnMouseClickDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.ControlOnMouseDoubleClickDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.ControlOnMouseCaptureChangedDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatMouse), SRDescription(DCSR.ControlOnMouseDownDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatMouse), SRDescription(DCSR.ControlOnMouseEnterDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatMouse), SRDescription(DCSR.ControlOnMouseLeaveDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatMouse), SRDescription(DCSR.ControlOnMouseHoverDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatMouse), SRDescription(DCSR.ControlOnMouseMoveDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatMouse), SRDescription(DCSR.ControlOnMouseUpDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatMouse), SRDescription(DCSR.ControlOnMouseWheelDescr), Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatLayout), SRDescription(DCSR.ControlOnMoveDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatKey), SRDescription(DCSR.PreviewKeyDownDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.ControlOnChangeUICuesDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.ControlOnStyleChangedDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.ControlOnSystemColorsChangedDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatFocus), SRDescription(DCSR.ControlOnValidatingDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatFocus), SRDescription(DCSR.ControlOnValidatedDescr)]
        ...
        protected internal void AccessibilityNotifyClients(AccessibleEvents accEvent, int childID) {
            AccessibilityNotifyClients(accEvent, WinFormNativeMethods.OBJID_CLIENT, childID);
        }
        ...
        protected void AccessibilityNotifyClients(AccessibleEvents accEvent, int objectID, int childID) {
            if (IsHandleCreated) {
                WinFormUnsafeNativeMethods.NotifyWinEvent((int)accEvent, new HandleRef(this, Handle), objectID, childID + 1);
            }
        }
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ControlOnParentChangedDescr)]
        ...
        public IAsyncResult BeginInvoke(Delegate method, params Object[] args) {
            ...
            {
                throw new NotSupportedException("Control not created");
            }
            if( this._InvokeMethods == null  )
            {
                this._InvokeMethods = new List<Tuple<Delegate, object[]>>();
            }
            this._InvokeMethods.Add(new Tuple<Delegate, object[]>(method, args));
            var result = DCWin32API.JSRuntime.InvokeVoidAsync("__DCExecuteControlCommandAsync", this.Handle.ToInt32() , "RunBeginInvoke", null);
            //DCMessageManager.PostMessage(
            //    marshaler.Handle.ToInt32(),
            //    WM_BeginInvoke,
            //    0,
            //    DCWin32API.PackageToHandle(new System.Tuple<Delegate, object[]>(method, args)));
        ...
        internal static async Task RunBeginInvoke(int intHandle)
        {
            var ctl = Control.FromHandle(intHandle);
            if ( ctl != null && ctl._InvokeMethods != null)
            {
                var arr = ctl._InvokeMethods.ToArray();
                ctl._InvokeMethods.Clear();
                foreach (var item in arr)
                {
                    var result = item.Item1.DynamicInvoke(item.Item2);
                    if(result is ValueTask vt)
                    {
                        await vt;
                    }
                    else if( result is Task tt )
                    {
                        await tt;
                    }
        ...
        private List<Tuple<Delegate, object[]>> _InvokeMethods = null;

        internal bool DoBeginInvoke(System.Windows.Forms.Message msg ) {
            if (msg.Msg == WM_BeginInvoke)
            {
                var tuple = DCWin32API.GetPackagedObjectByHandle<System.Tuple<Delegate, object[]>>(msg.LParam.ToInt32());
                if (tuple != null)
                {
        ...
        public const int WM_BeginInvoke = 0x01234400;

        internal void BeginUpdateInternal() {
            if (!IsHandleCreated) {
                return;
            }
            if (_updateCount == 0) SendMessage(WinFormNativeMethods.WM_SETREDRAW, 0, 0);
            _updateCount++;
        }
        ...
        public void BringToFront() {
            ...
            else if (IsHandleCreated && GetTopLevel() && WinFormSafeNativeMethods.IsWindowEnabled(new HandleRef(_Window, Handle))) {
                WinFormSafeNativeMethods.SetWindowPos(new HandleRef(_Window, Handle), WinFormNativeMethods.HWND_TOP, 0, 0, 0, 0,
        ...
        internal virtual bool CanProcessMnemonic() {
            ...
            if( this._Parent != null ){
                return this._Parent.CanProcessMnemonic();
            }
        ...
        internal static void CheckParentingCycle(Control bottom, Control toFind) {
            ...
            for (Control ctl = bottom; ctl != null; ctl = ctl.ParentInternal) {
                lastParent = ctl;
                if (ctl == toFind) {
                    throw new ArgumentException(DCSR.GetString(DCSR.CircularOwner));
                }
            }
        ...
        protected virtual void CreateHandle() {
            ...
            try {
                ...
                if (Application.UseVisualStyles) {
                    ...
                    userCookie = WinFormUnsafeNativeMethods.ThemingScope.Activate();
                }
                ...
                if (_Parent != null) {
                    ...
                    if (!parentClient.IsEmpty) {
                        if (cp.X != WinFormNativeMethods.CW_USEDEFAULT) {
                            cp.X -= parentClient.X;
                        }
                        if (cp.Y != WinFormNativeMethods.CW_USEDEFAULT) {
                            cp.Y -= parentClient.Y;
                        }
                    }
                }
                ...
                //
                //if (cp.Parent == IntPtr.Zero && (cp.Style & WinFormNativeMethods.WS_CHILD) != 0) {
                //    Debug.Assert((cp.ExStyle & WinFormNativeMethods.WS_EX_MDICHILD) == 0, "Can't put MDI child forms on the parking form");
        ...
        protected void DefWndProcCore( ref Message m)
        {
        ...
        protected virtual void DestroyHandle() {
                ...
                if (_threadCallbackList != null) {
                    ...
                    lock (_threadCallbackList) {
                        if (_threadCallbackMessage != 0) {
                            WinFormNativeMethods.MSG msg = new WinFormNativeMethods.MSG();
                            if (WinFormUnsafeNativeMethods.PeekMessage(ref msg, new HandleRef(this, Handle), _threadCallbackMessage,
                                                          _threadCallbackMessage, WinFormNativeMethods.PM_NOREMOVE)) {
            ...
            if (0 != (WinFormNativeMethods.WS_EX_MDICHILD & (int)(long)WinFormUnsafeNativeMethods.GetWindowLong(new HandleRef(_Window, InternalHandle), WinFormNativeMethods.GWL_EXSTYLE))) {
                WinFormUnsafeNativeMethods.DefMDIChildProc(InternalHandle, WinFormNativeMethods.WM_CLOSE, IntPtr.Zero, IntPtr.Zero);
            }
            else {
        ...
        protected override void Dispose(bool disposing) {
            if (this._InvokeMethods != null)
            {
                this._InvokeMethods.Clear();
                this._InvokeMethods = null;
            }
            if (GetState(STATE_OWNCTLBRUSH)) {
                ...
                if (backBrush != null) {
                    ...
                    if (p != IntPtr.Zero) {
                        WinFormSafeNativeMethods.DeleteObject(new HandleRef(this, p));
                    }
            ...
            if (disposing) {
                ...
                if (GetState(STATE_CREATINGHANDLE)) {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.ClosingWhileCreatingHandle, "Dispose"));
        ...
        public DragDropEffects DoDragDrop(Object data, DragDropEffects allowedEffects) {            
            ...
            WinFormUnsafeNativeMethods.IOleDropSource dropSource = new DropSource( this );
            ...
            try {
                WinFormSafeNativeMethods.DoDragDrop(dataObject, dropSource, (int)allowedEffects, finalEffect);
            }
            catch (Exception e) {
        ...
        public void DrawToBitmap(Bitmap bitmap, Rectangle targetBounds) {
            ...
            using (Graphics g = Graphics.FromImage(image)) {
                ...
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, this.Handle), WinFormNativeMethods.WM_PRINT, (IntPtr)hDc,
                    (IntPtr)(WinFormNativeMethods.PRF_CHILDREN | WinFormNativeMethods.PRF_CLIENT | WinFormNativeMethods.PRF_ERASEBKGND | WinFormNativeMethods.PRF_NONCLIENT));

                //now BLT the result to the destination bitmap.
                using (Graphics destGraphics = Graphics.FromImage(bitmap)) {
                    IntPtr desthDC = destGraphics.GetHdc();
                    WinFormSafeNativeMethods.BitBlt(new HandleRef(destGraphics, desthDC), targetBounds.X, targetBounds.Y, width, height,
        ...
        public Object EndInvoke(IAsyncResult asyncResult) {
            ...
            //        if (WinFormSafeNativeMethods.GetWindowThreadProcessId(new HandleRef(marshaler, marshaler.Handle), out pid) == WinFormSafeNativeMethods.GetCurrentThreadId()) {
        ...
        internal bool EndUpdateInternal(bool invalidate) {
            if (_updateCount > 0) {
                ...
                _updateCount--;
                if (_updateCount == 0) {
                    SendMessage(WinFormNativeMethods.WM_SETREDRAW, -1, 0);
                    if (invalidate) {
                        Invalidate();
                    }
        ...
        internal virtual bool FocusInternal() {
            ...
            if (CanFocus){
                WinFormUnsafeNativeMethods.SetFocus(new HandleRef(this, Handle));
            }
        ...
        internal static Control FromChildHandleInternal(IntPtr handle) {
            while (handle != IntPtr.Zero) {
                ...
                handle = WinFormUnsafeNativeMethods.GetAncestor(new HandleRef(null, handle), WinFormNativeMethods.GA_PARENT);
            }
            return null;
        }
        ...
        internal static Control FromHandleInternal(IntPtr handle) {
            return DCWin32API.GetControl (handle.ToInt32()) as Control;
        ...
        public Control GetChildAtPoint(Point pt, GetChildAtPointSkip skipValue) {
            ...
            IntPtr hwnd = WinFormUnsafeNativeMethods.ChildWindowFromPointEx(new HandleRef(null, Handle), pt.X, pt.Y, value);
    ...
    /// <devdoc>
        ...
        private static FontHandleWrapper GetDefaultFontHandleWrapper() {
            if (_defaultFontHandleWrapper == null) {
                _defaultFontHandleWrapper = new FontHandleWrapper(DefaultFont);
            }

            return _defaultFontHandleWrapper;
        }

        internal IntPtr GetHRgn(Region region) {
            Graphics graphics = CreateGraphicsInternal();
            IntPtr handle = region.GetHrgn(graphics);
            System.Internal.HandleCollector.Add(handle, WinFormNativeMethods.CommonHandles.GDI);
            graphics.Dispose();
            return handle;
        }
        ...
        protected virtual Rectangle GetScaledBounds(Rectangle bounds, SizeF factor, BoundsSpecified specified) {
            ...
            WinFormNativeMethods.RECT adornments = new WinFormNativeMethods.RECT(0, 0, 0, 0);
            CreateParams cp = CreateParams;
            WinFormSafeNativeMethods.AdjustWindowRectEx(ref adornments, cp.Style, HasMenu, cp.ExStyle);
        ...
        private MouseButtons GetXButton(int wparam) {
            switch (wparam) {
            case WinFormNativeMethods.XBUTTON1:
                return MouseButtons.XButton1;
            case WinFormNativeMethods.XBUTTON2:
        ...
        private MenuItem GetMenuItemFromHandleId(IntPtr hmenu, int item) {
            MenuItem mi = null;
            int id = WinFormUnsafeNativeMethods.GetMenuItemID(new HandleRef(null, hmenu), item);
            if (id == unchecked((int)0xFFFFFFFF)) {
                IntPtr childMenu = IntPtr.Zero;
                childMenu = WinFormUnsafeNativeMethods.GetSubMenu(new HandleRef(null, hmenu), item);
                int count = WinFormUnsafeNativeMethods.GetMenuItemCount(new HandleRef(null, childMenu));
                MenuItem found = null;
        ...
        private static ArrayList GetChildWindows(IntPtr hWndParent) {
            ...
            for (IntPtr hWndChild = WinFormUnsafeNativeMethods.GetWindow(new HandleRef(null, hWndParent), WinFormNativeMethods.GW_CHILD);
                 hWndChild != IntPtr.Zero;
                 hWndChild = WinFormUnsafeNativeMethods.GetWindow(new HandleRef(null, hWndChild), WinFormNativeMethods.GW_HWNDNEXT)) {
        ...
        internal static IntPtr GetSafeHandle(IWin32Window window)
        {
            ...
            if (control != null) {
                hWnd = control.Handle;
                Debug.Assert(hWnd == IntPtr.Zero || WinFormUnsafeNativeMethods.IsWindow(new HandleRef(null, hWnd)));
                return hWnd;
            }
            else {
                //IntSecurity.AllWindows.Demand();
                hWnd = window.Handle;
                if (hWnd == IntPtr.Zero || WinFormUnsafeNativeMethods.IsWindow(new HandleRef(null, hWnd))) {
                    return hWnd;
                }
                else {
                    throw new Win32Exception(WinFormNativeMethods.ERROR_INVALID_HANDLE);
                }
            }
        }
        ...
        private void HookMouseEvent() {
            if (!GetState(STATE_TRACKINGMOUSEEVENT)) {
                ...
                if (_trackMouseEvent == null) {
                    _trackMouseEvent = new WinFormNativeMethods.TRACKMOUSEEVENT();
                    _trackMouseEvent.dwFlags = WinFormNativeMethods.TME_LEAVE | WinFormNativeMethods.TME_HOVER;
                    _trackMouseEvent.hwndTrack = Handle;
                }

                WinFormSafeNativeMethods.TrackMouseEvent(_trackMouseEvent);
            }
        }
        ...
        internal virtual IntPtr InitializeDCForWmCtlColor (IntPtr dc, int msg) {
            if (!GetStyle(ControlStyles.UserPaint)) {
                WinFormSafeNativeMethods.SetTextColor(new HandleRef(null, dc), ColorTranslator.ToWin32(ForeColor));
                WinFormSafeNativeMethods.SetBkColor(new HandleRef(null, dc), ColorTranslator.ToWin32(BackColor));
                return BackColorBrush;
            }
            else {
                return WinFormUnsafeNativeMethods.GetStockObject(WinFormNativeMethods.HOLLOW_BRUSH);
            }
        }
                ...
                try {
                    ...
                    if (invalidateChildren) {
                        WinFormSafeNativeMethods.RedrawWindow(new HandleRef(this, Handle),
                                                       ...
                                                       WinFormNativeMethods.RDW_INVALIDATE |
                                                       WinFormNativeMethods.RDW_ERASE |
                                                       WinFormNativeMethods.RDW_ALLCHILDREN);
                    }
                    else {
                        // It's safe to invoke InvalidateRgn from a separate thread.
                        using (new MultithreadSafeCallScope())
                        {
                            WinFormSafeNativeMethods.InvalidateRgn(new HandleRef(this, Handle),
                    ...
                    WinFormSafeNativeMethods.DeleteObject(new HandleRef(region, regionHandle));
                }
        ...
        public void Invalidate(bool invalidateChildren) {
            if (IsHandleCreated) {
                if (invalidateChildren) {
                    WinFormSafeNativeMethods.RedrawWindow(new HandleRef(_Window, Handle),
                                                   null, WinFormNativeMethods.NullHandleRef,
                                                   WinFormNativeMethods.RDW_INVALIDATE |
                                                   WinFormNativeMethods.RDW_ERASE |
                                                   WinFormNativeMethods.RDW_ALLCHILDREN);
                }
                    ...
                    using (new MultithreadSafeCallScope())
                    {
                        WinFormSafeNativeMethods.InvalidateRect(new HandleRef(_Window, Handle),
                                                         null,
        ...
        public void Invalidate(Rectangle rc, bool invalidateChildren) {
            if (rc.IsEmpty) {
                ...
                if (invalidateChildren) {
                    WinFormNativeMethods.RECT rcArea = WinFormNativeMethods.RECT.FromXYWH(rc.X, rc.Y, rc.Width, rc.Height);
                    WinFormSafeNativeMethods.RedrawWindow(new HandleRef(_Window, Handle),
                                                   ref rcArea, WinFormNativeMethods.NullHandleRef,
                                                   WinFormNativeMethods.RDW_INVALIDATE |
                                                   WinFormNativeMethods.RDW_ERASE |
                                                   WinFormNativeMethods.RDW_ALLCHILDREN);
                }
                else {
                    WinFormNativeMethods.RECT rcArea =
                        WinFormNativeMethods.RECT.FromXYWH(rc.X, rc.Y, rc.Width,
                                                    rc.Height);
        ...
        private void InvokeMarshaledCallback(ThreadMethodEntry tme){
            if (tme.executionContext != null) {
                if (_invokeMarshaledCallbackHelperDelegate == null) {
                    _invokeMarshaledCallbackHelperDelegate = new ContextCallback(InvokeMarshaledCallbackHelper);
                }
                ...
                ExecutionContext.Run(tme.executionContext, _invokeMarshaledCallbackHelperDelegate, tme);
            }
            else {
        ...
        public static bool IsKeyLocked(Keys keyVal) {
            if (keyVal == Keys.Insert || keyVal == Keys.NumLock || keyVal == Keys.CapsLock || keyVal == Keys.Scroll) {
                int result = WinFormUnsafeNativeMethods.GetKeyState((int)keyVal);
            ...
            throw new NotSupportedException(DCSR.GetString(DCSR.ControlIsKeyLockedNumCapsScrollLockKeysSupportedOnly));
        }
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        protected virtual bool IsInputChar(char charCode) {
            ...
            if (charCode == (char)(int)Keys.Tab) {
                mask = WinFormNativeMethods.DLGC_WANTCHARS | WinFormNativeMethods.DLGC_WANTALLKEYS | WinFormNativeMethods.DLGC_WANTTAB;
            }
            else {
                mask = WinFormNativeMethods.DLGC_WANTCHARS | WinFormNativeMethods.DLGC_WANTALLKEYS;
            }
            return(unchecked( (int) (long)SendMessage(WinFormNativeMethods.WM_GETDLGCODE, 0, 0)) & mask) != 0;
        }
        ...
        protected virtual bool IsInputKey(Keys keyData) {
            ...
            int mask = WinFormNativeMethods.DLGC_WANTALLKEYS;
            switch (keyData & Keys.KeyCode) {
                case Keys.Tab:
                    mask = WinFormNativeMethods.DLGC_WANTALLKEYS | WinFormNativeMethods.DLGC_WANTTAB;
                    break;
                case Keys.Left:
                case Keys.Right:
                case Keys.Up:
                case Keys.Down:
                    mask = WinFormNativeMethods.DLGC_WANTALLKEYS | WinFormNativeMethods.DLGC_WANTARROWS;
                    break;
            }
        ...
        private Object MarshaledInvoke(Control caller, Delegate method, Object[] args, bool synchronous) {
            ...
            if (!IsHandleCreated) {
                throw new InvalidOperationException(DCSR.GetString(DCSR.ErrorNoMarshalingThread));
            }
            ...
            int pid; // ignored
            if (WinFormSafeNativeMethods.GetWindowThreadProcessId(new HandleRef(this, Handle), out pid) == WinFormSafeNativeMethods.GetCurrentThreadId()) {
                if (synchronous)
                    syncSameThread = true;
            }
            ...
            lock (_threadCallbackList) {
                if (_threadCallbackMessage == 0) {
                    _threadCallbackMessage = WinFormSafeNativeMethods.RegisterWindowMessage(Application.WindowMessagesVersion + "_ThreadCallbackMessage");
                }
            ...
            if (syncSameThread) {
                ...
                WinFormUnsafeNativeMethods.PostMessage(new HandleRef(this, Handle), _threadCallbackMessage, IntPtr.Zero, IntPtr.Zero);
            }
        ...
        protected virtual void OnEnabledChanged(EventArgs e) {
            ...
            if (IsHandleCreated) {
                WinFormSafeNativeMethods.EnableWindow(new HandleRef(this, Handle), Enabled);
        ...
        internal virtual void OnParentHandleRecreated() {
            ...
            if (parent != null) {
                if (IsHandleCreated) {
                    WinFormUnsafeNativeMethods.SetParent(new HandleRef(this, this.Handle), new HandleRef(parent, parent.Handle));
                    UpdateZOrder();
                }
            }
        ...
        protected virtual void OnPrint(PaintEventArgs e) {
            ...
            if (GetStyle(ControlStyles.UserPaint)) {
                ...
                if (ppev == null) {
                    IntPtr flags = (IntPtr)(WinFormNativeMethods.PRF_CHILDREN | WinFormNativeMethods.PRF_CLIENT | WinFormNativeMethods.PRF_ERASEBKGND | WinFormNativeMethods.PRF_NONCLIENT);
                    hdc = e.HDC;
                    ...
                    m = Message.Create(this.Handle, WinFormNativeMethods.WM_PRINTCLIENT, hdc, flags);
                }
                else {
                    m = ppev.Message;
                }
        ...
        [EditorBrowsable(EditorBrowsableState.Advanced)]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        protected virtual async Task OnClickAsync(EventArgs e)
        {
            var handler = (EventHandlerAsync)this.Events[EventClickAsync];
            if(handler != null )
            {
        ...
        protected virtual void OnHandleCreated(EventArgs e) {
            ...
            if (this.IsHandleCreated) {
                ...
                if (_text != null && _text.Length != 0) {
                    DCWin32API.SetWindowText(this.Handle.ToInt32(), _text);
                    //WinFormUnsafeNativeMethods.SetWindowText(new HandleRef(this, Handle), text);
                }
        ...
        internal virtual void OnInvokedSetScrollPosition(object sender, EventArgs e) {
            if (!(this is ScrollableControl) && !IsMirrored) {
                ...
                si.fMask = WinFormNativeMethods.SIF_RANGE;
                if (WinFormUnsafeNativeMethods.GetScrollInfo(new HandleRef(this, Handle), WinFormNativeMethods.SB_HORZ,si) != false) {
                    si.nPos = (RightToLeft == RightToLeft.Yes) ? si.nMax : si.nMin;
                    SendMessage(WinFormNativeMethods.WM_HSCROLL, WinFormNativeMethods.Util.MAKELPARAM(WinFormNativeMethods.SB_THUMBPOSITION, si.nPos), 0);
                }                
            } 
        }
        ...
        protected virtual void OnHandleDestroyed(EventArgs e) {
            ...
            try {
                if (!GetAnyDisposingInHierarchy()) {
                    _text = Text;
                    if (_text != null && _text.Length == 0) _text = null;
                }
        ...
        private static readonly object EventDoubleClickAsync = new object();
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public EventHandlerAsync DoubleClickAsync
        {
            get
            {
                return (EventHandlerAsync)this.Events[EventDoubleClickAsync];
            }
            set
            {
                this.Events[EventDoubleClickAsync] = value;
            }
        }

        [EditorBrowsable(EditorBrowsableState.Advanced)]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        protected virtual async Task OnDoubleClickAsync(EventArgs e)
        {
            var handler = (EventHandlerAsync)Events[EventDoubleClickAsync];
            if(handler != null )
            {
                await handler(this, e);
            }
        ...
        private static readonly object EventMouseDoubleClickAsync = new object();
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public MouseEventHandlerAsync MouseDoubleClickAsync
        {
            get
            {
                return (MouseEventHandlerAsync)this.Events[EventMouseDoubleClickAsync];
            }
            set
            {
                this.Events[EventMouseDoubleClickAsync] = value;
            }
        }
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        protected virtual async Task OnMouseDoubleClickAsync(MouseEventArgs e)
        {
            var handler = (MouseEventHandlerAsync)this.Events[EventMouseDoubleClickAsync];
            if(handler != null )
            {
                await handler(this, e);
            }
        ...
        private static readonly object EventMouseClickAsync = new object();
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public MouseEventHandlerAsync MouseClickAsync
        {
            get
            {
                return (MouseEventHandlerAsync)this.Events[EventMouseClickAsync];
            }
            set
            {
                this.Events[EventMouseClickAsync] = value;
            }
        }
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        protected virtual async Task OnMouseClickAsync( MouseEventArgs e )
        {
            var handler = (MouseEventHandlerAsync)this.Events[EventMouseClickAsync];
            if(handler != null )
            {
                await handler(this, e);
            }
        ...
        private static readonly object EventMouseUpAsync = new object();
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public MouseEventHandlerAsync MouseUpAsync
        {
            get
            {
                return (MouseEventHandlerAsync)this.Events[EventMouseUpAsync];
            }
            set
            {
                this.Events[EventMouseUpAsync] = value;
            }
        }
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        protected virtual async Task OnMouseUpAsync(MouseEventArgs e)
        {
            var handler = (MouseEventHandlerAsync)this.Events[EventMouseUpAsync];
            if( handler != null )
            {
                await handler(this, e);
            }
        ...
        protected virtual void OnPaintBackground(PaintEventArgs pevent) {
            ...
            WinFormNativeMethods.RECT rect = new WinFormNativeMethods.RECT();
            WinFormUnsafeNativeMethods.GetClientRect(new HandleRef(_Window, InternalHandle), ref rect);
        ...
        protected virtual void OnRegionChanged(EventArgs e) {
           Contract.Requires(e != null);
           EventHandler eh = this.Events[EventRegionChanged] as EventHandler;
           if (eh != null) {
                eh(this, e);
           }
        }
        ...
        protected virtual void OnResize(EventArgs e) {
            ...
            EventHandler handler = (EventHandler)this.Events[EventResize];
            if (handler != null) handler(this, e);
        }
        ...
        internal Point PointToClientInternal(Point p) {
            ...
            WinFormNativeMethods.POINT point = new WinFormNativeMethods.POINT(p.X, p.Y);
            WinFormUnsafeNativeMethods.MapWindowPoints(WinFormNativeMethods.NullHandleRef, new HandleRef(this, Handle), point, 1);
        ...
        public Point PointToScreen(Point p) {
            ...
            WinFormNativeMethods.POINT point = new WinFormNativeMethods.POINT(p.X, p.Y);
            WinFormUnsafeNativeMethods.MapWindowPoints(new HandleRef(this, Handle), WinFormNativeMethods.NullHandleRef, point, 1);
            return new Point(point.x, point.y);
        }
        ...
        public virtual bool PreProcessMessage(ref Message msg) {
         //   Debug.WriteLineIf(ControlKeyboardRouting.TraceVerbose, "Control.PreProcessMessage " + msg.ToString());
            ...
            if (msg.Msg == WinFormNativeMethods.WM_KEYDOWN || msg.Msg == WinFormNativeMethods.WM_SYSKEYDOWN) {
            ...
            else if (msg.Msg == WinFormNativeMethods.WM_CHAR || msg.Msg == WinFormNativeMethods.WM_SYSCHAR) {
                if (msg.Msg == WinFormNativeMethods.WM_CHAR && IsInputChar((char)msg.WParam)) {
        ...
        private void PrintToMetaFile(HandleRef hDC, IntPtr lParam) {
            Debug.Assert(WinFormUnsafeNativeMethods.GetObjectType(hDC) == WinFormNativeMethods.OBJ_ENHMETADC,
                "PrintToMetaFile() called with a non-Enhanced MetaFile DC.");
            Debug.Assert(((long) lParam & WinFormNativeMethods.PRF_CHILDREN) != 0,
                "PrintToMetaFile() called without PRF_CHILDREN.");

            // Strip the PRF_CHILDREN flag.  We will manually walk our children and print them.
            lParam = (IntPtr)((long) lParam & ~WinFormNativeMethods.PRF_CHILDREN);
            ...
            WinFormNativeMethods.POINT viewportOrg = new WinFormNativeMethods.POINT();
            bool success = WinFormSafeNativeMethods.GetViewportOrgEx(hDC, viewportOrg);
            Debug.Assert(success, "GetViewportOrgEx() failed.");

            HandleRef hClippingRegion = new HandleRef(null, WinFormSafeNativeMethods.CreateRectRgn(viewportOrg.x,viewportOrg.y, viewportOrg.x + this.Width, viewportOrg.y + this.Height));
            ...
            try {
                ...
                WinFormNativeMethods.RegionFlags selectResult = (WinFormNativeMethods.RegionFlags)WinFormSafeNativeMethods.SelectClipRgn(hDC, hClippingRegion);
                Debug.Assert((selectResult == WinFormNativeMethods.RegionFlags.SIMPLEREGION ||
                              selectResult == WinFormNativeMethods.RegionFlags.NULLREGION),
                              "SIMPLEREGION or NULLLREGION expected.");

                PrintToMetaFileRecursive(hDC, lParam, new Rectangle(Point.Empty, this.Size));
            }
            finally {
                success = WinFormSafeNativeMethods.DeleteObject(hClippingRegion);
        ...
        internal virtual void PrintToMetaFileRecursive(HandleRef hDC, IntPtr lParam, Rectangle bounds) {
            ...
            using (WindowsFormsUtils.DCMapping mapping = new WindowsFormsUtils.DCMapping(hDC, bounds)) {
                ...
                PrintToMetaFile_SendPrintMessage(hDC, (IntPtr)((long)lParam & ~WinFormNativeMethods.PRF_CLIENT));

                // figure out mapping for the client area
                WinFormNativeMethods.RECT windowRect = new WinFormNativeMethods.RECT();
                bool success = WinFormUnsafeNativeMethods.GetWindowRect(new HandleRef(null, this.Handle), ref windowRect);
                ...
                using (WindowsFormsUtils.DCMapping clientMapping = new WindowsFormsUtils.DCMapping(hDC, clientBounds)) {
                    ...
                    PrintToMetaFile_SendPrintMessage(hDC, (IntPtr)((long)lParam & ~WinFormNativeMethods.PRF_NONCLIENT));
        ...
        private void PrintToMetaFile_SendPrintMessage(HandleRef hDC, IntPtr lParam) {
            if(GetStyle(ControlStyles.UserPaint)) {
                ...
                SendMessage(WinFormNativeMethods.WM_PRINT, hDC.Handle, lParam);
            }
            else {
                ...
                using (MetafileDCWrapper dcWrapper = new MetafileDCWrapper(hDC, this.Size)) {
                    SendMessage(WinFormNativeMethods.WM_PRINT, dcWrapper.HDC, lParam);
                }
            }
        }
        ...
        protected virtual bool ProcessKeyEventArgs(ref Message m) {
            ...
            if (m.Msg == WinFormNativeMethods.WM_CHAR || m.Msg == WinFormNativeMethods.WM_SYSCHAR) {
            ...
            else if (m.Msg == WinFormNativeMethods.WM_IME_CHAR) {
                int charsToIgnore = this.ImeWmCharsToIgnore;
                ...
                if (Marshal.SystemDefaultCharSize == 1) {
                    ...
                    int stringLength = WinFormUnsafeNativeMethods.MultiByteToWideChar(0 /*CP_ACP*/, WinFormUnsafeNativeMethods.MB_PRECOMPOSED, b, b.Length, unicodeCharArray, 0);
                    if (stringLength > 0) {
                        unicodeCharArray = new char[stringLength];
                        WinFormUnsafeNativeMethods.MultiByteToWideChar(0 /*CP_ACP*/, WinFormUnsafeNativeMethods.MB_PRECOMPOSED, b, b.Length, unicodeCharArray, unicodeCharArray.Length);
                ...
                if (kpe.KeyChar == preEventCharacter) {
                    ...
                    if (Marshal.SystemDefaultCharSize == 1) {
                        ...
                        byte[] mbcsBytes = null;
                        int bytesNeeded = WinFormUnsafeNativeMethods.WideCharToMultiByte(0 /*CP_ACP*/, 0, keyChar, keyChar.Length, null, 0, IntPtr.Zero, IntPtr.Zero);
                        ...
                        if (bytesNeeded >= 2) {
                            ...
                            WinFormUnsafeNativeMethods.WideCharToMultiByte(0 /*CP_ACP*/, 0, keyChar, keyChar.Length, mbcsBytes, mbcsBytes.Length, IntPtr.Zero, IntPtr.Zero);
                            ...
                            mbcsBytes = new byte[bytesNeeded];
                            WinFormUnsafeNativeMethods.WideCharToMultiByte(0 /*CP_ACP*/,
                                                                    0,
                                                                    keyChar,
                                                                    keyChar.Length,
                                                                    mbcsBytes,
                ...
                if (m.Msg == WinFormNativeMethods.WM_KEYDOWN || m.Msg == WinFormNativeMethods.WM_SYSKEYDOWN) {
                    OnKeyDown(ke);
                }
                else {
                    OnKeyUp(ke);
            ...
            if (kpe != null) {
                ...
                if (ke.SuppressKeyPress) {
                    RemovePendingMessages(WinFormNativeMethods.WM_CHAR,     WinFormNativeMethods.WM_CHAR);
                    RemovePendingMessages(WinFormNativeMethods.WM_SYSCHAR,  WinFormNativeMethods.WM_SYSCHAR);
                    RemovePendingMessages(WinFormNativeMethods.WM_IME_CHAR, WinFormNativeMethods.WM_IME_CHAR);
                }
                return ke.Handled;
            }
        }
        ...
        protected internal virtual bool ProcessKeyMessage(ref Message m) {
            ...
            if (_Parent != null && _Parent.ProcessKeyPreview(ref m)) return true;
        ...
        protected internal virtual bool ProcessMnemonic(char charCode) {
         ...
         internal void ProcessUICues(ref Message msg) {
             ...
             int current = unchecked( (int) (long)SendMessage(WinFormNativeMethods.WM_QUERYUISTATE, 0, 0));
             ...
             if (current == 0 /*accelerator and focus cues are showing*/) {
                 ...
                 current = (int)topMostParent.SendMessage(WinFormNativeMethods.WM_QUERYUISTATE, 0, 0);
             }
             int toClear = 0;
            ...
            // we OR in UISF_HIDEACCEL, then call UIS_CLEAR to clear the "hidden" state.
             ...
             if (keyCode == Keys.F10 || keyCode == Keys.Menu) {
                 if ((current & WinFormNativeMethods.UISF_HIDEACCEL) != 0) {
                     // Keyboard accelerators are hidden, they need to be shown
                     toClear |= WinFormNativeMethods.UISF_HIDEACCEL;
                 }
             }
      
             if (keyCode == Keys.Tab) {
                 if ((current & WinFormNativeMethods.UISF_HIDEFOCUS) != 0) {
                     // Focus indicators are hidden, they need to be shown
                     toClear |= WinFormNativeMethods.UISF_HIDEFOCUS;
                 }
             }
             ...
             if (toClear != 0) {
                 ...
                 WinFormUnsafeNativeMethods.SendMessage(
                     new HandleRef(topMostParent, topMostParent.Handle),
                     WinFormUnsafeNativeMethods.GetParent(new HandleRef(null, topMostParent.Handle)) == IntPtr.Zero ? WinFormNativeMethods.WM_CHANGEUISTATE : WinFormNativeMethods.WM_UPDATEUISTATE,
                     (IntPtr)(WinFormNativeMethods.UIS_CLEAR | (toClear << 16)),
                     IntPtr.Zero);
             }
         }
        ...
        private void RemovePendingMessages(int msgMin, int msgMax) {
            if (!this.IsDisposed) {
                ...
                while (WinFormUnsafeNativeMethods.PeekMessage(ref msg, new HandleRef(this, hwnd),
                                                       msgMin, msgMax,
                                                       WinFormNativeMethods.PM_REMOVE)) {
                    ; // NULL loop
                }
            }
        }
       ...
       private void ResetSize() {
        ...
        internal virtual void RecreateHandleCore() {
            ...
            lock (this)
            {
                if (IsHandleCreated)
                {
                    ...
                    HandleRef parentHandle = new HandleRef(this, WinFormUnsafeNativeMethods.GetParent(new HandleRef(this, this.Handle)));
                    ...
                    finally
                    {
                        if (parentHandle.Handle != IntPtr.Zero                               // the parent was not null
                            && (Control.FromHandleInternal(parentHandle.Handle) == null || this._Parent == null) // but wasnt a windows forms window
                            && WinFormUnsafeNativeMethods.IsWindow(parentHandle))
                        {                 // and still is a window
                            ...
                            // us back.
                            WinFormUnsafeNativeMethods.SetParent(new HandleRef(this, this.Handle), parentHandle);
                        }
                    }
        ...
        public Rectangle RectangleToClient(Rectangle r) {
            ...
            WinFormNativeMethods.RECT rect = WinFormNativeMethods.RECT.FromXYWH(r.X, r.Y, r.Width, r.Height);
            WinFormUnsafeNativeMethods.MapWindowPoints(WinFormNativeMethods.NullHandleRef, new HandleRef(this, Handle), ref rect, 2);
        ...
        public Rectangle RectangleToScreen(Rectangle r) {
            ...
            WinFormNativeMethods.RECT rect = WinFormNativeMethods.RECT.FromXYWH(r.X, r.Y, r.Width, r.Height);
            WinFormUnsafeNativeMethods.MapWindowPoints(new HandleRef(this, Handle), WinFormNativeMethods.NullHandleRef, ref rect, 2);
            return Rectangle.FromLTRB(rect.left, rect.top, rect.right, rect.bottom);
        }
        ...
        internal static bool ReflectMessageInternal(IntPtr hWnd, ref Message m) {
            ...
            m.Result = control.SendMessage(WinFormNativeMethods.WM_REFLECT + m.Msg, m.WParam, m.LParam);
            return true;
        }
            ...
            if (accept != GetState(STATE_DROPTARGET) && IsHandleCreated) {
                try {
                    if (Application.OleRequired() != System.Threading.ApartmentState.STA) {
                        throw new ThreadStateException(DCSR.GetString(DCSR.ThreadMustBeSTA));
                    }
                    if (accept) {
                        //IntSecurity.ClipboardRead.Demand();
                        ...
                        // Register
                        int n = WinFormUnsafeNativeMethods.RegisterDragDrop(new HandleRef(this, Handle), (WinFormUnsafeNativeMethods.IOleDropTarget)(new DropTarget(this)));
                        Debug.WriteLineIf(CompModSwitches.DragDrop.TraceInfo, "   ret:" + n.ToString(CultureInfo.CurrentCulture));
                        if (n != 0 && n != WinFormNativeMethods.DRAGDROP_E_ALREADYREGISTERED) {
                        ...
                        // Revoke
                        int n = WinFormUnsafeNativeMethods.RevokeDragDrop(new HandleRef(this, Handle));
                        Debug.WriteLineIf(CompModSwitches.DragDrop.TraceInfo, "   ret:" + n.ToString(CultureInfo.InvariantCulture));
                        if (n != 0 && n != WinFormNativeMethods.DRAGDROP_E_NOTREGISTERED) {
                            throw new Win32Exception(n);
                        }
                    }
                    ...
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DragDropRegFailed), e);
                }
            }
        }
...
#pragma warning restore 618
        ...
        public bool SelectNextControl(Control ctl, bool forward, bool tabStopOnly, bool nested, bool wrap) {
            if (!Contains(ctl) || !nested && ctl._Parent != this) ctl = null;
        ...
        internal IntPtr SendMessage(int msg, int wparam, int lparam) {
            ...
            return WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), msg, wparam, lparam);
        }
        ...
        internal IntPtr SendMessage(int msg, ref int wparam, ref int lparam) {
            //Debug.Assert(IsHandleCreated, "Performance alert!  Calling Control::SendMessage and forcing handle creation.  Re-work control so handle creation is not required to set properties.  If there is no work around, wrap the call in an IsHandleCreated check.");
            return WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), msg, ref wparam, ref lparam);
        }
        internal IntPtr SendMessage(int msg, int wparam, IntPtr lparam) {
            Debug.Assert(IsHandleCreated, "Performance alert!  Calling Control::SendMessage and forcing handle creation.  Re-work control so handle creation is not required to set properties.  If there is no work around, wrap the call in an IsHandleCreated check.");
            return WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), msg, (IntPtr)wparam, lparam);
        }
        ...
        internal IntPtr SendMessage(int msg, IntPtr wparam, int lparam) {
            Debug.Assert(IsHandleCreated, "Performance alert!  Calling Control::SendMessage and forcing handle creation.  Re-work control so handle creation is not required to set properties.  If there is no work around, wrap the call in an IsHandleCreated check.");
            return WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), msg, wparam, (IntPtr)lparam);
        }
        ...
        ///     have a handle, it will be created.
        /// </devdoc>
        internal IntPtr SendMessage(int msg, int wparam, ref WinFormNativeMethods.RECT lparam) {
            Debug.Assert(IsHandleCreated, "Performance alert!  Calling Control::SendMessage and forcing handle creation.  Re-work control so handle creation is not required to set properties.  If there is no work around, wrap the call in an IsHandleCreated check.");
            return WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), msg, wparam, ref lparam);
        }
        ...
        public void SendToBack() {
            if (_Parent != null) {
                ...
                WinFormSafeNativeMethods.SetWindowPos(new HandleRef(_Window, Handle), WinFormNativeMethods.HWND_BOTTOM, 0, 0, 0, 0,
                                               WinFormNativeMethods.SWP_NOMOVE | WinFormNativeMethods.SWP_NOSIZE);
            }
        ...
        public void SetBounds(int x, int y, int width, int height) {
            if (this._Left != x || this._Top != y || this._Width != width ||
                this._Height != height) {
        ...
        public void SetBounds(int x, int y, int width, int height, BoundsSpecified specified) {
            if ((specified & BoundsSpecified.X) == BoundsSpecified.None) x = this._Left;
            if ((specified & BoundsSpecified.Y) == BoundsSpecified.None) y = this._Top;
            if ((specified & BoundsSpecified.Width) == BoundsSpecified.None) width = this._Width;
            if ((specified & BoundsSpecified.Height) == BoundsSpecified.None) height = this._Height;
            if (this._Left != x || this._Top != y || this._Width != width ||
                this._Height != height) {
                ...
                LayoutTransaction.DoLayout(ParentInternal, this, PropertyNames.Bounds);
                PropertyValueLogger.LogBounds(this, this._Left, this._Top, this._Width, this._Height);
            }
            else {
                // Still need to init scaling.
        ...
        protected virtual void SetBoundsCore(int x, int y, int width, int height, BoundsSpecified specified) {
            ...
            try {
                if (this._Left != x || this._Top != y || this._Width != width || this._Height != height)
                {
                    ...
                    if (!IsHandleCreated) {
                        ...
                        if (!GetState(STATE_SIZELOCKEDBYOS)) {
                            int flags = WinFormNativeMethods.SWP_NOZORDER | WinFormNativeMethods.SWP_NOACTIVATE;

                            if (this._Left == x && this._Top == y) {
                                flags |= WinFormNativeMethods.SWP_NOMOVE;
                            }
                            if (this._Width == width && this._Height == height) {
                                flags |= WinFormNativeMethods.SWP_NOSIZE;
                            }
                            //
                            ...
                            this._Width = width;
                            this._Height = height;
                            WinFormSafeNativeMethods.SetWindowPos(new HandleRef(_Window, Handle), WinFormNativeMethods.NullHandleRef, x, y, width, height, flags);
        ...
        internal Size SizeFromClientSize(int width, int height) {
            WinFormNativeMethods.RECT rect = new WinFormNativeMethods.RECT(0, 0, width, height);
            CreateParams cp = CreateParams;
        ...
        private void SetParentHandle(IntPtr value) {
            Debug.Assert(value != WinFormNativeMethods.InvalidIntPtr, "Outdated call to SetParentHandle");

            if (IsHandleCreated) {
                IntPtr parentHandle = WinFormUnsafeNativeMethods.GetParent(new HandleRef(_Window, Handle));
                ...
                if (parentHandle != value || (parentHandle == IntPtr.Zero && !topLevel)) {
                    ...
                    if (!GetTopLevel()) {
                        if (value == IntPtr.Zero) {
                            ...
                            WinFormUnsafeNativeMethods.SetParent(new HandleRef(_Window, Handle), new HandleRef(null, value));
                            if (_Parent != null) {
                    ...
                    WinFormUnsafeNativeMethods.SetParent(new HandleRef(_Window, Handle), new HandleRef(null, IntPtr.Zero));
                    Application.UnparkHandle(new HandleRef(_Window, Handle));
                }
            }
        }
        ...
        internal static IntPtr SetUpPalette(IntPtr dc, bool force, bool realizePalette) {
            ...
            IntPtr result = WinFormSafeNativeMethods.SelectPalette(new HandleRef(null, dc), new HandleRef(null, halftonePalette), (force ? 0 : 1));

            if (result != IntPtr.Zero && realizePalette) {
                WinFormSafeNativeMethods.RealizePalette(new HandleRef(null, dc));
            }
        ...
        internal void SetTopLevelInternal(bool value) {
            ...
            if (GetTopLevel() != value) {
                if (_Parent != null) {
                    throw new ArgumentException(DCSR.GetString(DCSR.TopLevelParentedControl), "value");
                }
        ...
        protected virtual void SetVisibleCore(bool value) {
            try {
                ...
                if (GetVisibleCore() != value) {
                    ...
                    if (GetTopLevel()) {
                        ...
                        if (IsHandleCreated || value) {
                                WinFormSafeNativeMethods.ShowWindow(new HandleRef(this, Handle), value ? ShowParams : WinFormNativeMethods.SW_HIDE);
                        }
                    }
                        ...
                        try {
                            ...
                            WinFormSafeNativeMethods.SetWindowPos(new HandleRef(_Window, Handle),
                                                           WinFormNativeMethods.NullHandleRef,
                                                           0, 0, 0, 0,
                                                           WinFormNativeMethods.SWP_NOSIZE
                                                           | WinFormNativeMethods.SWP_NOMOVE
                                                           | WinFormNativeMethods.SWP_NOZORDER
                                                           | WinFormNativeMethods.SWP_NOACTIVATE
                                                           | (value ? WinFormNativeMethods.SWP_SHOWWINDOW : WinFormNativeMethods.SWP_HIDEWINDOW));
                        }
                        catch {
                            SetState(STATE_VISIBLE, !value);
                            throw;
                    ...
                    if (!GetState(STATE_VISIBLE) && !value && IsHandleCreated) {
                        ...
                        // visible=false - if not, make it so.
                         if (!WinFormSafeNativeMethods.IsWindowVisible(new HandleRef(this,this.Handle))) {
                    ...
                    if (IsHandleCreated) {
                        ...
                        WinFormSafeNativeMethods.SetWindowPos(
                                                          new HandleRef(_Window, Handle), WinFormNativeMethods.NullHandleRef, 0, 0, 0, 0, WinFormNativeMethods.SWP_NOSIZE |
                                                          WinFormNativeMethods.SWP_NOMOVE | WinFormNativeMethods.SWP_NOZORDER | WinFormNativeMethods.SWP_NOACTIVATE |
                                                          (value ? WinFormNativeMethods.SWP_SHOWWINDOW : WinFormNativeMethods.SWP_HIDEWINDOW));
                    }
                }
            }
                ...
                this.LogWF2WPropertyValue("Visible", GetState(STATE_VISIBLE));
            }
        }
        ...
        private void SetWindowFont(){
            DCWin32API.SetControlFont(this.Handle.ToInt32(), this.Font);
            //SendMessage(WinFormNativeMethods.WM_SETFONT, FontHandle, 0 /*redraw = false*/);
        }

        private void SetWindowStyle(int flag, bool value) {
            int styleFlags = unchecked((int)((long)WinFormUnsafeNativeMethods.GetWindowLong(new HandleRef(this, Handle), WinFormNativeMethods.GWL_STYLE)));
            WinFormUnsafeNativeMethods.SetWindowLong(new HandleRef(this, Handle), WinFormNativeMethods.GWL_STYLE, new HandleRef(null, (IntPtr)(value? styleFlags | flag: styleFlags & ~flag)));
        }
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public void Update() {
            WinFormSafeNativeMethods.UpdateWindow(new HandleRef(_Window, InternalHandle));
        }
        ...
        protected internal void UpdateBounds() {
            var info2 = DCWin32API.GetWindowBoundsInfo(this.Handle);
            if (info2.Width > 0 || info2.Height > 0)
            {
                this.UpdateBounds(info2.Left, info2.Top, info2.Width, info2.Height, info2.ClientWidth, info2.ClientHeight);
            }
            //WinFormNativeMethods.RECT rect = new WinFormNativeMethods.RECT();
            //WinFormUnsafeNativeMethods.GetClientRect(new HandleRef(window, InternalHandle), ref rect);
            //int clientWidth = rect.right;
            //int clientHeight = rect.bottom;
            //WinFormUnsafeNativeMethods.GetWindowRect(new HandleRef(window, InternalHandle), ref rect);
            //if (!GetTopLevel()) {
            //    WinFormUnsafeNativeMethods.MapWindowPoints(WinFormNativeMethods.NullHandleRef, new HandleRef(null, WinFormUnsafeNativeMethods.GetParent(new HandleRef(window, InternalHandle))), ref rect, 2);
            //}
        ...
        protected void UpdateBounds(int x, int y, int width, int height, int clientWidth, int clientHeight) {
            ...
            //if(this is Panel && clientHeight == 36 )
            //{
            //    var s = 1;
            //}
            bool newLocation = this._Left != x || this._Top != y;
        ...
        private void UpdateChildControlIndex(Control ctl) {
            ...
            while ((hWnd = WinFormUnsafeNativeMethods.GetWindow(new HandleRef(null, hWnd), WinFormNativeMethods.GW_HWNDPREV)) != IntPtr.Zero) {
        ...
        private void UpdateChildZOrder(Control ctl) {
            if (!IsHandleCreated || !ctl.IsHandleCreated || ctl._Parent != this) return;
            IntPtr prevHandle = (IntPtr)WinFormNativeMethods.HWND_TOP;
            ...
            if (WinFormUnsafeNativeMethods.GetWindow(new HandleRef(ctl._Window, ctl.Handle), WinFormNativeMethods.GW_HWNDPREV) != prevHandle) {
                _State |= STATE_NOZORDER;
                try {
                    WinFormSafeNativeMethods.SetWindowPos(new HandleRef(ctl._Window, ctl.Handle), new HandleRef(null, prevHandle), 0, 0, 0, 0,
                                                   WinFormNativeMethods.SWP_NOMOVE | WinFormNativeMethods.SWP_NOSIZE);
                }
                finally {
                    _State &= ~STATE_NOZORDER;
        ...
        internal virtual void UpdateStylesCore() {
            if (IsHandleCreated) {
                ...
                if ((_State & STATE_VISIBLE) != 0){
                    cp.Style |= WinFormNativeMethods.WS_VISIBLE;
                }
                ...
                WinFormSafeNativeMethods.SetWindowPos(
                                              new HandleRef(this, Handle), WinFormNativeMethods.NullHandleRef, 0, 0, 0, 0,
                                              WinFormNativeMethods.SWP_DRAWFRAME | WinFormNativeMethods.SWP_NOACTIVATE | WinFormNativeMethods.SWP_NOMOVE
                                              | WinFormNativeMethods.SWP_NOSIZE | WinFormNativeMethods.SWP_NOZORDER);
        ...
        private void WmClose(ref Message m) {
            ...
            if (ParentInternal != null) {
                ...
                while (parentHandle != IntPtr.Zero) {
                    ...
                    int style = unchecked((int)((long)WinFormUnsafeNativeMethods.GetWindowLong(new HandleRef(null, lastParentHandle), WinFormNativeMethods.GWL_STYLE)));

                    if ((style & WinFormNativeMethods.WS_CHILD) == 0) {
                        break;
                    }
                ...
                if (lastParentHandle != IntPtr.Zero) {
                    WinFormUnsafeNativeMethods.PostMessage(new HandleRef(null, lastParentHandle), WinFormNativeMethods.WM_CLOSE, IntPtr.Zero, IntPtr.Zero);
                }
            }
        ...
        private void WmCommand(ref Message m) {
            if (IntPtr.Zero == m.LParam) {
                if (Command.DispatchID(WinFormNativeMethods.Util.LOWORD(m.WParam))) return;
            }
            else {
        ...
        internal void WmContextMenu(ref Message m, Control sourceControl) {
            ...
            if (contextMenu != null || contextMenuStrip != null) {
                int x = WinFormNativeMethods.Util.SignedLOWORD(m.LParam);
                int y = WinFormNativeMethods.Util.SignedHIWORD(m.LParam);
                Point client;
        ...
        private void WmEraseBkgnd(ref Message m) {
            if (GetStyle(ControlStyles.UserPaint)) {
                ...
                if (!(GetStyle(ControlStyles.AllPaintingInWmPaint))) {
                    ...
                    WinFormNativeMethods.RECT rc = new WinFormNativeMethods.RECT();
                    WinFormUnsafeNativeMethods.GetClientRect(new HandleRef(this, Handle), ref rc);
        ...
        private void WmGetObject(ref Message m) {
            ...
            //    //
            //    Guid IID_IAccessible = new Guid(WinFormNativeMethods.uuid_IAccessible);
            ...
            //        WinFormUnsafeNativeMethods.IAccessibleInternal iacc = (WinFormUnsafeNativeMethods.IAccessibleInternal) intAccessibleObject;
            ...
            //           // IntSecurity.UnmanagedCode.Assert();
            //            try {
            //                m.Result = WinFormUnsafeNativeMethods.LresultFromObject(ref IID_IAccessible, m.WParam, new HandleRef(ctrlAccessibleObject, punkAcc));
        ...
        private void WmHelp(ref Message m) {
            ...
            if (hpi != null) {
                switch (hpi.Option) {
                    case WinFormNativeMethods.HLP_FILE  : Help.ShowHelp (this, hpi.HelpFilePath);
                             break;
                    case WinFormNativeMethods.HLP_KEYWORD : Help.ShowHelp (this, hpi.HelpFilePath, hpi.Keyword);
                             break;
                    case WinFormNativeMethods.HLP_NAVIGATOR : Help.ShowHelp (this, hpi.HelpFilePath, hpi.Navigator);
                             break;
                    case WinFormNativeMethods.HLP_OBJECT : Help.ShowHelp (this, hpi.HelpFilePath, hpi.Navigator, hpi.Param);
                             break;
                }
            }

            // Note: info.hItemHandle is the handle of the window that sent the help message.
            WinFormNativeMethods.HELPINFO info = (WinFormNativeMethods.HELPINFO)m.GetLParam(typeof(WinFormNativeMethods.HELPINFO));
        ...
        private void WmMenuSelect(ref Message m) {
            int item = WinFormNativeMethods.Util.LOWORD(m.WParam);
            int flags = WinFormNativeMethods.Util.HIWORD(m.WParam);
            IntPtr hmenu = m.LParam;
            MenuItem mi = null;

            if ((flags & WinFormNativeMethods.MF_SYSMENU) != 0) {
                // nothing
            }
            else if ((flags & WinFormNativeMethods.MF_POPUP) == 0) {
        ...
        private void WmMouseDown(ref Message m, MouseButtons button, int clicks) {
            ...
            if (Enabled) {
                OnMouseDown(new MouseEventArgs(button, clicks, WinFormNativeMethods.Util.SignedLOWORD(m.LParam), WinFormNativeMethods.Util.SignedHIWORD(m.LParam), 0));
            }
        }
        ...
        private void WmMouseMove(ref Message m) {
            ...
            OnMouseMove(new MouseEventArgs(MouseButtons, 0, WinFormNativeMethods.Util.SignedLOWORD(m.LParam), WinFormNativeMethods.Util.SignedHIWORD(m.LParam), 0));
        }
        ...
        /// </devdoc>
        /// <internalonly/>
        private async Task WmMouseUp(Message m, MouseButtons button, int clicks)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        SendMessage(WinFormNativeMethods.WM_CONTEXTMENU, this.Handle, WinFormNativeMethods.Util.MAKELPARAM(pt.X, pt.Y));
                    }
                }
                ...
                {
                    if (GetState(STATE_MOUSEPRESSED) && !IsDisposed /*&& WinFormUnsafeNativeMethods.WindowFromPoint(pt.X, pt.Y) == Handle*/)
                    {
                        fireClick = true;
                    }
                }
                ...
                if (fireClick && !ValidationCancelled)
                {
                    if (!GetState(STATE_DOUBLECLICKFIRED))
                    {
                        ...
                        var args2 = new MouseEventArgs(button, clicks, WinFormNativeMethods.Util.SignedLOWORD(m.LParam), WinFormNativeMethods.Util.SignedHIWORD(m.LParam), 0);
                        await OnClickAsync(args2);
                        await OnMouseClickAsync(args2);
                        OnClick(args2);
                        OnMouseClick(args2);
                    }
                    ...
                    else
                    {
                        ...
                        var args = new MouseEventArgs(button, 2, WinFormNativeMethods.Util.SignedLOWORD(m.LParam), WinFormNativeMethods.Util.SignedHIWORD(m.LParam), 0);
                        await OnDoubleClickAsync(args);
                        await OnMouseDoubleClickAsync(args);
                        OnDoubleClick(args);
                ...
                var args3 = new MouseEventArgs(button, clicks, WinFormNativeMethods.Util.SignedLOWORD(m.LParam), WinFormNativeMethods.Util.SignedHIWORD(m.LParam), 0);
                await OnMouseUpAsync(args3);
                OnMouseUp(args3);
            }
            finally
            {
        ...
        private void WmMouseWheel(ref Message m) {
            Point p = new Point(WinFormNativeMethods.Util.SignedLOWORD(m.LParam), WinFormNativeMethods.Util.SignedHIWORD(m.LParam));
            p = PointToClient(p);
            HandledMouseEventArgs e = new HandledMouseEventArgs(MouseButtons.None,
                                                                0,
                                                                p.X,
                                                                p.Y,
                                                                WinFormNativeMethods.Util.SignedHIWORD(m.WParam));
            OnMouseWheel(e);
        ...
        private unsafe void WmNotify(ref Message m) {
            WinFormNativeMethods.NMHDR* nmhdr = (WinFormNativeMethods.NMHDR*)m.LParam;
            if (!ReflectMessageInternal(nmhdr->hwndFrom,ref m)) {
                if(nmhdr->code == WinFormNativeMethods.TTN_SHOW) {
                    m.Result = WinFormUnsafeNativeMethods.SendMessage(new HandleRef(null, nmhdr->hwndFrom), WinFormNativeMethods.WM_REFLECT + m.Msg, m.WParam, m.LParam);
                    return;
                }
                if(nmhdr->code == WinFormNativeMethods.TTN_POP) {
                    WinFormUnsafeNativeMethods.SendMessage(new HandleRef(null, nmhdr->hwndFrom), WinFormNativeMethods.WM_REFLECT + m.Msg, m.WParam, m.LParam);
                }
        ...
        private void WmOwnerDraw(ref Message m) {          
            ...
            IntPtr p = WinFormUnsafeNativeMethods.GetDlgItem(new HandleRef(null, m.HWnd), unchecked((int)(long)m.WParam));
            if (p == IntPtr.Zero) {
                p = m.WParam;
            }
            if (!ReflectMessageInternal(p, ref m)) {
                //Additional Check For Control .... TabControl truncates the Hwnd value...
                IntPtr handle = _Window.GetHandleFromID((short)WinFormNativeMethods.Util.LOWORD(m.WParam));
                if (handle != IntPtr.Zero) {
                    Control control = Control.FromHandleInternal(handle);
                    if (control != null) {
                        m.Result = control.SendMessage(WinFormNativeMethods.WM_REFLECT + m.Msg, handle, m.LParam);
                        reflectCalled = true;
                    }
                }
            }
        ...
        internal byte[] GetPaintData(Rectangle clipRect2 )
        {
            //if (this.DCOwnerDrawMode == DCOwnerDrawModeConsts.None)
            //{
            //    return;
            //}
            bool doubleBuffered = DoubleBuffered || (this.GetStyle(ControlStyles.AllPaintingInWmPaint) && DoubleBufferingEnabled);
#if DEBUG
...
#endif
            if (clipRect2.Width == -1 || clipRect2.Height == -1)
            {
                clipRect2 = this.ClientRectangle;
            }
            if (clipRect2.Width > 0 && clipRect2.Height > 0)
            {
                using (var g = System.Drawing.Graphics.CreateCanvas())
                {
                    var p2 = this.GetAutoScrollPositionForPaint();
                    g.SetAbsoluteOffset(p2.X, p2.Y);
                    var writer = new MyBinaryBuilder();
                    writer.Append4Int32(clipRect2.Left, clipRect2.Top, clipRect2.Width, clipRect2.Height);
                    writer.AppendBoolean(doubleBuffered);
                    writer.Append2Int32(p2.X, p2.Y);
                    var pevent = new PaintEventArgs(g, clipRect2);
                    g.SetClip(clipRect2);
                    g.ResetHasContent();
                    PaintWithErrorHandling(pevent, PaintLayerBackground);
                    ...
                    if (g.HasContent)
                    {
                        var bsData = g.BaseCanvas.FinallyWriteTo(writer);
                        //var bsData = writer.ToByteArray();
                        writer.Dispose();
                        return bsData;
                    }
                    else
        ...
        private void WmPaint(ref Message m) {
...
#endif
            Rectangle clipRect2 = Rectangle.Empty;
            if(m.ObjectLParam is JsonObject obj )
            {
                clipRect2 = obj.ConvertToRectangle();
            }
            else if (m.ObjectLParam is Rectangle)
            {
                clipRect2 = (Rectangle)m.ObjectLParam;
            }
            else
            {
                var jsonRect = m.GetObjectOnceFromLParam() as JsonObject;
                if (jsonRect != null)
                {
                    clipRect2 = jsonRect.ConvertToRectangle();
                }
            }
            var bolClearAll = false;
            if(clipRect2.Width == -1 || clipRect2.Height == -1 )
            {
                this.UpdateClientRectangleDirect();
                bolClearAll = true;
                clipRect2 = this.ClientRectangle;
            }
            if(clipRect2.Width >0 && clipRect2.Height > 0 )
            {
                using (var g = System.Drawing.Graphics.CreateCanvas())
                {
                    ...
                    writer.Append4Int32(clipRect2.Left, clipRect2.Top, clipRect2.Width, clipRect2.Height);
                    writer.AppendBoolean(doubleBuffered);
                    writer.AppendBoolean(bolClearAll);
                    writer.Append2Int32(p2.X, p2.Y);
                    PaintEventArgs pevent = new PaintEventArgs(g, clipRect2);
                    g.SetClip(clipRect2);
                    g.ResetHasContent();
                    PaintWithErrorHandling(pevent, PaintLayerBackground);
                    PaintWithErrorHandling(pevent, PaintLayerForeground);
                    if (g.HasContent)
                    {
                        ...
                        //var bsData = writer.ToByteArray();
                        writer.Dispose();
                        DCWin32API.JSRuntime.Invoke<object>(
                            "__DCPaintControlContent",
                            this.Handle.ToInt32(),
                            bsData);
                    }
                    else
...
//            IntPtr dc;
//            Rectangle clip;
//            WinFormNativeMethods.PAINTSTRUCT ps = new WinFormNativeMethods.PAINTSTRUCT();
...
//                    hWnd = this.Handle;
//                    dc = WinFormUnsafeNativeMethods.BeginPaint(new HandleRef(this, hWnd), ref ps);
//                    needDisposeDC = true;
...
//                            WinFormSafeNativeMethods.SelectPalette(new HandleRef(null, dc), new HandleRef(null, oldPal), 0);
//                        }
//                        if (bufferedGraphics != null) {
...
//            finally {
//                if (needDisposeDC) {
//                    WinFormUnsafeNativeMethods.EndPaint(new HandleRef(this, hWnd), ref ps);
//                }
//            }
        }
        ...
        private void WmQueryNewPalette(ref Message m) {
            ...
            IntPtr dc = WinFormUnsafeNativeMethods.GetDC(new HandleRef(this, Handle));
            try {
                SetUpPalette(dc, true /*force*/, true/*realize*/);
            }
            finally {
                // Let WmPaletteChanged do any necessary invalidation
                WinFormUnsafeNativeMethods.ReleaseDC(new HandleRef(this, Handle), new HandleRef(null, dc));
            }
            Invalidate(true);
            m.Result = (IntPtr)1;
            DefWndProc(ref m);
        ...
        private void WmSetCursor(ref Message m) {
            ...
            //
            if (m.WParam == InternalHandle && WinFormNativeMethods.Util.LOWORD(m.LParam) == WinFormNativeMethods.HTCLIENT) {
        ...
        private unsafe void WmWindowPosChanging(ref Message m) {
            ...
            //
            //if (IsActiveX) {
            //    WinFormNativeMethods.WINDOWPOS* wp = (WinFormNativeMethods.WINDOWPOS *)m.LParam;
            //    // Only call UpdateBounds if the new bounds are different.
            //    //
            //    bool different = false;

            //    if ((wp->flags & WinFormNativeMethods.SWP_NOMOVE) == 0 && (wp->x != Left || wp->y != Top)) {
            //        different = true;
            //    }
            //    if ((wp->flags & WinFormNativeMethods.SWP_NOSIZE) == 0 && (wp->cx != Width || wp->cy != Height)) {
            //        different = true;
            //    }
        ...
        private void WmParentNotify(ref Message m) {
            int msg = WinFormNativeMethods.Util.LOWORD(m.WParam);
            IntPtr hWnd = IntPtr.Zero;
            switch (msg) {
                case WinFormNativeMethods.WM_CREATE:
                    hWnd = m.LParam;
                    break;
                case WinFormNativeMethods.WM_DESTROY:
                    break;
                default:
                    hWnd = WinFormUnsafeNativeMethods.GetDlgItem(new HandleRef(this, Handle), WinFormNativeMethods.Util.HIWORD(m.WParam));
                    break;
            }
        ...
        private void WmUpdateUIState(ref Message m) {
            ...
            int cmd = WinFormNativeMethods.Util.LOWORD(m.WParam);

            // if we're initializing, dont bother updating the uiCuesState/Firing the event.
            
            if (cmd == WinFormNativeMethods.UIS_INITIALIZE) {
                return;
            }
            ...
            if ((WinFormNativeMethods.Util.HIWORD(m.WParam) & WinFormNativeMethods.UISF_HIDEACCEL) != 0) {

                // yes, clear means show.  nice api, guys.
                //
                bool showKeyboard = (cmd == WinFormNativeMethods.UIS_CLEAR);
            ...
            if ((WinFormNativeMethods.Util.HIWORD(m.WParam) & WinFormNativeMethods.UISF_HIDEFOCUS) != 0) {

                // yes, clear means show.  nice api, guys.
                //
                bool showFocus = (cmd == WinFormNativeMethods.UIS_CLEAR);
        ...
        internal virtual void Handle_WM_WINDOWPOSCHANGED(Message m )
        {
            this.WmWindowPosChanged(m);
        }
        ...
        /// </devdoc>
        /// <internalonly/>
        internal void WmWindowPosChanged(Message m)
        {
            try
            {
                DefWndProc(ref m);
                ...
                UpdateBounds();
                if (_Parent != null && WinFormUnsafeNativeMethods.GetParent(new HandleRef(_Window, InternalHandle)) == _Parent.InternalHandle &&
                    (_State & STATE_NOZORDER) == 0)
                {
                    var obj2 = m.GetObjectOnceFromLParam();
                    if (obj2 != null)
                    {
                        var wp = (WinFormNativeMethods.WINDOWPOS)obj2;
                        if ((wp.flags & WinFormNativeMethods.SWP_NOZORDER) == 0)
                        {
        ...
        internal async Task PublicWnProc(Message m )
        {
            await this.WndProc(m);
        }
        ...
        //    SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.UnmanagedCode)
        //]
        protected virtual async Task WndProc(Message m) {
            ...
            */
            switch (m.Msg) {
                case WinFormNativeMethods.WM_CAPTURECHANGED:
                     WmCaptureChanged(ref m);
                     break;

                case WinFormNativeMethods.WM_GETOBJECT:
                    WmGetObject(ref m);
                    break;

                case WinFormNativeMethods.WM_COMMAND:
                    WmCommand(ref m);
                    break;
                case WinFormNativeMethods.WM_CLOSE:
                    WmClose(ref m);
                    break;
                case WinFormNativeMethods.WM_CONTEXTMENU:
                    WmContextMenu(ref m);
                    break;
                case WinFormNativeMethods.WM_DISPLAYCHANGE:
                    WmDisplayChange(ref m);
                    break;
                case WinFormNativeMethods.WM_DRAWITEM:
                    WmDrawItem(ref m);
                    break;
                ...
                case WinFormNativeMethods.WM_EXITMENULOOP:
                    WmExitMenuLoop(ref m);
                    break;

                case WinFormNativeMethods.WM_HELP:
                    WmHelp(ref m);
                    break;

                case WinFormNativeMethods.WM_PAINT:
                    if (GetStyle(ControlStyles.UserPaint)) {
                        WmPaint(ref m);
                    }
                    else {
                ...
                case WinFormNativeMethods.WM_PRINTCLIENT:
                    if (GetStyle(ControlStyles.UserPaint)) {
                        WmPrintClient(ref m);
                    }
                    else {
                ...
                case WinFormNativeMethods.WM_INITMENUPOPUP:
                    WmInitMenuPopup(ref m);
                    break;

                case WinFormNativeMethods.WM_SYSCOMMAND:
                    if ((unchecked((int)(long)m.WParam) & 0xFFF0) == WinFormNativeMethods.SC_KEYMENU) {
                    ...
                    DefWndProc(ref m);
                break;
                case WinFormNativeMethods.WM_INPUTLANGCHANGE:
                    WmInputLangChange(ref m);
                    break;

                case WinFormNativeMethods.WM_INPUTLANGCHANGEREQUEST:
                    WmInputLangChangeRequest(ref m);
                    break;

                case WinFormNativeMethods.WM_MEASUREITEM:
                    WmMeasureItem(ref m);
                    break;
                case WinFormNativeMethods.WM_MENUCHAR:
                    WmMenuChar(ref m);
                    break;

                case WinFormNativeMethods.WM_MENUSELECT:
                    WmMenuSelect(ref m);
                    break;

                case WinFormNativeMethods.WM_SETCURSOR:
                    WmSetCursor(ref m);
                    break;

                case WinFormNativeMethods.WM_WINDOWPOSCHANGING:
                    WmWindowPosChanging(ref m);
                    break;

                case WinFormNativeMethods.WM_CHAR:
                case WinFormNativeMethods.WM_KEYDOWN:
                case WinFormNativeMethods.WM_SYSKEYDOWN:
                case WinFormNativeMethods.WM_KEYUP:
                case WinFormNativeMethods.WM_SYSKEYUP:
                    WmKeyChar(ref m);
                    break;
                case WinFormNativeMethods.WM_CREATE:
                    WmCreate(ref m);
                ...
                case WinFormNativeMethods.WM_CTLCOLOR:
                case WinFormNativeMethods.WM_CTLCOLORBTN:
                case WinFormNativeMethods.WM_CTLCOLORDLG:
                case WinFormNativeMethods.WM_CTLCOLORMSGBOX:
                case WinFormNativeMethods.WM_CTLCOLORSCROLLBAR:
                case WinFormNativeMethods.WM_CTLCOLOREDIT:
                case WinFormNativeMethods.WM_CTLCOLORLISTBOX:
                case WinFormNativeMethods.WM_CTLCOLORSTATIC:
                ...
                //
                case WinFormNativeMethods.WM_REFLECT + WinFormNativeMethods.WM_CTLCOLOR:
                case WinFormNativeMethods.WM_REFLECT + WinFormNativeMethods.WM_CTLCOLORBTN:
                case WinFormNativeMethods.WM_REFLECT + WinFormNativeMethods.WM_CTLCOLORDLG:
                case WinFormNativeMethods.WM_REFLECT + WinFormNativeMethods.WM_CTLCOLORMSGBOX:
                case WinFormNativeMethods.WM_REFLECT + WinFormNativeMethods.WM_CTLCOLORSCROLLBAR:
                case WinFormNativeMethods.WM_REFLECT + WinFormNativeMethods.WM_CTLCOLOREDIT:
                case WinFormNativeMethods.WM_REFLECT + WinFormNativeMethods.WM_CTLCOLORLISTBOX:
                case WinFormNativeMethods.WM_REFLECT + WinFormNativeMethods.WM_CTLCOLORSTATIC:                    
                    WmCtlColorControl(ref m);
                    break;
                case WinFormNativeMethods.WM_HSCROLL:
                case WinFormNativeMethods.WM_VSCROLL:
                case WinFormNativeMethods.WM_DELETEITEM:
                case WinFormNativeMethods.WM_VKEYTOITEM:
                case WinFormNativeMethods.WM_CHARTOITEM:
                case WinFormNativeMethods.WM_COMPAREITEM:
                    if (!ReflectMessageInternal(m.LParam, ref m)) {
                        DefWndProc(ref m);
                    }
                    break;
                case WinFormNativeMethods.WM_IME_CHAR:
                    WmImeChar(ref m);
                    break;
                case WinFormNativeMethods.WM_IME_STARTCOMPOSITION:
                    WmImeStartComposition(ref m);
                    break;
                case WinFormNativeMethods.WM_IME_ENDCOMPOSITION:
                    WmImeEndComposition(ref m);
                    break;
                case WinFormNativeMethods.WM_IME_NOTIFY:
                    WmImeNotify(ref m);
                    break;
                case WinFormNativeMethods.WM_KILLFOCUS:
                    WmKillFocus(ref m);
                    break;
                case WinFormNativeMethods.WM_LBUTTONDBLCLK:
                ...
                case WinFormNativeMethods.WM_LBUTTONUP:
                    await WmMouseUp(m, MouseButtons.Left, 1);
                    break;
                case WinFormNativeMethods.WM_MBUTTONDBLCLK:
                    WmMouseDown(ref m, MouseButtons.Middle, 2);
                    if (GetStyle(ControlStyles.StandardDoubleClick)) {
                        SetState(STATE_DOUBLECLICKFIRED, true);
                    }
                    break;
                case WinFormNativeMethods.WM_MBUTTONDOWN:
                    WmMouseDown(ref m, MouseButtons.Middle, 1);
                    break;
                case WinFormNativeMethods.WM_MBUTTONUP:
                    await WmMouseUp(m, MouseButtons.Middle, 1);
                    break;
                case WinFormNativeMethods.WM_XBUTTONDOWN:
                    WmMouseDown(ref m, GetXButton(WinFormNativeMethods.Util.HIWORD(m.WParam)), 1);
                    break;
                case WinFormNativeMethods.WM_XBUTTONUP:
                    await WmMouseUp( m, GetXButton(WinFormNativeMethods.Util.HIWORD(m.WParam)), 1);
                    break;
                case WinFormNativeMethods.WM_XBUTTONDBLCLK:
                    WmMouseDown(ref m, GetXButton(WinFormNativeMethods.Util.HIWORD(m.WParam)), 2);
                    if (GetStyle(ControlStyles.StandardDoubleClick)) {
                        SetState(STATE_DOUBLECLICKFIRED, true);
                    }
                    break;
                case WinFormNativeMethods.WM_MOUSELEAVE:
                    WmMouseLeave(ref m);
                    break;
                case WinFormNativeMethods.WM_MOUSEMOVE:
                    WmMouseMove(ref m);
                    break;
                case WinFormNativeMethods.WM_MOUSEWHEEL:
                    WmMouseWheel(ref m);
                    break;
                case WinFormNativeMethods.WM_MOVE:
                    WmMove(ref m);
                    break;
                case WinFormNativeMethods.WM_NOTIFY:
                    WmNotify(ref m);
                    break;
                case WinFormNativeMethods.WM_NOTIFYFORMAT:
                    WmNotifyFormat(ref m);
                    break;
                case WinFormNativeMethods.WM_REFLECT + WinFormNativeMethods.WM_NOTIFYFORMAT:
                    m.Result = (IntPtr)(Marshal.SystemDefaultCharSize == 1 ? WinFormNativeMethods.NFR_ANSI : WinFormNativeMethods.NFR_UNICODE);
                    break;
                case WinFormNativeMethods.WM_SHOWWINDOW:
                    WmShowWindow(ref m);
                    break;
                case WinFormNativeMethods.WM_RBUTTONDBLCLK:
                    WmMouseDown(ref m, MouseButtons.Right, 2);
                    if (GetStyle(ControlStyles.StandardDoubleClick)) {
                        SetState(STATE_DOUBLECLICKFIRED, true);
                    }
                    break;
                case WinFormNativeMethods.WM_RBUTTONDOWN:
                    WmMouseDown(ref m, MouseButtons.Right, 1);
                    break;
                case WinFormNativeMethods.WM_RBUTTONUP:
                    await WmMouseUp(m, MouseButtons.Right, 1);
                    break;
                case WinFormNativeMethods.WM_SETFOCUS:
                    WmSetFocus(ref m);
                    break;
                case WinFormNativeMethods.WM_MOUSEHOVER:
                    WmMouseHover(ref m);
                    break;
                case WinFormNativeMethods.WM_WINDOWPOSCHANGED:
                    WmWindowPosChanged(m);
                    break;
                case WinFormNativeMethods.WM_QUERYNEWPALETTE:
                    WmQueryNewPalette(ref m);
                    break;
                case WinFormNativeMethods.WM_UPDATEUISTATE:
                    WmUpdateUIState(ref m);
                    break;
                case WinFormNativeMethods.WM_PARENTNOTIFY:
                    WmParentNotify(ref m);
                    break;
                default:
                    // If we received a thread execute message, then execute it.
                    //
                    if (m.Msg == _threadCallbackMessage && m.Msg != 0) {
                        InvokeMarshaledCallbacks();
                        return;
                    }
                    ...
                    if (m.Msg == WinFormNativeMethods.WM_MOUSEENTER) {
                        WmMouseEnter(ref m);
                        break;
                    }
            ...
            if (site != null && site.DesignMode) {
                ...
                if(ccs != null) {
                    ...
                    try {
                        ...
                        if (locationProperty != null && !locationProperty.IsReadOnly && (bounds.X != this._Left || bounds.Y != this._Top)) {
                            if (!(site is INestedSite))
                            {
                    ...
                    case WinFormNativeMethods.WM_MOUSEMOVE:
                        if (!control.GetState(Control.STATE_TRACKINGMOUSEEVENT)) {
                            ...
                            if (!control.GetState(Control.STATE_MOUSEENTERPENDING)) {
                                control.SendMessage(WinFormNativeMethods.WM_MOUSEENTER, 0, 0);
                            }
                            else {
        ...
        public class ControlCollection : ArrangedElementCollection, IList, ICloneable {
            ...
            public virtual void Add(Control value) {
                ...
                if (value.GetTopLevel()) {
                    throw new ArgumentException(DCSR.GetString(DCSR.TopLevelControlAdd));
                }
                ...
                if (owner.CreateThreadId != value.CreateThreadId) {
                    throw new ArgumentException(DCSR.GetString(DCSR.AddDifferentThreads));
                }
            ...
            int IList.Add(object control) {
                if (control is Control) {
                    ...
                    throw new ArgumentException(DCSR.GetString(DCSR.ControlBadControl), "control");
                }
            }
            ...
            public new virtual Control this[int index] {
                get {
                    ...
                    if (index < 0 || index >= Count) {
                        throw new ArgumentOutOfRangeException("index", DCSR.GetString(DCSR.IndexOutOfRange, index.ToString(CultureInfo.CurrentCulture)));
                    }
            ...
            public virtual int GetChildIndex(Control child, bool throwException) {
                ...
                if (index == -1 && throwException) {
                    throw new ArgumentException(DCSR.GetString(DCSR.ControlNotChild));
                }
                return index;
            }
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IOleControl.GetControlInfo(WinFormNativeMethods.tagCONTROLINFO pCI) {
        //    Debug.WriteLineIf(CompModSwitches.ActiveX.TraceInfo, "AxSource:GetControlInfo");

        //    pCI.cb = Marshal.SizeOf(typeof(WinFormNativeMethods.tagCONTROLINFO));
        //    pCI.hAccel = IntPtr.Zero;
        //    pCI.cAccel = 0;
        //    pCI.dwFlags = 0;

        //    if (IsInputKey(Keys.Return)) {
        //        pCI.dwFlags |= WinFormNativeMethods.CTRLINFO_EATS_RETURN;
        //    }
        //    if (IsInputKey(Keys.Escape)) {
        //        pCI.dwFlags |= WinFormNativeMethods.CTRLINFO_EATS_ESCAPE;
        //    }
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IOleControl.OnMnemonic(ref WinFormNativeMethods.MSG pMsg) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IOleControl.OnAmbientPropertyChange(int dispID) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IOleControl.FreezeEvents(int bFreeze) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IOleInPlaceActiveObject.GetWindow(out IntPtr hwnd) {
        //    return((WinFormUnsafeNativeMethods.IOleInPlaceObject)this).GetWindow(out hwnd);
        //}
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IOleInPlaceActiveObject.ContextSensitiveHelp(int fEnterMode) {
        //    ((WinFormUnsafeNativeMethods.IOleInPlaceObject)this).ContextSensitiveHelp(fEnterMode);
        //}
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IOleInPlaceActiveObject.TranslateAccelerator(ref WinFormNativeMethods.MSG lpmsg) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IOleInPlaceActiveObject.OnFrameWindowActivate(bool fActivate) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IOleInPlaceActiveObject.OnDocWindowActivate(int fActivate) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IOleInPlaceActiveObject.ResizeBorder(WinFormNativeMethods.COMRECT prcBorder, WinFormUnsafeNativeMethods.IOleInPlaceUIWindow pUIWindow, bool fFrameWindow) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IOleInPlaceActiveObject.EnableModeless(int fEnable) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IOleInPlaceObject.GetWindow(out IntPtr hwnd) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IOleInPlaceObject.ContextSensitiveHelp(int fEnterMode) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IOleInPlaceObject.InPlaceDeactivate() {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IOleInPlaceObject.UIDeactivate() {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IOleInPlaceObject.SetObjectRects(WinFormNativeMethods.COMRECT lprcPosRect, WinFormNativeMethods.COMRECT lprcClipRect) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IOleInPlaceObject.ReactivateAndUndo() {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IOleObject.SetClientSite(WinFormUnsafeNativeMethods.IOleClientSite pClientSite) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //WinFormUnsafeNativeMethods.IOleClientSite WinFormUnsafeNativeMethods.IOleObject.GetClientSite() {
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.SetHostNames(string szContainerApp, string szContainerObj) {
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.Close(int dwSaveOption) {
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.SetMoniker(int dwWhichMoniker, Object pmk) {
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.GetMoniker(int dwAssign, int dwWhichMoniker, out Object moniker) {
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.InitFromData(IComDataObject pDataObject, int fCreation, int dwReserved) {
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.GetClipboardData(int dwReserved, out IComDataObject data) {
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.DoVerb(int iVerb, IntPtr lpmsg, WinFormUnsafeNativeMethods.IOleClientSite pActiveSite, int lindex, IntPtr hwndParent, WinFormNativeMethods.COMRECT lprcPosRect) {
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.EnumVerbs(out WinFormUnsafeNativeMethods.IEnumOLEVERB e) {
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.OleUpdate() {
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.IsUpToDate() {
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.GetUserClassID(ref Guid pClsid) {
//            pClsid = GetType().GUID;
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.GetUserType(int dwFormOfType, out string userType) {
//            Debug.WriteLineIf(CompModSwitches.ActiveX.TraceInfo, "AxSource:GetUserType");
//            if (dwFormOfType == WinFormNativeMethods.USERCLASSTYPE_FULL) {
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.SetExtent(int dwDrawAspect, WinFormNativeMethods.tagSIZEL pSizel) {
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.GetExtent(int dwDrawAspect, WinFormNativeMethods.tagSIZEL pSizel) {
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.Advise(IAdviseSink pAdvSink, out int cookie) {
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.Unadvise(int dwConnection) {
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.EnumAdvise(out IEnumSTATDATA e) {
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.GetMiscStatus(int dwAspect, out int cookie) {
//            if ((dwAspect & WinFormNativeMethods.DVASPECT_CONTENT) != 0) {
//                int status = WinFormNativeMethods.OLEMISC_ACTIVATEWHENVISIBLE | WinFormNativeMethods.OLEMISC_INSIDEOUT | WinFormNativeMethods.OLEMISC_SETCLIENTSITEFIRST;

//                if (GetStyle(ControlStyles.ResizeRedraw)) {
//                    status |= WinFormNativeMethods.OLEMISC_RECOMPOSEONRESIZE;
//                }

//                if (this is IButtonControl) {
//                    status |= WinFormNativeMethods.OLEMISC_ACTSLIKEBUTTON;
//                }
...
//                cookie = 0;
//                return WinFormNativeMethods.DV_E_DVASPECT;
//            }
//            return WinFormNativeMethods.S_OK;
//        }
...
//        /// </devdoc>
//        /// <internalonly/>
//        int WinFormUnsafeNativeMethods.IOleObject.SetColorScheme(WinFormNativeMethods.tagLOGPALETTE pLogpal) {
...
//        }
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IOleWindow.GetWindow(out IntPtr hwnd) {
        //    return((WinFormUnsafeNativeMethods.IOleInPlaceObject)this).GetWindow(out hwnd);
        //}
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IOleWindow.ContextSensitiveHelp(int fEnterMode) {
        //    ((WinFormUnsafeNativeMethods.IOleInPlaceObject)this).ContextSensitiveHelp(fEnterMode);
        //}
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IPersist.GetClassID(out Guid pClassID) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IPersistPropertyBag.InitNew() {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IPersistPropertyBag.GetClassID(out Guid pClassID) {
        //    pClassID = GetType().GUID;
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IPersistPropertyBag.Load(WinFormUnsafeNativeMethods.IPropertyBag pPropBag, WinFormUnsafeNativeMethods.IErrorLog pErrorLog) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IPersistPropertyBag.Save(WinFormUnsafeNativeMethods.IPropertyBag pPropBag, bool fClearDirty, bool fSaveAllProperties) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IPersistStorage.GetClassID(out Guid pClassID) {
        //    pClassID = GetType().GUID;
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IPersistStorage.IsDirty() {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IPersistStorage.InitNew(WinFormUnsafeNativeMethods.IStorage pstg) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IPersistStorage.Load(WinFormUnsafeNativeMethods.IStorage pstg) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IPersistStorage.Save(WinFormUnsafeNativeMethods.IStorage pstg, bool fSameAsLoad) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IPersistStorage.SaveCompleted(WinFormUnsafeNativeMethods.IStorage pStgNew) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IPersistStorage.HandsOffStorage() {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IPersistStreamInit.GetClassID(out Guid pClassID) {
        //    pClassID = GetType().GUID;
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IPersistStreamInit.IsDirty() {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IPersistStreamInit.Load(WinFormUnsafeNativeMethods.IStream pstm) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IPersistStreamInit.Save(WinFormUnsafeNativeMethods.IStream pstm, bool fClearDirty) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IPersistStreamInit.GetSizeMax(long pcbSize) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IPersistStreamInit.InitNew() {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IQuickActivate.QuickActivate(WinFormUnsafeNativeMethods.tagQACONTAINER pQaContainer, WinFormUnsafeNativeMethods.tagQACONTROL pQaControl) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IQuickActivate.SetContentExtent(WinFormNativeMethods.tagSIZEL pSizel) {
        //    Debug.WriteLineIf(CompModSwitches.ActiveX.TraceInfo, "AxSource:SetContentExtent");
        //    Debug.Indent();
        //    ActiveXInstance.SetExtent(WinFormNativeMethods.DVASPECT_CONTENT, pSizel);
        //    Debug.Unindent();
        //}
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IQuickActivate.GetContentExtent(WinFormNativeMethods.tagSIZEL pSizel) {
        //    Debug.WriteLineIf(CompModSwitches.ActiveX.TraceInfo, "AxSource:GetContentExtent");
        //    Debug.Indent();
        //    ActiveXInstance.GetExtent(WinFormNativeMethods.DVASPECT_CONTENT, pSizel);
        //    Debug.Unindent();
        //}
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IViewObject.Draw(int dwDrawAspect, int lindex, IntPtr pvAspect, WinFormNativeMethods.tagDVTARGETDEVICE ptd,
        //                                    IntPtr hdcTargetDev, IntPtr hdcDraw, WinFormNativeMethods.COMRECT lprcBounds, WinFormNativeMethods.COMRECT lprcWBounds,
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IViewObject.GetColorSet(int dwDrawAspect, int lindex, IntPtr pvAspect, WinFormNativeMethods.tagDVTARGETDEVICE ptd,
        //                                           IntPtr hicTargetDev, WinFormNativeMethods.tagLOGPALETTE ppColorSet) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IViewObject.Freeze(int dwDrawAspect, int lindex, IntPtr pvAspect, IntPtr pdwFreeze) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IViewObject.Unfreeze(int dwFreeze) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IViewObject.SetAdvise(int aspects, int advf, IAdviseSink pAdvSink) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IViewObject.GetAdvise(int[] paspects, int[] padvf, IAdviseSink[] pAdvSink) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IViewObject2.Draw(int dwDrawAspect, int lindex, IntPtr pvAspect, WinFormNativeMethods.tagDVTARGETDEVICE ptd,
        //                                     IntPtr hdcTargetDev, IntPtr hdcDraw, WinFormNativeMethods.COMRECT lprcBounds, WinFormNativeMethods.COMRECT lprcWBounds,
        //                                     IntPtr pfnContinue, int dwContinue) {
        //    Debug.WriteLineIf(CompModSwitches.ActiveX.TraceInfo, "AxSource:Draw");
        //    Debug.Indent();
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IViewObject2.GetColorSet(int dwDrawAspect, int lindex, IntPtr pvAspect, WinFormNativeMethods.tagDVTARGETDEVICE ptd,
        //                                            IntPtr hicTargetDev, WinFormNativeMethods.tagLOGPALETTE ppColorSet) {
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IViewObject2.Freeze(int dwDrawAspect, int lindex, IntPtr pvAspect, IntPtr pdwFreeze) {
        //    Debug.WriteLineIf(CompModSwitches.ActiveX.TraceInfo, "AxSource:Freezes");
        //    return WinFormNativeMethods.E_NOTIMPL;
        //}
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //int WinFormUnsafeNativeMethods.IViewObject2.Unfreeze(int dwFreeze) {
        //    Debug.WriteLineIf(CompModSwitches.ActiveX.TraceInfo, "AxSource:Unfreeze");
        //    return WinFormNativeMethods.E_NOTIMPL;
        //}
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IViewObject2.SetAdvise(int aspects, int advf, IAdviseSink pAdvSink) {
        //    Debug.WriteLineIf(CompModSwitches.ActiveX.TraceInfo, "AxSource:SetAdvise");
        //    ActiveXInstance.SetAdvise(aspects, advf, pAdvSink);
        //}
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IViewObject2.GetAdvise(int[] paspects, int[] padvf, IAdviseSink[] pAdvSink) {
        //    Debug.WriteLineIf(CompModSwitches.ActiveX.TraceInfo, "AxSource:GetAdvise");
        //    ActiveXInstance.GetAdvise(paspects, padvf, pAdvSink);
        //}
        ...
        ///// </devdoc>
        ///// <internalonly/>
        //void WinFormUnsafeNativeMethods.IViewObject2.GetExtent(int dwDrawAspect, int lindex, WinFormNativeMethods.tagDVTARGETDEVICE ptd, WinFormNativeMethods.tagSIZEL lpsizel) {
        ...
        //    //
        //    ((WinFormUnsafeNativeMethods.IOleObject)this).GetExtent(dwDrawAspect, lpsizel);
        //}
...
//            private static WinFormNativeMethods.tagOLEVERB[]     axVerbs;
...
//            private WinFormUnsafeNativeMethods.IOleClientSite          clientSite;
//            private WinFormUnsafeNativeMethods.IOleInPlaceUIWindow     inPlaceUiWindow;
//            private WinFormUnsafeNativeMethods.IOleInPlaceFrame        inPlaceFrame;
...
//            private WinFormNativeMethods.COMRECT   adjustRect; // temporary rect used during OnPosRectChange && SetObjectRects
...
//                    new AmbientProperty("Font", WinFormNativeMethods.ActiveX.DISPID_AMBIENT_FONT),
//                    new AmbientProperty("BackColor", WinFormNativeMethods.ActiveX.DISPID_AMBIENT_BACKCOLOR),
//                    new AmbientProperty("ForeColor", WinFormNativeMethods.ActiveX.DISPID_AMBIENT_FORECOLOR)
//                };
//            }
...
//                get {
//                    AmbientProperty prop = LookupAmbient(WinFormNativeMethods.ActiveX.DISPID_AMBIENT_BACKCOLOR);

//                    if (prop.Empty) {
//                        Object obj = null;
//                        if (GetAmbientProperty(WinFormNativeMethods.ActiveX.DISPID_AMBIENT_BACKCOLOR, ref obj)) {
//                            if (obj != null) {
//                                try {
...
//                [ResourceConsumption(ResourceScope.Process, ResourceScope.Process)]
//                get {
//                    AmbientProperty prop = LookupAmbient(WinFormNativeMethods.ActiveX.DISPID_AMBIENT_FONT);

//                    if (prop.Empty) {
//                        Object obj = null;
//                        if (GetAmbientProperty(WinFormNativeMethods.ActiveX.DISPID_AMBIENT_FONT, ref obj)) {
//                            try {
...
//                                WinFormUnsafeNativeMethods.IFont ifont = (WinFormUnsafeNativeMethods.IFont)obj;
...
//                get {
//                    AmbientProperty prop = LookupAmbient(WinFormNativeMethods.ActiveX.DISPID_AMBIENT_FORECOLOR);

//                    if (prop.Empty) {
//                        Object obj = null;
//                        if (GetAmbientProperty(WinFormNativeMethods.ActiveX.DISPID_AMBIENT_FORECOLOR, ref obj)) {
//                            if (obj != null) {
//                                try {
//                                    Debug.WriteLineIf(CompModSwitches.ActiveX.TraceInfo, "Object color type=" + obj.GetType().FullName);
//                                    prop.Value = ColorTranslator.FromOle(Convert.ToInt32(obj, CultureInfo.InvariantCulture));
...
//                            WinFormUnsafeNativeMethods.IOleContainer container;

//                            if (WinFormNativeMethods.Succeeded(clientSite.GetContainer(out container)) && container is WinFormNativeMethods.IHTMLDocument) {
//                                isIE = true;
//                                Debug.WriteLineIf(CompModSwitches.ActiveX.TraceVerbose, "AxSource:IsIE running under IE");
//                            }

//                            if (container != null && WinFormUnsafeNativeMethods.IsComObject(container)) {
//                                WinFormUnsafeNativeMethods.ReleaseComObject(container);
//                            }
//                        }
...
//                        logPixels = new Point();
//                        IntPtr dc = WinFormUnsafeNativeMethods.GetDC(WinFormNativeMethods.NullHandleRef);
//                        logPixels.X = WinFormUnsafeNativeMethods.GetDeviceCaps(new HandleRef(null, dc), WinFormNativeMethods.LOGPIXELSX);
//                        logPixels.Y = WinFormUnsafeNativeMethods.GetDeviceCaps(new HandleRef(null, dc), WinFormNativeMethods.LOGPIXELSY);
//                        WinFormUnsafeNativeMethods.ReleaseDC(WinFormNativeMethods.NullHandleRef, new HandleRef(null, dc));
//                    }
//                    return logPixels;
//                }
//            }
...
//                if ((dwSaveOption == WinFormNativeMethods.OLECLOSE_SAVEIFDIRTY ||
//                     dwSaveOption == WinFormNativeMethods.OLECLOSE_PROMPTSAVE) &&
...
//            /// </devdoc>
//            internal void DoVerb(int iVerb, IntPtr lpmsg, WinFormUnsafeNativeMethods.IOleClientSite pActiveSite, int lindex, IntPtr hwndParent, WinFormNativeMethods.COMRECT lprcPosRect) {
//                Debug.WriteLineIf(CompModSwitches.ActiveX.TraceVerbose, "AxSource:ActiveXImpl:DoVerb(" + iVerb + ")");
//                switch (iVerb) {
//                    case WinFormNativeMethods.OLEIVERB_SHOW:
//                    case WinFormNativeMethods.OLEIVERB_INPLACEACTIVATE:
//                    case WinFormNativeMethods.OLEIVERB_UIACTIVATE:
//                    case WinFormNativeMethods.OLEIVERB_PRIMARY:
...
//                            WinFormNativeMethods.MSG msg = (WinFormNativeMethods.MSG)WinFormUnsafeNativeMethods.PtrToStructure(lpmsg, typeof(WinFormNativeMethods.MSG));
//                            Control target = control;

//                            if (msg.hwnd != control.Handle && msg.message >= WinFormNativeMethods.WM_MOUSEFIRST && msg.message <= WinFormNativeMethods.WM_MOUSELAST) {

//                                // Must translate message coordniates over to our HWND.  We first try
//                                //
//                                IntPtr hwndMap = msg.hwnd == IntPtr.Zero ? hwndParent : msg.hwnd;
//                                WinFormNativeMethods.POINT pt = new WinFormNativeMethods.POINT();
//                                pt.x = WinFormNativeMethods.Util.LOWORD(msg.lParam);
//                                pt.y = WinFormNativeMethods.Util.HIWORD(msg.lParam);
//                                WinFormUnsafeNativeMethods.MapWindowPoints(new HandleRef(null, hwndMap), new HandleRef(control, control.Handle), pt, 1);
...
//                                    WinFormUnsafeNativeMethods.MapWindowPoints(new HandleRef(target, target.Handle), new HandleRef(realTarget, realTarget.Handle), pt, 1);
//                                    target = realTarget;
//                                }

//                                msg.lParam = WinFormNativeMethods.Util.MAKELPARAM(pt.x, pt.y);
//                            }
...
//                            if (msg.message == WinFormNativeMethods.WM_KEYDOWN && msg.wParam == (IntPtr)WinFormNativeMethods.VK_TAB) {
...
//                        //
//                    case WinFormNativeMethods.OLEIVERB_HIDE:
...
//                        ThrowHr(WinFormNativeMethods.E_NOTIMPL);
//                        break;
//                }
//            }
...
//            /// </devdoc>
//            internal void Draw(int dwDrawAspect, int lindex, IntPtr pvAspect, WinFormNativeMethods.tagDVTARGETDEVICE ptd,
//                             IntPtr hdcTargetDev, IntPtr hdcDraw, WinFormNativeMethods.COMRECT prcBounds, WinFormNativeMethods.COMRECT lprcWBounds,
//                             IntPtr pfnContinue, int dwContinue) {

//                // support the aspects required for multi-pass drawing
//                //
//                switch (dwDrawAspect) {
//                    case WinFormNativeMethods.DVASPECT_CONTENT:
//                    case WinFormNativeMethods.DVASPECT_OPAQUE:
//                    case WinFormNativeMethods.DVASPECT_TRANSPARENT:
//                        break;
//                    default:
//                        ThrowHr(WinFormNativeMethods.DV_E_DVASPECT);
//                        break;
//                }
...
//                //
//                int hdcType = WinFormUnsafeNativeMethods.GetObjectType(new HandleRef(null, hdcDraw));
//                if (hdcType == WinFormNativeMethods.OBJ_METADC) {
//                    ThrowHr(WinFormNativeMethods.VIEW_E_DRAW);
//                }

//                WinFormNativeMethods.RECT rc;
//                WinFormNativeMethods.POINT pVp = new WinFormNativeMethods.POINT();
//                WinFormNativeMethods.POINT pW = new WinFormNativeMethods.POINT();
//                WinFormNativeMethods.SIZE  sWindowExt = new WinFormNativeMethods.SIZE();
//                WinFormNativeMethods.SIZE  sViewportExt = new WinFormNativeMethods.SIZE();
//                int   iMode = WinFormNativeMethods.MM_TEXT;
...
//                //
//                if (prcBounds != null) {
//                    rc = new WinFormNativeMethods.RECT(prcBounds.left, prcBounds.top, prcBounds.right, prcBounds.bottom);
...
//                    // use.
//                    //
//                    WinFormSafeNativeMethods.LPtoDP(new HandleRef(null, hdcDraw), ref rc, 2);

//                    iMode = WinFormSafeNativeMethods.SetMapMode(new HandleRef(null, hdcDraw), WinFormNativeMethods.MM_ANISOTROPIC);
//                    WinFormSafeNativeMethods.SetWindowOrgEx(new HandleRef(null, hdcDraw), 0, 0, pW);
//                    WinFormSafeNativeMethods.SetWindowExtEx(new HandleRef(null, hdcDraw), control.Width, control.Height, sWindowExt);
//                    WinFormSafeNativeMethods.SetViewportOrgEx(new HandleRef(null, hdcDraw), rc.left, rc.top, pVp);
//                    WinFormSafeNativeMethods.SetViewportExtEx(new HandleRef(null, hdcDraw), rc.right - rc.left, rc.bottom - rc.top, sViewportExt);
//                }

//                // Now do the actual drawing.  We must ask all of our children to draw as well.
//                try {
//                    IntPtr flags = (IntPtr)(WinFormNativeMethods.PRF_CHILDREN
//                                    | WinFormNativeMethods.PRF_CLIENT
//                                    | WinFormNativeMethods.PRF_ERASEBKGND
//                                    | WinFormNativeMethods.PRF_NONCLIENT);
//                                  //| NativeMethods.PRF_CHECKVISIBLE
//                                  //| NativeMethods.PRF_OWNED));

//                    if(hdcType != WinFormNativeMethods.OBJ_ENHMETADC) {
//                        control.SendMessage(WinFormNativeMethods.WM_PRINT, hdcDraw, flags);
//                    } else {
...
//                    //
//                    if (prcBounds != null) {
//                        WinFormSafeNativeMethods.SetWindowOrgEx(new HandleRef(null, hdcDraw), pW.x, pW.y, null);
//                        WinFormSafeNativeMethods.SetWindowExtEx(new HandleRef(null, hdcDraw), sWindowExt.cx, sWindowExt.cy, null);
//                        WinFormSafeNativeMethods.SetViewportOrgEx(new HandleRef(null, hdcDraw), pVp.x, pVp.y, null);
//                        WinFormSafeNativeMethods.SetViewportExtEx(new HandleRef(null, hdcDraw), sViewportExt.cx, sViewportExt.cy, null);
//                        WinFormSafeNativeMethods.SetMapMode(new HandleRef(null, hdcDraw), iMode);
//                    }
//                }
//            }
...
//            /// </devdoc>
//            internal static int EnumVerbs(out WinFormUnsafeNativeMethods.IEnumOLEVERB e) {
//                if (axVerbs == null) {
//                    WinFormNativeMethods.tagOLEVERB verbShow             = new WinFormNativeMethods.tagOLEVERB();
//                    WinFormNativeMethods.tagOLEVERB verbInplaceActivate  = new WinFormNativeMethods.tagOLEVERB();
//                    WinFormNativeMethods.tagOLEVERB verbUIActivate       = new WinFormNativeMethods.tagOLEVERB();
//                    WinFormNativeMethods.tagOLEVERB verbHide             = new WinFormNativeMethods.tagOLEVERB();
//                    WinFormNativeMethods.tagOLEVERB verbPrimary          = new WinFormNativeMethods.tagOLEVERB();
//                    WinFormNativeMethods.tagOLEVERB verbProperties       = new WinFormNativeMethods.tagOLEVERB();

//                    verbShow.lVerb = WinFormNativeMethods.OLEIVERB_SHOW;
//                    verbInplaceActivate.lVerb = WinFormNativeMethods.OLEIVERB_INPLACEACTIVATE;
//                    verbUIActivate.lVerb = WinFormNativeMethods.OLEIVERB_UIACTIVATE;
//                    verbHide.lVerb = WinFormNativeMethods.OLEIVERB_HIDE;
//                    verbPrimary.lVerb = WinFormNativeMethods.OLEIVERB_PRIMARY;
//                    verbProperties.lVerb = WinFormNativeMethods.OLEIVERB_PROPERTIES;
//                    verbProperties.lpszVerbName = SR.GetString(SR.AXProperties);
//                    verbProperties.grfAttribs = WinFormNativeMethods.ActiveX.OLEVERBATTRIB_ONCONTAINERMENU;

//                    axVerbs = new WinFormNativeMethods.tagOLEVERB[] {
//                        verbShow,
//                        verbInplaceActivate,
//                        verbUIActivate,
//                        verbHide,
...
//                //
//                if (paspects != null) {
//                    paspects[0] = WinFormNativeMethods.DVASPECT_CONTENT;
//                }

//                if (padvf != null) {
//                    padvf[0] = 0;

//                    if (activeXState[viewAdviseOnlyOnce]) padvf[0] |= WinFormNativeMethods.ADVF_ONLYONCE;
//                    if (activeXState[viewAdvisePrimeFirst]) padvf[0] |= WinFormNativeMethods.ADVF_PRIMEFIRST;
//                }
...
//                if (clientSite is WinFormUnsafeNativeMethods.IDispatch) {
//                    Debug.WriteLineIf(CompModSwitches.ActiveX.TraceInfo, "clientSite implements IDispatch");

//                    WinFormUnsafeNativeMethods.IDispatch disp = (WinFormUnsafeNativeMethods.IDispatch)clientSite;
//                    Object[] pvt = new Object[1];
//                    Guid g = Guid.Empty;
//                    int hr = WinFormNativeMethods.E_FAIL;

//                   // IntSecurity.UnmanagedCode.Assert();
//                    try {
//                        hr = disp.Invoke(dispid, ref g, WinFormNativeMethods.LOCALE_USER_DEFAULT,
//                                         WinFormNativeMethods.DISPATCH_PROPERTYGET, new WinFormNativeMethods.tagDISPPARAMS(),
//                                         pvt, null, null);
//                    }
//                    finally {
//                       // CodeAccessPermission.RevertAssert();
...
//            /// </devdoc>
//            internal WinFormUnsafeNativeMethods.IOleClientSite GetClientSite() {
//                return clientSite;
//            }
...
//            /// <internalonly/>
//            //[SecurityPermission(SecurityAction.Assert, Flags=SecurityPermissionFlag.UnmanagedCode)]
//            internal int GetControlInfo(WinFormNativeMethods.tagCONTROLINFO pCI) {
//                if (accelCount == -1) {
...
//                    if (accelCount > 0) {
//                        int accelSize = WinFormUnsafeNativeMethods.SizeOf(typeof(WinFormNativeMethods.ACCEL));
...
//                        try {
//                            WinFormNativeMethods.ACCEL accel = new WinFormNativeMethods.ACCEL();
//                            accel.cmd = 0;
...
//                                    // Lower case letter
//                                    //
//                                    accel.fVirt = WinFormNativeMethods.FALT | WinFormNativeMethods.FVIRTKEY;
//                                    accel.key = (short)(WinFormUnsafeNativeMethods.VkKeyScan(ch) & 0x00FF);
...
//                                    accel.fVirt = WinFormNativeMethods.FALT | WinFormNativeMethods.FVIRTKEY | WinFormNativeMethods.FSHIFT;
//                                    Marshal.StructureToPtr(accel, structAddr, false);
//                                }
//                                else {
...
//                                    //
//                                    accel.fVirt = WinFormNativeMethods.FALT | WinFormNativeMethods.FVIRTKEY;
//                                    short scan = (short)(WinFormUnsafeNativeMethods.VkKeyScan(ch));
//                                    if ((scan & 0x0100) != 0) {
//                                        accel.fVirt |= WinFormNativeMethods.FSHIFT;
//                                    }
...
//	                        WinFormUnsafeNativeMethods.DestroyAcceleratorTable(new HandleRef(this, accelTable));
//				   accelTable = IntPtr.Zero;
//	                    	}
                            
//                            accelTable = WinFormUnsafeNativeMethods.CreateAcceleratorTable(new HandleRef(null, accelBlob), accelCount);
//                        }
//                        finally {
...
//            /// </devdoc>
//            internal void GetExtent(int dwDrawAspect, WinFormNativeMethods.tagSIZEL pSizel) {
//                if ((dwDrawAspect & WinFormNativeMethods.DVASPECT_CONTENT) != 0) {
...
//                if (!activeXState[inPlaceActive]) {
//                    hwnd = IntPtr.Zero;
//                    return WinFormNativeMethods.E_FAIL;
//                }
//                hwnd = control.Handle;
//                return WinFormNativeMethods.S_OK;
//            }
...
//                // go active then.
//                //
//                WinFormUnsafeNativeMethods.IOleInPlaceSite inPlaceSite = clientSite as WinFormUnsafeNativeMethods.IOleInPlaceSite;
//                if (inPlaceSite == null)
//                {
//                    return;
//                }
...
//                        if (WinFormNativeMethods.Succeeded(hr)) {
//                            hr = WinFormNativeMethods.E_FAIL;
//                        }
//                        ThrowHr(hr);
//                    }
...
//                    WinFormNativeMethods.tagOIFI inPlaceFrameInfo = new WinFormNativeMethods.tagOIFI();
//                    inPlaceFrameInfo.cb = WinFormUnsafeNativeMethods.SizeOf(typeof(WinFormNativeMethods.tagOIFI));
...
//                    WinFormUnsafeNativeMethods.IOleInPlaceFrame pFrame;
//                    WinFormUnsafeNativeMethods.IOleInPlaceUIWindow pWindow;
//                    WinFormNativeMethods.COMRECT posRect = new WinFormNativeMethods.COMRECT();
//                    WinFormNativeMethods.COMRECT clipRect = new WinFormNativeMethods.COMRECT();

//                    if (inPlaceUiWindow != null && WinFormUnsafeNativeMethods.IsComObject(inPlaceUiWindow)) {
//                        WinFormUnsafeNativeMethods.ReleaseComObject(inPlaceUiWindow);
//                        inPlaceUiWindow = null;
//                    }

//                    if (inPlaceFrame != null && WinFormUnsafeNativeMethods.IsComObject(inPlaceFrame)) {
//                        WinFormUnsafeNativeMethods.ReleaseComObject(inPlaceFrame);
//                        inPlaceFrame = null;
//                    }
...
//                    WinFormUnsafeNativeMethods.SetParent(new HandleRef(control, control.Handle), new HandleRef(null, hwndParent));
...
//                //
//                if (verb != WinFormNativeMethods.OLEIVERB_PRIMARY && verb != WinFormNativeMethods.OLEIVERB_UIACTIVATE) {
...
//                    if (WinFormNativeMethods.Failed(hr) && hr != WinFormNativeMethods.OLE_E_INVALIDRECT &&
//                        hr != WinFormNativeMethods.INPLACE_E_NOTOOLSPACE && hr != WinFormNativeMethods.E_NOTIMPL) {
//                        WinFormUnsafeNativeMethods.ThrowExceptionForHR(hr);
//                    }
...
//                //
//                WinFormUnsafeNativeMethods.IOleInPlaceSite oleClientSite = clientSite as WinFormUnsafeNativeMethods.IOleInPlaceSite;
...
//            /// </devdoc>
//            internal void Load(WinFormUnsafeNativeMethods.IStorage stg) {
//                WinFormUnsafeNativeMethods.IStream stream = null;

//                //IntSecurity.UnmanagedCode.Assert();
//                try {
//                    stream = stg.OpenStream(this.GetStreamName(), IntPtr.Zero, WinFormNativeMethods.STGM_READ | WinFormNativeMethods.STGM_SHARE_EXCLUSIVE, 0);
//                }
//                catch (COMException e) {
//                    if (e.ErrorCode == WinFormNativeMethods.STG_E_FILENOTFOUND) {
...
//                        stream = stg.OpenStream(GetType().FullName, IntPtr.Zero, WinFormNativeMethods.STGM_READ | WinFormNativeMethods.STGM_SHARE_EXCLUSIVE, 0);
//                    }
//                    else {
//                        throw;
//                    }
...
//                Load(stream);
//                stream = null;
//                if (WinFormUnsafeNativeMethods.IsComObject(stg)) {
//                    WinFormUnsafeNativeMethods.ReleaseComObject(stg);
//                }
//            }
...
//            /// </devdoc>
//            internal void Load(WinFormUnsafeNativeMethods.IStream stream) {
...
//                if (WinFormUnsafeNativeMethods.IsComObject(stream)) {
//                    WinFormUnsafeNativeMethods.ReleaseComObject(stream);
//                }
//            }
...
//            /// </devdoc>
//            internal void Load(WinFormUnsafeNativeMethods.IPropertyBag pPropBag, WinFormUnsafeNativeMethods.IErrorLog pErrorLog) {
...
//                        if (WinFormNativeMethods.Succeeded(hr) && obj != null) {
//                            Debug.Indent();
...
//                                }
//                                else {
//                                    errorCode = WinFormNativeMethods.E_FAIL;
//                                }
//                            }
//                            if (errorString != null) {
//                                Debug.WriteLineIf(CompModSwitches.ActiveX.TraceInfo, "Exception converting property: " + errorString);
//                                if (pErrorLog != null) {
//                                    WinFormNativeMethods.tagEXCEPINFO err = new WinFormNativeMethods.tagEXCEPINFO();
...
//                    }
//                }
//                if (WinFormUnsafeNativeMethods.IsComObject(pPropBag)) {
//                    WinFormUnsafeNativeMethods.ReleaseComObject(pPropBag);
//                }
//            }
...
//                    IntPtr newRegion = WinFormSafeNativeMethods.CreateRectRgn(0, 0, 0, 0);
//                    try {
//                        WinFormSafeNativeMethods.CombineRgn(new HandleRef(null, newRegion), new HandleRef(null, region), new HandleRef(this, clipRegion), WinFormNativeMethods.RGN_DIFF);
//                        WinFormSafeNativeMethods.DeleteObject(new HandleRef(null, region));
//                    }
//                    catch {
//                        WinFormSafeNativeMethods.DeleteObject(new HandleRef(null, newRegion));
//                        throw;
//                    }
//                    return newRegion;
//                }
...
//                if (dispID != WinFormNativeMethods.ActiveX.DISPID_UNKNOWN) {
...
//                    switch (dispID) {
//                        case WinFormNativeMethods.ActiveX.DISPID_AMBIENT_UIDEAD:
//                            if (GetAmbientProperty(WinFormNativeMethods.ActiveX.DISPID_AMBIENT_UIDEAD, ref obj)) {
//                                activeXState[uiDead] = (bool)obj;
//                            }
//                            break;

//                        case WinFormNativeMethods.ActiveX.DISPID_AMBIENT_DISPLAYASDEFAULT:
//                            IButtonControl ibuttonControl = control as IButtonControl;
//                            if (ibuttonControl != null && GetAmbientProperty(WinFormNativeMethods.ActiveX.DISPID_AMBIENT_DISPLAYASDEFAULT, ref obj)) {
...
//                        //CodeAccessPermission.RevertAssert();
//                    }
//                    if (WinFormNativeMethods.Failed(hr) && hr != WinFormNativeMethods.INPLACE_E_NOTOOLSPACE && hr != WinFormNativeMethods.E_NOTIMPL) {
//                        WinFormUnsafeNativeMethods.ThrowExceptionForHR(hr);
//                    }
//                }
//            }
...
//                if (activeXState[inPlaceActive] && clientSite is WinFormUnsafeNativeMethods.IOleControlSite) {
//                    //IntSecurity.UnmanagedCode.Assert();
//                    try {
//                        ((WinFormUnsafeNativeMethods.IOleControlSite)clientSite).OnFocus(focus ? 1 : 0);
//                    }
//                    finally {
//                        //CodeAccessPermission.RevertAssert();
//                    }
...
//                    InPlaceActivate(WinFormNativeMethods.OLEIVERB_UIACTIVATE);
//                }
//            }
...
//            /// </devdoc>
//            internal void QuickActivate(WinFormUnsafeNativeMethods.tagQACONTAINER pQaContainer, WinFormUnsafeNativeMethods.tagQACONTROL pQaControl) {
//                // Hookup our ambient colors
//                //
//                AmbientProperty prop = LookupAmbient(WinFormNativeMethods.ActiveX.DISPID_AMBIENT_BACKCOLOR);
//                prop.Value = ColorTranslator.FromOle(unchecked((int)pQaContainer.colorBack));

//                prop = LookupAmbient(WinFormNativeMethods.ActiveX.DISPID_AMBIENT_FORECOLOR);
...
//                    prop = LookupAmbient(WinFormNativeMethods.ActiveX.DISPID_AMBIENT_FONT);
...
//                        WinFormUnsafeNativeMethods.IFont ifont = (WinFormUnsafeNativeMethods.IFont)objfont;
//                        hfont = ifont.GetHFont();
...
//                pQaControl.cbSize = WinFormUnsafeNativeMethods.SizeOf(typeof(WinFormUnsafeNativeMethods.tagQACONTROL));

//                SetClientSite(pQaContainer.pClientSite);

//                if (pQaContainer.pAdviseSink != null) {
//                    SetAdvise(WinFormNativeMethods.DVASPECT_CONTENT, 0, (IAdviseSink)pQaContainer.pAdviseSink);
//                }
                
//                //IntSecurity.UnmanagedCode.Assert();
//                try {
//                    ((WinFormUnsafeNativeMethods.IOleObject)control).GetMiscStatus(WinFormNativeMethods.DVASPECT_CONTENT, out status);
//                }
//                finally {
//                   // CodeAccessPermission.RevertAssert();
//                }
...
//                if (pQaContainer.pPropertyNotifySink != null && WinFormUnsafeNativeMethods.IsComObject(pQaContainer.pPropertyNotifySink)) {
//                    WinFormUnsafeNativeMethods.ReleaseComObject(pQaContainer.pPropertyNotifySink);
//                }

//                if (pQaContainer.pUnkEventSink != null && WinFormUnsafeNativeMethods.IsComObject(pQaContainer.pUnkEventSink)) {
//                    WinFormUnsafeNativeMethods.ReleaseComObject(pQaContainer.pUnkEventSink);
//                }
//            }
...
//            /// </devdoc>
//            internal void Save(WinFormUnsafeNativeMethods.IStorage stg, bool fSameAsLoad) {
//                WinFormUnsafeNativeMethods.IStream stream = null;

//                //IntSecurity.UnmanagedCode.Assert();
//                try {
//                    stream = stg.CreateStream(this.GetStreamName(), WinFormNativeMethods.STGM_WRITE | WinFormNativeMethods.STGM_SHARE_EXCLUSIVE | WinFormNativeMethods.STGM_CREATE, 0, 0);
//                }
//                finally {
//                    //CodeAccessPermission.RevertAssert();
//                }
...
//            /// </devdoc>
//            internal void Save(WinFormUnsafeNativeMethods.IStream stream, bool fClearDirty) {
//                // We do everything through property bags because we support full fidelity
...
//            /// </devdoc>
//            //[SecurityPermission(SecurityAction.Assert, Flags=SecurityPermissionFlag.UnmanagedCode)]
//            internal void Save(WinFormUnsafeNativeMethods.IPropertyBag pPropBag, bool fClearDirty, bool fSaveAllProperties) {
//                PropertyDescriptorCollection props = TypeDescriptor.GetProperties(control,
//                    new Attribute[] {DesignerSerializationVisibilityAttribute.Visible});
...
//                //
//                if ((aspects & WinFormNativeMethods.DVASPECT_CONTENT) == 0) {
//                    ThrowHr(WinFormNativeMethods.DV_E_DVASPECT);
//                }

//                // set up some flags  [we gotta stash for GetAdvise ...]
//                //
//                activeXState[viewAdvisePrimeFirst] = (advf & WinFormNativeMethods.ADVF_PRIMEFIRST) != 0 ? true : false;
//                activeXState[viewAdviseOnlyOnce] = (advf & WinFormNativeMethods.ADVF_ONLYONCE) != 0 ? true : false;

//                if (viewAdviseSink != null && WinFormUnsafeNativeMethods.IsComObject(viewAdviseSink)) {
//                    WinFormUnsafeNativeMethods.ReleaseComObject(viewAdviseSink);
//                }
...
//            /// </devdoc>
//            internal void SetClientSite(WinFormUnsafeNativeMethods.IOleClientSite value) {
//                if (clientSite != null) {
...
//                    if (WinFormUnsafeNativeMethods.IsComObject(clientSite)) {
//                        //IntSecurity.UnmanagedCode.Assert();
//                        try {
...
//                if (control is IButtonControl && GetAmbientProperty(WinFormNativeMethods.ActiveX.DISPID_AMBIENT_UIDEAD, ref obj)) {
...
//            /// </devdoc>
//            //[SecurityPermission(SecurityAction.Assert, Flags=SecurityPermissionFlag.UnmanagedCode)]
//            internal void SetExtent(int dwDrawAspect, WinFormNativeMethods.tagSIZEL pSizel) {
//                if ((dwDrawAspect & WinFormNativeMethods.DVASPECT_CONTENT) != 0) {
...
//                        //
//                        if (activeXState[inPlaceActive]) {
//                            WinFormUnsafeNativeMethods.IOleInPlaceSite ioleClientSite = clientSite as WinFormUnsafeNativeMethods.IOleInPlaceSite;
...
//                                ioleClientSite.OnPosRectChange(WinFormNativeMethods.COMRECT.FromXYWH(bounds.X, bounds.Y, bounds.Width, bounds.Height));
//                            }
//                        }
...
//            /// </devdoc>
//            internal void SetObjectRects(WinFormNativeMethods.COMRECT lprcPosRect, WinFormNativeMethods.COMRECT lprcClipRect) {
...
//                        //
//                        WinFormNativeMethods.RECT rcIntersect = WinFormNativeMethods.RECT.FromXYWH(intersect.X, intersect.Y, intersect.Width, intersect.Height);
//                        IntPtr hWndParent = WinFormUnsafeNativeMethods.GetParent(new HandleRef(control, control.Handle));
...
//                        WinFormUnsafeNativeMethods.MapWindowPoints(new HandleRef(null, hWndParent), new HandleRef(control, control.Handle), ref rcIntersect, 2);
...
//                        //
//                        clipRegion = WinFormSafeNativeMethods.CreateRectRgn(rcIntersect.left, rcIntersect.top,
...
//                    WinFormUnsafeNativeMethods.SetWindowRgn(new HandleRef(control, control.Handle), new HandleRef(this, finalClipRegion), WinFormSafeNativeMethods.IsWindowVisible(new HandleRef(control, control.Handle)));
//                }
...
//            /// </devdoc>
//            internal int TranslateAccelerator(ref WinFormNativeMethods.MSG lpmsg) {
...
//                    case WinFormNativeMethods.WM_SYSKEYDOWN:
//                    case WinFormNativeMethods.WM_CHAR:
//                    case WinFormNativeMethods.WM_SYSCHAR:
//                        needPreProcess = true;
//                        break;
//                }
...
//                                WinFormUnsafeNativeMethods.TranslateMessage(ref lpmsg);
//                                if (WinFormSafeNativeMethods.IsWindowUnicode(new HandleRef(null, lpmsg.hwnd))) {
//                                    WinFormUnsafeNativeMethods.DispatchMessageW(ref lpmsg);
//                                }
//                                else {
//                                    WinFormUnsafeNativeMethods.DispatchMessageA(ref lpmsg);
//                                }
//                                return WinFormNativeMethods.S_OK;
...
//                int hr = WinFormNativeMethods.S_FALSE;

//                Debug.WriteLineIf(CompModSwitches.ActiveX.TraceInfo, "AxSource: Control did not process accelerator, handing to site");
    
//                WinFormUnsafeNativeMethods.IOleControlSite ioleClientSite = clientSite as WinFormUnsafeNativeMethods.IOleControlSite;
//                if (ioleClientSite != null) {
//                    int keyState = 0;
    
//                    if (WinFormUnsafeNativeMethods.GetKeyState(WinFormNativeMethods.VK_SHIFT) < 0)     keyState |= 1;
//                    if (WinFormUnsafeNativeMethods.GetKeyState(WinFormNativeMethods.VK_CONTROL) < 0)   keyState |= 2;
//                    if (WinFormUnsafeNativeMethods.GetKeyState(WinFormNativeMethods.VK_MENU) < 0)      keyState |= 4;
//                    //IntSecurity.UnmanagedCode.Assert();
//                    try {
...
//                    ThrowHr(WinFormNativeMethods.OLE_E_NOCONNECTION);
//                }

//                IAdviseSink sink = (IAdviseSink)adviseList[dwConnection - 1];
//                adviseList.RemoveAt(dwConnection - 1);
//                if (sink != null && WinFormUnsafeNativeMethods.IsComObject(sink)) {
//                    WinFormUnsafeNativeMethods.ReleaseComObject(sink);
//                }
//            }
...
//                    WinFormUnsafeNativeMethods.IOleInPlaceSite ioleClientSite = clientSite as WinFormUnsafeNativeMethods.IOleInPlaceSite;
//                    if (ioleClientSite != null) {
//                        WinFormNativeMethods.COMRECT rc = new WinFormNativeMethods.COMRECT();

//                        if ((flags & WinFormNativeMethods.SWP_NOMOVE) != 0) {
...
//                        if ((flags & WinFormNativeMethods.SWP_NOSIZE) != 0) {
...
//                    //IntSecurity.UnmanagedCode.Assert();
//                    try {
//                        viewAdviseSink.OnViewChange(WinFormNativeMethods.DVASPECT_CONTENT, -1);
//                    }
//                    finally {
//                        //CodeAccessPermission.RevertAssert();
//                    }
...
//                        if (WinFormUnsafeNativeMethods.IsComObject(viewAdviseSink)) {
//                            WinFormUnsafeNativeMethods.ReleaseComObject(viewAdviseSink);
//                        }
//                        viewAdviseSink = null;
//                    }
...
//                    if (m.Msg >= WinFormNativeMethods.WM_MOUSEFIRST && m.Msg <= WinFormNativeMethods.WM_MOUSELAST) {
//                        return;
//                    }
//                    if (m.Msg >= WinFormNativeMethods.WM_NCLBUTTONDOWN && m.Msg <= WinFormNativeMethods.WM_NCMBUTTONDBLCLK) {
//                        return;
//                    }
//                    if (m.Msg >= WinFormNativeMethods.WM_KEYFIRST && m.Msg <= WinFormNativeMethods.WM_KEYLAST) {
//                        return;
//                    }
//                }
...
//            /// </devdoc>
//            private class PropertyBagStream : WinFormUnsafeNativeMethods.IPropertyBag {
//                private Hashtable bag = new Hashtable();

//               //[SecurityPermission(SecurityAction.Assert, Flags=SecurityPermissionFlag.UnmanagedCode)]
//                internal void Read(WinFormUnsafeNativeMethods.IStream istream) {
...
//                //[SecurityPermission(SecurityAction.Assert, Flags = SecurityPermissionFlag.UnmanagedCode)]
//                int WinFormUnsafeNativeMethods.IPropertyBag.Read(string pszPropName, ref object pVar, WinFormUnsafeNativeMethods.IErrorLog pErrorLog)
//                {
...
//                //[SecurityPermission(SecurityAction.Assert, Flags = SecurityPermissionFlag.UnmanagedCode)]
//                int WinFormUnsafeNativeMethods.IPropertyBag.Write(string pszPropName, ref object pVar)
//                {
...
//                //[SecurityPermission(SecurityAction.Assert, Flags = SecurityPermissionFlag.UnmanagedCode)]
//                internal void Write(WinFormUnsafeNativeMethods.IStream istream)
//                {
//                    Stream stream = new DataStreamFromComStream(istream);
//                    BinaryFormatter formatter = new BinaryFormatter();
...
//        }
        ...
        private class AxSourcingSite : ISite {
            ...
            internal AxSourcingSite(IComponent component, WinFormUnsafeNativeMethods.IOleClientSite clientSite, string name) {
            ...
            public Object GetService(Type service) {
                ...
                //    WinFormUnsafeNativeMethods.IOleContainer iOlecontainer;
                //    int hr;
                //    try {
                ...
                //    //if (WinFormNativeMethods.Succeeded(hr)
                //    //        && (iOlecontainer is WinFormUnsafeNativeMethods.IHTMLDocument)) {
                //    //    if (shimManager == null) {
                ...
                //    //    //retVal = new HtmlDocument(shimManager, iOlecontainer as WinFormUnsafeNativeMethods.IHTMLDocument);
                //    //}
        ...
        private class ActiveXFontMarshaler : ICustomMarshaler {
            ...
            public IntPtr MarshalManagedToNative(object obj) {
                Font font = (Font)obj;
                WinFormNativeMethods.tagFONTDESC fontDesc = new WinFormNativeMethods.tagFONTDESC();
                WinFormNativeMethods.LOGFONT logFont = new WinFormNativeMethods.LOGFONT();
               ...
               // IntSecurity.ObjectFromWin32Handle.Assert();
                ...
                Guid iid = typeof(WinFormUnsafeNativeMethods.IFont).GUID;

                WinFormUnsafeNativeMethods.IFont oleFont = WinFormUnsafeNativeMethods.OleCreateFontIndirect(fontDesc, ref iid);
                ...
                if (WinFormNativeMethods.Failed(hr)) {
            ...
            public object MarshalNativeToManaged(IntPtr pObj) {
                WinFormUnsafeNativeMethods.IFont nativeFont = (WinFormUnsafeNativeMethods.IFont)Marshal.GetObjectForIUnknown(pObj);
                IntPtr hfont = IntPtr.Zero;
        ...
        /// </devdoc>
        private class ActiveXVerbEnum : WinFormUnsafeNativeMethods.IEnumOLEVERB {
            private WinFormNativeMethods.tagOLEVERB[] verbs;
            private int current;

            internal ActiveXVerbEnum(WinFormNativeMethods.tagOLEVERB[] verbs) {
                this.verbs = verbs;
                current = 0;
            }

            public int Next(int celt, WinFormNativeMethods.tagOLEVERB rgelt, int[] pceltFetched) {
                int fetched = 0;
...
#endif
                return(celt == 0 ? WinFormNativeMethods.S_OK : WinFormNativeMethods.S_FALSE);
            }
            ...
            public void Clone(out WinFormUnsafeNativeMethods.IEnumOLEVERB ppenum) {
        ...
        private class MetafileDCWrapper : IDisposable {
            ...
            HandleRef hBitmapDC     = WinFormNativeMethods.NullHandleRef;
            HandleRef hBitmap       = WinFormNativeMethods.NullHandleRef;
            HandleRef hOriginalBmp  = WinFormNativeMethods.NullHandleRef;
            HandleRef hMetafileDC   = WinFormNativeMethods.NullHandleRef;
            WinFormNativeMethods.RECT destRect;
            ...
            internal MetafileDCWrapper(HandleRef hOriginalDC, Size size) {
                Debug.Assert(WinFormUnsafeNativeMethods.GetObjectType(hOriginalDC) == WinFormNativeMethods.OBJ_ENHMETADC,
                    "Why wrap a non-Enhanced MetaFile DC?");

                // Security fix: make sure the size has non-negative width and height.
                if (size.Width < 0 || size.Height < 0) {
                    throw new ArgumentException("size", DCSR.GetString(DCSR.ControlMetaFileDCWrapperSizeInvalid));
                }

                hMetafileDC = hOriginalDC;
                destRect = new WinFormNativeMethods.RECT(0, 0, size.Width, size.Height);
                hBitmapDC = new HandleRef(this, WinFormUnsafeNativeMethods.CreateCompatibleDC(WinFormNativeMethods.NullHandleRef));

                int planes = WinFormUnsafeNativeMethods.GetDeviceCaps(hBitmapDC, WinFormNativeMethods.PLANES);
                int bitsPixel = WinFormUnsafeNativeMethods.GetDeviceCaps(hBitmapDC, WinFormNativeMethods.BITSPIXEL);
                hBitmap = new HandleRef(this, WinFormSafeNativeMethods.CreateBitmap(size.Width, size.Height, planes, bitsPixel, IntPtr.Zero));

                hOriginalBmp = new HandleRef(this, WinFormSafeNativeMethods.SelectObject(hBitmapDC, hBitmap));
            }
            ...
            void IDisposable.Dispose() {
                ...
                try {
                    ...
                    WinFormSafeNativeMethods.SelectObject(hBitmapDC, hOriginalBmp);
                    success = WinFormSafeNativeMethods.DeleteObject(hBitmap);
                    Debug.Assert(success, "DeleteObject() failed.");
                    success = WinFormUnsafeNativeMethods.DeleteCompatibleDC(hBitmapDC);
                    Debug.Assert(success, "DeleteObject() failed.");
                } 
                finally {

                    // Dispose is done. Set all the handles to IntPtr.Zero so this way the Dispose method executes only once.
                    hBitmapDC = WinFormNativeMethods.NullHandleRef;
                    hBitmap = WinFormNativeMethods.NullHandleRef;
                    hOriginalBmp = WinFormNativeMethods.NullHandleRef;
            ...
            private unsafe bool DICopy(HandleRef hdcDest, HandleRef hdcSrc, WinFormNativeMethods.RECT rect, bool bStretch) {
                long i;
                ...
                HandleRef hNullBitmap = new HandleRef(this, WinFormSafeNativeMethods.CreateBitmap(1, 1, 1, 1, IntPtr.Zero));
                if (hNullBitmap.Handle == IntPtr.Zero) return fSuccess;

                try {
                    HandleRef hBitmap = new HandleRef(this, WinFormSafeNativeMethods.SelectObject(hdcSrc, hNullBitmap));
                    if (hBitmap.Handle == IntPtr.Zero) return fSuccess;

                    //
                    // Restore original bitmap
                    WinFormSafeNativeMethods.SelectObject(hdcSrc, hBitmap);


                    WinFormNativeMethods.BITMAP bmp = new WinFormNativeMethods.BITMAP();
                    if (WinFormUnsafeNativeMethods.GetObject(hBitmap, Marshal.SizeOf(bmp), bmp) == 0) {
                        return fSuccess;
                    }

                    WinFormNativeMethods.BITMAPINFO_FLAT lpbmi = new WinFormNativeMethods.BITMAPINFO_FLAT();
                    lpbmi.bmiHeader_biSize = Marshal.SizeOf(typeof(WinFormNativeMethods.BITMAPINFOHEADER));
                    ...
                    lpbmi.bmiHeader_biCompression = WinFormNativeMethods.BI_RGB;
                    ...
                    lpbmi.bmiColors = new byte[WinFormNativeMethods.BITMAPINFO_MAX_COLORSIZE*4];

                    //
                    // Include the palette for 256 color bitmaps
                    long iColors = 1 << (bmp.bmBitsPixel * bmp.bmPlanes);
                    if (iColors <= 256) {
                        byte[] aj = new byte[Marshal.SizeOf(typeof(WinFormNativeMethods.PALETTEENTRY)) * 256];
                        WinFormSafeNativeMethods.GetSystemPaletteEntries(hdcSrc, 0, (int)iColors, aj);

                        fixed (byte* pcolors = lpbmi.bmiColors) {
                            fixed (byte* ppal = aj) {
                                WinFormNativeMethods.RGBQUAD* prgb = (WinFormNativeMethods.RGBQUAD*)pcolors;
                                WinFormNativeMethods.PALETTEENTRY* lppe = (WinFormNativeMethods.PALETTEENTRY*)ppal;
                                //
                    ...
                    //
                    // Get the bitmap bits
                    int diRet = WinFormSafeNativeMethods.GetDIBits(hdcSrc, hBitmap, 0, bmp.bmHeight, lpBits,
                            ref lpbmi, WinFormNativeMethods.DIB_RGB_COLORS);
                    ...
                    // Paint the bitmap
                    int iRet = WinFormSafeNativeMethods.StretchDIBits(hdcDest,
                            xDest, yDest, cxDest, cyDest, 0, 0, bmp.bmWidth, bmp.bmHeight,
                            lpBits, ref lpbmi, WinFormNativeMethods.DIB_RGB_COLORS, WinFormNativeMethods.SRCCOPY);
                    if (iRet == WinFormNativeMethods.GDI_ERROR) return fSuccess;

                    fSuccess = true;
                }
                finally {
                    WinFormSafeNativeMethods.DeleteObject(hNullBitmap);
                }
                return fSuccess;
            }
        }
        ...
        public class ControlAccessibleObject : AccessibleObject {
            ...
            private static IntPtr oleAccAvailable = WinFormNativeMethods.InvalidIntPtr;
            ...
            public IntPtr Handle {
                ...
                set {
                    ...
                    if (handle != value) {
                        ...
                        if (oleAccAvailable == WinFormNativeMethods.InvalidIntPtr) {
                            oleAccAvailable = WinFormUnsafeNativeMethods.LoadLibrary("oleacc.dll");
                        ...
                        if (freeLib) {
                            WinFormUnsafeNativeMethods.FreeLibrary(new HandleRef(null, oleAccAvailable));
                        }
            ...
            public void NotifyClients(AccessibleEvents accEvent) {
                ...
                WinFormUnsafeNativeMethods.NotifyWinEvent((int)accEvent, new HandleRef(this, Handle), WinFormNativeMethods.OBJID_CLIENT, 0);
            }
            ...
            public void NotifyClients(AccessibleEvents accEvent, int childID) {
                ...
                WinFormUnsafeNativeMethods.NotifyWinEvent((int)accEvent, new HandleRef(this, Handle), WinFormNativeMethods.OBJID_CLIENT, childID + 1);
            }
...
#if DEBUG
                Debug.Assert(finalizing || this != _defaultFontHandleWrapper, "Don't dispose the defaultFontHandleWrapper");
#endif
...
#endif
                    WinFormSafeNativeMethods.DeleteObject(new HandleRef(this, handle));
                    handle = IntPtr.Zero;
                }
        ...
        private sealed class MultithreadSafeCallScope : IDisposable
        {
            ...
            internal MultithreadSafeCallScope()
            {
                ...
                // expense otherwise).
                if (_checkForIllegalCrossThreadCalls && !_inCrossThreadSafeCall)
                {
                    _inCrossThreadSafeCall = true;
                    resultedInSet = true;
                }
                else
                {
