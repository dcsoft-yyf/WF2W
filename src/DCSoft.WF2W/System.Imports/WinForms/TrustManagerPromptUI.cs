    ...
    internal class TrustManagerPromptUI : System.Windows.Forms.Form
    {
        ...
        private void LoadResources()
        {
            ...
            if ((this.m_options & TrustManagerPromptOptions.StopApp) != 0)
            {
                ...
                this.btnCancel.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_Close);
            ...
            else
            {
                ...
                {
                    this.btnCancel.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_DoNotInstall);
                }
                else
                {
                    this.btnCancel.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_DoNotRun);
                }
            ...
            {
                this.linkLblPublisher.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_UnknownPublisher);
            ...
            if ((this.m_options & TrustManagerPromptOptions.AddsShortcut) != 0)
            {
                this.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_InstallTitle);
            }
            else
            {
                this.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_RunTitle);
                this.btnInstall.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_Run);
            }

            // Choose a question
            if ((this.m_options & TrustManagerPromptOptions.StopApp) != 0)
            {
                this.lblQuestion.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_BlockedApp);
            }
            else if (this.m_publisherName == null)
            {
                if ((this.m_options & TrustManagerPromptOptions.AddsShortcut) != 0)
                {
                    this.lblQuestion.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_NoPublisherInstallQuestion);
                }
                else
                {
                    this.lblQuestion.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_NoPublisherRunQuestion);
                }
            }
            else if ((this.m_options & TrustManagerPromptOptions.AddsShortcut) != 0)
            {
                this.lblQuestion.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_InstallQuestion);
            }
            else
            {
                this.lblQuestion.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_RunQuestion);
            }
            ...
            if ((this.m_options & TrustManagerPromptOptions.StopApp) != 0)
            {
                ...
                if ((this.m_options & TrustManagerPromptOptions.AddsShortcut) != 0)
                {
                    this.linkLblMoreInformation.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_InstalledAppBlockedWarning);
                }
                else
                {
                    this.linkLblMoreInformation.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_RunAppBlockedWarning);
                }
                this.linkLblMoreInformation.TabStop = false;
                this.linkLblMoreInformation.AccessibleDescription = DCSR.GetString(DCSR.TrustManagerPromptUI_WarningAccessibleDescription);
                this.linkLblMoreInformation.AccessibleName = DCSR.GetString(DCSR.TrustManagerPromptUI_WarningAccessibleName);
            }
            else
            {
                string strMoreInfo = DCSR.GetString(DCSR.TrustManagerPromptUI_MoreInformation);
                ...
                if ((this.m_options & TrustManagerPromptOptions.LocalComputerSource) != 0)
                {
                    ...
                    if ((this.m_options & TrustManagerPromptOptions.AddsShortcut) != 0)
                    {
                        this.linkLblMoreInformation.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_InstallFromLocalMachineWarning, strMoreInfo);
                    }
                    else
                    {
                        this.linkLblMoreInformation.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_RunFromLocalMachineWarning, strMoreInfo);
                    }
                }
                else if ((this.m_options & TrustManagerPromptOptions.AddsShortcut) != 0)
                {
                    this.linkLblMoreInformation.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_InstallWarning, strMoreInfo);
                }
                else
                {
                    this.linkLblMoreInformation.Text = DCSR.GetString(DCSR.TrustManagerPromptUI_RunWarning, strMoreInfo);
                }
                this.linkLblMoreInformation.TabStop = true;
                this.linkLblMoreInformation.AccessibleDescription = DCSR.GetString(DCSR.TrustManagerPromptUI_MoreInformationAccessibleDescription);
                this.linkLblMoreInformation.AccessibleName = DCSR.GetString(DCSR.TrustManagerPromptUI_MoreInformationAccessibleName);
            ...
            if ((this.m_options & TrustManagerPromptOptions.StopApp) != 0)
            {
                if ((this.m_options & TrustManagerPromptOptions.AddsShortcut) != 0)
                {
                    this.AccessibleDescription = DCSR.GetString(DCSR.TrustManagerPromptUI_AccessibleDescription_InstallBlocked);
                }
                else
                {
                    this.AccessibleDescription = DCSR.GetString(DCSR.TrustManagerPromptUI_AccessibleDescription_RunBlocked);
                }
            }
            else if ((this.m_options & TrustManagerPromptOptions.RequiresPermissions) != 0)
            {
                if ((this.m_options & TrustManagerPromptOptions.AddsShortcut) != 0)
                {
                    this.AccessibleDescription = DCSR.GetString(DCSR.TrustManagerPromptUI_AccessibleDescription_InstallWithElevatedPermissions);
                }
                else
                {
                    this.AccessibleDescription = DCSR.GetString(DCSR.TrustManagerPromptUI_AccessibleDescription_RunWithElevatedPermissions);
                }
            }
            else if ((this.m_options & TrustManagerPromptOptions.AddsShortcut) != 0)
            {
                this.AccessibleDescription = DCSR.GetString(DCSR.TrustManagerPromptUI_AccessibleDescription_InstallConfirmation);
            }
            else
            {
                this.AccessibleDescription = DCSR.GetString(DCSR.TrustManagerPromptUI_AccessibleDescription_RunConfirmation);
            }
        ...
        private void LoadWarningBitmap(TrustManagerWarningLevel warningLevel)
        {
            ...
            switch (warningLevel)
            {
                case TrustManagerWarningLevel.Green:
                    ...
                    this.pictureBoxWarning.AccessibleDescription = string.Format(CultureInfo.CurrentCulture, DCSR.GetString(DCSR.TrustManager_WarningIconAccessibleDescription_LowRisk), this.pictureBoxWarning.AccessibleDescription);
                    break;
                case TrustManagerWarningLevel.Yellow:
                    bitmap = new Bitmap(typeof(System.Windows.Forms.Form), "TrustManagerWarning.bmp");
                    this.pictureBoxWarning.AccessibleDescription = string.Format(CultureInfo.CurrentCulture, DCSR.GetString(DCSR.TrustManager_WarningIconAccessibleDescription_MediumRisk), this.pictureBoxWarning.AccessibleDescription);
                    break;
                default:
                    ...
                    this.pictureBoxWarning.AccessibleDescription = string.Format(CultureInfo.CurrentCulture, DCSR.GetString(DCSR.TrustManager_WarningIconAccessibleDescription_HighRisk), this.pictureBoxWarning.AccessibleDescription);
                    break;
            }
            if (bitmap != null)
            {
        ...
        private void linkLblFromUrl_MouseEnter(object sender, EventArgs e)
        {
            if (!controlToolTip && toolTipFromUrl != null)
            {
                ...
                try 
                {
                    ...
                    WinFormUnsafeNativeMethods.SendMessage(new HandleRef(toolTipFromUrl, toolTipFromUrl.Handle), WinFormNativeMethods.TTM_SETMAXTIPWIDTH, 0, 600);
                }
                finally 
                {
