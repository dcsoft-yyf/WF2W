...
namespace System.Windows.Forms {
    ...
    public class ComboBox : ListControl {
        //public override void WriteAttributeTo(System.Text.Json.Nodes.JsonObject json)
        //{
        //    base.WriteAttributeTo(json);

        //    try
        //    {
        //        json["DropDownStyle"] = System.Text.Json.Nodes.JsonValue.Create(this.DropDownStyle.ToString());
        //        json["DropDownWidth"] = System.Text.Json.Nodes.JsonValue.Create(this.DropDownWidth);
        //        json["DropDownHeight"] = System.Text.Json.Nodes.JsonValue.Create(this.DropDownHeight);
        //        json["DroppedDown"] = System.Text.Json.Nodes.JsonValue.Create(this.DroppedDown);

        //        json["MaxDropDownItems"] = System.Text.Json.Nodes.JsonValue.Create(this.MaxDropDownItems);
        //        json["MaxLength"] = System.Text.Json.Nodes.JsonValue.Create(this.MaxLength);
        //        json["Sorted"] = System.Text.Json.Nodes.JsonValue.Create(this.Sorted);
        //        json["SelectedIndex"] = System.Text.Json.Nodes.JsonValue.Create(this.SelectedIndex);

        //        if (!string.IsNullOrEmpty(this.SelectedText))
        //        {
        //            json["SelectedText"] = System.Text.Json.Nodes.JsonValue.Create(this.SelectedText);
        //        }

        //        if (this.Items != null && this.Items.Count > 0)
        //        {
        //            var itemsArray = new System.Text.Json.Nodes.JsonArray();
        //            foreach (var item in this.Items)
        //            {
        //                if (item != null)
        //                {
        //                    itemsArray.Add(System.Text.Json.Nodes.JsonValue.Create(item.ToString()));
        //                }
        //            }
        //            json["Items"] = itemsArray;
        //        }

        //        json["AutoCompleteMode"] = System.Text.Json.Nodes.JsonValue.Create(this.AutoCompleteMode.ToString());
        //        json["AutoCompleteSource"] = System.Text.Json.Nodes.JsonValue.Create(this.AutoCompleteSource.ToString());

        //        json["FlatStyle"] = System.Text.Json.Nodes.JsonValue.Create(this.FlatStyle.ToString());
        //        json["DrawMode"] = System.Text.Json.Nodes.JsonValue.Create(this.DrawMode.ToString());
        //        if( this.DrawMode == DrawMode.OwnerDrawFixed || this.DrawMode == DrawMode.OwnerDrawVariable )
        //        {
        //            json["ItemHeight"] = System.Text.Json.Nodes.JsonValue.Create(this.ItemHeight);
        //        }
        //    }
        //    catch
        //    {
        ...
        SRDescription(DCSR.ComboBoxAutoCompleteModeDescr),
        ...
        public AutoCompleteMode AutoCompleteMode {
            ...
            set {
                ...
                if (this.DropDownStyle == ComboBoxStyle.DropDownList &&
                    ...
                    throw new NotSupportedException(DCSR.GetString(DCSR.ComboBoxAutoCompleteModeOnlyNoneAllowed));
                }
        ...
        SRDescription(DCSR.ComboBoxAutoCompleteSourceDescr),
        Browsable(true), EditorBrowsable(EditorBrowsableState.Always)
        ]
        public AutoCompleteSource AutoCompleteSource {
            ...
            set {
                ...
                if (this.DropDownStyle == ComboBoxStyle.DropDownList &&
                    ...
                    throw new NotSupportedException(DCSR.GetString(DCSR.ComboBoxAutoCompleteSourceOnlyListItemsAllowed));
                }
                if (Application.OleRequired() != System.Threading.ApartmentState.STA) {
                    throw new ThreadStateException(DCSR.GetString(DCSR.ThreadMustBeSTA));
                }
        ...
        Localizable(true),
        SRDescription(DCSR.ComboBoxAutoCompleteCustomSourceDescr),
        ...
        protected override CreateParams CreateParams {
            ...
            get {
                ...
                cp.Style |= WinFormNativeMethods.WS_VSCROLL | WinFormNativeMethods.CBS_HASSTRINGS | WinFormNativeMethods.CBS_AUTOHSCROLL;
                cp.ExStyle |= WinFormNativeMethods.WS_EX_CLIENTEDGE;
                if (!integralHeight) cp.Style |= WinFormNativeMethods.CBS_NOINTEGRALHEIGHT;

                switch (DropDownStyle) {
                    case ComboBoxStyle.Simple:
                        cp.Style |= WinFormNativeMethods.CBS_SIMPLE;
                        break;
                    case ComboBoxStyle.DropDown:
                        cp.Style |= WinFormNativeMethods.CBS_DROPDOWN;
                        // Make sure we put the height back or we won't be able to size the dropdown!
                        cp.Height = PreferredHeight;
                        break;
                    case ComboBoxStyle.DropDownList:
                        cp.Style |= WinFormNativeMethods.CBS_DROPDOWNLIST;
                        // Comment above...
                        cp.Height = PreferredHeight;
                        break;
                }
                switch (DrawMode) {
                    ...
                    case DrawMode.OwnerDrawFixed:
                        cp.Style |= WinFormNativeMethods.CBS_OWNERDRAWFIXED;
                        break;
                    case DrawMode.OwnerDrawVariable:
                        cp.Style |= WinFormNativeMethods.CBS_OWNERDRAWVARIABLE;
                        break;
                }
        ...
        SRDescription(DCSR.ListControlDataSourceDescr)
        ]
        ...
        SRDescription(DCSR.ComboBoxDrawModeDescr),
        RefreshProperties(RefreshProperties.Repaint)
        ]
        ...
        [
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.ComboBoxDropDownWidthDescr)
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public int DropDownWidth {
            ...
            set {
                if (value < 1) {
                    throw new ArgumentOutOfRangeException("DropDownWidth", DCSR.GetString(DCSR.InvalidArgument, "DropDownWidth", (value).ToString(CultureInfo.CurrentCulture)));
                }
                if (Properties.GetInteger(PropDropDownWidth) != value) {
                    Properties.SetInteger(PropDropDownWidth, value);
                    if (IsHandleCreated) {
                        SendMessage(WinFormNativeMethods.CB_SETDROPPEDWIDTH, value, 0);
                    }
                                        this.LogWF2WPropertyValue("DropDownWidth", value);
                }
            }
        }
        ...
        [
        SRCategory(DCSR.CatBehavior),
        SRDescription(DCSR.ComboBoxDropDownHeightDescr),
        Browsable(true), EditorBrowsable(EditorBrowsableState.Always),
        DefaultValue(106)
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public int DropDownHeight {
            ...
            set {
                if (value < 1) {
                    throw new ArgumentOutOfRangeException("DropDownHeight", DCSR.GetString(DCSR.InvalidArgument, "DropDownHeight", (value).ToString(CultureInfo.CurrentCulture)));
                }
                if (Properties.GetInteger(PropDropDownHeight) != value) {
                    ...
                    this.LogWF2WPropertyValue("DropDownHeight", value);
                }
            }
        }
        ...
        SRDescription(DCSR.ComboBoxDroppedDownDescr)
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public bool DroppedDown {
            get {
                if (IsHandleCreated) {
                    return unchecked( (int) (long)SendMessage(WinFormNativeMethods.CB_GETDROPPEDSTATE, 0, 0) ) != 0;
                }
                else {
                    return false;
                }
            ...
            set {
                ...
                SendMessage(WinFormNativeMethods.CB_SHOWDROPDOWN, value ? -1 : 0, 0);
            }
        }
        ...
        Localizable(true),
        SRDescription(DCSR.ComboBoxFlatStyleDescr)
        ]
        ...
        public override bool Focused {
            get {
                ...
                IntPtr focus = WinFormUnsafeNativeMethods.GetFocus();
        ...
        DefaultValue(true),
        Localizable(true),
        SRDescription(DCSR.ComboBoxIntegralHeightDescr)
        ]
        public bool IntegralHeight {
            ...
            set {
                if (integralHeight != value) {
                    ...
                    RecreateHandle();
                    this.LogWF2WPropertyValue("IntegralHeight", value);
                }
            }
        }
        ...
        SRCategory(DCSR.CatBehavior),
        Localizable(true),
        SRDescription(DCSR.ComboBoxItemHeightDescr)
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public int ItemHeight {
            get {
                ...
                int h = unchecked( (int) (long)SendMessage(WinFormNativeMethods.CB_GETITEMHEIGHT, 0, 0) );
                if (h == -1) {
            ...
            set {
                if (value < 1) {
                    throw new ArgumentOutOfRangeException("ItemHeight", DCSR.GetString(DCSR.InvalidArgument, "ItemHeight", (value).ToString(CultureInfo.CurrentCulture)));
                }
                ...
                if (Properties.GetInteger(PropItemHeight) != value) {
                    ...
                    this.LogWF2WPropertyValue("ItemHeight", value);
                }
            }
        }
        ...
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content),
        Localizable(true),
        SRDescription(DCSR.ComboBoxItemsDescr),
        Editor("System.Windows.Forms.Design.ListControlStringCollectionEditor, " + AssemblyRef.SystemDesign, typeof(UITypeEditor)),
        ...
        DefaultValue(8),
        Localizable(true),
        SRDescription(DCSR.ComboBoxMaxDropDownItemsDescr)
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public int MaxDropDownItems {
            ...
            set {
                if (value < 1 || value > 100) {
                    throw new ArgumentOutOfRangeException("MaxDropDownItems", DCSR.GetString(DCSR.InvalidBoundArgument, "MaxDropDownItems", (value).ToString(CultureInfo.CurrentCulture), (1).ToString(CultureInfo.CurrentCulture), (100).ToString(CultureInfo.CurrentCulture)));
                }
                maxDropDownItems = (short)value;
                this.LogWF2WPropertyValue("MaxDropDownItems", value);
            }
        }
        ...
        DefaultValue(0),
        Localizable(true),
        SRDescription(DCSR.ComboBoxMaxLengthDescr)
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public int MaxLength {
            ...
            set {
                ...
                if (MaxLength != value) {
                    ...
                    if (IsHandleCreated) SendMessage(WinFormNativeMethods.CB_LIMITTEXT, value, 0);
                }
            }
        }
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ComboBoxPreferredHeightDescr)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ComboBoxSelectedIndexDescr)
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public override int SelectedIndex {
            get {
                if (IsHandleCreated) {
                    return base.InvokeJSMethod<int>("GetSelectedIndex");
                }
                else {
            ...
            set {
                if (SelectedIndex != value) {
                    ...
                    if (value < -1 || value >= itemCount) {
                        throw new ArgumentOutOfRangeException("SelectedIndex", DCSR.GetString(DCSR.InvalidArgument, "SelectedIndex", (value).ToString(CultureInfo.CurrentCulture)));
                    }

                    if (IsHandleCreated) {
                        base.InvokeJSMethod<object>("SetSelectedIndex", value);
                        //SendMessage(WinFormNativeMethods.CB_SETCURSEL, value, 0);
        ...
        Bindable(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ComboBoxSelectedItemDescr)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ComboBoxSelectedTextDescr)
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
            ...
            set {
                if (DropDownStyle != ComboBoxStyle.DropDownList) {
                    ...
                    if (IsHandleCreated) {
                        ...
                        if (childEdit != null) {
                            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, childEdit.Handle), WinFormNativeMethods.EM_REPLACESEL, WinFormNativeMethods.InvalidIntPtr, str);
                        }
                    }
                }
            }
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ComboBoxSelectionLengthDescr)
        ]
        public int SelectionLength {
            get {
                int[] end = new int[] { 0 };
                int[] start = new int[] { 0 };
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.CB_GETEDITSEL, start, end);
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ComboBoxSelectionStartDescr)
        ]
        public int SelectionStart {
            get {
                int[] value = new int[] { 0 };
                WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.CB_GETEDITSEL, value, (int[])null);
                return value[0];
            }
            set {
                if (value < 0) {
                    throw new ArgumentOutOfRangeException("SelectionStart", DCSR.GetString(DCSR.InvalidArgument, "SelectionStart", value.ToString(CultureInfo.CurrentCulture)));
                }
        ...
        SRCategory(DCSR.CatBehavior),
        DefaultValue(false),
        SRDescription(DCSR.ComboBoxSortedDescr)
        ]
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public bool Sorted {
            get {
            ...
            set {
                if (sorted != value) {
                    if (this.DataSource != null && value) {
                        throw new ArgumentException(DCSR.GetString(DCSR.ComboBoxSortWithDataSource));
                    }

                    sorted = value;
                    RefreshItems();
                    SelectedIndex = -1;
                    this.LogWF2WPropertyValue("Sorted", value);
                }
            }
        }
        ...
        SRDescription(DCSR.ComboBoxStyleDescr),
        ...
        public ComboBoxStyle DropDownStyle {
            ...
            set {
                if (DropDownStyle != value) {
                    ...
                    this.LogWF2WPropertyValue("DropDownStyle", value);
                }
            }
        }
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.ComboBoxOnDropDownDescr)]
        ...
        private static readonly object EVENT_DROPDOWNAsync = new object();
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.ComboBoxOnDropDownDescr)]
        public event EventHandlerAsync DropDownAsync
        {
            add
            {
                Events.AddHandler(EVENT_DROPDOWNAsync, value);
            }
            remove
            {
                Events.RemoveHandler(EVENT_DROPDOWNAsync, value);
            }
        }
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.selectedIndexChangedEventDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.selectionChangeCommittedEventDescr)]
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.ComboBoxDropDownStyleChangedDescr)]
        ...
        /// <include file='doc\ComboBox.uex' path='docs/doc[@for="ComboBox.TextUpdate"]/*' />
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.ComboBoxOnTextUpdateDescr)]
        ...
        /// <include file='doc\ComboBox.uex' path='docs/doc[@for="ComboBox.DropDownClosed"]/*' />
        /// </devdoc>
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.ComboBoxOnDropDownClosedDescr)]
        ...
        private void CheckNoDataSource() {
            if (DataSource != null) {
                throw new ArgumentException(DCSR.GetString(DCSR.DataSourceLocksItems));
            }
        }
        ...
        internal Point EditToComboboxMapping(Message m) {
            ...
            // Get the Combox Rect ...
            //
            WinFormNativeMethods.RECT comboRectMid = new WinFormNativeMethods.RECT();
            WinFormUnsafeNativeMethods.GetWindowRect(new HandleRef(this, Handle), ref comboRectMid);
            //
            //Get the Edit Rectangle...
            //
            WinFormNativeMethods.RECT editRectMid = new WinFormNativeMethods.RECT();
            WinFormUnsafeNativeMethods.GetWindowRect(new HandleRef(this, childEdit.Handle), ref editRectMid);

            //get the delta
            int comboXMid = WinFormNativeMethods.Util.SignedLOWORD(m.LParam) + (editRectMid.left - comboRectMid.left);
            int comboYMid = WinFormNativeMethods.Util.SignedHIWORD(m.LParam) + (editRectMid.top - comboRectMid.top);
            ...
            switch (m.Msg) {
                ...
                case WinFormNativeMethods.WM_SETFONT:
                    ...
                    if (childEdit != null && m.HWnd == childEdit.Handle) {
                        WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, childEdit.Handle), WinFormNativeMethods.EM_SETMARGINS,
                                                  WinFormNativeMethods.EC_LEFTMARGIN | WinFormNativeMethods.EC_RIGHTMARGIN, 0);
                    }
                    break;
                    ...
                    if (mouseEvents && !ValidationCancelled) {
                        ...
                        if (mousePressed) {
                            if (ClientRect.Contains(pt)) {
                                mousePressed = false;
                                OnClick(new MouseEventArgs(MouseButtons.Left, 1, WinFormNativeMethods.Util.SignedLOWORD(m.LParam), WinFormNativeMethods.Util.SignedHIWORD(m.LParam), 0));
                                OnMouseClick(new MouseEventArgs(MouseButtons.Left, 1, WinFormNativeMethods.Util.SignedLOWORD(m.LParam), WinFormNativeMethods.Util.SignedHIWORD(m.LParam), 0));
                            }
                            else {
                                mousePressed = false;
                                mouseInEdit = false;
                ...
                case WinFormNativeMethods.WM_MBUTTONUP:
                    ...
                    CaptureInternal = false;
                    DefChildWndProc(ref m);
                    OnMouseUp(new MouseEventArgs(MouseButtons.Middle, 1, WinFormNativeMethods.Util.SignedLOWORD(m.LParam), WinFormNativeMethods.Util.SignedHIWORD(m.LParam), 0));
                    break;
                ...
                case WinFormNativeMethods.WM_CONTEXTMENU:
                    ...
                    if (this.ContextMenu != null || this.ContextMenuStrip != null) {
                        WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.WM_CONTEXTMENU, m.WParam, m.LParam);
                    }
                    else {
                        DefChildWndProc(ref m);
                    }
                ...
                case WinFormNativeMethods.WM_SETCURSOR:
                    if (Cursor != DefaultCursor && childEdit != null && m.HWnd == childEdit.Handle && WinFormNativeMethods.Util.LOWORD(m.LParam) == WinFormNativeMethods.HTCLIENT) {
        ...
        private void OnMouseLeaveInternal(EventArgs args) {
            ...
            WinFormUnsafeNativeMethods.GetWindowRect(new HandleRef(this, Handle), ref rect);
        ...
        public void EndUpdate() {
            ...
            if (EndUpdateInternal()) {
                if (childEdit != null && childEdit.Handle != IntPtr.Zero) {
                    WinFormSafeNativeMethods.InvalidateRect(new HandleRef(this, childEdit.Handle), null, false);
                }
                if (childListBox != null && childListBox.Handle != IntPtr.Zero) {
                    WinFormSafeNativeMethods.InvalidateRect(new HandleRef(this, childListBox.Handle), null, false);
                }
            }
        }
    ...
    [SuppressMessage("Microsoft.Portability", "CA1902:AvoidTestingForFloatingPointEquality")]
        ...
        public int GetItemHeight(int index) {
            ...
            if (IsHandleCreated) {
                ...
                int h = unchecked( (int) (long)SendMessage(WinFormNativeMethods.CB_GETITEMHEIGHT, index, 0) );
                if (h == -1) {
                    throw new Win32Exception();
                }
                return h;
        ...
        internal override IntPtr InitializeDCForWmCtlColor(IntPtr dc, int msg) {
            if ((msg == WinFormNativeMethods.WM_CTLCOLORSTATIC) && !ShouldSerializeBackColor()) {
            ...
            else if ((msg == WinFormNativeMethods.WM_CTLCOLORLISTBOX) && GetStyle(ControlStyles.UserPaint)) {
        ...
        private bool InterceptAutoCompleteKeystroke(Message m) {
            if (m.Msg == WinFormNativeMethods.WM_KEYDOWN) {
            ...
            else if (m.Msg == WinFormNativeMethods.WM_CHAR) {
                Debug.Assert((ModifierKeys & Keys.Alt) == 0);
                char keyChar = unchecked((char)(long)m.WParam);
        ...
        private void InvalidateEverything() {
            WinFormSafeNativeMethods.RedrawWindow(new HandleRef(this, Handle),
                                           ...
                                           WinFormNativeMethods.RDW_FRAME |  // Control.Invalidate(true) doesn't invalidate the non-client region
        ...
        private int NativeAdd(object item) {
            ...
            int insertIndex = unchecked( (int) (long)SendMessage(WinFormNativeMethods.CB_ADDSTRING, 0, GetItemText(item)));
            if (insertIndex < 0) {
                throw new OutOfMemoryException(DCSR.GetString(DCSR.ComboBoxItemOverflow));
            }
            return insertIndex;
        }
        ...
        private void NativeClear() {
            ...
            SendMessage(WinFormNativeMethods.CB_RESETCONTENT, 0, 0);
            if (saved != null) {
                WindowText = saved;
            }
        }
        ...
        private string NativeGetItemText(int index) {
            int len = unchecked( (int) (long)SendMessage(WinFormNativeMethods.CB_GETLBTEXTLEN, index, 0));
            StringBuilder sb = new StringBuilder(len + 1);
            WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, Handle), WinFormNativeMethods.CB_GETLBTEXT, index, sb);
            return sb.ToString();
        }
        ...
        private int NativeInsert(int index, object item) {
            Debug.Assert(IsHandleCreated, "Shouldn't be calling Native methods before the handle is created.");
            int insertIndex = unchecked( (int) (long)SendMessage(WinFormNativeMethods.CB_INSERTSTRING, index, GetItemText(item)));
            if (insertIndex < 0) {
                throw new OutOfMemoryException(DCSR.GetString(DCSR.ComboBoxItemOverflow));
            }
        ...
        private void NativeRemoveAt(int index) {
            ...
            SendMessage(WinFormNativeMethods.CB_DELETESTRING, index, 0);
        }
        ...
        protected override void OnHandleCreated(EventArgs e) {
            ...
            if (MaxLength > 0) {
                SendMessage(WinFormNativeMethods.CB_LIMITTEXT, MaxLength, 0);
            }
            ...
            if (ok && DropDownStyle != ComboBoxStyle.DropDownList) {
                IntPtr hwnd = WinFormUnsafeNativeMethods.GetWindow(new HandleRef(this, Handle), WinFormNativeMethods.GW_CHILD);
                if (hwnd != IntPtr.Zero) {
                    ...
                    if (DropDownStyle == ComboBoxStyle.Simple) {
                        ...
                        // get the edits hwnd...
                        //
                        hwnd = WinFormUnsafeNativeMethods.GetWindow(new HandleRef(this, hwnd), WinFormNativeMethods.GW_HWNDNEXT);
                    }
            ...
            int dropDownWidth = Properties.GetInteger(PropDropDownWidth, out found);
            if (found) {
                SendMessage(WinFormNativeMethods.CB_SETDROPPEDWIDTH, dropDownWidth, 0);
            }
            ...
            if (itemsCollection != null) {
                ...
                //
                if (selectedIndex >= 0) {
                    SendMessage(WinFormNativeMethods.CB_SETCURSEL, selectedIndex, 0);
                    UpdateText();
                    selectedIndex = -1;
                }
            }
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        protected virtual async ValueTask OnDropDownAsync(EventArgs e)
        {
            var handler2 = (EventHandlerAsync)this.Events[EVENT_DROPDOWNAsync];
            if (handler2 != null) await handler2(this, e);
        }

        internal async ValueTask _RaiseDropDownEvent( )
        {
            this.OnDropDown(EventArgs.Empty);
            await this.OnDropDownAsync(EventArgs.Empty);
        }
        ...
        protected override void OnDataSourceChanged(EventArgs e) {
            if (Sorted) {
                if (DataSource != null && Created) {
                    ...
                    DataSource = null;
                    throw new InvalidOperationException(DCSR.GetString(DCSR.ComboBoxDataSourceWithSort));
                }
            }
            if (DataSource == null) {
                BeginUpdate();
	...
	[SuppressMessage("Microsoft.Security", "CA2122:DoNotIndirectlyExposeMethodsWithLinkDemands")]
        private void SetAutoComplete(bool reset, bool recreate) {
            ...
            if (AutoCompleteMode != AutoCompleteMode.None) {
                ...
                if (AutoCompleteSource == AutoCompleteSource.CustomSource) {
                    if (AutoCompleteCustomSource != null) {
                        if (AutoCompleteCustomSource.Count == 0) {
                            int mode = WinFormNativeMethods.AUTOSUGGEST_OFF | WinFormNativeMethods.AUTOAPPEND_OFF;
                            WinFormSafeNativeMethods.SHAutoComplete(new HandleRef(this, childEdit.Handle), mode);
                        }
                        else {
                        ...
                        if (itemsCollection != null) {
                            if (itemsCollection.Count == 0) {
                                ...
                                if (stringSource == null)
                                {
                                    ...
                                    if (!stringSource.Bind(new HandleRef(this, childEdit.Handle), (int)AutoCompleteMode)) {
                                        throw new ArgumentException(DCSR.GetString(DCSR.AutoCompleteFailureListItems));
                                    }
                                }
                                else
                                {
                    ...
                    try {
                        ...
                        int ret = WinFormSafeNativeMethods.SHAutoComplete(new HandleRef(this, childEdit.Handle), (int)AutoCompleteSource | mode);
                    }
        ...
        public void Select(int start, int length) {
            if (start < 0) {
                throw new ArgumentOutOfRangeException("start", DCSR.GetString(DCSR.InvalidArgument, "start", start.ToString(CultureInfo.CurrentCulture)));
            }
            ...
            if (end < 0) {
                throw new ArgumentOutOfRangeException("length", DCSR.GetString(DCSR.InvalidArgument, "length", length.ToString(CultureInfo.CurrentCulture)));
            }

            SendMessage(WinFormNativeMethods.CB_SETEDITSEL, 0, WinFormNativeMethods.Util.MAKELPARAM(start, end));
        }
        ...
        protected override void SetItemsCore(IList value) {
            ...
            if (this.DataManager != null) {
                ...
                if (IsHandleCreated) {
                    SendMessage(WinFormNativeMethods.CB_SETCURSEL, DataManager.Position, 0);
                }
                else {
        ...
        private void UpdateDropDownHeight() {
            if (dropDownHandle != IntPtr.Zero) {
                ...
                WinFormSafeNativeMethods.SetWindowPos(new HandleRef(this, dropDownHandle), WinFormNativeMethods.NullHandleRef, 0, 0, DropDownWidth, height,
                                     WinFormNativeMethods.SWP_NOMOVE | WinFormNativeMethods.SWP_NOZORDER);
            }
        }
        ...
        private void UpdateItemHeight() {
            ...
            if (DrawMode == DrawMode.OwnerDrawFixed) {
                SendMessage(WinFormNativeMethods.CB_SETITEMHEIGHT, -1, ItemHeight);
                SendMessage(WinFormNativeMethods.CB_SETITEMHEIGHT, 0, ItemHeight);
            }
            else if (DrawMode == DrawMode.OwnerDrawVariable) {
                SendMessage(WinFormNativeMethods.CB_SETITEMHEIGHT, -1, ItemHeight);
                Graphics graphics = CreateGraphicsInternal();
                for (int i = 0; i < Items.Count; i++) {
                    int original = unchecked( (int) (long)SendMessage(WinFormNativeMethods.CB_GETITEMHEIGHT, i, 0));
                    ...
                    if (mievent.ItemHeight != original) {
                        SendMessage(WinFormNativeMethods.CB_SETITEMHEIGHT, i, mievent.ItemHeight);
                    }
                }
                graphics.Dispose();
            }
        ...
        private void UpdateText() {
            ...
            if (DropDownStyle == ComboBoxStyle.DropDown) {
                if (childEdit != null && childEdit.Handle != IntPtr.Zero) {
                    WinFormUnsafeNativeMethods.SendMessage(new HandleRef(this, childEdit.Handle), WinFormNativeMethods.WM_SETTEXT, IntPtr.Zero, s);
                }
            }
        }
        ...
        private void WmEraseBkgnd(ref Message m) {
            if ((DropDownStyle == ComboBoxStyle.Simple) && ParentInternal != null) {
                WinFormNativeMethods.RECT rect = new WinFormNativeMethods.RECT();
                WinFormSafeNativeMethods.GetClientRect(new HandleRef(this, Handle), ref rect);
        ...
        private void WmParentNotify(ref Message m) {
            base.WndProc(m);
            if (unchecked((int)(long)m.WParam) == (WinFormNativeMethods.WM_CREATE | 1000 << 16)) {
        ...
        private void WmReflectCommand(ref Message m) {
            switch (WinFormNativeMethods.Util.HIWORD(m.WParam)) {
                case WinFormNativeMethods.CBN_DBLCLK:
                    //OnDoubleClick(EventArgs.Empty);
                    break;
                case WinFormNativeMethods.CBN_EDITUPDATE:
                    OnTextUpdate(EventArgs.Empty);
                    break;
                case WinFormNativeMethods.CBN_CLOSEUP:
                    ...
                    dropDown = false;
                    break;
                case WinFormNativeMethods.CBN_DROPDOWN:
                    currentText = Text;
                    dropDown = true;
                    ...
                    break;
                case WinFormNativeMethods.CBN_EDITCHANGE:
                    OnTextChanged(EventArgs.Empty);
                    break;
                case WinFormNativeMethods.CBN_SELCHANGE:
                    UpdateText();
                    OnSelectedIndexChanged(EventArgs.Empty);
                    break;
                case WinFormNativeMethods.CBN_SELENDOK:
                    OnSelectionChangeCommittedInternal(EventArgs.Empty);
                    break;
            }
        }
        ...
        private void WmReflectDrawItem(ref Message m) {
            ...
            try {
                ...
                if (oldPal != IntPtr.Zero) {
                    WinFormSafeNativeMethods.SelectPalette(new HandleRef(this, dis.hDC), new HandleRef(null, oldPal), 0);
                }
            }
            m.Result = (IntPtr)1;
        }
        ...
        protected override async Task WndProc(Message m) {
            switch (m.Msg) {
                ...
                case WinFormNativeMethods.WM_KILLFOCUS:
                    try {
                        ...
                        if (!Application.RenderWithVisualStyles && GetStyle(ControlStyles.UserPaint) == false && this.DropDownStyle == ComboBoxStyle.DropDownList && (FlatStyle == FlatStyle.Flat || FlatStyle == FlatStyle.Popup)) {
                            WinFormUnsafeNativeMethods.PostMessage(new HandleRef(this, Handle), WinFormNativeMethods.WM_MOUSELEAVE, 0, 0);                            
                        }
                    }
                ...
                case WinFormNativeMethods.WM_REFLECT + WinFormNativeMethods.WM_COMMAND:
                    ...
                    break;
                case WinFormNativeMethods.WM_REFLECT + WinFormNativeMethods.WM_DRAWITEM:
                    WmReflectDrawItem(ref m);
                    break;
                case WinFormNativeMethods.WM_REFLECT + WinFormNativeMethods.WM_MEASUREITEM:
                    ...
                    if (GetStyle(ControlStyles.UserPaint) == false && (FlatStyle == FlatStyle.Flat || FlatStyle == FlatStyle.Popup)) {
                        ...
                        using (WindowsRegion dr = new WindowsRegion(FlatComboBoxAdapter.dropDownRect)) {
                            using (WindowsRegion wr = new WindowsRegion(this.Bounds)) {
                                ...
                                WinFormNativeMethods.RegionFlags updateRegionFlags = (WinFormNativeMethods.RegionFlags)WinFormSafeNativeMethods.GetUpdateRgn(new HandleRef(this, this.Handle), new HandleRef(this, wr.HRegion), true);
                                ...
                                if (m.WParam == IntPtr.Zero) {
                                    dc = WinFormUnsafeNativeMethods.BeginPaint(new HandleRef(this, Handle), ref ps);
                                    disposeDc = true;
                                }
                                else {
                                    dc = m.WParam;
                                ...
                                using (DeviceContext mDC = DeviceContext.FromHdc(dc)) {
                                    using (WindowsGraphics wg = new WindowsGraphics(mDC)) {
                                        if (updateRegionFlags != WinFormNativeMethods.RegionFlags.ERROR) {
                                ...
                                if (disposeDc) {
                                    WinFormUnsafeNativeMethods.EndPaint(new HandleRef(this, Handle), ref ps);
                                }
                ...
                case WinFormNativeMethods.WM_PRINTCLIENT: 
                    ...
                    if (GetStyle(ControlStyles.UserPaint) == false && FlatStyle == FlatStyle.Flat || FlatStyle == FlatStyle.Popup) {
                        ...
                        if ((unchecked( (int) (long)m.LParam) & WinFormNativeMethods.PRF_CLIENT) == WinFormNativeMethods.PRF_CLIENT) { 
                            if (GetStyle(ControlStyles.UserPaint) == false && FlatStyle == FlatStyle.Flat || FlatStyle == FlatStyle.Popup) {
        ...
        internal override void Handle_WM_WINDOWPOSCHANGED(Message m)
        {
            if (!suppressNextWindosPos)
            {
                base.Handle_WM_WINDOWPOSCHANGED(m);
            }
            suppressNextWindosPos = false;
        }
        /// <devdoc>
        ...
        private class ComboBoxChildNativeWindow : NativeWindow {
            ...
            private void WmGetObject(ref Message m) {
                ...
                //
                if (WinFormNativeMethods.OBJID_CLIENT == unchecked((int)(long)m.LParam)) {
                    ...
                    try {
                        ...
                        WinFormUnsafeNativeMethods.IAccessibleInternal iacc = null;
                        ...
                        iacc = (WinFormUnsafeNativeMethods.IAccessibleInternal)_accessibilityObject;
                        ...
                        //IntSecurity.UnmanagedCode.Assert();
                        try {
                            m.Result = WinFormUnsafeNativeMethods.LresultFromObject(ref IID_IAccessible, m.WParam, new HandleRef(this, punkAcc));
                        }
                        finally {
                            //CodeAccessPermission.RevertAssert();
                        ...
                        throw new InvalidOperationException(DCSR.GetString(DCSR.RichControlLresult), e);
                    }
                }
        ...
        private sealed class ACNativeWindow : NativeWindow {
            ...
            internal ACNativeWindow(IntPtr acHandle) {
                ...
                WinFormUnsafeNativeMethods.EnumChildWindows(new HandleRef(this, acHandle),
                    new WinFormNativeMethods.EnumChildrenCallback(ACNativeWindow.RegisterACWindowRecursive),
            ...
            internal bool Visible {
                get {
                    return WinFormSafeNativeMethods.IsWindowVisible(new HandleRef(this, Handle));
                }
            }
            ...
            protected override void WndProc(ref Message m) {
                ...
                if (m.Msg == WinFormNativeMethods.WM_NCDESTROY) {
        ...
        private class AutoCompleteDropDownFinder {
            ...
            internal void FindDropDowns(bool subclass) {
                ...
                WinFormUnsafeNativeMethods.EnumThreadWindows(WinFormSafeNativeMethods.GetCurrentThreadId(), new WinFormNativeMethods.EnumThreadWindowsCallback(this.Callback), new HandleRef(null, IntPtr.Zero));
            }
            ...
            static string GetClassName(HandleRef hRef) {
                ...
                WinFormUnsafeNativeMethods.GetClassName(hRef, sb, MaxClassName);
                return sb.ToString();
            }
        }
        ...
        internal class FlatComboAdapter {
             ...
             public void ValidateOwnerDrawRegions(ComboBox comboBox, Rectangle updateRegionBox) {
                 WinFormNativeMethods.RECT validRect;
                 ...
                 if (topOwnerDrawArea.IntersectsWith(updateRegionBox)) {                            
                     validRect =  new WinFormNativeMethods.RECT(topOwnerDrawArea);
                     WinFormSafeNativeMethods.ValidateRect(new HandleRef(comboBox, comboBox.Handle), ref validRect);
                 }
 
                 if (bottomOwnerDrawArea.IntersectsWith(updateRegionBox)) {                            
                     validRect =  new WinFormNativeMethods.RECT(bottomOwnerDrawArea);
                     WinFormSafeNativeMethods.ValidateRect(new HandleRef(comboBox, comboBox.Handle), ref validRect);
                 }
 
                 if (leftOwnerDrawArea.IntersectsWith(updateRegionBox)) {                            
                     validRect =  new WinFormNativeMethods.RECT(leftOwnerDrawArea);
                     WinFormSafeNativeMethods.ValidateRect(new HandleRef(comboBox, comboBox.Handle), ref validRect);
                 }
 
                 if (rightOwnerDrawArea.IntersectsWith(updateRegionBox)) {                            
                     validRect =  new WinFormNativeMethods.RECT(rightOwnerDrawArea);
                     WinFormSafeNativeMethods.ValidateRect(new HandleRef(comboBox, comboBox.Handle), ref validRect);
                 }
