...
namespace System.Windows.Forms
{
    ...
    public class DataGridViewComboBoxColumn : DataGridViewColumn
    {
        ...
        [
            ...
            SRDescription(DCSR.DataGridView_ComboBoxColumnAutoCompleteDescr)
        ]
        public bool AutoComplete
        {
            get
            {
                ...
                {
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewColumn_CellTemplateRequired));
                }
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidCastException(DCSR.GetString(DCSR.DataGridViewTypeColumn_WrongCellTemplateType, "System.Windows.Forms.DataGridViewComboBoxCell"));
                }
        ...
        [
            ...
            SRDescription(DCSR.DataGridView_ComboBoxColumnDataSourceDescr),
        ...
        [
            DefaultValue(""),
            SRCategory(DCSR.CatData),
            SRDescription(DCSR.DataGridView_ComboBoxColumnDisplayMemberDescr),
        ...
        [
            ...
            SRDescription(DCSR.DataGridView_ComboBoxColumnDisplayStyleDescr)
        ]
        ...
        [
            DefaultValue(false),
            SRCategory(DCSR.CatAppearance),
            SRDescription(DCSR.DataGridView_ComboBoxColumnDisplayStyleForCurrentCellOnlyDescr)
        ]
        ...
        [
            DefaultValue(1),
            SRCategory(DCSR.CatBehavior),
            SRDescription(DCSR.DataGridView_ComboBoxColumnDropDownWidthDescr),
        ]
        ...
        [
            ...
            SRCategory(DCSR.CatAppearance),
            SRDescription(DCSR.DataGridView_ComboBoxColumnFlatStyleDescr),
        ]
        ...
        [
            ...
            SRCategory(DCSR.CatData),
            SRDescription(DCSR.DataGridView_ComboBoxColumnItemsDescr)
        ]
        ...
        [
            DefaultValue(""),
            SRCategory(DCSR.CatData),
            SRDescription(DCSR.DataGridView_ComboBoxColumnValueMemberDescr),
            TypeConverterAttribute("System.Windows.Forms.Design.DataMemberFieldConverter, " + AssemblyRef.SystemDesign),
            Editor("System.Windows.Forms.Design.DataMemberFieldEditor, " + AssemblyRef.SystemDesign, typeof(System.Drawing.Design.UITypeEditor))
        ]
        ...
        [
            ...
            SRCategory(DCSR.CatBehavior),
            SRDescription(DCSR.DataGridView_ComboBoxColumnMaxDropDownItemsDescr)
        ]
        ...
        [
            DefaultValue(false),
            SRCategory(DCSR.CatBehavior),
            SRDescription(DCSR.DataGridView_ComboBoxColumnSortedDescr)
        ]
        public bool Sorted
        {
            get 
