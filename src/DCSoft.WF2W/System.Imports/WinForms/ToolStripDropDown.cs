...
[System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = false )]
    public class ToolStripDropDown : ToolStrip {
        ...
        SRDescription(DCSR.ControlAllowTransparencyDescr)
        ]
        ...
        SRDescription(DCSR.ToolStripDropDownAutoCloseDescr)
        ]
        public bool AutoClose {
            ...
            set {
                ...
                if (autoClose != value) {
                    ...
                    this.LogWF2WPropertyValue("AutoClose", value);
                }
            }
        }
        ...
        protected override CreateParams CreateParams {
           //[SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.UnmanagedCode)]
            get {
                ...
                cp.Style &= ~(WinFormNativeMethods.WS_CAPTION | WinFormNativeMethods.WS_CLIPSIBLINGS);         /* no caption, no siblings */
                cp.ExStyle &= ~(WinFormNativeMethods.WS_EX_APPWINDOW);  /* show in taskbar = false */
                // | NativeMethods.WS_EX_TOOLWINDOW
                cp.Style |= (TopLevel) ? WinFormNativeMethods.WS_POPUP : WinFormNativeMethods.WS_CHILD;
                cp.ExStyle |= (WinFormNativeMethods.WS_EX_CONTROLPARENT);  /* show in taskbar = false */
                ...
                if (topLevel && (state[stateLayered])) {
                    ...
                    cp.ClassStyle |= WinFormNativeMethods.CS_SAVEBITS;
                }
                else if (!topLevel) {
                    cp.Style |= WinFormNativeMethods.WS_CLIPSIBLINGS;
                }
        ...
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.ToolStripDropDownClosedDecr)]
        ...
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.ToolStripDropDownClosingDecr)]
        ...
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.ToolStripDropDownOpeningDescr)]
        ...
        /// </devdoc>
        [SRCategory(DCSR.CatAction), SRDescription(DCSR.ToolStripDropDownOpenedDescr)]
        ...
        SRDescription(DCSR.FormOpacityDescr),
        DefaultValue(1.0),
        Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced)
        ]
...
// }
          ...
          SRDescription(DCSR.ControlOnTabIndexChangedDescr)
          ]
        ...
        [
                SRCategory(DCSR.CatBehavior),
                Localizable(true),
                SRDescription(DCSR.ControlVisibleDescr),
                DefaultValue(false),
                Browsable(false),
                DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)
        ]
        ...
        private void ApplyTopMost(bool topMost) {
            if (TopMost) {
                HandleRef topMostFlag = (topMost) ? WinFormNativeMethods.HWND_TOPMOST : WinFormNativeMethods.HWND_NOTOPMOST;
                WinFormSafeNativeMethods.SetWindowPos(new HandleRef(this, Handle), topMostFlag, 0, 0, 0, 0,
                                             WinFormNativeMethods.SWP_NOMOVE | WinFormNativeMethods.SWP_NOSIZE | WinFormNativeMethods.SWP_NOACTIVATE);
            }
        }
        ...
        internal override void RecreateHandleCore() {
         ...
         private void ReparentToActiveToolStripWindow() {
              ...
              WinFormUnsafeNativeMethods.SetWindowLong(new HandleRef(this, Handle), WinFormNativeMethods.GWL_HWNDPARENT, ToolStripManager.ModalMenuFilter.ActiveHwnd);
          }
          ...
          private void ReparentToDropDownOwnerWindow() {
              ...
              WinFormUnsafeNativeMethods.SetWindowLong(new HandleRef(this, Handle), WinFormNativeMethods.GWL_HWNDPARENT, ownerHandle);
          }
...
#pragma warning restore 618
        ...
        private void SetTopLevelStyle(bool value) {
            if (IsHandleCreated) {
                ...
                if (value) {
                    ...
                    styleFlags &= ~WinFormNativeMethods.WS_CHILD;
                    styleFlags |= WinFormNativeMethods.WS_POPUP;
                }
                else {
                ...
                if (visible) {
                    ...
                    try {
                        ...
                        if (!openingEventCancelled) {
                            ...
                            else if (IsHandleCreated && WinFormSafeNativeMethods.IsWindowEnabled(new HandleRef(this, Handle)))   {
                                WinFormSafeNativeMethods.SetWindowPos(new HandleRef(this, Handle), WinFormNativeMethods.HWND_TOP, 0, 0, 0, 0,
                                                             WinFormNativeMethods.SWP_NOMOVE | WinFormNativeMethods.SWP_NOSIZE | WinFormNativeMethods.SWP_NOACTIVATE);
                            }
        ...
        protected override async Task WndProc(Message m) {
           ...
           if (m.Msg >= WinFormNativeMethods.WM_KEYFIRST && m.Msg <= WinFormNativeMethods.WM_KEYLAST && IsRestrictedWindow) {
                // SECREVIEW:
           ...
           switch (m.Msg) {
               ...
               case WinFormNativeMethods.WM_ACTIVATE:
                   ...
                   Debug.WriteLineIf(ToolStrip.SnapFocusDebug.TraceVerbose, "[ToolStripDropDown.WndProc] got a WM_ACTIVATE " + (((int)m.WParam == WinFormNativeMethods.WA_ACTIVE) ? "WA_ACTIVE" : "WA_INACTIVE") + " - checkin if we need to set the active toolstrip");
               
                   if((int)m.WParam == WinFormNativeMethods.WA_ACTIVE) {
                       if (this.Visible) {
            ...
            if (m.WParam != IntPtr.Zero /*activating*/) {
                ...
                if (!sendingActivateMessage) {
                    ...
                    try {
                        ...
                        WinFormUnsafeNativeMethods.SendMessage(activeHwndHandleRef, WinFormNativeMethods.WM_NCACTIVATE, (IntPtr)1, WinFormNativeMethods.InvalidIntPtr);
                        WinFormSafeNativeMethods.RedrawWindow(activeHwndHandleRef, null, WinFormNativeMethods.NullHandleRef, WinFormNativeMethods.RDW_FRAME | WinFormNativeMethods.RDW_INVALIDATE);
                        m.WParam = (IntPtr)1;
                    }
                    finally {
