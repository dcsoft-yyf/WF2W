...
namespace System.Windows.Forms {
    ...
    public struct TableLayoutPanelCellPosition {
        ...
        public TableLayoutPanelCellPosition(int column, int row) {
            ...
            if (column < -1) {
                throw new ArgumentOutOfRangeException("column", DCSR.GetString(DCSR.InvalidArgument, "column", (column).ToString(CultureInfo.CurrentCulture)));
            }
            this.row = row;
            this.column = column;
        }
            ...
            if (value is string) {
                ...
                if (text.Length == 0) {
                    ...
                    if (values.Length == 2) {
                        ...
                        throw new ArgumentException(DCSR.GetString(DCSR.TextParseFailedFormat,
                                                                  text,
                                                                  "column, row"));
                    }
                }
