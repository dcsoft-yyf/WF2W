        ...
        public Type DefaultHeaderCellType
        {
            ...
            set
            {
                if (value != null || this.Properties.ContainsObject(PropDefaultHeaderCellType))
                {
                    ...
                    {
                        throw new ArgumentException(DCSR.GetString(DCSR.DataGridView_WrongType, "DefaultHeaderCellType", "System.Windows.Forms.DataGridViewHeaderCell"));
                    }
                }
            }
        }
        ...
        internal int DividerThickness
        {
            ...
            set
            {
                if (value < 0)
                {
                    if (this.bandIsRow)
                    {
                        throw new ArgumentOutOfRangeException("DividerHeight", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "DividerHeight", (value).ToString(CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture)));
                    }
                    else
                    {
                        throw new ArgumentOutOfRangeException("DividerWidth", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "DividerWidth", (value).ToString(CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture)));
                    }
                }
                if (value > maxBandThickness)
                {
                    if (this.bandIsRow)
                    {
                        throw new ArgumentOutOfRangeException("DividerHeight", DCSR.GetString(DCSR.InvalidHighBoundArgumentEx, "DividerHeight", (value).ToString(CultureInfo.CurrentCulture), (maxBandThickness).ToString(CultureInfo.CurrentCulture)));
                    }
                    else
                    {
                        throw new ArgumentOutOfRangeException("DividerWidth", DCSR.GetString(DCSR.InvalidHighBoundArgumentEx, "DividerWidth", (value).ToString(CultureInfo.CurrentCulture), (maxBandThickness).ToString(CultureInfo.CurrentCulture)));
                    }
                }
                ...
                if (value != null || this.Properties.ContainsObject(PropHeaderCell))
                {
                    ...
                    if (value != null)
                    {
                        if (this.bandIsRow)
                        {
                            ...
                            {
                                throw new ArgumentException(DCSR.GetString(DCSR.DataGridView_WrongType, "HeaderCell", "System.Windows.Forms.DataGridViewRowHeaderCell"));
                            }
                        ...
                        else
                        {
                            ...
                            {
                                throw new ArgumentException(DCSR.GetString(DCSR.DataGridView_WrongType, "HeaderCell", "System.Windows.Forms.DataGridViewColumnHeaderCell"));
                            }
                            // A HeaderCell can only be used by one band.
            ...
            set
            {
                if (this.minimumThickness != value)
                {
                    if (value < minBandThickness)
                    {
                        if (this.bandIsRow)
                        {
                            throw new ArgumentOutOfRangeException("MinimumHeight", value, DCSR.GetString(DCSR.DataGridViewBand_MinimumHeightSmallerThanOne, (DataGridViewBand.minBandThickness).ToString(CultureInfo.CurrentCulture)));
                        }
                        else
                        {
                            throw new ArgumentOutOfRangeException("MinimumWidth", value, DCSR.GetString(DCSR.DataGridViewBand_MinimumWidthSmallerThanOne, (DataGridViewBand.minBandThickness).ToString(CultureInfo.CurrentCulture)));
                        }
                    }
            ...
            set
            {
                if (this.DataGridView != null)
                {
                    ...
                    if (this.bandIsRow)
                    {
                        if (this.bandIndex == -1)
                        {
                            throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidPropertySetOnSharedRow, "ReadOnly"));
                        }
            ...
            set
            {
                if (this.DataGridView != null)
                {
                    ...
                    if (this.bandIsRow)
                    {
                        if (this.bandIndex == -1)
                        {
                            throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridView_InvalidPropertySetOnSharedRow, "Selected"));
                        }
                ...
                else if (value)
                {
                    ...
                    throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewBand_CannotSelect));
                }
            }
        }
        ...
        internal int Thickness
        {
            ...
            set
            {
                ...
                if (value > maxBandThickness)
                {
                    if (this.bandIsRow)
                    {
                        throw new ArgumentOutOfRangeException("Height", DCSR.GetString(DCSR.InvalidHighBoundArgumentEx, "Height", (value).ToString(CultureInfo.CurrentCulture), (maxBandThickness).ToString(CultureInfo.CurrentCulture)));
                    }
                    else
                    {
                        throw new ArgumentOutOfRangeException("Width", DCSR.GetString(DCSR.InvalidHighBoundArgumentEx, "Width", (value).ToString(CultureInfo.CurrentCulture), (maxBandThickness).ToString(CultureInfo.CurrentCulture)));
                    }
                }
            ...
            set
            {
                if (((this.State & DataGridViewElementStates.Visible) != 0) != value)
                {
                        ...
                        !value)
                    {
                        ...
                        throw new InvalidOperationException(DCSR.GetString(DCSR.DataGridViewBand_NewRowCannotBeInvisible));
                    }
