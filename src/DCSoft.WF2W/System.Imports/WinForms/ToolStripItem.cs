...
namespace System.Windows.Forms {
    ...
    public abstract class ToolStripItem : Component, 
        ...
        protected void LogWF2WPropertyValue(string name, System.Text.Json.Nodes.JsonNode value) { PropertyValueLogger.Log(this, name, value); }
        ...
        internal void CheckCreateHandle()
        {
            if (this._Handle == IntPtr.Zero)
            {
                this._Handle = DCWin32API.AllocHandle(this);
                DCWin32API.RegisterControl(this._Handle.ToInt32(), this);
            }
        }
        ...
        SRDescription(DCSR.ToolStripItemAccessibilityObjectDescr)
        ]
        ...
        Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced), 
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        SRDescription(DCSR.ToolStripItemAccessibleDefaultActionDescr)
        ]
        ...
        DefaultValue(null),
        Localizable(true),
        SRDescription(DCSR.ToolStripItemAccessibleDescriptionDescr)
        ]
        ...
        DefaultValue(null),
        Localizable(true),
        SRDescription(DCSR.ToolStripItemAccessibleNameDescr)
        ]
        ...
        SRDescription(DCSR.ToolStripItemAccessibleRoleDescr)
        ]
        ...
        SRDescription(DCSR.ToolStripItemAlignmentDescr)
        ]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [
        SRCategory(DCSR.CatDragDrop),
        DefaultValue(false),
        SRDescription(DCSR.ToolStripItemAllowDropDescr),
        ...
        [Localizable(true)]
        [SRDescription(DCSR.ToolStripItemAutoSizeDescr)]
        ...
        public bool AutoSize {
            ...
            set {
                if (state[stateAutoSize] != value) {
                    ...
                    LogWF2WPropertyValue("AutoSize", value);
                }
            }
        }
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [DefaultValue(false)]
        [SRDescription(DCSR.ToolStripItemAutoToolTipDescr)]
        [SRCategory(DCSR.CatBehavior)]
        public bool AutoToolTip {
           ...
           set {
                ...
                this.LogWF2WPropertyValue("AutoToolTip", value);
            }
        }
        ...
        [
        Browsable(false),
        SRDescription(DCSR.ToolStripItemAvailableDescr),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)
        ]
        ...
        SRDescription(DCSR.ToolStripItemOnAvailableChangedDescr)
        ]
        ...
        SRDescription(DCSR.ToolStripItemImageDescr),
        DefaultValue(null)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripItemBackColorDescr)
        ]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ToolStripItemOnBackColorChangedDescr)]
        ...
        SRDescription(DCSR.ToolStripItemOnClickDescr)
        ]
        ...
        public event EventHandlerAsync ClickAsync
        {
            add
            {
                Events.AddHandler(EventClickAsync, value);
            }
            remove
            {
                Events.RemoveHandler(EventClickAsync, value);
            }
        }
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripItemDisplayStyleDescr)
        ]
            ...
            set {
                 if (displayStyle != value) {
                    ...
                    if (!state[stateContstructing]) {
                        ...
                        this.LogWF2WPropertyValue("DisplayStyle", value);
                    }
                }
        ...
        DefaultValue(false), 
        SRCategory(DCSR.CatBehavior), 
        SRDescription(DCSR.ToolStripItemDoubleClickedEnabledDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatDragDrop), 
        SRDescription(DCSR.ToolStripItemOnDragDropDescr),
        EditorBrowsable(EditorBrowsableState.Advanced),
        Browsable(false)
        ]
        ...
        [
        SRCategory(DCSR.CatDragDrop), 
        SRDescription(DCSR.ToolStripItemOnDragEnterDescr),
        EditorBrowsable(EditorBrowsableState.Advanced),
        Browsable(false)
        ]
        ...
        [
        SRCategory(DCSR.CatDragDrop), 
        SRDescription(DCSR.ToolStripItemOnDragOverDescr),
        EditorBrowsable(EditorBrowsableState.Advanced),
        Browsable(false)
        ]
        ...
        [
        SRCategory(DCSR.CatDragDrop), 
        SRDescription(DCSR.ToolStripItemOnDragLeaveDescr),
        EditorBrowsable(EditorBrowsableState.Advanced),
        Browsable(false)
        ]
        ...
        SRCategory(DCSR.CatBehavior),
        Localizable(true),
        SRDescription(DCSR.ToolStripItemEnabledDescr),
        DefaultValue(true)
        ]
        public virtual bool Enabled {
            ...
            set {
                ...
                if (state[stateEnabled] != value) {
                    ...
                    Invalidate();
                    this.LogWF2WPropertyValue("Enabled", value);
                }
        ...
        /// </devdoc>
        [ 
        SRDescription(DCSR.ToolStripItemEnabledChangedDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripItemForeColorDescr)
        ]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ToolStripItemOnForeColorChangedDescr)]
        ...
        SRCategory(DCSR.CatAppearance),
        Localizable(true),
        SRDescription(DCSR.ToolStripItemFontDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatDragDrop), 
        SRDescription(DCSR.ToolStripItemOnGiveFeedbackDescr),
        EditorBrowsable(EditorBrowsableState.Advanced),
        Browsable(false)
        ]
        ...
        Localizable(true),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripItemImageAlignDescr)
        ]
        public ContentAlignment ImageAlign {
            ...
            set {
                ...
                if (imageAlign != value) {
                    ...
                    this.LogWF2WPropertyValue("ImageAlign", value);
                }
            }
        }
        ...
        public virtual Image Image {
            ...
            set {
                if (Image != value) {
                    ...
                    this.LogWF2WPropertyValue("Image", this.Image);
                }
            }
        }
        ...
        Localizable(true),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripItemImageTransparentColorDescr)
        ] 
        public Color ImageTransparentColor {
            ...
            set {
                if (imageTransparentColor != value) {
                    ...
                    Invalidate();
                    this.LogWF2WPropertyValue("ImageTransparentColor", value);
                }
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [
        SRDescription(DCSR.ToolStripItemImageIndexDescr),
        Localizable(true),
        SRCategory(DCSR.CatBehavior),
        ...
        public int ImageIndex {
            ...
            set {
                if (value < -1) {
                    throw new ArgumentOutOfRangeException("ImageIndex", DCSR.GetString(DCSR.InvalidLowBoundArgumentEx, "ImageIndex", value.ToString(CultureInfo.CurrentCulture), (-1).ToString(CultureInfo.CurrentCulture)));
                }
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [
        SRDescription(DCSR.ToolStripItemImageKeyDescr),
        SRCategory(DCSR.CatBehavior),
        Localizable(true),
        ...
        Localizable(true),
        SRDescription(DCSR.ToolStripItemImageScalingDescr)
        ]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatLayout), SRDescription(DCSR.ToolStripItemOnLocationChangedDescr)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [
        SRDescription(DCSR.ToolStripItemMarginDescr),
        SRCategory(DCSR.CatLayout)
        ]
        public Padding Margin {
            ...
            set { 
                if (Margin != value) {
                    ...
                    this.LogWF2WPropertyValue("Margin", value);
                }
            }
        }
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [
        SRDescription(DCSR.ToolStripMergeActionDescr),
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [
        SRDescription(DCSR.ToolStripMergeIndexDescr),
        DefaultValue(-1),
        SRCategory(DCSR.CatLayout)
        ]
        ...
        SRDescription(DCSR.ToolStripItemOnMouseDownDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatMouse), 
        SRDescription(DCSR.ToolStripItemOnMouseEnterDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatMouse), 
        SRDescription(DCSR.ToolStripItemOnMouseLeaveDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatMouse), 
        SRDescription(DCSR.ToolStripItemOnMouseHoverDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatMouse), 
        SRDescription(DCSR.ToolStripItemOnMouseMoveDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatMouse), 
        SRDescription(DCSR.ToolStripItemOnMouseUpDescr)
        ]
        ...
        public string Name {
            ...
            set {
                ...
                this.LogWF2WPropertyValue("Name", value);
            }
        }
        ...
        [
        SRCategory(DCSR.CatBehavior), 
        SRDescription(DCSR.ToolStripItemOwnerChangedDescr)
        ]
        ...
        [
        SRCategory(DCSR.CatAppearance), 
        SRDescription(DCSR.ToolStripItemOnPaintDescr)
        ]
        ...
        SRDescription(DCSR.ToolStripItemOverflowDescr),
        SRCategory(DCSR.CatLayout)
        ]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [
        SRDescription(DCSR.ToolStripItemPaddingDescr),
        SRCategory(DCSR.CatLayout)
        ]
        public virtual Padding Padding {
            ...
            set {
                if (Padding != value) {
                    ...
                    this.LogWF2WPropertyValue("Padding", value);
                }
            }
        }            
        ...
        [
        SRCategory(DCSR.CatDragDrop), 
        SRDescription(DCSR.ToolStripItemOnQueryContinueDragDescr),
        EditorBrowsable(EditorBrowsableState.Advanced),
        Browsable(false)
        ]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatBehavior), SRDescription(DCSR.ToolStripItemOnQueryAccessibilityHelpDescr)]
        ...
        SRCategory(DCSR.CatAppearance),
        Localizable(true),
        SRDescription(DCSR.ToolStripItemRightToLeftDescr)
        ]
        public virtual RightToLeft RightToLeft {
            ...
            set {
                ...
                if (oldValue != RightToLeft) {
                    ...
                    this.LogWF2WPropertyValue("RightToLeft", value);
                }
            }
        }
        ...
        SRCategory(DCSR.CatAppearance),
        Localizable(true),
        SRDescription(DCSR.ToolStripItemRightToLeftAutoMirrorImageDescr)
        ]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ToolStripItemOnRightToLeftChangedDescr)]
        ...
        SRCategory(DCSR.CatLayout),
        Localizable(true),
        SRDescription(DCSR.ToolStripItemSizeDescr)
        ]
        ...
        Localizable(false),
        Bindable(true),
        SRDescription(DCSR.ToolStripItemTagDescr),
        ...
        SRCategory(DCSR.CatAppearance),
        Localizable(true),
        SRDescription(DCSR.ToolStripItemTextDescr)
        ]
        ...
        Localizable(true),
        SRCategory(DCSR.CatAppearance),
        SRDescription(DCSR.ToolStripItemTextAlignDescr)
        ]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ToolStripItemOnTextChangedDescr)]
        ...
        [
        SRDescription(DCSR.ToolStripTextDirectionDescr),
        SRCategory(DCSR.CatAppearance)
        ]
        public virtual ToolStripTextDirection TextDirection {
             ...
             set {
                ...
                this.LogWF2WPropertyValue("TextDirection", value);
            }
        }
        ...
        Localizable(true),
        SRDescription(DCSR.ToolStripItemTextImageRelationDescr),
        SRCategory(DCSR.CatAppearance)]
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRDescription(DCSR.ToolStripItemToolTipTextDescr)]
        [SRCategory(DCSR.CatBehavior)]
        ...
        public string ToolTipText {
            ...
            set {
                toolTipText = value;
                this.LogWF2WPropertyValue("ToolTipText", value);
            }
        }
        ...
        SRCategory(DCSR.CatBehavior),
        Localizable(true),
        SRDescription(DCSR.ToolStripItemVisibleDescr)
        ]
        public bool Visible {
            get { 
            ...
            set { 
                SetVisibleCore(value);                
                this.LogWF2WPropertyValue("Visible", value);
            }
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        [SRCategory(DCSR.CatPropertyChanged), SRDescription(DCSR.ToolStripItemOnVisibleChangedDescr)]
       ...
       //
        ...
        protected override void Dispose(bool disposing)
        {
            if (this._Handle != IntPtr.Zero)
            {
                DCWin32API.RemoveHandle(this._Handle.ToInt32());
        ...
        public DragDropEffects DoDragDrop(Object data, DragDropEffects allowedEffects) {
            ...
            WinFormUnsafeNativeMethods.IOleDropSource dropSource = this.DropSource;
	...
	[SuppressMessage("Microsoft.Performance", "CA1800:DoNotCastUnnecessarily")]
        ...
        internal void HandleClick(System.EventArgs e) {  
        ...
        internal async Task HandleClickAsync(System.EventArgs e)
        {
            Debug.Assert(Enabled, "Who called me when I am disabled?");
            Debug.WriteLineIf(MouseDebugging.TraceVerbose, "[" + this.Text + "] HandleClick");
            ...
            try
            {
                ...
                {
                    Debug.WriteLineIf(MouseDebugging.TraceVerbose, "[" + this.Text + "] HandleItemClick");
                    await this.Owner.HandleItemClickAsync(this);
        ...
        internal bool HasEventClickAsync()
        {
            return this.Events[EventClickAsync] != null;
        }
               ...
               if (ParentInternal != null 
                    ...
                    if (Enabled) {
                       ...
                       if (ParentInternal.LastMouseDownedItem == this) {
                           ...
                           if (WinFormUnsafeNativeMethods.GetKeyState((int)Keys.LButton) < 0) {
                                this.Push(true);
                           }
                       }
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers =true)]
        protected virtual async ValueTask OnClickAsync(System.EventArgs e)
        {
    ...
    if (ToolStrip.SelectionDebug.TraceVerbose) {
        ...
        internal protected virtual void SetBounds(Rectangle bounds) {
            ...
            if (! state[stateContstructing]) {
                ...
                PropertyValueLogger.LogBounds(this, bounds.Left, bounds.Top, bounds.Width, bounds.Height);
            }
        }
            ...
            public override string DefaultAction {
                get {
                    ...
                    if (defaultAction != null) {
                        ...
                        return DCSR.GetString(DCSR.AccessibleActionPress);
                    }
                }
            }
