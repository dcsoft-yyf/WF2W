...
namespace System.Windows.Forms
{
    ...
    //]
    internal static class WinFormUnsafeNativeMethods
    {
        ...
        public static extern WinFormUnsafeNativeMethods.IClassFactory2 CoGetClassObject(
            [In]
            ref Guid clsid,
            int dwContext,
            int serverInfo,
        ...
        */
        ...
        [ResourceExposure(ResourceScope.None)]
        public static extern bool PageSetupDlg([In, Out] WinFormNativeMethods.PAGESETUPDLG lppsd);

        [DllImport(ExternDll.Comdlg32, EntryPoint = "PrintDlg", SetLastError = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool PrintDlg_32([In, Out] WinFormNativeMethods.PRINTDLG_32 lppd);

        [DllImport(ExternDll.Comdlg32, EntryPoint = "PrintDlg", SetLastError = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool PrintDlg_64([In, Out] WinFormNativeMethods.PRINTDLG_64 lppd);

        public static bool PrintDlg([In, Out] WinFormNativeMethods.PRINTDLG lppd)
        {
            if (IntPtr.Size == 4)
            {
                WinFormNativeMethods.PRINTDLG_32 lppd_32 = lppd as WinFormNativeMethods.PRINTDLG_32;
                if (lppd_32 == null)
                {
            ...
            {
                WinFormNativeMethods.PRINTDLG_64 lppd_64 = lppd as WinFormNativeMethods.PRINTDLG_64;
                if (lppd_64 == null)
                {
                    throw new System.NullReferenceException("PRINTDLG data is null");
                }
        ...
        [DllImport(ExternDll.Comdlg32, SetLastError = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern int PrintDlgEx([In, Out] WinFormNativeMethods.PRINTDLGEX lppdex);
        ...
        [ResourceExposure(ResourceScope.None)]
        public static extern void OleCreatePropertyFrameIndirect(WinFormNativeMethods.OCPFIPARAMS p);
        [DllImport(ExternDll.Oleaut32, EntryPoint = "OleCreateFontIndirect", ExactSpelling = true, PreserveSig = false)]
        [ResourceExposure(ResourceScope.Process)]
        public static extern WinFormUnsafeNativeMethods.IFont OleCreateIFontIndirect(WinFormNativeMethods.FONTDESC fd, ref Guid iid);
        [DllImport(ExternDll.Oleaut32, EntryPoint = "OleCreatePictureIndirect", ExactSpelling = true, PreserveSig = false)]
        [ResourceExposure(ResourceScope.Machine)]
        public static extern WinFormUnsafeNativeMethods.IPicture OleCreateIPictureIndirect([MarshalAs(UnmanagedType.AsAny)] object pictdesc, ref Guid iid, bool fOwn);
        [DllImport(ExternDll.Oleaut32, EntryPoint = "OleCreatePictureIndirect", ExactSpelling = true, PreserveSig = false)]
        [ResourceExposure(ResourceScope.Machine)]
        public static extern WinFormUnsafeNativeMethods.IPictureDisp OleCreateIPictureDispIndirect([MarshalAs(UnmanagedType.AsAny)] object pictdesc, ref Guid iid, bool fOwn);
        // cpb: #8309 -- next two methods, refiid arg must be IPicture.iid
        [DllImport(ExternDll.Oleaut32, PreserveSig = false)]
        [ResourceExposure(ResourceScope.Machine)]
        public static extern WinFormUnsafeNativeMethods.IPicture OleCreatePictureIndirect(WinFormNativeMethods.PICTDESC pictdesc, [In] ref Guid refiid, bool fOwn);
        [DllImport(ExternDll.Oleaut32, PreserveSig = false)]
        [ResourceExposure(ResourceScope.Process)]
        public static extern WinFormUnsafeNativeMethods.IFont OleCreateFontIndirect(WinFormNativeMethods.tagFONTDESC fontdesc, [In] ref Guid refiid);
        [DllImport(ExternDll.Oleaut32, ExactSpelling = true)]
        [ResourceExposure(ResourceScope.None)]
        ...
        [ResourceExposure(ResourceScope.None)]
        public static extern bool EnumChildWindows(HandleRef hwndParent, WinFormNativeMethods.EnumChildrenCallback lpEnumFunc, HandleRef lParam);
        [DllImport(ExternDll.Shell32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        ...
        [DllImport(ExternDll.Shell32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern int Shell_NotifyIcon(int message, WinFormNativeMethods.NOTIFYICONDATA pnid);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public extern static bool InsertMenuItem(HandleRef hMenu, int uItem, bool fByPosition, WinFormNativeMethods.MENUITEMINFO_T lpmii);
        //[DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        //[ResourceExposure(ResourceScope.None)]
        ...
        //[DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool GetMenuItemInfo(HandleRef hMenu, int uItem, bool fByPosition, [In, Out] WinFormNativeMethods.MENUITEMINFO_T lpmii);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool GetMenuItemInfo(HandleRef hMenu, int uItem, bool fByPosition, [In, Out] WinFormNativeMethods.MENUITEMINFO_T_RW lpmii);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public extern static bool SetMenuItemInfo(HandleRef hMenu, int uItem, bool fByPosition, WinFormNativeMethods.MENUITEMINFO_T lpmii);
        ...
        {
            return System.Internal.HandleCollector.Add(IntCreateMenu(), WinFormNativeMethods.CommonHandles.Menu);
        }

        [DllImport(ExternDll.Comdlg32, SetLastError = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool GetOpenFileName([In, Out] WinFormNativeMethods.OPENFILENAME_I ofn);
        ...
        //    System.Internal.HandleCollector.Add(handleTarget, WinFormNativeMethods.CommonHandles.Kernel);
        //    return ret;
        //}

        [DllImport(ExternDll.Ole32, PreserveSig = false)]
        [ResourceExposure(ResourceScope.None)]
        public static extern WinFormUnsafeNativeMethods.IStorage StgOpenStorageOnILockBytes(WinFormUnsafeNativeMethods.ILockBytes iLockBytes, WinFormUnsafeNativeMethods.IStorage pStgPriority, int grfMode, int sndExcluded, int reserved);
        [DllImport(ExternDll.Ole32, PreserveSig = false)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr GetHGlobalFromILockBytes(WinFormUnsafeNativeMethods.ILockBytes pLkbyt);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SetWindowsHookEx(int hookid, WinFormNativeMethods.HookProc pfnhook, HandleRef hinst, int threadid);
        ...
        [DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern int ScreenToClient(HandleRef hWnd, [In, Out] WinFormNativeMethods.POINT pt);
        [DllImport(ExternDll.Kernel32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern int GetModuleFileName(HandleRef hModule, StringBuilder buffer, int length);
        [DllImport(ExternDll.User32, CharSet = CharSet.Unicode)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool IsDialogMessage(HandleRef hWndDlg, [In, Out] ref WinFormNativeMethods.MSG msg);
        //[DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        //[ResourceExposure(ResourceScope.None)]
        public static bool TranslateMessage([In, Out] ref WinFormNativeMethods.MSG msg) { return false; }
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr DispatchMessage([In] ref WinFormNativeMethods.MSG msg);
        [DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Ansi)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr DispatchMessageA([In] ref WinFormNativeMethods.MSG msg);
        [DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Unicode)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr DispatchMessageW([In] ref WinFormNativeMethods.MSG msg);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        ...
        [DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public extern static bool EnumThreadWindows(int dwThreadId, WinFormNativeMethods.EnumThreadWindowsCallback lpfn, HandleRef lParam);
        ...
        [DllImport(ExternDll.Comdlg32, SetLastError = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool GetSaveFileName([In, Out] WinFormNativeMethods.OPENFILENAME_I ofn);
        ...
        {
            System.Internal.HandleCollector.Remove((IntPtr)handle, WinFormNativeMethods.CommonHandles.Kernel);
        ...
        {
            return System.Internal.HandleCollector.Add(IntCreateCompatibleDC(hDC), WinFormNativeMethods.CommonHandles.CompatibleHDC);
        }
        ...
        [ResourceExposure(ResourceScope.None)]
        public static extern uint SendInput(uint nInputs, WinFormNativeMethods.INPUT[] pInputs, int cbSize);
...
*/
        ...
        {
            return System.Internal.HandleCollector.Add(IntMapViewOfFile(hFileMapping, dwDesiredAccess, dwFileOffsetHigh, dwFileOffsetLow, dwNumberOfBytesToMap), WinFormNativeMethods.CommonHandles.Kernel);
        }
        ...
        {
            System.Internal.HandleCollector.Remove((IntPtr)pvBaseAddress, WinFormNativeMethods.CommonHandles.Kernel);
        ...
        {
            return System.Internal.HandleCollector.Add(IntGetDCEx(hWnd, hrgnClip, flags), WinFormNativeMethods.CommonHandles.HDC);
        }

        // GetObject stuff
        [DllImport(ExternDll.Gdi32, SetLastError = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern int GetObject(HandleRef hObject, int nSize, [In, Out] WinFormNativeMethods.BITMAP bm);

        [DllImport(ExternDll.Gdi32, SetLastError = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern int GetObject(HandleRef hObject, int nSize, [In, Out] WinFormNativeMethods.LOGPEN lp);
        public static int GetObject(HandleRef hObject, WinFormNativeMethods.LOGPEN lp)
        {
            return GetObject(hObject, Marshal.SizeOf(typeof(WinFormNativeMethods.LOGPEN)), lp);
        }

        [DllImport(ExternDll.Gdi32, SetLastError = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern int GetObject(HandleRef hObject, int nSize, [In, Out] WinFormNativeMethods.LOGBRUSH lb);
        public static int GetObject(HandleRef hObject, WinFormNativeMethods.LOGBRUSH lb)
        {
            return GetObject(hObject, Marshal.SizeOf(typeof(WinFormNativeMethods.LOGBRUSH)), lb);
        }

        [DllImport(ExternDll.Gdi32, SetLastError = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern int GetObject(HandleRef hObject, int nSize, [In, Out] WinFormNativeMethods.LOGFONT lf);
        public static int GetObject(HandleRef hObject, WinFormNativeMethods.LOGFONT lp)
        {
            return GetObject(hObject, Marshal.SizeOf(typeof(WinFormNativeMethods.LOGFONT)), lp);
        }
        ...
        {
            return System.Internal.HandleCollector.Add(IntCreateAcceleratorTable(pentries, cCount), WinFormNativeMethods.CommonHandles.Accelerator);
        }
        ...
        {
            System.Internal.HandleCollector.Remove((IntPtr)hAccel, WinFormNativeMethods.CommonHandles.Accelerator);
        ...
        //[DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        //[ResourceExposure(ResourceScope.None)]
        public static IntPtr GetCapture() { return IntPtr.Zero; }
        //[DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        //[ResourceExposure(ResourceScope.None)]
        ...
        {
            return new IntPtr(DCWin32API.JSRuntime.Invoke<int>("__DCWin32API.GetFocus"));
        }
        [DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool GetCursorPos([In, Out] WinFormNativeMethods.POINT pt);
        //[DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        //[ResourceExposure(ResourceScope.None)]
        public static Func<int, short> GetKeyState = null;
        [DllImport(ExternDll.Kernel32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        ...
        public static int SetWindowRgn(HandleRef hwnd, HandleRef hrgn, bool fRedraw)
        {
            ...
            if (retval != 0)
            {
                ...
                //
                System.Internal.HandleCollector.Remove((IntPtr)hrgn, WinFormNativeMethods.CommonHandles.GDI);
            }
            return retval;
        }
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        ...
        {
            return DCWin32API.JSRuntime.Invoke<int>("__DCWin32API.SetFocus", hWnd.Handle.ToInt32());
        }
        ...
        {
            var result = DCWin32API.JSRuntime.Invoke<int>("__DCWin32API.GetParent", hWnd.Handle.ToInt32());
            if(result == 0)
            {
                var s = 1;
            }
        ...
        {
            return DCWin32API.JSRuntime.Invoke<bool>("__DCWin32API.IsChild", hWndParent.Handle.ToInt32(), hwnd.Handle.ToInt32());
        }
        ...
        [DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern int MapWindowPoints(HandleRef hWndFrom, HandleRef hWndTo, [In, Out] ref WinFormNativeMethods.RECT rect, int cPoints);

        //[DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        //[ResourceExposure(ResourceScope.None)]
        public static int MapWindowPoints(HandleRef hWndFrom, HandleRef hWndTo, [In, Out] WinFormNativeMethods.POINT pt, int cPoints)
        {
            return 1;
        }
        ...
        {
            var ptr = DCWin32API.MarshalObjectToPtr(lParam);
            var result = SendMessage( hWnd , msg, wParam, ptr);
        ...
        {
            var lp2 = DCWin32API.MarshalObjectToPtr(lParam);
            var result = SendMessage( hWnd , msg, wParam, lp2);
            DCWin32API.MarshalFreePtr(lp2);
            return result;
        }

        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.TOOLINFO_T lParam);

        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.TOOLINFO_TOOLTIP lParam);

        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, ref WinFormNativeMethods.TBBUTTON lParam);

        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, ref WinFormNativeMethods.TBBUTTONINFO lParam);

        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, ref WinFormNativeMethods.TV_ITEM lParam);

        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, ref WinFormNativeMethods.TV_INSERTSTRUCT lParam);

        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.TV_HITTESTINFO lParam);

        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.LVBKIMAGE lParam);

        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern int SendMessage(HandleRef hWnd, int msg, int wParam, ref WinFormNativeMethods.LVHITTESTINFO lParam);

        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.TCITEM_T lParam);

        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, ref WinFormNativeMethods.HDLAYOUT hdlayout);
        ...
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, [In, Out, MarshalAs(UnmanagedType.LPStruct)] WinFormNativeMethods.PARAFORMAT lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, [In, Out, MarshalAs(UnmanagedType.LPStruct)] WinFormNativeMethods.CHARFORMATA lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, [In, Out, MarshalAs(UnmanagedType.LPStruct)] WinFormNativeMethods.CHARFORMAT2A lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, [In, Out, MarshalAs(UnmanagedType.LPStruct)] WinFormNativeMethods.CHARFORMATW lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        ...
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.CHARRANGE lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.FINDTEXT lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.TEXTRANGE lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.POINT lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, WinFormNativeMethods.POINT wParam, int lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.REPASTESPECIAL lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.EDITSTREAM lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.EDITSTREAM64 lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, WinFormNativeMethods.GETTEXTLENGTHEX wParam, int lParam);

        // For Button
        //
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, [In, Out] WinFormNativeMethods.SIZE lParam);

        // For ListView
        //
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, [In, Out] ref WinFormNativeMethods.LVFINDINFO lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.LVHITTESTINFO lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.LVCOLUMN_T lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, [In, Out] ref WinFormNativeMethods.LVITEM lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.LVCOLUMN lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.LVGROUP lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, WinFormNativeMethods.POINT wParam, [In, Out] WinFormNativeMethods.LVINSERTMARK lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.LVINSERTMARK lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool SendMessage(HandleRef hWnd, int msg, int wParam, [In, Out] WinFormNativeMethods.LVTILEVIEWINFO lParam);

        // For MonthCalendar
        //
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.MCHITTESTINFO lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.SYSTEMTIME lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.SYSTEMTIMEARRAY lParam);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, [In, Out] WinFormNativeMethods.LOGFONT lParam);
        //[DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        //[ResourceExposure(ResourceScope.None)]
        //public static extern IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, WinFormNativeMethods.MSG lParam);
        //[DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        //[ResourceExposure(ResourceScope.None)]
        public static IntPtr SendMessage(HandleRef hWnd, int msg, int wParam, int lParam)
        {
            return new IntPtr( DCMessageManager.SendMessage(hWnd.Handle.ToInt32(), msg, wParam, lParam));
        }
        //[DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        //[ResourceExposure(ResourceScope.None)]
        public static IntPtr SendMessage(HandleRef hWnd, int msg, IntPtr wParam, IntPtr lParam)
        {
            return new IntPtr(DCMessageManager.SendMessage(hWnd.Handle.ToInt32(), msg, wParam.ToInt32(), lParam.ToInt32()));
        }
        //[DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        //[ResourceExposure(ResourceScope.None)]
        public static IntPtr SendMessage(HandleRef hWnd, int Msg, IntPtr wParam, [In, Out] ref WinFormNativeMethods.RECT lParam)
        {
            return new IntPtr(DCMessageManager.SendMessage(hWnd.Handle.ToInt32(), Msg, wParam.ToInt32(), 0));
        }
        //[DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        //[ResourceExposure(ResourceScope.None)]
        ...
        {
            return new IntPtr(DCMessageManager.SendMessage(hWnd.Handle.ToInt32(), Msg, wParam, lParam.ToInt32()));
        }
        //[DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        //[ResourceExposure(ResourceScope.None)]
        public static IntPtr SendMessage(HandleRef hWnd, int Msg, int wParam, [In, Out] ref WinFormNativeMethods.RECT lParam)
        {
            return new IntPtr(DCMessageManager.SendMessage(hWnd.Handle.ToInt32(), Msg, wParam, 0));
        }
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        ...
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public extern static IntPtr SendMessage(HandleRef hWnd, int Msg, IntPtr wParam, WinFormNativeMethods.ListViewCompareCallback pfnCompare);
        ...
        {
            return DCWin32API.JSRuntime.Invoke<int>("__DCWin32API.SetParent",hWnd.Handle.ToInt32(), hWndParent.Handle.ToInt32());
        }

        //[DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        //[ResourceExposure(ResourceScope.None)]
        public static bool GetWindowRect(HandleRef hWnd, [In, Out] ref WinFormNativeMethods.RECT rect)
        {
            var obj = DCWin32API.JSRuntime.Invoke<JsonObject>("__DCWin32API.GetWindowRect", hWnd.Handle.ToInt32());
            foreach (var item in obj)
            {
                if (item.Key == "Left") rect.left = DCValueConvert.ConvertToInt32(item.Value, 0);
                else if (item.Key == "Top") rect.top = DCValueConvert.ConvertToInt32(item.Value, 0);
                else if (item.Key == "Right") rect.right = DCValueConvert.ConvertToInt32(item.Value, 0);
                else if (item.Key == "Bottom") rect.bottom = DCValueConvert.ConvertToInt32(item.Value, 0);
            }
            return true;
        }
        //[DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        ...
        {
            return new IntPtr(DCWin32API.JSRuntime.Invoke<int>("__DCWin32API.GetWindow", hWnd.Handle.ToInt32(), uCmd));
            //return new IntPtr(DCWin32API.GetWindow(hWnd.Handle.ToInt32(), uCmd));
        }
        [DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        ...
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool GetClassInfo(HandleRef hInst, string lpszClass, [In, Out] WinFormNativeMethods.WNDCLASS_I wc);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        ...
        */
        ...
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool SystemParametersInfo(int nAction, int nParam, ref WinFormNativeMethods.RECT rc, int nUpdate);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        ...
        {
            // 1. 核心常量定义（仅保留必要的Win7参数常量）
            const int SPI_GETSCREENSAVEACTIVE = 0x0010;
            const int SPI_SETSCREENSAVEACTIVE = 0x0011;
            const int SPI_GETMOUSEACCELERATION = 0x0043;
            const int SPI_SETMOUSEACCELERATION = 0x0044;
            const int SPI_GETDESKTOPICONS = 0x007F;
            const int SPI_SETDESKTOPICONS = 0x0080;

            // 2. 静态变量存储参数状态（Win7默认值）
            const bool _screensaverActive = false;
            const bool _mouseAcceleration = true;
            const bool _desktopIcons = true;

            // 3. 极简switch-case：仅处理核心GET/SET逻辑
            switch (nAction)
            {
                // GET操作：直接赋值
                case SPI_GETSCREENSAVEACTIVE:
                    value = _screensaverActive;
                    return true;
                case SPI_GETMOUSEACCELERATION:
                    value = _mouseAcceleration;
                    return true;
                case SPI_GETDESKTOPICONS:
                    value = _desktopIcons;
                    return true;
                ...
                case SPI_SETSCREENSAVEACTIVE:
                    ...
                    //return true;
                case SPI_SETMOUSEACCELERATION:
                    return false;
                    //_mouseAcceleration = value;
                    //return true;
                case SPI_SETDESKTOPICONS:
                    return false;
                    //_desktopIcons = value;
                    //return true;
        ...
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool SystemParametersInfo(int nAction, int nParam, ref WinFormNativeMethods.HIGHCONTRAST_I rc, int nUpdate);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool SystemParametersInfo(int nAction, int nParam, [In, Out] WinFormNativeMethods.NONCLIENTMETRICS metrics, int nUpdate);
        /*
                [DllImport(ExternDll.User32, CharSet=CharSet.Auto)]
        ...
        */
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool SystemParametersInfo(int nAction, int nParam, [In, Out] WinFormNativeMethods.LOGFONT font, int nUpdate);
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        ...
        [ResourceExposure(ResourceScope.None)]
        public static extern bool GetUserObjectInformation(HandleRef hObj, int nIndex, [MarshalAs(UnmanagedType.LPStruct)] WinFormNativeMethods.USEROBJECTFLAGS pvBuffer, int nLength, ref int lpnLengthNeeded);
        [DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern int ClientToScreen(HandleRef hWnd, [In, Out] WinFormNativeMethods.POINT pt);
        [DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.Process)]
        ...
        [DllImport(ExternDll.Ole32, ExactSpelling = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern int RegisterDragDrop(HandleRef hwnd, WinFormUnsafeNativeMethods.IOleDropTarget target);
        [DllImport(ExternDll.Ole32, ExactSpelling = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern int RevokeDragDrop(HandleRef hwnd);
        //[DllImport(ExternDll.User32, CharSet = CharSet.Auto)]
        //[ResourceExposure(ResourceScope.None)]
        public static bool PeekMessage([In, Out] ref WinFormNativeMethods.MSG msg, HandleRef hwnd, int msgMin, int msgMax, int remove)
        { return false; }
        //[DllImport(ExternDll.User32, CharSet = CharSet.Unicode)]
        //[ResourceExposure(ResourceScope.None)]
        public static bool PeekMessageW([In, Out] ref WinFormNativeMethods.MSG msg, HandleRef hwnd, int msgMin, int msgMax, int remove)
        {
            return false;
        }
        //[DllImport(ExternDll.User32, CharSet = CharSet.Ansi)]
        //[ResourceExposure(ResourceScope.None)]
        public static bool PeekMessageA([In, Out] ref WinFormNativeMethods.MSG msg, HandleRef hwnd, int msgMin, int msgMax, int remove)
        {
            return false;
        }
        ...
        */
        ...
        {
            return DCMessageManager.PostMessage(hwnd.Handle.ToInt32(), msg, wparam.ToInt32(), lparam.ToInt32());
        }
        ...
        [DllImport(ExternDll.Oleaut32, PreserveSig = false)]
        [ResourceExposure(ResourceScope.None)]
        public static extern void GetErrorInfo(int reserved, [In, Out] ref WinFormUnsafeNativeMethods.IErrorInfo errorInfo);
        [DllImport(ExternDll.User32, ExactSpelling = true, EntryPoint = "BeginPaint", CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        private static extern IntPtr IntBeginPaint(HandleRef hWnd, [In, Out] ref WinFormNativeMethods.PAINTSTRUCT lpPaint);
        public static IntPtr BeginPaint(HandleRef hWnd, [In, Out, MarshalAs(UnmanagedType.LPStruct)] ref WinFormNativeMethods.PAINTSTRUCT lpPaint)
        {
            return System.Internal.HandleCollector.Add(IntBeginPaint(hWnd, ref lpPaint), WinFormNativeMethods.CommonHandles.HDC);
        }

        [DllImport(ExternDll.User32, ExactSpelling = true, EntryPoint = "EndPaint", CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        private static extern bool IntEndPaint(HandleRef hWnd, ref WinFormNativeMethods.PAINTSTRUCT lpPaint);
        public static bool EndPaint(HandleRef hWnd, [In, MarshalAs(UnmanagedType.LPStruct)] ref WinFormNativeMethods.PAINTSTRUCT lpPaint)
        {
            System.Internal.HandleCollector.Remove(lpPaint.hdc, WinFormNativeMethods.CommonHandles.HDC);
        ...
        {
            return System.Internal.HandleCollector.Add(IntGetDC(hWnd), WinFormNativeMethods.CommonHandles.HDC);
        }
        ...
        {
            return System.Internal.HandleCollector.Add(IntGetWindowDC(hWnd), WinFormNativeMethods.CommonHandles.HDC);
        }
        ...
        {
            System.Internal.HandleCollector.Remove((IntPtr)hDC, WinFormNativeMethods.CommonHandles.HDC);
        ...
        {
            return System.Internal.HandleCollector.Add(IntCreateDC(lpszDriver, null, null, WinFormNativeMethods.NullHandleRef), WinFormNativeMethods.CommonHandles.HDC);
        }
        [ResourceExposure(ResourceScope.Process)]
        [ResourceConsumption(ResourceScope.Process)]
        public static IntPtr CreateDC(string lpszDriverName, string lpszDeviceName, string lpszOutput, HandleRef /*DEVMODE*/ lpInitData)
        {
            return System.Internal.HandleCollector.Add(IntCreateDC(lpszDriverName, lpszDeviceName, lpszOutput, lpInitData), WinFormNativeMethods.CommonHandles.HDC);
        }
        ...
        {
            return System.Windows.Forms.Internal.IntUnsafeNativeMethods.GetDeviceCaps(hDC, nIndex);
        }

        //[DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        //[ResourceExposure(ResourceScope.None)]
        public static bool GetScrollInfo(HandleRef hWnd, int fnBar, WinFormNativeMethods.SCROLLINFO si)
        {
            var result = DCWin32API.JSRuntime.Invoke<JsonObject>(
                "__DCWin32API.GetScrollInfo",
                hWnd.Handle.ToInt32(),
                fnBar);
            if( result == null )
            {
            ...
            else
            {
                foreach (var item in result)
                {
                    if (item.Value != null)
                    {
                        switch (item.Key)
                        {
                            case "nPage": si.nPage = item.Value.ConvertToInt32(); break;
                            case "fMask": si.fMask = item.Value.ConvertToInt32(); break;
                            case "nMax": si.nMax = item.Value.ConvertToInt32(); break;
                            case "nMin": si.nMin = item.Value.ConvertToInt32(); break;
                            case "cbSize": si.cbSize = item.Value.ConvertToInt32();break;
                            case "nPos":si.nPos = item.Value.ConvertToInt32();break;
                            case "nTrackPos": si.nTrackPos = item.Value.ConvertToInt32();break;
                        }
                    }
                }
                return true;
        ...
        //[DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        //[ResourceExposure(ResourceScope.None)]
        public static int SetScrollInfo(HandleRef hWnd, int fnBar, WinFormNativeMethods.SCROLLINFO si, bool redraw)
        {
            var json = new JsonObject();
            json["cbSize"] = si.cbSize;
            json["fMask"] = si.fMask;
            json["nMax"] = si.nMax;
            json["nMin"] = si.nMin;
            json["nPage"] = si.nPage;
            json["nPos"] = si.nPos;
            json["nTrackPos"] = si.nTrackPos;
            var result = DCWin32API.JSRuntime.Invoke<int>(
                "__DCWin32API.SetScrollInfo",
                hWnd.Handle.ToInt32(), 
                fnBar,
                json,
                redraw);
        ...
        {
            return new IntPtr(DCWin32API.JSRuntime.Invoke<int>("__DCWin32API.GetWindowLong", hWnd.Handle.ToInt32(), nIndex));
            //if (IntPtr.Size == 4)
            //{
        ...
        {
            return new IntPtr(DCWin32API.JSRuntime.Invoke<int>("__DCWin32API.SetWindowLong", hWnd.Handle.ToInt32(), nIndex, dwNewLong.Handle.ToInt32()));
            //if (IntPtr.Size == 4)
            //{
        ...
        public static IntPtr SetWindowLong(HandleRef hWnd, int nIndex, WinFormNativeMethods.WndProc wndproc)
        {
            if (IntPtr.Size == 4)
            {
        ...
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto, EntryPoint = "SetWindowLong")]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SetWindowLongPtr32(HandleRef hWnd, int nIndex, WinFormNativeMethods.WndProc wndproc);
        [SuppressMessage("Microsoft.Interoperability", "CA1400:PInvokeEntryPointsShouldExist")]
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto, EntryPoint = "SetWindowLongPtr")]
        [ResourceExposure(ResourceScope.None)]
        public static extern IntPtr SetWindowLongPtr64(HandleRef hWnd, int nIndex, WinFormNativeMethods.WndProc wndproc);

        [DllImport(ExternDll.Ole32, PreserveSig = false)]
        [ResourceExposure(ResourceScope.None)]
        public static extern WinFormUnsafeNativeMethods.ILockBytes CreateILockBytesOnHGlobal(HandleRef hGlobal, bool fDeleteOnRelease);
        [DllImport(ExternDll.Ole32, PreserveSig = false)]
        [ResourceExposure(ResourceScope.None)]
        public static extern WinFormUnsafeNativeMethods.IStorage StgCreateDocfileOnILockBytes(WinFormUnsafeNativeMethods.ILockBytes iLockBytes, int grfMode, int reserved);
        ...
        {
            return System.Internal.HandleCollector.Add(IntCreatePopupMenu(), WinFormNativeMethods.CommonHandles.Menu);
        }
        ...
        {
            System.Internal.HandleCollector.Remove((IntPtr)hMenu, WinFormNativeMethods.CommonHandles.Menu);
        ...
        {
            return DCWin32API.JSRuntime.Invoke<bool>("__DCWin32API.SetForegroundWindow", hWnd.Handle.ToInt32());
        }
        ...
        [DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool TranslateMDISysAccel(IntPtr hWndClient, [In, Out] ref WinFormNativeMethods.MSG msg);
        ...
        //[DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        //[ResourceExposure(ResourceScope.None)]
        public static int GetWindowPlacement(HandleRef hWnd, ref WinFormNativeMethods.WINDOWPLACEMENT placement)
        {
            var obj = DCWin32API.JSRuntime.Invoke<JsonObject>("__DCWin32API.GetWindowPlacement",hWnd.Handle.ToInt32());
            if(obj != null )
            {/*
              *  flags: 0,
              ...
              */
                ...
                foreach (var item in obj )
                {
                    switch(item.Key )
                    {
                        case "flags":placement.flags = item.Value.ConvertToInt32();break;
                        case "showCmd":placement.showCmd = item.Value.ConvertToInt32();break;
                        case "minX":placement.ptMinPosition_x = item.Value.ConvertToInt32();break;
                        case "minY":placement.ptMinPosition_y = item.Value.ConvertToInt32();break;
                        case "maxX": placement.ptMaxPosition_x = item.Value.ConvertToInt32();break;
                        case "maxY": placement.ptMaxPosition_y = item.Value.ConvertToInt32();break;
                        case "normalLeft": placement.rcNormalPosition_left = item.Value.ConvertToInt32();break;
                        case "normalTop": placement.rcNormalPosition_top = item.Value.ConvertToInt32(); break;
                        case "normalRight": placement.rcNormalPosition_right = item.Value.ConvertToInt32(); break;
                        case "normalBottom": placement.rcNormalPosition_bottom = item.Value.ConvertToInt32(); break;
                    }
                }
                return 1;
            }
        ...
        [DllImport(ExternDll.Kernel32, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern void GetStartupInfo([In, Out] WinFormNativeMethods.STARTUPINFO_I startupinfo_i);
        ...
        {
            return System.Internal.HandleCollector.Add(IntCreateIC(lpszDriverName, lpszDeviceName, lpszOutput, lpInitData), WinFormNativeMethods.CommonHandles.HDC);
        }

        [DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool ClipCursor(ref WinFormNativeMethods.RECT rcClip);

        [DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool ClipCursor(WinFormNativeMethods.COMRECT rcClip);
        ...
        {
            System.Internal.HandleCollector.Remove((IntPtr)hCurs, WinFormNativeMethods.CommonHandles.Cursor);
        ...
        {
            return DCWin32API.JSRuntime.Invoke<bool>("__DCWin32API.IsWindow", hWnd.Handle.ToInt32());
        }
        ...
        {
            System.Internal.HandleCollector.Remove((IntPtr)hDC, WinFormNativeMethods.CommonHandles.CompatibleHDC);
            return IntDeleteDC(hDC);
        }
        ...
        //[DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Ansi)]
        //[ResourceExposure(ResourceScope.None)]
        public static bool GetMessageA([In, Out] ref WinFormNativeMethods.MSG msg, HandleRef hWnd, int uMsgFilterMin, int uMsgFilterMax) { return false; }

        //[DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Unicode)]
        //[ResourceExposure(ResourceScope.None)]
        public static bool GetMessageW([In, Out] ref WinFormNativeMethods.MSG msg, HandleRef hWnd, int uMsgFilterMin, int uMsgFilterMax) { return false; }
        ...
        {
            var str = DCWin32API.JSRuntime.Invoke<string>("__DCWin32API.GetClientRect", hWnd.Handle.ToInt32());
            if (str != null)
            {
                var items = str.Split('|');
                rect.left = 0;
                rect.top = 0;
                rect.right = int.Parse(items[2]);
                rect.bottom = int.Parse(items[3]);
                return true;
            }
            return false;
        }
        ...
        public static IntPtr CreateWindowEx(int dwExStyle, string lpszClassName,
                                         string lpszWindowName, int style, int x, int y, int width, int height,
                                         HandleRef hWndParent, HandleRef hMenu, HandleRef hInst, CreateParams cp)
        {
            return DCWin32API.CreateWindowEx( dwExStyle, lpszClassName,
                                         lpszWindowName, style, x, y, width, height,
                                         hWndParent, hMenu, hInst, cp);
            //var json = new JsonObject();
            //json["ControlTypeName"] = cp.ControlType.FullName;
            //var strBaseTypes = new StringBuilder();
            //if (DCWin32API.IsStandardControlType(cp.ControlType) == false)
            //{
            ...
            //            strBaseTypes.Append(bt.FullName);
            //        }
            //        if (DCWin32API.IsStandardControlType(bt))
            //        {
            //            break;
            //        }
            //        bt = bt.BaseType;
            ...
            //if( cp.FormIcon != null )
            //{
            //    json["IconImage"] = DCWin32API.CreateBlobUrl(cp.FormIcon.ToByteArray(), "image/x-icon");
            //}
            ...
            //}
            //var result = DCWin32API.IntCreateWindowEx(json);
        ...
        {
            DCWin32API.JSRuntime.Invoke<object>("__DCWin32API.DestroyWindow", hWnd.Handle.ToInt32());
            DCWin32API.RemoveHandle(hWnd.Handle.ToInt32());
            return true;
        }
        ...
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto, SetLastError = true)]
        [ResourceExposure(ResourceScope.None)]
        public static extern short RegisterClass(WinFormNativeMethods.WNDCLASS_D wc);
        ...
        [DllImport(ExternDll.User32, ExactSpelling = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool SetWindowPlacement(HandleRef hWnd, [In] ref WinFormNativeMethods.WINDOWPLACEMENT placement);

        // For system power status
        //
        [DllImport(ExternDll.Kernel32, ExactSpelling = true, CharSet = CharSet.Auto)]
        [ResourceExposure(ResourceScope.None)]
        public static extern bool GetSystemPowerStatus([In, Out] ref WinFormNativeMethods.SYSTEM_POWER_STATUS systemPowerStatus);
        ...
        public unsafe static WinFormNativeMethods.RECT[] GetRectsFromRegion(IntPtr hRgn)
        {
            WinFormNativeMethods.RECT[] regionRects = null;
            ...
            try
            {
                ...
                if (regionDataSize != 0)
                {
                    ...
                    if (ret == regionDataSize)
                    {
                        ...
                        WinFormNativeMethods.RGNDATAHEADER* pRgnDataHeader = (WinFormNativeMethods.RGNDATAHEADER*)pBytes;
                        if (pRgnDataHeader->iType == 1)
                        {    // expecting RDH_RECTANGLES
                            regionRects = new WinFormNativeMethods.RECT[pRgnDataHeader->nCount];

                            Debug.Assert(regionDataSize == pRgnDataHeader->cbSizeOfStruct + pRgnDataHeader->nCount * pRgnDataHeader->nRgnSize);
                            Debug.Assert(Marshal.SizeOf(typeof(WinFormNativeMethods.RECT)) == pRgnDataHeader->nRgnSize || pRgnDataHeader->nRgnSize == 0);
                            ...
                            for (int i = 0; i < pRgnDataHeader->nCount; i++)
                            {
                                ...
                                regionRects[i] = *((WinFormNativeMethods.RECT*)((byte*)pBytes + rectStart + (Marshal.SizeOf(typeof(WinFormNativeMethods.RECT)) * i)));
                            }
                        }
                    }
                }
        ...
        */
        ...
        public interface IOleControlSite
        {
            ...
            int TransformCoords(
                [In, Out]
                WinFormNativeMethods._POINTL pPtlHimetric,
                [In, Out]
                WinFormNativeMethods.tagPOINTF pPtfContainer,
                [In, MarshalAs(UnmanagedType.U4)]
                int dwFlags);
            ...
            int TranslateAccelerator(
                [In]
                ref WinFormNativeMethods.MSG pMsg,
                [In, MarshalAs(UnmanagedType.U4)]
                int grfModifiers);
        ...
        public interface IOleInPlaceSite
        {
            ...
            int GetWindowContext(
                [Out, MarshalAs(UnmanagedType.Interface)]
                out WinFormUnsafeNativeMethods.IOleInPlaceFrame ppFrame,
                [Out, MarshalAs(UnmanagedType.Interface)]
                out WinFormUnsafeNativeMethods.IOleInPlaceUIWindow ppDoc,
                [Out]
                WinFormNativeMethods.COMRECT lprcPosRect,
                [Out]
                WinFormNativeMethods.COMRECT lprcClipRect,
                [In, Out]
                WinFormNativeMethods.tagOIFI lpFrameInfo);

            [PreserveSig]
            int Scroll(
                WinFormNativeMethods.tagSIZE scrollExtant);
        ...
        public interface IOleInPlaceFrame
        {
            ...
            int GetBorder(
                [Out]
                WinFormNativeMethods.COMRECT lprectBorder);

            [PreserveSig]
            int RequestBorderSpace(
                [In]
                WinFormNativeMethods.COMRECT pborderwidths);
            ...
            int SetActiveObject(
                [In, MarshalAs(UnmanagedType.Interface)]
                WinFormUnsafeNativeMethods.IOleInPlaceActiveObject pActiveObject,
            ...
            int InsertMenus(
                ...
                IntPtr hmenuShared,
                [In, Out]
                WinFormNativeMethods.tagOleMenuGroupWidths lpMenuWidths);
            ...
            int TranslateAccelerator(
                [In]
                ref WinFormNativeMethods.MSG lpmsg,
        ...
        public interface IDocHostUIHandler
        {
            ...
            int GetHostInfo(
                [In, Out]
                WinFormNativeMethods.DOCHOSTUIINFO info);
            ...
            int ShowUI(
                ...
                int dwID,
                [In]
                WinFormUnsafeNativeMethods.IOleInPlaceActiveObject activeObject,
                [In]
                WinFormNativeMethods.IOleCommandTarget commandTarget,
                [In]
                WinFormUnsafeNativeMethods.IOleInPlaceFrame frame,
                [In]
                WinFormUnsafeNativeMethods.IOleInPlaceUIWindow doc);
            ...
            int ResizeBorder(
                [In]
                WinFormNativeMethods.COMRECT rect,
                [In]
                WinFormUnsafeNativeMethods.IOleInPlaceUIWindow doc,
                bool fFrameWindow);
            ...
            int TranslateAccelerator(
                [In]
                ref WinFormNativeMethods.MSG msg,
                [In]
                ref Guid group,
                [In, MarshalAs(UnmanagedType.I4)]
                int nCmdID);
            ...
            int GetDropTarget(
                [In, MarshalAs(UnmanagedType.Interface)]
                WinFormUnsafeNativeMethods.IOleDropTarget pDropTarget,
                [Out, MarshalAs(UnmanagedType.Interface)]
                out WinFormUnsafeNativeMethods.IOleDropTarget ppDropTarget);
        ...
        public interface IWebBrowser2
        {
            ...
            void Navigate2([In] ref object URL, [In] ref object flags,
                            [In] ref object targetFrameName, [In] ref object postData,
                            [In] ref object headers);
            [DispId(501)] WinFormNativeMethods.OLECMDF QueryStatusWB([In] WinFormNativeMethods.OLECMDID cmdID);
            [DispId(502)]
            void ExecWB([In] WinFormNativeMethods.OLECMDID cmdID,
                    [In] WinFormNativeMethods.OLECMDEXECOPT cmdexecopt,
                    ref object pvaIn,
                    IntPtr pvaOut);
            [DispId(503)]
        ...
        internal interface IHTMLDocument2
        {
            ...
            string GetReferrer();
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLLocation GetLocation();
            ...
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLWindow2 GetParentWindow();
        ...
        internal interface IHTMLDocument3
        {
            ...
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLElement GetDocumentElement();
            string GetUniqueID();
            ...
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLElementCollection GetElementsByName([In] string v);
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLElement GetElementById([In] string v);
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLElementCollection GetElementsByTagName([In] string v);
        }
        ...
        {
            [DispId(-2147418102)] bool onhelp(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-600)] bool onclick(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-601)] bool ondblclick(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-602)] void onkeydown(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-604)] void onkeyup(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-603)] bool onkeypress(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-605)] void onmousedown(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-606)] void onmousemove(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-607)] void onmouseup(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418103)] void onmouseout(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418104)] void onmouseover(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-609)] void onreadystatechange(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418108)] bool onbeforeupdate(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418107)] void onafterupdate(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418106)] bool onrowexit(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418105)] void onrowenter(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418101)] bool ondragstart(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418100)] bool onselectstart(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418099)] bool onerrorupdate(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1023)] bool oncontextmenu(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1026)] bool onstop(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418080)] void onrowsdelete(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418079)] void onrowsinserted(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418078)] void oncellchange(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418093)] void onpropertychange(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418098)] void ondatasetchanged(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418097)] void ondataavailable(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418096)] void ondatasetcomplete(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1027)] void onbeforeeditfocus(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1037)] void onselectionchange(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1036)] bool oncontrolselect(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1033)] bool onmousewheel(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1048)] void onfocusin(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1049)] void onfocusout(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1044)] void onactivate(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1045)] void ondeactivate(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1047)] bool onbeforeactivate(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1034)] bool onbeforedeactivate(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
        }
        ...
        public interface IHTMLWindow2
        {
            ...
            int GetLength();
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLFramesCollection2 GetFrames();
            ...
            object GetImage();
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLLocation GetLocation();
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IOmHistory GetHistory();
            void Close();
            void SetOpener([In] object p);
            [return: MarshalAs(UnmanagedType.IDispatch)] object GetOpener();
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IOmNavigator GetNavigator();
            void SetName([In] string p);
            string GetName();
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLWindow2 GetParent();
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLWindow2 Open([In] string URL, [In] string name, [In] string features, [In] bool replace);
            object GetSelf();
            object GetTop();
            object GetWindow();
            ...
            Object GetOnscroll();
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLDocument2 GetDocument();
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLEventObj GetEvent();
            object Get_newEnum();
            ...
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLScreen GetScreen();
            object GetOption();
            void Focus();
            bool GetClosed();
            void Blur();
        ...
        {
            [DispId(1003)] void onload(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1008)] void onunload(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418102)] bool onhelp(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418111)] void onfocus(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418112)] void onblur(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1002)] bool onerror(string description, string url, int line);
            [DispId(1016)] void onresize(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1014)] void onscroll(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1017)] void onbeforeunload(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1024)] void onbeforeprint(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1025)] void onafterprint(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
        }
        ...
        public interface IHTMLPopup
        {
            ...
            void hide();
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLDocument GetDocument();
            bool IsOpen();
        }
        ...
        {
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLElement GetSrcElement();
            bool GetAltKey();
            bool GetCtrlKey();
            bool GetShiftKey();
            ...
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLElement GetFromElement();
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLElement GetToElement();
        ...
        internal interface IHTMLElement
        {
            ...
            int GetOffsetWidth();
            int GetOffsetHeight();
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLElement GetOffsetParent();
        ...
        internal interface IHTMLElement2
        {
            ...
            object GetOnContextMenu();
            [return: MarshalAs(UnmanagedType.Interface)]
            WinFormUnsafeNativeMethods.IHTMLElement
                InsertAdjacentElement(string @where,
                    [In, MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLElement insertedElement);
            [return: MarshalAs(UnmanagedType.Interface)]
            WinFormUnsafeNativeMethods.IHTMLElement
                applyElement([In, MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLElement apply,
                    string @where);
            ...
            [return: MarshalAs(UnmanagedType.Interface)] WinFormUnsafeNativeMethods.IHTMLElementCollection GetElementsByTagName(string v);
        }
        ...
        public interface DHTMLElementEvents2
        {
            ...
            [DispId(-607)] void onmouseup(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418100)] bool onselectstart(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418095)] void onfilterchange(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418101)] bool ondragstart(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418108)] bool onbeforeupdate(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418107)] void onafterupdate(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418099)] bool onerrorupdate(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            ...
            [DispId(-2147418097)] void ondataavailable(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418096)] void ondatasetcomplete(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418094)] void onlosecapture(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418093)] void onpropertychange(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1014)] void onscroll(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418111)] void onfocus(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418112)] void onblur(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1016)] void onresize(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418092)] bool ondrag(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418091)] void ondragend(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418090)] bool ondragenter(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418089)] bool ondragover(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418088)] void ondragleave(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418087)] bool ondrop(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418083)] bool onbeforecut(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418086)] bool oncut(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418082)] bool onbeforecopy(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418085)] bool oncopy(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418081)] bool onbeforepaste(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418084)] bool onpaste(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1023)] bool oncontextmenu(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418080)] void onrowsdelete(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418079)] void onrowsinserted(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147418078)] void oncellchange(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-609)] void onreadystatechange(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1030)] void onlayoutcomplete(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1031)] void onpage(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1042)] void onmouseenter(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1043)] void onmouseleave(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1044)] void onactivate(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1045)] void ondeactivate(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1034)] bool onbeforedeactivate(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1047)] bool onbeforeactivate(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1048)] void onfocusin(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1049)] void onfocusout(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1035)] void onmove(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1036)] bool oncontrolselect(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1038)] bool onmovestart(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1039)] void onmoveend(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1040)] bool onresizestart(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1041)] void onresizeend(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1033)] bool onmousewheel(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
        }
        ...
        public interface DHTMLFormElementEvents2
        {
            ...
            [DispId(1041)] void onresizeend(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1033)] bool onmousewheel(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1007)] bool onsubmit(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1015)] bool onreset(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
        }
        ...
        public interface DHTMLImgEvents2
        {
            ...
            [DispId(1033)] bool onmousewheel(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1003)] void onload(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1002)] void onerror(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1000)] void onabort(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
        }
        ...
        public interface DHTMLInputFileElementEvents2
        {
            ...
            [DispId(1041)] void onresizeend(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1033)] bool onmousewheel(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147412082)] bool onchange(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147412102)] void onselect(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1003)] void onload(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1002)] void onerror(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1000)] void onabort(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
        }
        ...
        public interface DHTMLInputImageEvents2
        {
            ...
            [DispId(1041)] void onresizeend(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1033)] bool onmousewheel(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147412080)] void onload(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147412083)] void onerror(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147412084)] void onabort(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
        }
        ...
        public interface DHTMLInputTextElementEvents2
        {
            ...
            [DispId(1041)] void onresizeend(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1033)] bool onmousewheel(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1001)] bool onchange(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1006)] void onselect(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1003)] void onload(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1002)] void onerror(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1001)] void onabort(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
        }
        ...
        public interface DHTMLMarqueeElementEvents2
        {
            ...
            [DispId(1041)] void onresizeend(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1033)] bool onmousewheel(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147412092)] void onbounce(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147412086)] void onfinish(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147412085)] void onstart(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
        }
        ...
        public interface DHTMLSelectElementEvents2
        {
            ...
            [DispId(1041)] void onresizeend(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1033)] bool onmousewheel(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(-2147412082)] void onchange_void(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
        }
        ...
        public interface DHTMLTextContainerEvents2
        {
            ...
            [DispId(1041)] void onresizeend(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1033)] bool onmousewheel(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1001)] void onchange_void(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
            [DispId(1006)] void onselect(WinFormUnsafeNativeMethods.IHTMLEventObj evtObj);
        }
        ...
        public interface IMsoComponentManager
        {
            ...
            bool FRegisterComponent(
                ...
                WinFormNativeMethods.MSOCRINFOSTRUCT pcrinfo,
            ...
            /// </devdoc>
            [PreserveSig]
            bool FUpdateComponentRegistration(IntPtr dwComponentID, WinFormNativeMethods.MSOCRINFOSTRUCT pcrinfo);
        ...
        public interface IMsoComponent
        {
            ...
            /// </devdoc>
            [PreserveSig]
            bool FPreTranslateMessage(ref WinFormNativeMethods.MSG msg);
            ...
            bool FContinueMessageLoop(
                int uReason,
                int pvLoopData,
                [MarshalAs(UnmanagedType.LPArray)] WinFormNativeMethods.MSG[] pMsgPeeked);
        ...
        public interface IRichEditOleCallback
        {
            ...
            [PreserveSig]
            int GetClipboardData(WinFormNativeMethods.CHARRANGE lpchrg, int reco, IntPtr lplpdataobj);

            [PreserveSig]
            int GetDragDropEffect(bool fDrag, int grfKeyState, ref int pdwEffect);

            [PreserveSig]
            int GetContextMenu(short seltype, IntPtr lpoleobj, WinFormNativeMethods.CHARRANGE lpchrg, out IntPtr hmenu);
        }
        ...
        public interface IOleInPlaceActiveObject
        {
            ...
            void ResizeBorder(
                   [In]
                      WinFormNativeMethods.COMRECT prcBorder,
                   [In]
                      WinFormUnsafeNativeMethods.IOleInPlaceUIWindow pUIWindow,
        ...
        public interface IOleObject
        {
            ...
            int SetClientSite(
                   [In, MarshalAs(UnmanagedType.Interface)]
                      WinFormUnsafeNativeMethods.IOleClientSite pClientSite);


            WinFormUnsafeNativeMethods.IOleClientSite GetClientSite();
            ...
            int DoVerb(
                   ...
                   [In]
                     IntPtr lpmsg,
                   [In, MarshalAs(UnmanagedType.Interface)]
                      WinFormUnsafeNativeMethods.IOleClientSite pActiveSite,
            ...
            [PreserveSig]
            int EnumVerbs(out WinFormUnsafeNativeMethods.IEnumOLEVERB e);
            ...
            int SetExtent(
                   [In, MarshalAs(UnmanagedType.U4)]
                     int dwDrawAspect,
                   [In]
                     WinFormNativeMethods.tagSIZEL pSizel);
            ...
            int SetColorScheme(
                   [In]
                      WinFormNativeMethods.tagLOGPALETTE pLogpal);
        }
        ...
        public interface IOleInPlaceObjectWindowless
        {
            ...
            [PreserveSig]
            int GetClientSite(out WinFormUnsafeNativeMethods.IOleClientSite site);
        ...
        public interface IOleControl
        {
            ...
            int GetControlInfo(
                   [Out]
                      WinFormNativeMethods.tagCONTROLINFO pCI);
        ...
        public interface IViewObject
        {
            ...
            int Draw(
                ...
                IntPtr pvAspect,
                [In]
                WinFormNativeMethods.tagDVTARGETDEVICE ptd,

                IntPtr hdcTargetDev,

                IntPtr hdcDraw,
                [In]
                WinFormNativeMethods.COMRECT lprcBounds,
                [In]
                WinFormNativeMethods.COMRECT lprcWBounds,
            ...
            int GetColorSet(
                ...
                IntPtr hicTargetDev,
                [Out]
                WinFormNativeMethods.tagLOGPALETTE ppColorSet);
        ...
        public interface IViewObject2 /* : IViewObject */
        {
            ...
            void GetExtent(
                ...
                WinFormNativeMethods.tagDVTARGETDEVICE ptd,
                [Out]
                WinFormNativeMethods.tagSIZEL lpsizel);
        }
        ...
        public interface IQuickActivate
        {
            void QuickActivate(
                              [In]
                              WinFormUnsafeNativeMethods.tagQACONTAINER pQaContainer,
                              [Out]
                              WinFormUnsafeNativeMethods.tagQACONTROL pQaControl);
        ...
        public interface IErrorLog
        {
            void AddError(
                   ...
                   [In, MarshalAs(UnmanagedType.Struct)]
                              WinFormNativeMethods.tagEXCEPINFO pExcepInfo_p1);
        ...
        public interface IPersistStream
        {
            ...
            void Load(
                   [In, MarshalAs(UnmanagedType.Interface)]
                  WinFormUnsafeNativeMethods.IStream pstm);
        ...
        public interface IEnumVariant
        {
            ...
            void Clone(
                   [Out, MarshalAs(UnmanagedType.LPArray)]
                   WinFormUnsafeNativeMethods.IEnumVariant[] ppenum);
        }
        ...
        public interface IEnumOLEVERB
        {
            ...
            int Next(
                ...
                int celt,
                   [Out]
                WinFormNativeMethods.tagOLEVERB rgelt,
                   [Out, MarshalAs(UnmanagedType.LPArray)]
                int[] pceltFetched);
        ...
        public interface IStream
        {
            ...
            void Stat(
                    [Out]
                 WinFormNativeMethods.STATSTG pStatstg,
                    int grfStatFlag);

            [return: MarshalAs(UnmanagedType.Interface)]
            WinFormUnsafeNativeMethods.IStream Clone();
        }
        ...
        public class ComStreamFromDataStream : IStream
        {
            ...
            {
                ExternalException e = new ExternalException(msg, WinFormNativeMethods.E_FAIL);
                throw e;
            }

            protected static void NotImplemented()
            {
                ExternalException e = new ExternalException(DCSR.GetString(DCSR.UnsafeNativeMethodsNotImplemented), WinFormNativeMethods.E_NOTIMPL);
                throw e;
            }
            ...
            public long Seek(long offset, int origin)
            {
                ...
                switch (origin)
                {
                    case WinFormNativeMethods.STREAM_SEEK_SET:
                        if (offset <= len)
                        {
                        ...
                        break;
                    case WinFormNativeMethods.STREAM_SEEK_END:
                        if (offset <= 0)
                        {
                        ...
                        break;
                    case WinFormNativeMethods.STREAM_SEEK_CUR:
                        if (offset + pos <= len)
                        {
            ...
            public void Stat(WinFormNativeMethods.STATSTG pstatstg, int grfStatFlag)
            {
        ...
        public interface IStorage
        {
            ...
            [return: MarshalAs(UnmanagedType.Interface)]
            WinFormUnsafeNativeMethods.IStream CreateStream(
                    [In, MarshalAs(UnmanagedType.BStr)]
                 string pwcsName,
                    [In, MarshalAs(UnmanagedType.U4)]
                 int grfMode,
            ...
            [return: MarshalAs(UnmanagedType.Interface)]
            WinFormUnsafeNativeMethods.IStream OpenStream(
                    [In, MarshalAs(UnmanagedType.BStr)]
                 string pwcsName,
            ...
            [return: MarshalAs(UnmanagedType.Interface)]
            WinFormUnsafeNativeMethods.IStorage CreateStorage(
                    [In, MarshalAs(UnmanagedType.BStr)]
                 string pwcsName,
                    [In, MarshalAs(UnmanagedType.U4)]
                 int grfMode,
            ...
            [return: MarshalAs(UnmanagedType.Interface)]
            WinFormUnsafeNativeMethods.IStorage OpenStorage(
                    [In, MarshalAs(UnmanagedType.BStr)]
                 string pwcsName,
            ...
            void CopyTo(
                 ...
                 Guid[] pIIDExclude,
                    ...
                    IntPtr snbExclude,
                   [In, MarshalAs(UnmanagedType.Interface)]
                 WinFormUnsafeNativeMethods.IStorage stgDest);
            ...
            void SetElementTimes(
                 ...
                 string pwcsName,
                   [In]
                 WinFormNativeMethods.FILETIME pctime,
                   [In]
                 WinFormNativeMethods.FILETIME patime,
                   [In]
                 WinFormNativeMethods.FILETIME pmtime);
        ...
        public interface IClassFactory2
        {
            ...
            void GetLicInfo(
                   [Out]
                  WinFormNativeMethods.tagLICINFO licInfo);
        ...
        public interface IDispatch
        {
            ...
            int Invoke(
                 ...
                 int dwFlags,
                   [Out, In]
                  WinFormNativeMethods.tagDISPPARAMS pDispParams,
                   [Out, MarshalAs(UnmanagedType.LPArray)]
                  object[] pVarResult,
                   [Out, In]
                  WinFormNativeMethods.tagEXCEPINFO pExcepInfo,
                   [Out, MarshalAs(UnmanagedType.LPArray)]
                  IntPtr [] pArgErr);
        ...
        public interface ITypeInfo
        {
            ...
            int GetTypeComp(
                    [Out, MarshalAs(UnmanagedType.LPArray)]
                       WinFormUnsafeNativeMethods.ITypeComp[] ppTComp);
            ...
            int GetDllEntry(
                     ...
                     int memid,
                      ...
                      WinFormNativeMethods.tagINVOKEKIND invkind,
                    [Out, MarshalAs(UnmanagedType.LPArray)]
                      string[] pBstrDllName,
                    [Out, MarshalAs(UnmanagedType.LPArray)]
                      string[] pBstrName,
            ...
            int GetContainingTypeLib(
                    [Out, MarshalAs(UnmanagedType.LPArray)]
                       WinFormUnsafeNativeMethods.ITypeLib[] ppTLib,
                    [Out, MarshalAs(UnmanagedType.LPArray)]
                      int[] pIndex);
        ...
        public interface ITypeComp
        {
            void RemoteBind(
                 ...
                 short wFlags,
                   [Out, MarshalAs(UnmanagedType.LPArray)]
                   WinFormUnsafeNativeMethods.ITypeInfo[] ppTInfo,
                   [Out, MarshalAs(UnmanagedType.LPArray)]
                  WinFormNativeMethods.tagDESCKIND[] pDescKind,
                   [Out, MarshalAs(UnmanagedType.LPArray)]
                   WinFormNativeMethods.tagFUNCDESC[] ppFuncDesc,
                   [Out, MarshalAs(UnmanagedType.LPArray)]
                   WinFormNativeMethods.tagVARDESC[] ppVarDesc,
                   [Out, MarshalAs(UnmanagedType.LPArray)]
                   WinFormUnsafeNativeMethods.ITypeComp[] ppTypeComp,
                   [Out, MarshalAs(UnmanagedType.LPArray)]
                  int[] pDummy);
        ...
        public interface ITypeLib
        {
            ...
            void GetTypeInfoType(
                 ...
                 int index,
                   [Out, MarshalAs(UnmanagedType.LPArray)]
                  WinFormNativeMethods.tagTYPEKIND[] pTKind);
        ...
        public sealed class tagQACONTAINER
        {
            ...
            public WinFormUnsafeNativeMethods.IOleClientSite pClientSite;

            [MarshalAs(UnmanagedType.Interface)]
            public object pAdviseSink = null;

            public WinFormUnsafeNativeMethods.IPropertyNotifySink pPropertyNotifySink;
        ...
        internal class Shell32
        {
            ...
            [DllImport(ExternDll.Shell32)]
            [ResourceExposure(ResourceScope.None)]
            public static extern int SHGetMalloc([Out, MarshalAs(UnmanagedType.LPArray)] WinFormUnsafeNativeMethods.IMalloc[] ppMalloc);
        ...
        public interface IOleDocumentView
        {
            ...
            void SetRect(
                 [In]
                    ref WinFormNativeMethods.RECT prcView);
            ...
            void SetRectComplex(
                 [In]
                    WinFormNativeMethods.RECT prcView,
                 [In]
                    WinFormNativeMethods.RECT prcHScroll,
                 [In]
                    WinFormNativeMethods.RECT prcVScroll,
                 [In]
                    WinFormNativeMethods.RECT prcSizeBox);
        ...
        public interface IFont
        {
            ...
            void Clone(
                      out WinFormUnsafeNativeMethods.IFont ppfont);

            [System.Runtime.InteropServices.PreserveSig]
            int IsEqual(
                   [In, MarshalAs(UnmanagedType.Interface)]
                      WinFormUnsafeNativeMethods.IFont pfontOther);
