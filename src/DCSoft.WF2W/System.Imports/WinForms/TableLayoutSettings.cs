...
namespace System.Windows.Forms {
    ...
    public sealed class TableLayoutSettings : LayoutSettings, ISerializable {
        ...
        [DefaultValue(TableLayoutPanelCellBorderStyle.None), SRCategory(DCSR.CatAppearance), SRDescription(DCSR.TableLayoutPanelCellBorderStyleDescr)]
        internal TableLayoutPanelCellBorderStyle CellBorderStyle {
            ...
            set { 
                ...
                if (!ClientUtils.IsEnumValid(value, (int)value, (int)TableLayoutPanelCellBorderStyle.None, (int)TableLayoutPanelCellBorderStyle.OutsetPartial)){
                    throw new ArgumentException(DCSR.GetString(DCSR.InvalidArgument, "CellBorderStyle", value.ToString()));
                }
                _borderStyle = value;   
        ...
        /// </devdoc>
        [SRDescription(DCSR.GridPanelColumnsDescr)]
        ...
        public int ColumnCount {
            ...
            set { 
                if (value < 0) {                    
                     throw new ArgumentOutOfRangeException("ColumnCount", value, DCSR.GetString (DCSR.InvalidLowBoundArgumentEx, "ColumnCount", value.ToString (CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture)));
                }
                TableLayout.ContainerInfo containerInfo = TableLayout.GetContainerInfo(Owner);         
        ...
        /// causing out of memory exception
        /// </devdoc>
        [SRDescription(DCSR.GridPanelRowsDescr)]
        [SRCategory(DCSR.CatLayout)]
        [DefaultValue(0)]
        public int RowCount {
            get { 
            ...
            set { 
                if (value < 0) {                    
                     throw new ArgumentOutOfRangeException("RowCount", value, DCSR.GetString (DCSR.InvalidLowBoundArgumentEx, "RowCount", value.ToString (CultureInfo.CurrentCulture), (0).ToString(CultureInfo.CurrentCulture)));
                }
                TableLayout.ContainerInfo containerInfo = TableLayout.GetContainerInfo(Owner);
        ...
        [SRDescription(DCSR.GridPanelRowStylesDescr)]
        ...
        [SRDescription(DCSR.GridPanelColumnStylesDescr)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        [SRCategory(DCSR.CatLayout)]
        ...
        /// </devdoc>
        [SRDescription(DCSR.TableLayoutPanelGrowStyleDescr)]
        [SRCategory(DCSR.CatLayout)]
        ...
        public TableLayoutPanelGrowStyle GrowStyle {
            ...
            set { 
                ...
                if (!ClientUtils.IsEnumValid(value, (int)value, (int)TableLayoutPanelGrowStyle.FixedSize, (int)TableLayoutPanelGrowStyle.AddColumns)){
                    throw new ArgumentException(DCSR.GetString(DCSR.InvalidArgument, "GrowStyle", value.ToString()));
                }            
        ...
        public void SetColumnSpan(object control, int value) {
            if(value < 1) {
                throw new ArgumentOutOfRangeException("ColumnSpan", DCSR.GetString(DCSR.InvalidArgument, "ColumnSpan", (value).ToString(CultureInfo.CurrentCulture)));
            }
            if (IsStub) {
        ...
        public void SetRowSpan(object control, int value) {
            if(value < 1) {
                throw new ArgumentOutOfRangeException("RowSpan", DCSR.GetString(DCSR.InvalidArgument, "RowSpan", (value).ToString(CultureInfo.CurrentCulture)));
            }
            if (control == null) {
                throw new ArgumentNullException("control");
            }
        ...
        [SRDescription(DCSR.GridPanelRowDescr)]
        [SRCategory(DCSR.CatLayout)]
        [DefaultValue(-1)]
        ...
        public void SetRow(object control, int row) {
            ...
            if (row < -1) {
                throw new ArgumentOutOfRangeException("Row", DCSR.GetString(DCSR.InvalidArgument, "Row", (row).ToString(CultureInfo.CurrentCulture)));
            }   
        ...
        [SRDescription(DCSR.TableLayoutSettingsGetCellPositionDescr)]
        [SRCategory(DCSR.CatLayout)]
        [DefaultValue(-1)]
        ...
        //get the column position of the element
        [SRDescription(DCSR.TableLayoutSettingsSetCellPositionDescr)]
        [SRCategory(DCSR.CatLayout)]
        [DefaultValue(-1)]
        ...
        //get the column position of the element
        [SRDescription(DCSR.GridPanelColumnDescr)]
        [SRCategory(DCSR.CatLayout)]
        [DefaultValue(-1)]
        ...
        public void SetColumn(object control, int column) {
            if (column < -1) {
                throw new ArgumentException(DCSR.GetString(DCSR.InvalidArgument, "Column", (column).ToString(CultureInfo.CurrentCulture)));
            }
            if (IsStub) {
