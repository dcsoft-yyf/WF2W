...
namespace System.Drawing {
    ...
    public static class SystemBrushes {
        public static readonly Brush ActiveBorder = new SolidBrush(Color.FromArgb(-4934476),true);
        public static readonly Brush ActiveCaption = new SolidBrush(Color.FromArgb(-6703919),true);
        public static readonly Brush ActiveCaptionText = new SolidBrush(Color.FromArgb(-16777216),true);
        public static readonly Brush AppWorkspace = new SolidBrush(Color.FromArgb(-5526613),true);
        public static readonly Brush ButtonFace = new SolidBrush(Color.FromArgb(-986896),true);
        public static readonly Brush ButtonHighlight = new SolidBrush(Color.FromArgb(-1),true);
        public static readonly Brush ButtonShadow = new SolidBrush(Color.FromArgb(-6250336),true);
        public static readonly Brush Control = new SolidBrush(Color.FromArgb(-986896),true);
        public static readonly Brush ControlLightLight = new SolidBrush(Color.FromArgb(-1),true);
        public static readonly Brush ControlLight = new SolidBrush(Color.FromArgb(-1842205),true);
        public static readonly Brush ControlDark = new SolidBrush(Color.FromArgb(-6250336),true);
        public static readonly Brush ControlDarkDark = new SolidBrush(Color.FromArgb(-9868951),true);
        public static readonly Brush ControlText = new SolidBrush(Color.FromArgb(-16777216),true);
        public static readonly Brush Desktop = new SolidBrush(Color.FromArgb(-16777216),true);
        public static readonly Brush GradientActiveCaption = new SolidBrush(Color.FromArgb(-4599318),true);
        public static readonly Brush GradientInactiveCaption = new SolidBrush(Color.FromArgb(-2628366),true);
        public static readonly Brush GrayText = new SolidBrush(Color.FromArgb(-9605779),true);
        public static readonly Brush Highlight = new SolidBrush(Color.FromArgb(-16746281),true);
        public static readonly Brush HighlightText = new SolidBrush(Color.FromArgb(-1),true);
        public static readonly Brush HotTrack = new SolidBrush(Color.FromArgb(-16750900),true);
        public static readonly Brush InactiveCaption = new SolidBrush(Color.FromArgb(-4207141),true);
        public static readonly Brush InactiveBorder = new SolidBrush(Color.FromArgb(-722948),true);
        public static readonly Brush InactiveCaptionText = new SolidBrush(Color.FromArgb(-16777216),true);
        public static readonly Brush Info = new SolidBrush(Color.FromArgb(-31),true);
        public static readonly Brush InfoText = new SolidBrush(Color.FromArgb(-16777216),true);
        public static readonly Brush Menu = new SolidBrush(Color.FromArgb(-986896),true);
        public static readonly Brush MenuBar = new SolidBrush(Color.FromArgb(-986896),true);
        public static readonly Brush MenuHighlight = new SolidBrush(Color.FromArgb(-13395457),true);
        public static readonly Brush MenuText = new SolidBrush(Color.FromArgb(-16777216),true);
        public static readonly Brush ScrollBar = new SolidBrush(Color.FromArgb(-3618616),true);
        public static readonly Brush Window = new SolidBrush(Color.FromArgb(-1),true);
        public static readonly Brush WindowFrame = new SolidBrush(Color.FromArgb(-10197916),true);
        public static readonly Brush WindowText = new SolidBrush(Color.FromArgb(-16777216),true);
        ...
        public static Brush FromSystemColor(Color c)
        {
            if (!c.IsSystemColor)
            {
                throw new ArgumentException(DCSR.GetString(DCSR.ColorNotSystemColor, c.ToString()));
            }
