    ...
    public class FontConverter : TypeConverter {
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType) {
            ...
            if (destinationType == typeof(string)) {
                ...
                if (font == null) {
                    return DCSR.GetString(DCSR.toStringNone);
                }
                else {
                    if (culture == null) {
                        culture = CultureInfo.CurrentCulture;
        ...
        public override object CreateInstance(ITypeDescriptorContext context, IDictionary propertyValues) {
            ...
            if( !(  name is string &&
                ...
                throw new ArgumentException( DCSR.GetString( DCSR.PropertyValueInvalidEntry ) );    
            }
        ...
        private ArgumentException GetFormatException(string text, char separator){
            ...
            return new ArgumentException(DCSR.GetString(DCSR.TextParseFailedFormat, text, fonstStringFormat));
        }
        ...
        private GraphicsUnit ParseGraphicsUnits(string units) {
            ...
            if (unitName == null) {
                throw new ArgumentException(DCSR.GetString(DCSR.InvalidArgument, "units", units));
            }
