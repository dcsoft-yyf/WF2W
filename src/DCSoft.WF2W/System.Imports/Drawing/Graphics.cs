...
namespace System.Drawing
{
    ...
    public sealed class Graphics : MarshalByRefObject, IDisposable, IDeviceContext
    {
        ...
        public IntPtr NativeGraphics = IntPtr.Zero;
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public void ReleaseHdc(IntPtr hnd)
        {

        }
        public object GetContextInfo() { return null; }

        private static readonly Dictionary<int,Graphics> _HDC_Graphics_Map = new Dictionary<int, Graphics>();

        private static int _HDCCounter = 1;
        private int _HDC = 0;
        ...
        public IntPtr GetHdc()
        {
            if(this._HDC == 0 )
            {
                this._HDC = _HDCCounter++;
                _HDC_Graphics_Map[this._HDC] = this;
            }
            return (IntPtr)this._HDC;
        }
        public void ReleaseHdcInternal(IntPtr p)
        {

        }
        public static Graphics FromHdcInternal(IntPtr p)
        {
            if (p == IntPtr.Zero) return null;
            if( _HDC_Graphics_Map.TryGetValue((int)p , out var g ) )
            {
                return g;
            }
            return null;
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public static Graphics FromHdc(IntPtr p)
        {
            if (p == IntPtr.Zero) return null;
            if (_HDC_Graphics_Map.TryGetValue((int)p, out var g))
            {
        ...
        public static Graphics FromHwndInternal(IntPtr p)
        {
            return CreateCanvas();
        }
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        internal void ResetHasContent()
        {
            this._HasContent = false;
        }
        internal bool HasContent
        {
            get { return this._HasContent; }
        }
        private Graphics()
        {
            //this._Canvas = new CanvasGraphics(this);
        }

        public static Graphics CreateCanvas()
        {
            var g = new Graphics();
            g._Canvas = new CanvasGraphics(g);
            return g;
        }

        public static Graphics CreateSVG( System.IO.TextWriter writer ,int pageWidth , int pageHeight)
        {
            var g = new Graphics();
            g._SVG = new SVGGraphics(writer);
            g._SVG.StartSVGPageContent(pageWidth, pageHeight);
            return g;
        }

        private SVGGraphics _SVG = null;
        internal SVGGraphics BaseSVG { get { return this._SVG; } }

        private CanvasGraphics _Canvas = null;
        internal CanvasGraphics BaseCanvas
        {
        ...
        {
            this._Canvas.SetAbsoluteOffset(x, y);
        }
        /// <summary>
        /// 缩放比率
        /// </summary>
        internal float ZoomRate
        {
            get
            {
                return this._Canvas.ZoomRate;
            }
            set
            {
                this._Canvas.ZoomRate = value;
            }
        }
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public RectangleF ClipBounds
        {
            get
            {
                ...
                {
                    return this._Canvas.ClipBounds;
                }
                if (this._SVG != null)
                {
                    return this._SVG.ClipRectangle;
                }
        ...
        public InterpolationMode InterpolationMode
        {
            get
            {
                ...
                if (this._Canvas != null)
                {
                    return this._Canvas.InterpolationMode;
                }
            ...
            set
            {
                ...
                if (this._Canvas != null)
                {
                    this._Canvas.InterpolationMode = value;
                }
            }
        }
        ...
        public PixelOffsetMode PixelOffsetMode
        {
            get
            {
                ...
                if (this._Canvas != null)
                {
                    return this._Canvas.PixelOffsetMode;
                }
            ...
            set
            {
                ...
                if (this._Canvas != null)
                {
                    this._Canvas.PixelOffsetMode = value;
                }
            }
        }
        ...
        public SmoothingMode SmoothingMode
        {
            get
            {
                ...
                if (this._Canvas != null)
                {
                    return this._Canvas.SmoothingMode;
                }
            ...
            set
            {
                ...
                if (this._Canvas != null)
                {
                    this._Canvas.SmoothingMode = value;
                }
            }
        }
        ...
        public TextRenderingHint TextRenderingHint
        {
            get
            {
                ...
                if (this._Canvas != null)
                {
                    return this._Canvas.TextRenderingHint;
                }
            ...
            set
            {
                ...
                if (this._Canvas != null)
                {
                    this._Canvas.TextRenderingHint = value;
                }
            }
        }
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        public void ApplyTransformData()
        {
            if (this._Canvas != null)
            {
                this._Canvas.ApplyTransformData();
            }
        }
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        public void TranslateTransform(float x, float y)
        {
            if (this._Canvas != null)
            {
                this._Canvas.TranslateTransform(x, y);
            }
            else if (this._SVG != null)
            {
                this._SVG.TranslateTransform(x, y);
            }
        }
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public void TranslateTransform(float x, float y,MatrixOrder order)
        {
            if (this._Canvas != null)
            {
                this._Canvas.TranslateTransform(x, y , order);
            }
            else if (this._SVG != null)
            {
                this._SVG.TranslateTransform(x, y);
        ...
        public void ScaleTransform(float sx, float sy)
        {
            if (this._Canvas != null)
            {
                this._Canvas.ScaleTransform(sx, sy);
            }
            else if (this._SVG != null)
            {
                this._SVG.Transform.Scale(sx, sy);
            }
        }
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public void RotateTransform(float angle)
        {
            if (this._Canvas != null)
            {
                this._Canvas.RotateTransform(angle);
            }
            else if (this._SVG != null)
            {
                this._SVG.RotateTransform(angle);
            }
        }
        ...
        public void DrawRectangle(Pen pen, float x, float y, float width, float height, float radius = 0)
        {
            ...
            if (this._Canvas != null)
            {
                this._Canvas.DrawRectangle(pen, x, y, width, height, radius);
            }
            else if (this._SVG != null)
            {
                this._SVG.DrawRectangle(pen, x, y, width, height, radius);
            }
        }
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        public void DrawEllipse(Pen pen, float x, float y, float width, float height)
        {
            ...
            if (this._Canvas != null)
            {
                this._Canvas.DrawEllipse(pen, x, y, width, height);
            }
            else if (this._SVG != null)
            {
                this._SVG.DrawEllipse(pen, x, y, width, height);
            }
        }
        ...
        public void DrawPie(Pen pen, float x, float y, float width, float height, float startAngle, float sweepAngle)
        {
            ...
            if (this._Canvas != null)
            {
                this._Canvas.DrawPie(pen, x, y, width, height, startAngle, sweepAngle);
            }
            else if (this._SVG != null)
            {
                this._SVG.DrawPie(pen, x, y, width, height, startAngle, sweepAngle);
            }
        }
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        public void DrawPath(Pen pen, GraphicsPath path)
        {
            ...
            if (this._Canvas != null)
            {
                this._Canvas.DrawPath(pen, path);
            }
            else if (this._SVG != null)
            {
                this._SVG.DrawPath(pen, path);
            }
        }
        ...
        public void FillRectangle(Brush brush, float x, float y, float width, float height)
        {
            ...
            if (this._Canvas != null)
            {
                this._Canvas.FillRectangle(brush, x, y, width, height);
            }
            else if (this._SVG != null)
            {
                this._SVG.FillRectangle(brush, x, y, width, height, 0);
            }
        }
        ...
        public void FillPolygon(Brush brush, PointF[] points)
        {
            ...
            if (this._Canvas != null)
            {
                this._Canvas.FillPolygon(brush, points);
            }
            else if (this._SVG != null)
            {
                using var path = new GraphicsPath();
                path.AddPolygon(points);
                this._SVG.FillPath(brush, path);
            }
        }
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public void FillPolygon(Brush brush, Point[] points)
        {
            ...
            {
                using var path = new GraphicsPath();
                path.AddPolygon(DCValueConvert.ToPointFArray(points));
                this._SVG.FillPath(brush, path);
            }
        }
        ...
        public void FillEllipse(Brush brush, float x, float y, float width, float height)
        {
            ...
            if (this._Canvas != null)
            {
                this._Canvas.FillEllipse(brush, x, y, width, height);
            }
            else if (this._SVG != null)
            {
                this._SVG.FillEllipse(brush, x, y, width, height);
            }
        }
        ...
        public void FillPie(Brush brush, float x, float y, float width, float height, float startAngle, float sweepAngle)
        {
            ...
            if (this._Canvas != null)
            {
                this._Canvas.FillPie(brush, x, y, width, height, startAngle, sweepAngle);
            }
            else if (this._SVG != null)
            {
                this._SVG.FillPie(brush, x, y, width, height, startAngle, sweepAngle);
            }
        }
        ...
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public void DrawString(string txt, Font font, Brush brush, RectangleF layoutRectangle, StringFormat format)
        {
            this._HasContent = true;
            if (this._Canvas != null)
            {
                this._Canvas.DrawString(txt, font, brush, layoutRectangle.Left , layoutRectangle.Top , layoutRectangle.Width , layoutRectangle.Height , format);
            }
            else if (this._SVG != null)
            {
                var color = brush is SolidBrush solidBrush ? solidBrush.Color : Color.Black;
                this._SVG.DrawString(txt, font.Name, font.Size, font.Style, color, layoutRectangle, format);
            }
        }
        ...
        {
            return this._Canvas.MeasureString(text, font);
        }
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        public SizeF MeasureString(string text, Font font, int width, StringFormat format)
        {
            ...
            return this._Canvas.MeasureString(text, font, width, format);
        }
        ...
        {
            this._Canvas.SetImageSmoothing(v);
        }
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        public void DrawImage(Image image, float x, float y, float width, float height)
        {
            ...
            if (this._Canvas != null)
            {
                this._Canvas.DrawImage(image, x, y, width, height);
            }
            else if(this._SVG != null )
            {
                this._SVG.DrawImage(image, x, y, width, height , null );
            }
        }
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        public void DrawImage(Image image, RectangleF destRect, RectangleF srcRect, GraphicsUnit srcUnit)
        {
            ...
            if (this._Canvas != null)
            {
                ...
                this._Canvas.DrawImage(image, destRect, srcRect, srcUnit);
            }
            else if (this._SVG != null)
            {
                this._SVG.DrawImage(image, destRect, srcRect, srcUnit, null);
            }
        }
        ...
        public void DrawLine(Pen pen, float x1, float y1, float x2, float y2)
        {
            ...
            if (this._Canvas != null)
            {
                this._Canvas.DrawLine(pen, x1, y1, x2, y2);
            }
            else if(this._SVG != null )
            {
        ...
        public void DrawLines(Pen pen, PointF[] points)
        {
            ...
            if (this._Canvas != null)
            {
                this._Canvas.DrawLines(pen, points);
            }
            else if(this._SVG != null )
            {
        ...
        public void DrawLines(Pen pen, Point[] points)
        {
            ...
            {
                this._SVG.DrawLines(pen, DCValueConvert.ToPointFArray( points));
            }
        }
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        public void FillPath(Brush brush, GraphicsPath path)
        {
            ...
            if (this._Canvas != null)
            {
                this._Canvas.FillPath(brush, path);
            }
            else if(this._SVG != null )
            {
                this._SVG.FillPath(brush, path);
        ...
        public async System.Threading.Tasks.Task<byte[]> UpdateContentImage()
        {
            if (this._ParentImage is Bitmap bitmap)
            {
                var writer = new MyBinaryBuilder();
                writer.AppendInt16((short)bitmap.Width);
                writer.AppendInt16((short)bitmap.Height);
                writer.AppendByte((byte)Bitmap.StaticGetImageFormatByteHeaderFlag(bitmap.Data));
                writer.AppendByteArray(bitmap.Data);
                var bs = this.FinallyWriteTo(writer);
                writer.Dispose();
                var strResultFormat = "jpg";
                if (bitmap.IsPng) strResultFormat = "png";
                else if (bitmap.IsBmp) strResultFormat = "bmp";
                var bsResult = await DCPaintToImageHandler(bs, strResultFormat);
                bitmap.Data = bsResult;
                return bsResult;
            }
            return null;
        }
        ...
        public void Restore(GraphicsState gstate)
        {
            ...
            CheckDispose();
            if (this._Canvas != null) this._Canvas.Restore(gstate);
            else if (this._SVG != null) this._SVG.RestoreState(gstate);
        }

        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public GraphicsState Save()
        {
            if (this._Canvas != null) return this._Canvas.Save();
            else if (this._SVG != null) return this._SVG.SaveState();
            return null;
        }

        

        internal static System.Func<byte[],string, System.Threading.Tasks.Task<byte[]>> DCPaintToImageHandler = null;
        ...
        public void Dispose()
        {
            if(this._HDC > 0 )
            {
                _HDC_Graphics_Map.Remove(this._HDC);
                this._HDC = 0;
            }
        ...
        {
            return this._Canvas.ToByteArray();
        }
        internal byte[] FinallyWriteTo(MyBinaryBuilder strResult)
        {
            return this._Canvas.FinallyWriteTo(strResult);
        }
        ...
        public CompositingQuality CompositingQuality
        {
            get
            {
                return this._CompositingQuality;
            }
            set
            {
        ...
        public Region Clip
        {
            get
            {
                if (this._Canvas != null) return this._Canvas.Clip;
                else if (this._SVG != null) return this._SVG.Clip;
                return null;
            ...
            set
            {
                if (this._Canvas != null) this._Canvas.Clip = value;
                else if (this._SVG != null) this._SVG.Clip = value;
            }
        }
