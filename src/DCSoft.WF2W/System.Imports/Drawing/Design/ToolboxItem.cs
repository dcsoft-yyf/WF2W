...
namespace System.Drawing.Design {
    ...
    public class ToolboxItem : ISerializable {
        ...
        public virtual string ComponentType {
            get {
                return DCSR.GetString(DCSR.DotNET_ComponentType);
            }
        }
        ...
        protected void CheckUnlocked() {
            if (Locked) throw new InvalidOperationException(DCSR.GetString(DCSR.ToolboxItemLocked));
        }
        ...
        protected void ValidatePropertyType(string propertyName, object value, Type expectedType, bool allowNull) {
            if (value == null) {
                ...
                if (!expectedType.IsInstanceOfType(value)) {
                    throw new ArgumentException(DCSR.GetString(DCSR.ToolboxItemInvalidPropertyType, propertyName, expectedType.FullName), "value");
                }
            }
        }
        ...
        private class LockableDictionary : Hashtable
        {
            ...
            private void CheckSerializable(object value) {
                if (value != null && !value.GetType().IsSerializable) {
                    throw new ArgumentException(DCSR.GetString(DCSR.ToolboxItemValueNotSerializable, value.GetType().FullName));
                }
            }
            ...
            private string GetPropertyName(object key) {
                ...
                if (propertyName == null || propertyName.Length == 0) {
                    throw new ArgumentException(DCSR.GetString(DCSR.ToolboxItemInvalidKey), "key");
                }
