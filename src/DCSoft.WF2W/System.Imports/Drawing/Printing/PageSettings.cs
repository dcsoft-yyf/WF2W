...
namespace System.Drawing.Printing
{
    ...
    public class PageSettings : ICloneable
    {
        ...
        private PaperSize _PaperSize = PaperSize.A4Instance;
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        public PrinterResolution PrinterResolution
        {
            get
            {
                ...
                {
                    this.printerResolution = new PrinterResolution();
                    ////IntSecurity.AllPrintingAndUnmanagedCode.Assert();
        ...
        internal Rectangle GetBounds()
        {
            if (this.Landscape)
            {
                return new Rectangle(0, 0, this.PaperSize.Width, this.PaperSize.Height);
            }
            else
            {
                return new Rectangle(0, 0, this.PaperSize.Height, this.PaperSize.Width);
            }
        }
