...
namespace System.Drawing.Printing {
    ...
    public class PrinterSettings : ICloneable {
        private static readonly PaperSourceCollection _StandardPaperSources;
        private static readonly PaperSizeCollection _StandardPaperSizes;
        static PrinterSettings()
        {
            var ps = new PaperSource(PaperSourceKind.Manual ,"Default");
            _StandardPaperSources = new PaperSourceCollection(new PaperSource[] { ps });
            _StandardPaperSizes = new PaperSizeCollection(PaperSize.StandartInstances);
        }
        ...
        private string printerName = GetDefaultPrinterName(); // default printer.
        ...
        public bool CanDuplex {
            get { return false; }// DeviceCapabilities(SafeNativeMethods.DC_DUPLEX, IntPtr.Zero, 0) == 1;}
        }
        ...
        public short Copies {
            ...
            set {
                ...
                //if (value < 0)
                //    throw new ArgumentException(DCSR.GetString(DCSR.InvalidLowBoundArgumentEx,
        ...
        */
        ...
        private static StringCollection _InstalledPrinters = new StringCollection(new string[] { GetDefaultPrinterName() });
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        public bool IsPlotter {
            get {
                return false;// GetDeviceCaps(SafeNativeMethods.TECHNOLOGY, SafeNativeMethods.DT_RASPRINTER) == SafeNativeMethods.DT_PLOTTER;
            }
        }
        ...
        public bool IsValid {
            get {
                return true;// DeviceCapabilities(SafeNativeMethods.DC_COPIES, IntPtr.Zero, -1) != -1;
            }
        }
        ...
        public int LandscapeAngle
        {
            get
            {
                return 90; // DeviceCapabilities(SafeNativeMethods.DC_ORIENTATION, IntPtr.Zero, 0);
            }
        }
        ...
        public int MaximumCopies {
            get 
            {
                return 10000;// return DeviceCapabilities(SafeNativeMethods.DC_COPIES, IntPtr.Zero, 1);
            }
        }
        ...
        private string _PrintFileName = null;
        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        ...
        public PaperSizeCollection PaperSizes {
            get { return _StandardPaperSizes;}
        }

        [System.Reflection.Obfuscation(Exclude = true, ApplyToMembers = true)]
        public PaperSourceCollection PaperSources {
            get { return _StandardPaperSources; }
        }
        ...
        private static string GetDefaultPrinterName() {
            ...
            //    if (!status)
            //        return DCSR.GetString(DCSR.NoDefaultPrinter);
        ...
        public void SetHdevmode(IntPtr hdevmode) {
            ...
            if (hdevmode == IntPtr.Zero)
                throw new ArgumentException(DCSR.GetString(DCSR.InvalidPrinterHandle, hdevmode));
        ...
        public void SetHdevnames(IntPtr hdevnames) {
            ...
            if (hdevnames == IntPtr.Zero)
                throw new ArgumentException(DCSR.GetString(DCSR.InvalidPrinterHandle, hdevnames));
