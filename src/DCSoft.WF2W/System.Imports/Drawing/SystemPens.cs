...
namespace System.Drawing {
    ...
    public static class SystemPens {
        public static readonly Pen ActiveBorder = new Pen(Color.FromArgb(-4934476),true);
        public static readonly Pen ActiveCaption = new Pen(Color.FromArgb(-6703919),true);
        public static readonly Pen ActiveCaptionText = new Pen(Color.FromArgb(-16777216),true);
        public static readonly Pen AppWorkspace = new Pen(Color.FromArgb(-5526613),true);
        public static readonly Pen ButtonFace = new Pen(Color.FromArgb(-986896),true);
        public static readonly Pen ButtonHighlight = new Pen(Color.FromArgb(-1),true);
        public static readonly Pen ButtonShadow = new Pen(Color.FromArgb(-6250336),true);
        public static readonly Pen Control = new Pen(Color.FromArgb(-986896),true);
        public static readonly Pen ControlText = new Pen(Color.FromArgb(-16777216),true);
        public static readonly Pen ControlDark = new Pen(Color.FromArgb(-6250336),true);
        public static readonly Pen ControlDarkDark = new Pen(Color.FromArgb(-9868951),true);
        public static readonly Pen ControlLight = new Pen(Color.FromArgb(-1842205),true);
        public static readonly Pen ControlLightLight = new Pen(Color.FromArgb(-1),true);
        public static readonly Pen Desktop = new Pen(Color.FromArgb(-16777216),true);
        public static readonly Pen GradientActiveCaption = new Pen(Color.FromArgb(-4599318),true);
        public static readonly Pen GradientInactiveCaption = new Pen(Color.FromArgb(-2628366),true);
        public static readonly Pen GrayText = new Pen(Color.FromArgb(-9605779),true);
        public static readonly Pen Highlight = new Pen(Color.FromArgb(-16746281),true);
        public static readonly Pen HighlightText = new Pen(Color.FromArgb(-1),true);
        public static readonly Pen HotTrack = new Pen(Color.FromArgb(-16750900),true);
        public static readonly Pen InactiveBorder = new Pen(Color.FromArgb(-722948),true);
        public static readonly Pen InactiveCaption = new Pen(Color.FromArgb(-4207141),true);
        public static readonly Pen InactiveCaptionText = new Pen(Color.FromArgb(-16777216),true);
        public static readonly Pen Info = new Pen(Color.FromArgb(-31),true);
        public static readonly Pen InfoText = new Pen(Color.FromArgb(-16777216),true);
        public static readonly Pen Menu = new Pen(Color.FromArgb(-986896),true);
        public static readonly Pen MenuBar = new Pen(Color.FromArgb(-986896),true);
        public static readonly Pen MenuHighlight = new Pen(Color.FromArgb(-13395457),true);
        public static readonly Pen MenuText = new Pen(Color.FromArgb(-16777216),true);
        public static readonly Pen ScrollBar = new Pen(Color.FromArgb(-3618616),true);
        public static readonly Pen Window = new Pen(Color.FromArgb(-1),true);
        public static readonly Pen WindowFrame = new Pen(Color.FromArgb(-10197916),true);
        public static readonly Pen WindowText = new Pen(Color.FromArgb(-16777216),true);
