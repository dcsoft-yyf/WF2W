    ...
    internal static class DpiHelper
    {
        ...
        private static void Initialize()
        {
            ...
            if (enableHighDpi)
            {
                ...
                //if (hDC != IntPtr.Zero)
                //{
                //    deviceDpiX = WinFormUnsafeNativeMethods.GetDeviceCaps(new HandleRef(null, hDC), WinFormNativeMethods.LOGPIXELSX);
                //    deviceDpiY = WinFormUnsafeNativeMethods.GetDeviceCaps(new HandleRef(null, hDC), WinFormNativeMethods.LOGPIXELSY);
