...
#endif
{
    ...
    sealed partial class DeviceContext : MarshalByRefObject, IDeviceContext, IDisposable
    {
        ...
        public Color BackgroundColor
        {
            get
            {
                return this.BackgroundColor;// ColorTranslator.FromWin32(IntUnsafeNativeMethods.GetBkColor( new HandleRef( this, this.Hdc )));
            }
#if WINFORMS_PUBLIC_GRAPHICS_LIBRARY
            set
            {
        ...
        private DeviceContextBackgroundMode _BackgroundMode = DeviceContextBackgroundMode.Transparent;
        /// <devdoc>
        ///     DC background mode.
        /// </devdoc>  
        public DeviceContextBackgroundMode BackgroundMode 
        {
            get
            {
                return this._BackgroundMode;// (DeviceContextBackgroundMode) IntUnsafeNativeMethods.GetBkMode( new HandleRef( this, this.Hdc ) );
            }
#if WINFORMS_PUBLIC_GRAPHICS_LIBRARY
            set
            {
        ...
        {
            var v = this._BackgroundMode;
            this._BackgroundMode = newMode;
            return v;
            //return (DeviceContextBackgroundMode) IntUnsafeNativeMethods.SetBkMode(new HandleRef(this, this.Hdc), (int) newMode);
        }

        private DeviceContextBinaryRasterOperationFlags _BinaryRasterOperation = DeviceContextBinaryRasterOperationFlags.CopyPen;
        /// <devdoc>
        ...
        public DeviceContextBinaryRasterOperationFlags BinaryRasterOperation
        {
            get
            {
                return this._BinaryRasterOperation;// (DeviceContextBinaryRasterOperationFlags) IntUnsafeNativeMethods.GetROP2( new HandleRef( this, this.Hdc ) );
            }
            /*
        ...
        {
            var v = this._BinaryRasterOperation;
            this._BinaryRasterOperation = rasterOperation;
            return v;
        ...
        private WindowsFont _Font = new WindowsFont(SystemFonts.DefaultFontName);
...
//                return WindowsFont.FromHdc( this.Hdc );
        ...
        public IntPtr SelectFont( WindowsFont font )
        {
            ...
            WindowsFont previousFont = this.selectedFont;            
            this.selectedFont = font;
            this.hCurrentFont = font.Hfont;
            if (previousFont == null) return IntPtr.Zero;
            else return previousFont.Hfont;
...
//            return result;
        ...
        private DeviceContextMapMode _MapMode = DeviceContextMapMode.HiMetric;
        /// <devdoc>
        ...
        private DeviceContextTextAlignment _TextAlignment = DeviceContextTextAlignment.Default;
        /// <devdoc>
        ///     DC text alignment.
        /// </devdoc>  
        ...
        {
            var v = this._TextAlignment;
            this._TextAlignment = newAligment;
            return v;
        ...
        private Size _ViewportExtent = Size.Empty;
        /// <devdoc>
        ...
        {
            var v = this._ViewportExtent;
            this._ViewportExtent = newExtent;
            return v;
        ...
        private Point _ViewportOrigin = Point.Empty;
        /// <devdoc>
        ...
        {
            var v = this._ViewportOrigin;
            this._ViewportOrigin = newOrigin;
            return v;
