...
internal sealed partial class BinaryFormattedObject
{
    internal sealed class DefaultTypeResolver : ITypeResolver
    {
        ...
        Type ITypeResolver.GetType(TypeName typeName)
        {
            ...
            _types[typeName.AssemblyQualifiedName] = type ?? throw new SerializationException(DCResourceSR.Format(DCResourceSR.Serialization_MissingType, typeName.AssemblyQualifiedName));
            return type;
        }
