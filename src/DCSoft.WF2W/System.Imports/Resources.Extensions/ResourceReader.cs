...
#if RESOURCES_EXTENSIONS
    using DCResourceReader = DCDeserializingResourceReader;
#endif
#pragma warning restore IDE0065
        ...
        : IResourceReader
    {
        ...
        public
#if RESOURCES_EXTENSIONS
        DCDeserializingResourceReader(string fileName)
#else
        ...
        public
#if RESOURCES_EXTENSIONS
        DCDeserializingResourceReader(Stream stream)
#else
...
#endif
        {
            ...
            if (!stream.CanRead)
            {
                throw new ArgumentException(DCResourceSR.Argument_StreamNotReadable);
            }
        ...
        private void SkipString()
        {
            ...
            if (stringLength < 0)
            {
                throw new BadImageFormatException(DCResourceSR.BadImageFormat_NegativeStringLength);
            }
        ...
        private unsafe int GetNamePosition(int index)
        {
            ...
            {
                throw new FormatException(DCResourceSR.Format(DCResourceSR.BadImageFormat_ResourcesNameInvalidOffset, r));
            }
            return r;
        }
        ...
        {
            if (_resCache == null)
                throw new InvalidOperationException(DCResourceSR.ResourceReaderIsClosed);
            ...
            lock (this)
            {
                for (int i = lo; i <= hi; i++)
                {
                    ...
                    if (CompareStringEqualsName(name))
                    {
                        ...
                        {
                            throw new FormatException(DCResourceSR.Format(DCResourceSR.BadImageFormat_ResourcesDataInvalidOffset, dataPos));
                        }
                        return dataPos;
                    }
                }
        ...
        private unsafe bool CompareStringEqualsName(string name)
        {
            ...
            if (_ums != null)
            {
                ...
                {
                    throw new BadImageFormatException(DCResourceSR.BadImageFormat_ResourcesNameTooLong);
                }
            ...
            else
            {
                ...
                while (numBytesToRead > 0)
                {
                    ...
                    if (n == 0)
                        throw new BadImageFormatException(DCResourceSR.BadImageFormat_ResourceNameCorrupted);
                    numBytesToRead -= n;
                }
            ...
            lock (this)
            {
                ...
                if (_ums != null)
                {
                    if (_ums.Position > _ums.Length - byteLen)
                        throw new BadImageFormatException(DCResourceSR.Format(DCResourceSR.BadImageFormat_ResourcesIndexTooLong, index));
                    ...
                    {
                        throw new FormatException(DCResourceSR.Format(DCResourceSR.BadImageFormat_ResourcesDataInvalidOffset, dataOffset));
                    }
                    return s;
                }
                ...
                while (count > 0)
                {
                    ...
                    if (n == 0)
                        throw new EndOfStreamException(DCResourceSR.Format(DCResourceSR.BadImageFormat_ResourceNameCorrupted_NameIndex, index));
                    count -= n;
                }
                dataOffset = _store.ReadInt32();
                if (dataOffset < 0 || dataOffset >= _store.BaseStream.Length - _dataSectionOffset)
            ...
            lock (this)
            {
                ...
                if (_version == 1)
                {
                    ...
                    if (FindType(typeIndex) != typeof(string))
                        throw new InvalidOperationException(DCResourceSR.Format(DCResourceSR.InvalidOperation_ResourceNotString_Type, FindType(typeIndex).FullName));
                    s = _store.ReadString();
                }
                else
                {
                    ...
                    if (typeCode != ResourceTypeCode.String && typeCode != ResourceTypeCode.Null)
                    {
                        ...
                        throw new InvalidOperationException(DCResourceSR.Format(DCResourceSR.InvalidOperation_ResourceNotString_Type, typeString));
                    }
        ...
        private object? LoadObjectV1(int pos)
        {
            ...
            {
                throw new BadImageFormatException(DCResourceSR.BadImageFormat_TypeMismatch, eof);
            }
            catch (ArgumentOutOfRangeException e)
            {
                throw new BadImageFormatException(DCResourceSR.BadImageFormat_TypeMismatch, e);
            }
        }
        ...
        private object? _LoadObjectV2(int pos, out ResourceTypeCode typeCode)
        {
            ...
            switch (typeCode)
            {
                ...
                case ResourceTypeCode.ByteArray:
                    {
                        ...
                        if (len < 0)
                        {
                            throw new BadImageFormatException(DCResourceSR.Format(DCResourceSR.BadImageFormat_ResourceDataLengthInvalid, len));
                        }
                ...
                default:
                    if (typeCode < ResourceTypeCode.StartOfUserTypes)
                    {
                        throw new BadImageFormatException(DCResourceSR.BadImageFormat_TypeMismatch);
                    }
                    break;
            }
        ...
        private void ReadResources()
        {
            ...
            {
                throw new BadImageFormatException(DCResourceSR.BadImageFormat_ResourcesHeaderCorrupted, eof);
            }
            catch (IndexOutOfRangeException e)
            {
                throw new BadImageFormatException(DCResourceSR.BadImageFormat_ResourcesHeaderCorrupted, e);
            }
        }
        ...
        private void _ReadResources()
        {
            ...
            if (magicNum != ResourceManager.MagicNumber)
                throw new ArgumentException(DCResourceSR.Resources_StreamNotValid);
            ...
            {
                throw new BadImageFormatException(DCResourceSR.BadImageFormat_ResourcesHeaderCorrupted);
            }
            ...
            else
            {
                ...
                if (!ValidateReaderType(readerType))
                    throw new NotSupportedException(DCResourceSR.Format(DCResourceSR.NotSupported_WrongResourceReader_Type, readerType));
            ...
            if (version != CurrentVersion && version != 1)
                throw new ArgumentException(DCResourceSR.Format(DCResourceSR.Arg_ResourceFileUnsupportedVersion, CurrentVersion, version));
            _version = version;
        ...
        private Type FindType(int typeIndex)
        {
            ...
            {
                throw new NotSupportedException(DCResourceSR.ResourceManager_ReflectionNotAllowed);
            }

            if (typeIndex < 0 || typeIndex >= _typeTable.Length)
            {
                throw new BadImageFormatException(DCResourceSR.BadImageFormat_InvalidType);
            }
        ...
        public static Func<string, Type> EventGetType = null;
        ...
        private Type UseReflectionToGetType(int typeIndex)
        {
            ...
            try
            {
                ...
                if (EventGetType == null)
                {
                    Console.WriteLine("DCDeserializingResourceReader.EventGetType=null");
                    _typeTable[typeIndex] = Type.GetType(typeName, true);
                }
                else
                {
                    var resultType = Type.GetType(typeName, false);
                    if(resultType == null )
                    {
                        resultType = EventGetType(typeName);
                    }
                    if(resultType == null )
                    {
                        throw new NotSupportedException("DCDeserializingResourceReader.UseReflectionToGetType:" + typeName);
                    }
                    _typeTable[typeIndex] = resultType;
                }
...
// For that reason, the bellow code is only relevant when building CoreLib's ResourceReader.
        ...
        internal sealed class ResourceEnumerator : IDictionaryEnumerator
        {
            ...
            private readonly DCResourceReader _reader;
            private bool _currentIsValid;
            private int _currentName;
            private int _dataPosition; // cached for case-insensitive table

            internal ResourceEnumerator(DCResourceReader reader)
            {
            ...
            public object Key
            {
                get
                {
                    if (_currentName == ENUM_DONE) throw new InvalidOperationException(DCResourceSR.InvalidOperation_EnumEnded);
                    if (!_currentIsValid) throw new InvalidOperationException(DCResourceSR.InvalidOperation_EnumNotStarted);
                    if (_reader._resCache == null) throw new InvalidOperationException(DCResourceSR.ResourceReaderIsClosed);
